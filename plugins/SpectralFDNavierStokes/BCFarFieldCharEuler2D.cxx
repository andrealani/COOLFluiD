...
#include "SpectralFDNavierStokes/BCFarFieldCharEuler2D.hh"
...
Framework::MethodStrategyProvider<
    BCFarFieldCharEuler2D,SpectralFDMethodData,BCStateComputer,SpectralFDNavierStokesModule >
...
void BCFarFieldCharEuler2D::setup()
{
  ...
  {
    throw Common::ShouldNotBeHereException (FromHere(),"Update variable set is not Euler2DVarSet in BCFarFieldCharEuler2D!");
  }
