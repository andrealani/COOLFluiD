#ifndef COOLFluiD_Numerics_SpectralFD_BCSubInletEulerRhoV2D_hh
#define COOLFluiD_Numerics_SpectralFD_BCSubInletEulerRhoV2D_hh
 ...
 */
class BCSubInletEulerRhoV2D : public BCStateComputer {
...
public:  // methods
  ...
  /// Constructor
  BCSubInletEulerRhoV2D(const std::string& name);

  /// Destructor
  ~BCSubInletEulerRhoV2D();

  /// Gets the Class name
  static std::string getClassName()
  {
    return "BCSubInletEulerRhoV2D";
  }
...
#endif  // COOLFluiD_Numerics_SpectralFD_BCSubInletEulerRhoV2D_hh
