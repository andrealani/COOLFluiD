...
#include "SpectralFDNavierStokes/BCSubInletEulerRhoV2D.hh"
...
Framework::MethodStrategyProvider<
    BCSubInletEulerRhoV2D,SpectralFDMethodData,BCStateComputer,SpectralFDNavierStokesModule >
  BCSubInletEulerRhoV2DProvider("SubInletEulerRhoV2D");

//////////////////////////////////////////////////////////////////////////////

void BCSubInletEulerRhoV2D::defineConfigOptions(Config::OptionList& options)
{
...
BCSubInletEulerRhoV2D::BCSubInletEulerRhoV2D(const std::string& name) :
...
BCSubInletEulerRhoV2D::~BCSubInletEulerRhoV2D()
{
  CFAUTOTRACE;
}
...
void BCSubInletEulerRhoV2D::computeGhostStates(const vector< State* >& intStates,
...
void BCSubInletEulerRhoV2D::computeGhostGradients(const std::vector< std::vector< RealVector* > >& intGrads,
...
void BCSubInletEulerRhoV2D::setup()
{
  CFAUTOTRACE;
  ...
  {
    throw Common::ShouldNotBeHereException (FromHere(),"Update variable set is not Euler2DVarSet in BCSubInletEulerRhoV2D!");
  }
...
void BCSubInletEulerRhoV2D::configure ( Config::ConfigArgs& args )
{
