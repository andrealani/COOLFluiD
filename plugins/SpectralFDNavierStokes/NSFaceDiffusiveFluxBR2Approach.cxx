...
MethodStrategyProvider<
    NSFaceDiffusiveFluxBR2Approach,SpectralFDMethodData,FaceDiffusiveFlux,SpectralFDNavierStokesModule >
NSFaceDiffusiveFluxBR2ApproachProvider("NSBR2Approach");

//////////////////////////////////////////////////////////////////////////////

NSFaceDiffusiveFluxBR2Approach::NSFaceDiffusiveFluxBR2Approach(const std::string& name) :
  FaceDiffusiveFluxBR2Approach(name),
...
NSFaceDiffusiveFluxBR2Approach::~NSFaceDiffusiveFluxBR2Approach()
{
  CFAUTOTRACE;
}
...
vector< RealVector >& NSFaceDiffusiveFluxBR2Approach::computeDiffFlux(vector< vector< RealVector* >* >& lGrads,
...
// vector< RealVector >& NSFaceDiffusiveFluxBR2Approach::computeBndDiffFlux(const vector< vector< RealVector* > >& intGrads,
...
void NSFaceDiffusiveFluxBR2Approach::setup()
{
  CFAUTOTRACE;

  FaceDiffusiveFluxBR2Approach::setup();
...
void NSFaceDiffusiveFluxBR2Approach::unsetup()
{
  CFAUTOTRACE;
...
//   m_ghostGradVarGradients.resize(0);
  ...
  FaceDiffusiveFluxBR2Approach::unsetup();
}
