#ifndef COOLFluiD_Numerics_SpectralFD_BCFarField1DCharLinEuler3D_hh
#define COOLFluiD_Numerics_SpectralFD_BCFarField1DCharLinEuler3D_hh
...
/**
 * This class represents a simple far field boundary condition for the 3D linearized Euler equations
 ...
 */
class BCFarField1DCharLinEuler3D : public BCStateComputer {

public:  // methods

  /// Constructor
  BCFarField1DCharLinEuler3D(const std::string& name);

  /// Destructor
  ~BCFarField1DCharLinEuler3D();

  /// Gets the Class name
  static std::string getClassName()
  {
    return "BCFarField1DCharLinEuler3D";
  }
...
}; // class BCFarField1DCharLinEuler3D
