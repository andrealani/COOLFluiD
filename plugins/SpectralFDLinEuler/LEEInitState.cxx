...
#include "SpectralFDLinEuler/LEEInitState.hh"
...
MethodCommandProvider<LEEInitState, SpectralFDMethodData, SpectralFDModule>
LEEInitStateProvider("LEEInitState");

////////////////////////////////////////////////////////////////////////////
//

std::vector<Common::SafePtr<BaseDataSocketSink> >
LEEInitState::needsSockets()
{
...
void LEEInitState::defineConfigOptions(Config::OptionList& options)
{
...
LEEInitState::LEEInitState(const std::string& name) :
...
LEEInitState::~LEEInitState()
{
}

////////////////////////////////////////////////////////////////////////////

void LEEInitState::setup()
{
...
void LEEInitState::configure ( Config::ConfigArgs& args )
{
  CFAUTOTRACE;
...
void LEEInitState::executeOnTrs()
{
  CFAUTOTRACE;
  ...
  CFLogDebugMin("LEEInitState::executeOnTrs() called for TRS: " << trs->getName() << "\n");
