#ifndef COOLFluiD_Numerics_SpectralFD_BCSubInletLinEulerRhoV2D_hh
#define COOLFluiD_Numerics_SpectralFD_BCSubInletLinEulerRhoV2D_hh
...
/**
 * This class represents a subsonic inlet boundary condition for the 2D Linearized Euler equations
 * Mass density and velocity components are imposed
 *
 * @author Matteo Parsani and modified by Ghader Ghorbaniasl
 */
class BCSubInletLinEulerRhoV2D : public BCStateComputer {
...
public:  // methods
  ...
  /// Constructor
  BCSubInletLinEulerRhoV2D(const std::string& name);

  /// Destructor
  ~BCSubInletLinEulerRhoV2D();

  /// Gets the Class name
  static std::string getClassName()
  {
    return "BCSubInletLinEulerRhoV2D";
  }
