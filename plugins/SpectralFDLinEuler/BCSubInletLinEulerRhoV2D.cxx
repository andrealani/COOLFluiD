...
#include "SpectralFDLinEuler/BCSubInletLinEulerRhoV2D.hh"
...
Framework::MethodStrategyProvider<
    BCSubInletLinEulerRhoV2D,SpectralFDMethodData,BCStateComputer,SpectralFDLinEulerModule >
    BCSubInletLinEulerRhoV2DProvider("SubInletLinEulerRhoV2D");

//////////////////////////////////////////////////////////////////////////////

std::vector<Common::SafePtr<BaseDataSocketSink> >
BCSubInletLinEulerRhoV2D::needsSockets()
{
...
void BCSubInletLinEulerRhoV2D::defineConfigOptions(Config::OptionList& options)
{
...
BCSubInletLinEulerRhoV2D::BCSubInletLinEulerRhoV2D(const std::string& name) :
...
BCSubInletLinEulerRhoV2D::~BCSubInletLinEulerRhoV2D()
{
  CFAUTOTRACE;
}
...
void BCSubInletLinEulerRhoV2D::computeGhostStates(const vector< State* >& intStates,
...
void BCSubInletLinEulerRhoV2D::computeGhostGradients(const std::vector< std::vector< RealVector* > >& intGrads,
                                               std::vector< std::vector< RealVector* > >& ghostGrads,
                                               const std::vector< RealVector >& normals,
                                               const std::vector< RealVector >& coords)
{
  throw Common::NotImplementedException(FromHere(),"BCSubInletLinEulerRhoV2D::computeGhostGradients(): this should not be needed for linearized Euler!!!");
}

  
//////////////////////////////////////////////////////////////////////////////

void BCSubInletLinEulerRhoV2D::setup()
{
  CFAUTOTRACE;
  ...
  {
    throw Common::ShouldNotBeHereException(FromHere(),"Update variable set is not LinEuler2DVarSet in BCSubInletLinEulerRhoV2D!");
  }
...
void BCSubInletLinEulerRhoV2D::configure ( Config::ConfigArgs& args )
{
