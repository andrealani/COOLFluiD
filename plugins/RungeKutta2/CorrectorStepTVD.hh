...
#ifndef COOLFluiD_Numerics_RungeKutta2_CorrectorStepTVD_hh
#define COOLFluiD_Numerics_RungeKutta2_CorrectorStepTVD_hh
...
class CorrectorStepTVD : public RK2Com {
public:

  /// Constructor.
  explicit CorrectorStepTVD(const std::string& name) :
    RK2Com(name),
    socket_rhs("rhs"),
    socket_u0("u0"),
...
#endif // COOLFluiD_Numerics_RungeKutta2_CorrectorStepTVD_hh
