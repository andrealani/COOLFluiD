...
#ifndef COOLFluiD_Numerics_RungeKutta2_PredictorStep_hh
#define COOLFluiD_Numerics_RungeKutta2_PredictorStep_hh
...
class PredictorStep : public RK2Com {
public:

  /// Constructor.
  explicit PredictorStep(const std::string& name) :
    RK2Com(name),
    socket_rhs("rhs"),
...
#endif // COOLFluiD_Numerics_RungeKutta2_PredictorStep_hh
