...
MethodCommandProvider<CorrectorStepTVD, RK2Data, RungeKutta2Module> correctorStepTVDProvider("CorrectorTVD");

//////////////////////////////////////////////////////////////////////////////

void CorrectorStepTVD::execute()
{
  CFAUTOTRACE;
...
vector<SafePtr<BaseDataSocketSink> > CorrectorStepTVD::needsSockets()
{
