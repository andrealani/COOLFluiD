...
#ifndef COOLFluiD_Numerics_RungeKutta2_RK2_hh
#define COOLFluiD_Numerics_RungeKutta2_RK2_hh
...
/// stepping algorithm of second order.
/// @author Tiago Quintino
class RK2 : public Framework::ConvergenceMethod {
public:
  ...
  explicit RK2(const std::string& name);
...
protected: // member data
  ...
  Common::SelfRegistPtr<RK2Com> m_setup;

  ///The UnSetup command to use
  Common::SelfRegistPtr<RK2Com> m_unSetup;

  ///The backupSol command to use
  Common::SelfRegistPtr<RK2Com> m_backupSol;

  ///The predictor step command to use
  Common::SelfRegistPtr<RK2Com> m_predictorStep;

  ///The corrector step command to use
  Common::SelfRegistPtr<RK2Com> m_correctorStep;
  ...
  ///The predictor step command string for configuration
  std::string m_predictorStepStr;

  ///The corrector step command string for configuration
  std::string m_correctorStepStr;

  ///The data to share between RungeKutta2Method commands
  Common::SharedPtr<RK2Data> m_data;
...
#endif // COOLFluiD_Numerics_RungeKutta2_RK2_hh
