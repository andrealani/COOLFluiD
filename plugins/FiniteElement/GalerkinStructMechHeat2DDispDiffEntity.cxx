#include "GalerkinStructMechHeat2DDispDiffEntity.hh"
...
MethodStrategyProvider<GalerkinStructMechHeat2DDispDiffEntity,
                       FiniteElementMethodData,
                            DiffusiveEntity,
                            FiniteElementStructMechHeatModule>
GalerkinStructMechHeat2DDispDiffEntityProvider("GalerkinStructMechHeat2DDiffusiveDisp");

//////////////////////////////////////////////////////////////////////////////

GalerkinStructMechHeat2DDispDiffEntity::GalerkinStructMechHeat2DDispDiffEntity(const std::string& name) :
...
GalerkinStructMechHeat2DDispDiffEntity::~GalerkinStructMechHeat2DDispDiffEntity()
{
}

//////////////////////////////////////////////////////////////////////////////

void GalerkinStructMechHeat2DDispDiffEntity::setup()
{
  DiffusiveEntity::setup();

  _structDiffVarSet = _diffVarSet.d_castTo<StructMechHeat2DDiffusiveDisp>();
...
RealMatrix& GalerkinStructMechHeat2DDispDiffEntity::operator() ()
{
...
//   const RealVector& shapeF = (*_localElemData->solShapeF)[iQuadPoint];
  ...
  _result(2,2) = k * thickness * grad(iState,XX)*grad(jState,XX) + grad(iState,YY)*grad(jState,YY);
...
void GalerkinStructMechHeat2DDispDiffEntity::modifyStiffness(Framework::GeometricEntity* const geo)
{
...
void GalerkinStructMechHeat2DDispDiffEntity::resetStiffness()
{
