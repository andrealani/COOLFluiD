#ifndef COOLFluiD_Numerics_FiniteElement_StatesPeriodicBC_hh
#define COOLFluiD_Numerics_FiniteElement_StatesPeriodicBC_hh
 ...
 *
 */
class StatesPeriodicBC : public FiniteElementMethodCom {
public:
  ...
  /// Constructor
  StatesPeriodicBC(const std::string& name);
...
protected: // data
  ...
  ///file name
  std::string m_otherfilename;

  ///List of states to apply the PeriodicBC
  std::vector<CFuint> m_statesList;

  std::vector<CFuint> m_otherStatesList;

  std::vector<CFuint> m_correspondingStatesList;

  CFreal m_rotationAngle;

}; // end of class StatesPeriodicBC
...
#endif // COOLFluiD_Numerics_FiniteElement_StatesPeriodicBC_hh
