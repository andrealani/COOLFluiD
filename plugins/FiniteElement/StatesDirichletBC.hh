#ifndef COOLFluiD_Numerics_FiniteElement_StatesDirichletBC_hh
#define COOLFluiD_Numerics_FiniteElement_StatesDirichletBC_hh
 ...
 *
 */
class StatesDirichletBC : public FiniteElementMethodCom {
public:
  ...
  /// Constructor
  StatesDirichletBC(const std::string& name);
...
}; // end of class StatesDirichletBC
...
#endif // COOLFluiD_Numerics_FiniteElement_StatesDirichletBC_hh
