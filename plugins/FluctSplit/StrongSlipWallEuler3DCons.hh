#ifndef COOLFluiD_Numerics_FluctSplit_StrongSlipWallEuler3DCons_hh
#define COOLFluiD_Numerics_FluctSplit_StrongSlipWallEuler3DCons_hh
 ...
 *
 */
class StrongSlipWallEuler3DCons : public FluctuationSplitCom {
...
public:
   ...
   * Constructor.
   */
  StrongSlipWallEuler3DCons(const std::string& name);

  /**
   * Default destructor
   */
  ~StrongSlipWallEuler3DCons();
...
}; // end of class StrongSlipWallEuler3DCons
