#ifndef COOLFluiD_Numerics_FluctSplit_UnsteadySmagorinskyTerm_hh
#define COOLFluiD_Numerics_FluctSplit_UnsteadySmagorinskyTerm_hh
 ...
 *
 */
class UnsteadySmagorinskyTerm : public ComputeDiffusiveTerm {
public:

  /**
   * Constructor
   */
  UnsteadySmagorinskyTerm(const std::string& name);
  
  /**
   * Default destructor
   */
  virtual ~UnsteadySmagorinskyTerm();
...
protected: // data
  ...
  Common::SafePtr<Physics::LESvki::Smagorinsky2DVarSet> _diffVar;
