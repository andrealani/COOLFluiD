#ifndef COOLFluiD_Numerics_FluctSplit_StrongSubInletEuler3DCons_hh
#define COOLFluiD_Numerics_FluctSplit_StrongSubInletEuler3DCons_hh
...
class StrongSubInletEuler3DCons : public FluctuationSplitCom {
public:

  /**
   * Constructor
   */
  StrongSubInletEuler3DCons(const std::string& name);

  /**
   * Default destructor
   */
  ~StrongSubInletEuler3DCons();
...
}; // end of class StrongSubInletEuler3DCons
