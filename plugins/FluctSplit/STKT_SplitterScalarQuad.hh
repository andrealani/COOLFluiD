#ifndef COOLFluiD_Numerics_FluctSplit_STKT_SplitterScalarQuad_hh
#define COOLFluiD_Numerics_FluctSplit_STKT_SplitterScalarQuad_hh
...
class STKT_SplitterScalarQuad : public SpaceTime_Splitter {
public:

  /**
   * Constructor
   */
  STKT_SplitterScalarQuad(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~STKT_SplitterScalarQuad();
...
}; // end of class STKT_SplitterScalarQuad
...
#endif // COOLFluiD_Numerics_FluctSplit_STKT_SplitterScalarQuad_hh
