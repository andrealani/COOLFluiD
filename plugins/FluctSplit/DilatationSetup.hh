...
#ifndef COOLFluiD_Numerics_FluctSplit_DilatationSetup_hh
#define COOLFluiD_Numerics_FluctSplit_DilatationSetup_hh
...
/// @author Andrea Lani
class FluctSplit_API DilatationSetup : public FluctuationSplitCom {
public: // member functions

  /// Constructor.
  explicit DilatationSetup(const std::string& name);

  /// Destructor.
  virtual ~DilatationSetup();
...
//   /// socket with theta clending coefficient
       Framework::DataSocketSource<CFreal> socket_dilatation;
  // /// initial limiter socket name
   std::string _dilatationSocketName;
   
    /// socket for the derivatives storage
//   Framework::DataSocketSource<RealVector> socket_variablesDerivativesU;
//   Framework::DataSocketSource<RealVector> socket_variablesDerivativesV;
//   Framework::DataSocketSource<RealVector> socket_variablesDerivativesW;
