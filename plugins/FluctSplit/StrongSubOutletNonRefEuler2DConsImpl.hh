#ifndef COOLFluiD_Numerics_FluctSplit_StrongSubOutletNonRefEuler2DConsImpl_hh
#define COOLFluiD_Numerics_FluctSplit_StrongSubOutletNonRefEuler2DConsImpl_hh
...
/**
 * Multidimensional characteristic bc for conservative variables
 *
...
class StrongSubOutletNonRefEuler2DConsImpl : public FluctuationSplitCom {
public:
   ...
   * Constructor
   */
  StrongSubOutletNonRefEuler2DConsImpl(const std::string& name);

  /**
   * Default destructor
   */
  ~StrongSubOutletNonRefEuler2DConsImpl();
...
//////////////////// SANDBOX ////////////////////////////////////////////////////
  ...
  /// the socket the data of the mean flow
  Framework::DataSocketSink<RealVector> socket_meanflowNS;
...
}; // end of class StrongSubOutletNonRefEuler2DConsImpl
