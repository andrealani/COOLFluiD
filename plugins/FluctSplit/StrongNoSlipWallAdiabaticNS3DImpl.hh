#ifndef COOLFluiD_Numerics_FluctSplit_StrongNoSlipWallAdiabaticNS3DImpl_hh
#define COOLFluiD_Numerics_FluctSplit_StrongNoSlipWallAdiabaticNS3DImpl_hh
...
/// @author Andrea Lani
class FluctSplit_API StrongNoSlipWallAdiabaticNS3DImpl : public FluctuationSplitCom {

public:

  /// Constructor.
  StrongNoSlipWallAdiabaticNS3DImpl(const std::string& name);

  /// Default destructor
  ~StrongNoSlipWallAdiabaticNS3DImpl();
...
}; // end of class StrongNoSlipWallAdiabaticNS3DImpl
...
#endif // COOLFluiD_Numerics_FluctSplit_StrongNoSlipWallAdiabaticNS3DImpl_hh
