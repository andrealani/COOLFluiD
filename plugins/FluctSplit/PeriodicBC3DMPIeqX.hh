#ifndef COOLFluiD_Numerics_FluctSplit_PeriodicBC3DMPIeqX_hh
#define COOLFluiD_Numerics_FluctSplit_PeriodicBC3DMPIeqX_hh
...
class FluctSplit_API PeriodicBC3DMPIeqX : public FluctuationSplitCom {
...
public: // functions
  ...
  /// Constructor
  PeriodicBC3DMPIeqX(const std::string& name);

  /// Default destructor
  virtual ~PeriodicBC3DMPIeqX();
