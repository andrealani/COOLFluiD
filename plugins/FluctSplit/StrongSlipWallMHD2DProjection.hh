#ifndef COOLFluiD_Numerics_FluctSplit_StrongSlipWallMHD2DProjection_hh
#define COOLFluiD_Numerics_FluctSplit_StrongSlipWallMHD2DProjection_hh
 ...
 *
 */
class StrongSlipWallMHD2DProjection : public FluctuationSplitCom {
...
public:
   ...
   * Constructor.
   */
  StrongSlipWallMHD2DProjection(const std::string& name);

  /**
   * Default destructor
   */
  ~StrongSlipWallMHD2DProjection();
...
}; // end of class StrongSlipWallMHD2DProjection
...
#endif // COOLFluiD_Numerics_FluctSplit_StrongSlipWallMHD2DProjection_hh
