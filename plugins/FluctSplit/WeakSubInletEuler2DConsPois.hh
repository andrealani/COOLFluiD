#ifndef COOLFluiD_Numerics_FluctSplit_WeakSubInletEuler2DConsPois_hh
#define COOLFluiD_Numerics_FluctSplit_WeakSubInletEuler2DConsPois_hh
 ...
 *
 */
class WeakSubInletEuler2DConsPois : public WeakBC2D {
...
public:
   ...
   * Constructor.
   */
  WeakSubInletEuler2DConsPois(const std::string& name);

  /**
   * Default destructor
   */
  ~WeakSubInletEuler2DConsPois();
