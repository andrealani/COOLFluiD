...
#include "ScalarUnsteady2DSourceTerm.hh"
...
MethodStrategyProvider<ScalarUnsteady2DSourceTerm,
		       FluctuationSplitData,
		       ComputeSourceTermFSM,
		       FluctSplitSpaceTimeModule>
su2DSTProvider("ScalarUnsteady2DSource");

//////////////////////////////////////////////////////////////////////////////

void ScalarUnsteady2DSourceTerm::defineConfigOptions(Config::OptionList& options)
{
...
ScalarUnsteady2DSourceTerm::ScalarUnsteady2DSourceTerm(const std::string& name) :
...
ScalarUnsteady2DSourceTerm::~ScalarUnsteady2DSourceTerm()
{
}

//////////////////////////////////////////////////////////////////////////////

void ScalarUnsteady2DSourceTerm::setup()
{
...
void ScalarUnsteady2DSourceTerm::computeSourceFSM(Framework::GeometricEntity *const cell,
					 RealVector& source,
