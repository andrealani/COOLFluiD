#ifndef COOLFluiD_Numerics_FluctSplit_WeakSubInletEuler3DConsHO_hh
#define COOLFluiD_Numerics_FluctSplit_WeakSubInletEuler3DConsHO_hh
 ...
 * @author Fabio Pinna
 */
class WeakSubInletEuler3DConsHO : public WeakBC3DHO {
...
public:
   ...
   * Constructor.
   */
  WeakSubInletEuler3DConsHO(const std::string& name);

  /**
   * Default destructor
   */
  ~WeakSubInletEuler3DConsHO();
