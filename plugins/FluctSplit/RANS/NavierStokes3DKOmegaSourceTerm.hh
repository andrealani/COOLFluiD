#ifndef COOLFluiD_Numerics_FluctSplit_NavierStokes3DKOmegaSourceTerm_hh
#define COOLFluiD_Numerics_FluctSplit_NavierStokes3DKOmegaSourceTerm_hh
...
class NavierStokes3DKOmegaSourceTerm : public ComputeSourceTermFSM {
public:
   ...
   * @see NavierStokes3D
   */
  NavierStokes3DKOmegaSourceTerm(const std::string& name);
  
  /**
   * Default destructor
   */
  virtual ~NavierStokes3DKOmegaSourceTerm();
...
//   {
//     std::vector<Common::SafePtr<Framework::BaseDataSocketSink> > result = NavierStokes3DKOmegaSourceTerm::needsSockets();
// 
...
}; // end of class NavierStokes3DKOmegaSourceTerm
...
#include "NavierStokes3DKOmegaSourceTerm.ci"

//////////////////////////////////////////////////////////////////////////////

#endif // COOLFluiD_Numerics_FluctSplit_NavierStokes3DKOmegaSourceTerm_hh
