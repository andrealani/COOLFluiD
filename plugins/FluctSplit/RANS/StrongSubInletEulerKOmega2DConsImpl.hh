#ifndef COOLFluiD_Numerics_FluctSplit_StrongSubInletEulerKOmega2DConsImpl_hh
#define COOLFluiD_Numerics_FluctSplit_StrongSubInletEulerKOmega2DConsImpl_hh
...
class StrongSubInletEulerKOmega2DConsImpl : public FluctuationSplitCom {
public:

  /**
   * Constructor
   */
  StrongSubInletEulerKOmega2DConsImpl(const std::string& name);

  /**
   * Default destructor
   */
  ~StrongSubInletEulerKOmega2DConsImpl();
...
private:
  ...
  RealMatrix _jacob;  
}; // end of class StrongSubInletEulerKOmega2DConsImpl
