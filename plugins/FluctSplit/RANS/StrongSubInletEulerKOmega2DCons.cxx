...
#include "StrongSubInletEulerKOmega2DCons.hh"
...
MethodCommandProvider<StrongSubInletEulerKOmega2DCons, FluctuationSplitData, FluctSplitSpaceTimeNavierStokesModule> strongSubFunctionInletLinEuler2DConsProvider("StrongSubInletEulerKOmega2DCons");

//////////////////////////////////////////////////////////////////////////////

StrongSubInletEulerKOmega2DCons::StrongSubInletEulerKOmega2DCons(const std::string& name) :
...
void StrongSubInletEulerKOmega2DCons::defineConfigOptions(Config::OptionList&
options)
{
...
StrongSubInletEulerKOmega2DCons::~StrongSubInletEulerKOmega2DCons()
{
  if (isSetup()) unsetup();
}
...
StrongSubInletEulerKOmega2DCons::needsSockets()
{
...
void StrongSubInletEulerKOmega2DCons::setup()
{
...
void StrongSubInletEulerKOmega2DCons::executeOnTrs()
{
  vector<RealVector>* bcNormalsInTrs = &_bcNormals[getCurrentTrsID()];
  DataHandle < Framework::State*, Framework::GLOBAL > states = socket_states.getDataHandle();
  DataHandle<bool> isUpdated = socket_isUpdated.getDataHandle();
...
void StrongSubInletEulerKOmega2DCons::configure ( Config::ConfigArgs& args )
{
  ...
  if(m_function_inflow.empty())
     throw BadValueException(FromHere(),"StrongSubInletEulerKOmega2DCons::setFuntion(): no incoming flow function provided.");
...
//////////////////////////////////////////////////////////////////////////////
void StrongSubInletEulerKOmega2DCons::unsetup()
{
  inflow.resize(0);
  _bcNormals.resize(0);
