#ifndef COOLFluiD_Numerics_FluctSplit_WeakSlipWallKOmega3DImpl_hh
#define COOLFluiD_Numerics_FluctSplit_WeakSlipWallKOmega3DImpl_hh
 ...
 *
 */
class WeakSlipWallKOmega3DImpl : public FluctuationSplitCom {
...
public:
   ...
   * Constructor.
   */
  WeakSlipWallKOmega3DImpl(const std::string& name);

  /**
   * Default destructor
   */
  ~WeakSlipWallKOmega3DImpl();
...
}; // end of class WeakSlipWallKOmega3DImpl
...
#endif // COOLFluiD_Numerics_FluctSplit_WeakSlipWallKOmega3DImpl_hh
