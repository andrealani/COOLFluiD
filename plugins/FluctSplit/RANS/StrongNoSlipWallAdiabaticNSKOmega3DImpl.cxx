...
#include "StrongNoSlipWallAdiabaticNSKOmega3DImpl.hh"
...
MethodCommandProvider<StrongNoSlipWallAdiabaticNSKOmega3DImpl, FluctuationSplitData, FluctSplitModule> strongNoSlipWallAdiabaticNS3DImplProvider("StrongNoSlipWallAdiabaticNSKOmega3DImpl");

//////////////////////////////////////////////////////////////////////////////
void StrongNoSlipWallAdiabaticNSKOmega3DImpl::defineConfigOptions(Config::OptionList& options)
{
...
StrongNoSlipWallAdiabaticNSKOmega3DImpl::StrongNoSlipWallAdiabaticNSKOmega3DImpl(const std::string& name) :
...
StrongNoSlipWallAdiabaticNSKOmega3DImpl::~StrongNoSlipWallAdiabaticNSKOmega3DImpl()
{
}
...
StrongNoSlipWallAdiabaticNSKOmega3DImpl::needsSockets()
{
...
void StrongNoSlipWallAdiabaticNSKOmega3DImpl::executeOnTrs()
{
  ...
  for (CFuint iState = 0; iState < statesIdx->size(); ++iState) {
	...
	(*currState)[6] = 0.0;	
	    ...
	    const CFuint kID = globalID + 5;
            const CFuint OID = globalID + 6;    
