...
#include "WeakSlipWallKOmega3DImpl.hh"
...
MethodCommandProvider<WeakSlipWallKOmega3DImpl, FluctuationSplitData, FluctSplitNavierStokesModule> 
weakSlipWallEuler3DImplProvider("WeakSlipWallKOmega3DImpl");
...
void WeakSlipWallKOmega3DImpl::defineConfigOptions(Config::OptionList& options)
{
...
WeakSlipWallKOmega3DImpl::WeakSlipWallKOmega3DImpl(const std::string& name) :
...
WeakSlipWallKOmega3DImpl::~WeakSlipWallKOmega3DImpl()
 {
...
WeakSlipWallKOmega3DImpl::needsSockets()
{
...
void WeakSlipWallKOmega3DImpl::setup()
{
...
void WeakSlipWallKOmega3DImpl::executeOnTrs()
{
  const CFuint nbEqs = PhysicalModelStack::getActive()->getNbEq();
...
void WeakSlipWallKOmega3DImpl::computeNormalFluxAndJacob(const State& state,
							...
							RealMatrix& fluxJacob)
{
   ...
   const CFreal k = _physicalData[iK];
   const CFreal omega = _physicalData[iK+1];
...
void WeakSlipWallKOmega3DImpl::setFaceNormal(const CFuint faceID,
						RealVector& normal)
{
...
void WeakSlipWallKOmega3DImpl::configure ( Config::ConfigArgs& args )
{
