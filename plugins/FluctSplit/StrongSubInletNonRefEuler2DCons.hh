#ifndef COOLFluiD_Numerics_FluctSplit_StrongSubInletNonRefEuler2DCons_hh
#define COOLFluiD_Numerics_FluctSplit_StrongSubInletNonRefEuler2DCons_hh
 ...
 *
 */
class StrongSubInletNonRefEuler2DCons : public FluctuationSplitCom {
public:
   ...
   * Constructor
   */
  StrongSubInletNonRefEuler2DCons(const std::string& name);
  /**
   * Default destructor
   */
...
}; // end of class StrongSubInletNonRefEuler2DCons
