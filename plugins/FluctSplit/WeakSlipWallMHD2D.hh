#ifndef COOLFluiD_Numerics_FluctSplit_WeakSlipWallMHD2D_hh
#define COOLFluiD_Numerics_FluctSplit_WeakSlipWallMHD2D_hh
...
class WeakSlipWallMHD2D : public FluctuationSplitCom {
...
public:
   ...
   * Constructor.
   */
  WeakSlipWallMHD2D(const std::string& name);
...
}; // end of class WeakSlipWallMHD2D
...
#endif // COOLFluiD_Numerics_FluctSplit_WeakSlipWallMHD2D_hh
