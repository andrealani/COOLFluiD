...
#include "FluctSplit/UnsteadScalarDiffusionTerm.hh"
...
MethodStrategyProvider<UnsteadScalarDiffusionTerm,
		       FluctuationSplitData,
		       ComputeDiffusiveTerm,
		       FluctSplitAdvectionDiffusionModule>
unsdDiffusiveTermProvider("UnsteadScalarDiffusion");

//////////////////////////////////////////////////////////////////////////////

UnsteadScalarDiffusionTerm::UnsteadScalarDiffusionTerm(const std::string& name) :
...
UnsteadScalarDiffusionTerm::~UnsteadScalarDiffusionTerm()
{
...
void UnsteadScalarDiffusionTerm::setDiffusiveVarSet(SafePtr<DiffusiveVarSet> diffVar)
{
...
void UnsteadScalarDiffusionTerm::setUpdateVarSet(SafePtr<ConvectiveVarSet> updateVar)
{
...
void UnsteadScalarDiffusionTerm::computeDiffusiveTerm
(GeometricEntity *const geo, vector<RealVector>& result, bool updateCoeffFlag)
{
 ...
 ADTerm& model = _diffVar->getModel();
  ...
  for (CFuint iEq = 0; iEq < nbEqs; ++iEq) {
	...
	grad[iDim] += (*_states[is])[0]*normals[cellID]->getNodalNormComp(is,iDim);
      }
    }
    grad *= coeffGrad;
...
void UnsteadScalarDiffusionTerm::setup()
{  
  const CFuint nbEqs = PhysicalModelStack::getActive()->getNbEq();
...
void UnsteadScalarDiffusionTerm::configure ( Config::ConfigArgs& args )
{
