#ifndef COOLFluiD_Numerics_FluctSplit_StdSetupMeshIsoP2CompP1P2_hh
#define COOLFluiD_Numerics_FluctSplit_StdSetupMeshIsoP2CompP1P2_hh
...
/// @author Andrea Lani
class FluctSplit_API StdSetupMeshIsoP2CompP1P2 : public FluctuationSplitCom {
public: // member functions

  /// Constructor.
  explicit StdSetupMeshIsoP2CompP1P2(const std::string& name);

  /// Destructor.
  virtual ~StdSetupMeshIsoP2CompP1P2();
...
#endif // COOLFluiD_Numerics_FluctSplit_StdSetupMeshIsoP2CompP1P2_hh
