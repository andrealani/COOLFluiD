#ifndef COOLFluiD_Numerics_FluctSplit_StrongSubFunctionInletLinEuler2DCons_hh
#define COOLFluiD_Numerics_FluctSplit_StrongSubFunctionInletLinEuler2DCons_hh
...
class StrongSubFunctionInletLinEuler2DCons : public FluctuationSplitCom {
public:

  /**
   * Constructor
   */
  StrongSubFunctionInletLinEuler2DCons(const std::string& name);

  /**
   * Default destructor
   */
  ~StrongSubFunctionInletLinEuler2DCons();
...
}; // end of class StrongSubFunctionInletLinEuler2DCons
