#ifndef COOLFluiD_Numerics_FluctSplit_StrongSubOutletLinEuler2DConsImpl_hh
#define COOLFluiD_Numerics_FluctSplit_StrongSubOutletLinEuler2DConsImpl_hh
...
class StrongSubOutletLinEuler2DConsImpl : public FluctuationSplitCom {
public:

  /**
   * Constructor
   */
  StrongSubOutletLinEuler2DConsImpl(const std::string& name);

  /**
   * Default destructor
   */
  ~StrongSubOutletLinEuler2DConsImpl();
...
}; // end of class StrongSubOutletLinEuler2DConsImpl
