#ifndef COOLFluiD_Numerics_FluctSplit_StrongSubInletHedstrom2DCons_hh
#define COOLFluiD_Numerics_FluctSplit_StrongSubInletHedstrom2DCons_hh
...
class StrongSubInletHedstrom2DCons : public FluctuationSplitCom {
public:

  /**
   * Constructor
   */
  StrongSubInletHedstrom2DCons(const std::string& name);

  /**
   * Default destructor
   */
  ~StrongSubInletHedstrom2DCons();
...
}; // end of class StrongSubInletHedstrom2DCons
