...
#include "StrongSubFunctionInletLinEuler2DCons.hh"
...
MethodCommandProvider<StrongSubFunctionInletLinEuler2DCons, FluctuationSplitData, FluctSplitLinEulerModule> strongSubFunctionInletLinEuler2DConsProvider("StrongSubFunctionInletLinEuler2DCons");

//////////////////////////////////////////////////////////////////////////////

StrongSubFunctionInletLinEuler2DCons::StrongSubFunctionInletLinEuler2DCons(const std::string& name) :
...
void StrongSubFunctionInletLinEuler2DCons::defineConfigOptions(Config::OptionList&
options)
{
...
StrongSubFunctionInletLinEuler2DCons::~StrongSubFunctionInletLinEuler2DCons()
{
  if (isSetup()) unsetup();
}
...
StrongSubFunctionInletLinEuler2DCons::needsSockets()
{
...
void StrongSubFunctionInletLinEuler2DCons::setup()
{
...
void StrongSubFunctionInletLinEuler2DCons::executeOnTrs()
{
...
void StrongSubFunctionInletLinEuler2DCons::configure ( Config::ConfigArgs& args )
{
  ...
  if(m_function_inflow.empty())
     throw BadValueException(FromHere(),"StrongSubFunctionInletLinEuler2DCons::setFuntion(): no incoming flow function provided.");
...
//////////////////////////////////////////////////////////////////////////////
void StrongSubFunctionInletLinEuler2DCons::unsetup()
{
  inflow.resize(0);
  _bcNormals.resize(0);
