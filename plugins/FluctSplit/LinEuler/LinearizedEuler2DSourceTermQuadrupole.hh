#ifndef COOLFluiD_Numerics_FluctSplit_LinearizedEuler2DSourceTermQuadrupole_hh
#define COOLFluiD_Numerics_FluctSplit_LinearizedEuler2DSourceTermQuadrupole_hh
...
/**
 * This class represents a source term for LinearizedEuler2D QUADRUPOLE
 * 
 * @author  Lilla Edit Koloszar
 */
class LinearizedEuler2DSourceTermQuadrupole : public ComputeSourceTermFSM {
public:
   ...
   * @see LinEuler2D
   */
  LinearizedEuler2DSourceTermQuadrupole(const std::string& name);
  
  /**
   * Default destructor
   */
  ~LinearizedEuler2DSourceTermQuadrupole();
...
#endif // COOLFluiD_Numerics_FluctSplit_LinearizedEuler2DSourceTermQuadrupole_hh
