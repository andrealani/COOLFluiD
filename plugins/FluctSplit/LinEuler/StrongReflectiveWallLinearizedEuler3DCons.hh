#ifndef COOLFluiD_Numerics_FluctSplit_StrongReflectiveWallLinearizedEuler3DCons_hh
#define COOLFluiD_Numerics_FluctSplit_StrongReflectiveWallLinearizedEuler3DCons_hh
 ...
 * boundary condition for RD schemes for the LEE in 3D
 *
 * @author Erik Torres
 *
 */

class StrongReflectiveWallLinearizedEuler3DCons : public FluctuationSplitCom {
public:

  /**
   * Constructor
   */
  StrongReflectiveWallLinearizedEuler3DCons(const std::string& name);

  /**
   * Default destructor
   */
  ~StrongReflectiveWallLinearizedEuler3DCons();
...
}; // end of class StrongReflectiveWallLinearizedEuler3DCons
...
#endif // COOLFluiD_Numerics_FluctSplit_StrongSubOutletEuler3DCons_hh
