#ifndef COOLFluiD_Numerics_FluctSplit_LinearizedEuler3DSourceLES_hh
#define COOLFluiD_Numerics_FluctSplit_LinearizedEuler3DSourceLES_hh
...
/**
 * This class represents a source term for LinearizedEuler2D LES
 * 
 * @author  Stefan Probsting
 */
class LinearizedEuler3DSourceLES : public ComputeSourceTermFSM {
public:
   ...
   * @see LinEuler2D
   */
  LinearizedEuler3DSourceLES(const std::string& name);
  
  /**
   * Default destructor
   */
  ~LinearizedEuler3DSourceLES();
...
private: // data
 ...
 }; // end of class LLinearizedEuler3DSourceLES
...
#endif // COOLFluiD_Numerics_FluctSplit_LinearizedEuler3DSourceLES_hh
