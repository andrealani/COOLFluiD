#ifndef COOLFluiD_Numerics_FluctSplit_StrongSubInletLinEuler3DCons_hh
#define COOLFluiD_Numerics_FluctSplit_StrongSubInletLinEuler3DCons_hh
 ...
 *
 */
class StrongSubInletLinEuler3DCons : public FluctuationSplitCom {
public:

  /**
   * Constructor
   */
  StrongSubInletLinEuler3DCons(const std::string& name);

  /**
   * Default destructor
   */
  ~StrongSubInletLinEuler3DCons();
...
protected:
  ...
  void computeCharK(std::vector<Framework::State*>& states,   RealVector& _kPlus,   RealVector&  _k,   RealVector&  _kPast, std::vector<RealVector*>& normal, RealVector& faceLength, CFreal& Area, CFreal Uvel, CFreal Vvel);
...
}; // end of class StrongSubInletLinEuler3DCons
