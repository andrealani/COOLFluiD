#ifndef COOLFluiD_Numerics_FluctSplit_StrongSubInletLinEuler2DCons_hh
#define COOLFluiD_Numerics_FluctSplit_StrongSubInletLinEuler2DCons_hh
 ...
 *
 */
class StrongSubInletLinEuler2DCons : public FluctuationSplitCom {
public:

  /**
   * Constructor
   */
  StrongSubInletLinEuler2DCons(const std::string& name);

  /**
   * Default destructor
   */
  ~StrongSubInletLinEuler2DCons();
...
}; // end of class StrongSubInletLinEuler2DCons
