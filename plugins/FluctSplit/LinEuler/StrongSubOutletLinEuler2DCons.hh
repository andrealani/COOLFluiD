#ifndef COOLFluiD_Numerics_FluctSplit_StrongSubOutletLinEuler2DCons_hh
#define COOLFluiD_Numerics_FluctSplit_StrongSubOutletLinEuler2DCons_hh
...
class StrongSubOutletLinEuler2DCons : public FluctuationSplitCom {
public:

  /**
   * Constructor
   */
  StrongSubOutletLinEuler2DCons(const std::string& name);

  /**
   * Default destructor
   */
  ~StrongSubOutletLinEuler2DCons();
...
}; // end of class StrongSubOutletLinEuler2DCons
