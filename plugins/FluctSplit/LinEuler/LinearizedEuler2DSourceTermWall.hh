#ifndef COOLFluiD_Numerics_FluctSplit_LinearizedEuler2DSourceTermWall_hh
#define COOLFluiD_Numerics_FluctSplit_LinearizedEuler2DSourceTermWall_hh
 ...
 */
class LinearizedEuler2DSourceTermWall : public ComputeSourceTermFSM {
public:
   ...
   * @see LinEuler2D
   */
  LinearizedEuler2DSourceTermWall(const std::string& name);
  
  /**
   * Default destructor
   */
  ~LinearizedEuler2DSourceTermWall();
...
#endif // COOLFluiD_Numerics_FluctSplit_LinearizedEuler2DSourceTermWall_hh
