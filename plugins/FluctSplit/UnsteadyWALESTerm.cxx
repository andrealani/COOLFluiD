...
#include "FluctSplit/UnsteadyWALESTerm.hh"
...
MethodStrategyProvider<UnsteadyWALESTerm,
		       FluctuationSplitData,
		       ComputeDiffusiveTerm,
		       FluctSplitLESModule>
UnsteadyWALES2dDiffusiveTermProvider("UnsteadyWALES2d");

//////////////////////////////////////////////////////////////////////////////

UnsteadyWALESTerm::UnsteadyWALESTerm(const std::string& name) :
...
UnsteadyWALESTerm::~UnsteadyWALESTerm()
{
  deletePtr(_avValues);
  deletePtr(_avState);
}
...
void UnsteadyWALESTerm::setDiffusiveVarSet(SafePtr<DiffusiveVarSet> diffVar)
{
  _diffVar = diffVar.d_castTo<WALES2DVarSet>();
 }

//////////////////////////////////////////////////////////////////////////////

void UnsteadyWALESTerm::setUpdateVarSet(SafePtr<ConvectiveVarSet> updateVar)
{
...
void UnsteadyWALESTerm::computeDiffusiveTerm
...
void UnsteadyWALESTerm::configure ( Config::ConfigArgs& args )
{
...
void UnsteadyWALESTerm::computeCellGradientsAndAverageState
