#ifndef COOLFluiD_Numerics_FluctSplit_PeriodicBCMPIeqY_hh
#define COOLFluiD_Numerics_FluctSplit_PeriodicBCMPIeqY_hh
...
class FluctSplit_API PeriodicBCMPIeqY : public FluctuationSplitCom {
...
public: // functions
  ...
  /// Constructor
  PeriodicBCMPIeqY(const std::string& name);

  /// Default destructor
  virtual ~PeriodicBCMPIeqY();
