#ifndef COOLFluiD_Numerics_FluctSplit_STU_CRD_SplitStrategyquad_hh
#define COOLFluiD_Numerics_FluctSplit_STU_CRD_SplitStrategyquad_hh
...
class STU_CRD_SplitStrategyquad : public FluctuationSplitStrategy {

public: // methods

  /// Constructor.
  STU_CRD_SplitStrategyquad(const std::string& name);

  /// Destructor.
  virtual ~STU_CRD_SplitStrategyquad();
