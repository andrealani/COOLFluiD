#ifndef COOLFluiD_Numerics_FluctSplit_RmsSetup_hh
#define COOLFluiD_Numerics_FluctSplit_RmsSetup_hh
...
/// @author Andrea Lani
class FluctSplit_API RmsSetup : public FluctuationSplitCom {
public: // member functions

  /// Constructor.
  explicit RmsSetup(const std::string& name);
...
//   /// socket with theta clending coefficient
  ...
  // /// initial limiter socket name
   std::string _rmsSocketName;
   
  // /// Variable for RMS dimension, must either be 2D (default) or 3D 
   std::string _rmsDimension;
