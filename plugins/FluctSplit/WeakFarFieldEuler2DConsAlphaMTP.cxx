...
#include "WeakFarFieldEuler2DConsAlphaMTP.hh"
...
MethodCommandProvider<WeakFarFieldEuler2DConsAlphaMTP, FluctuationSplitData, FluctSplitNavierStokesModule> weakFarFieldEuler2DConsAlphaMTPProvider("WeakFarFieldEuler2DConsAlphaMTP");

//////////////////////////////////////////////////////////////////////////////

void WeakFarFieldEuler2DConsAlphaMTP::defineConfigOptions(Config::OptionList& options)
{
...
WeakFarFieldEuler2DConsAlphaMTP::WeakFarFieldEuler2DConsAlphaMTP(const std::string& name) :
  WeakBC2D(name),
  _varSet()
 {
...
WeakFarFieldEuler2DConsAlphaMTP::~WeakFarFieldEuler2DConsAlphaMTP()
{
}

//////////////////////////////////////////////////////////////////////////////

void WeakFarFieldEuler2DConsAlphaMTP::setup()
{
  WeakBC2D::setup();
  _varSet->setup();
...
void WeakFarFieldEuler2DConsAlphaMTP::setGhostState(const State& state,
                                                    State& gstate)
{
  ...
  const CFreal gammaMinus1 = _varSet->getModel()->getGamma() - 1.;
  gstate[3] = _pressure/gammaMinus1 + 0.5*rhoV2/rho;
}

//////////////////////////////////////////////////////////////////////////////

void WeakFarFieldEuler2DConsAlphaMTP::configure ( Config::ConfigArgs& args )
{
