#ifndef COOLFluiD_Numerics_FluctSplit_STU_CRD_SplitStrategyhyb_hh
#define COOLFluiD_Numerics_FluctSplit_STU_CRD_SplitStrategyhyb_hh
...
class STU_CRD_SplitStrategyhyb : public FluctuationSplitStrategy {

public: // methods

  /// Constructor.
  STU_CRD_SplitStrategyhyb(const std::string& name);

  /// Destructor.
  virtual ~STU_CRD_SplitStrategyhyb();
...
private: // data
 ...
 std::vector<Framework::State*> Cell_states;
...
#endif // COOLFluiD_Numerics_FluctSplit_STU_CRD_SplitStrategyhyb_hh
