...
#include "FluctSplit/StdSetupIsoP3.hh"
...
MethodCommandProvider<StdSetupIsoP3, FluctuationSplitData, FluctSplitModule> stdSetupIsoP3Provider("StdSetupIsoP3");

//////////////////////////////////////////////////////////////////////////////

StdSetupIsoP3::StdSetupIsoP3(const std::string& name) :
...
void StdSetupIsoP3::configure ( Config::ConfigArgs& args )
{
  CFAUTOTRACE;
...
void StdSetupIsoP3::storeBoundaryNormals()
{
...
void StdSetupIsoP3::computeNormalsData()
{
  CFAUTOTRACE;
// CF_DEBUG_POINT;
...
// CF_DEBUG_OBJ(nbElemTypes);
  ...
  /// @note this is hardcoded to P3P3 curved elements
  const CFuint nb_subfaces_elem = 18;
...
// 	const CFuint nbfaces = eData.getNbFaces();
// 	CF_DEBUG_OBJ(nbelems);
// 	CF_DEBUG_OBJ(nbfaces);
	//Check if the element is a P2-P2 triangle:
	if (eData.getGeoShape() == CFGeoShape::TRIAG && eData.getGeoOrder() == CFPolyOrder::ORDER3)
        {
...
void StdSetupIsoP3::flagBoundaryStates()
{
  CFAUTOTRACE;
...
void StdSetupIsoP3::setFaceNeighCell()
{
  CFAUTOTRACE;
...
// CF_DEBUG_POINT;
              ...
              bool fo1 = false;
	      pair<MapIterator, MapIterator> faces = mapBNode2BFace.find(nodeID, fo1);
	      cf_assert(fo1);
...
void StdSetupIsoP3::computeCellVolumes()
{
