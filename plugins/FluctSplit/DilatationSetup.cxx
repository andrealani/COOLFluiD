...
#include "FluctSplit/DilatationSetup.hh"
...
MethodCommandProvider<DilatationSetup, FluctuationSplitData, FluctSplitModule> dilatationSetupProvider("DilatationSetup");

//////////////////////////////////////////////////////////////////////////////

void DilatationSetup::defineConfigOptions(Config::OptionList& options)
{
  options.addConfigOption< std::string >
    ("DilatationName","name of the input limiter socket");
}
//////////////////////////////////////////////////////////////////////////////

DilatationSetup::DilatationSetup(const std::string& name) :
  ...
  socket_flagStates("flagStates")
{
 addConfigOptionsTo(this);
  ...
  _dilatationSocketName = "Null";
   setParameter("DilatationName",&_dilatationSocketName);
}

//////////////////////////////////////////////////////////////////////////////

DilatationSetup::~DilatationSetup()
{
}
...
DilatationSetup::providesSockets()
{
...
void DilatationSetup::configure ( Config::ConfigArgs& args )
{
  CFAUTOTRACE;
  ...
  if (_dilatationSocketName != "Null") {
    m_dynamicSockets.createSocketSink<CFreal>(_dilatationSocketName, true);
  }
...
void DilatationSetup::execute()
{
 ...
 const CFuint sizedilatation = nbStates;
   DataHandle<CFreal> dilatation = socket_dilatation.getDataHandle();
     dilatation.resize(sizedilatation);

  if (m_dynamicSockets.sinkSocketExists(_dilatationSocketName)) {
  
    DataHandle<CFreal> initdilatation = m_dynamicSockets.getSocketSink<CFreal>(_dilatationSocketName)->getDataHandle();
    cf_assert(initdilatation.size() == dilatation.size());
    for (CFuint i = 0; i < sizedilatation; ++i) {
      dilatation[i] = initdilatation[i];
    }
  } 
...
void DilatationSetup::storeBoundaryNormals()
{
...
void DilatationSetup::computeNormalsData()
{
  CFAUTOTRACE;
...
void DilatationSetup::flagBoundaryStates()
{
  CFAUTOTRACE;
...
void DilatationSetup::setFaceNeighCell()
{
  CFAUTOTRACE;
...
void DilatationSetup::computeCellVolumes()
{
