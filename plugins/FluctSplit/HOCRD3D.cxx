...
MethodStrategyProvider<HOCRD3D,
                       FluctuationSplitData,
                       FluctuationSplitStrategy,
                       FluctSplitHOModule>
aHOCRD3D_Provider("HOCRD3D");



//////////////////////////////////////////////////////////////////////////////

void HOCRD3D::defineConfigOptions(Config::OptionList& options)
{
  options.addConfigOption< CFuint>("scheme","LDA (0) or N (1)?");
}
...
//.................... MODIFIED ...............................
HOCRD3D::HOCRD3D(const std::string& name) :
...
void HOCRD3D::computeFluctuation(vector<RealVector>& residual)
{
...
//...............................................................
  // The kis and the distribution are computed in this class
   computeK(substates,m_kPlus);

  SafePtr<vector<RealMatrix> >& currBetaMatrix =
    distdata.currBetaMat;
...
//...............................................................
  ...
  *phi = *getMethodData().getSolutionToDistribMatTrans()->transformFromRef(m_phisubT[0]);
  switch( m_scheme )
	{
	case 0:
	  distributeLDA(m_kPlus,subresidual);
	  break;
	case 1:
	  distributeN(m_kPlus,subresidual);
	  break;
	}

  residual[1] += subresidual[0];
  residual[5] += subresidual[1];
  residual[4] += subresidual[2];
  residual[7] += subresidual[3];
//..............................................................
...
*phi = *getMethodData().getSolutionToDistribMatTrans()->transformFromRef(m_phisubT[1]);
 currBetaMatrix = &distdata.betaMats[1];
  ...
  residual[2] += subresidual[1];
  residual[6] += subresidual[2];
  residual[8] += subresidual[3];
...
void HOCRD3D::computeHOCurvedFluctuation(CFuint &i1)
{
...
//////////////////////////////////////////////////////////////////////////////////////
void HOCRD3D::computeK(const std::vector<Framework::State*>& states,
...
//////////////////////////////////////////////////////////////////////////////
void HOCRD3D::distributeLDA(std::vector<RealMatrix*> & m_kPlus,vector<RealVector> & phiLDA){
...
//////////////////////////////////////////////////////////////////////////////
void HOCRD3D::distributeN(std::vector<RealMatrix*> & m_kPlus,vector<RealVector> & phiN){
