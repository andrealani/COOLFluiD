...
#include "FluctSplit/HONavierStokes/WeakSlipWallEuler2DHOImplIsoP2Upwind.hh"
...
MethodCommandProvider<WeakSlipWallEuler2DHOImplIsoP2Upwind,
		      FluctuationSplitData,
		      FluctSplitHONavierStokesModule>
WeakSlipWallEuler2DHOImplIsoP2UpwindProvider("WeakSlipWallEuler2DHOImplIsoP2Upwind");

//////////////////////////////////////////////////////////////////////////////

WeakSlipWallEuler2DHOImplIsoP2Upwind::WeakSlipWallEuler2DHOImplIsoP2Upwind(const std::string& name) :
   WeakSlipWall2DHOImplIsoP2Upwind(name),
   _varSet(CFNULL)
{
}
...
WeakSlipWallEuler2DHOImplIsoP2Upwind::~WeakSlipWallEuler2DHOImplIsoP2Upwind()
{
}

//////////////////////////////////////////////////////////////////////////////

void WeakSlipWallEuler2DHOImplIsoP2Upwind::setup()
{
  WeakSlipWall2DHOImplIsoP2Upwind::setup();
...
void WeakSlipWallEuler2DHOImplIsoP2Upwind::computeNormalFluxAndJacob
(const State& state,
