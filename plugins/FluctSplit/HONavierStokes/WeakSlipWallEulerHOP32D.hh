#ifndef COOLFluiD_Numerics_FluctSplit_WeakSlipWallEulerHOP32D_hh
#define COOLFluiD_Numerics_FluctSplit_WeakSlipWallEulerHOP32D_hh
 ...
 * for P3 elements, it is the extention of the bc of E. Van der Weide
...
class WeakSlipWallEulerHOP32D : public FluctuationSplitCom {
...
public:
   ...
   * Constructor.
   */
  WeakSlipWallEulerHOP32D(const std::string& name);

  /**
   * Default destructor
   */
  ~WeakSlipWallEulerHOP32D();
...
protected:
 ...
 private:
  ...
  /// Normals at each quadrature points
...
#endif // COOLFluiD_Numerics_FluctSplit_WeakSlipWallEulerHOP32D_hh
