#ifndef COOLFluiD_Numerics_FluctSplit_WeakSlipWallEuler2DHOImplIsoP2_hh
#define COOLFluiD_Numerics_FluctSplit_WeakSlipWallEuler2DHOImplIsoP2_hh
 ...
 *
 */
class WeakSlipWallEuler2DHOImplIsoP2 : public WeakSlipWall2DHOImplIsoP2 {
public:

  /**
   * Constructor.
   */
  WeakSlipWallEuler2DHOImplIsoP2(const std::string& name);

  /**
   * Default destructor
   */
  ~WeakSlipWallEuler2DHOImplIsoP2();
