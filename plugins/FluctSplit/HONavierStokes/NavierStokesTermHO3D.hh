#ifndef COOLFluiD_Numerics_FluctSplit_NavierStokesTermHO3D_hh
#define COOLFluiD_Numerics_FluctSplit_NavierStokesTermHO3D_hh
 ...
 *
 */
class NavierStokesTermHO3D : public ComputeDiffusiveTerm {
public:

  /**
   * Constructor
   */
  NavierStokesTermHO3D(const std::string& name);
  
  /**
   * Default destructor
   */
  virtual ~NavierStokesTermHO3D();
