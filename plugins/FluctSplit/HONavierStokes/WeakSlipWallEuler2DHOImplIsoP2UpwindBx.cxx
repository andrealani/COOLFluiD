...
#include "FluctSplit/HONavierStokes/WeakSlipWallEuler2DHOImplIsoP2UpwindBx.hh"
...
MethodCommandProvider<WeakSlipWallEuler2DHOImplIsoP2UpwindBx,
		      FluctuationSplitData,
		      FluctSplitHONavierStokesModule>
WeakSlipWallEuler2DHOImplIsoP2UpwindBxProvider("WeakSlipWallEuler2DHOImplIsoP2UpwindBx");

//////////////////////////////////////////////////////////////////////////////

WeakSlipWallEuler2DHOImplIsoP2UpwindBx::WeakSlipWallEuler2DHOImplIsoP2UpwindBx(const std::string& name) :
   WeakSlipWall2DHOImplIsoP2UpwindBx(name),
   _varSet(CFNULL)
{
}
...
WeakSlipWallEuler2DHOImplIsoP2UpwindBx::~WeakSlipWallEuler2DHOImplIsoP2UpwindBx()
{
}

//////////////////////////////////////////////////////////////////////////////

void WeakSlipWallEuler2DHOImplIsoP2UpwindBx::setup()
{
  WeakSlipWall2DHOImplIsoP2UpwindBx::setup();
...
void WeakSlipWallEuler2DHOImplIsoP2UpwindBx::computeNormalFluxAndJacob
(const State& state,
