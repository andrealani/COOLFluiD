...
//////////////////////////////////////////////////////////////////////////////
  ...
  CFuint WeakSlipWall2DHOImplIsoP2Upwind::m_subFaceIdx0[6] = {2, 0, 1, 5, 3, 4};
  CFuint WeakSlipWall2DHOImplIsoP2Upwind::m_subFaceIdx1[6] = {3, 4, 5, 6, 7, 8};
  CFuint WeakSlipWall2DHOImplIsoP2Upwind::m_subFaceIdx2[6] = {7, 8, 6, 1, 2, 0};

  CFuint WeakSlipWall2DHOImplIsoP2Upwind::m_subElemIdx0[2] = {0, 1};
  CFuint WeakSlipWall2DHOImplIsoP2Upwind::m_subElemIdx1[2] = {1, 2};
  CFuint WeakSlipWall2DHOImplIsoP2Upwind::m_subElemIdx2[2] = {2, 0};

  CFuint WeakSlipWall2DHOImplIsoP2Upwind::m_subTri0[6] = { 0, 3, 5, 3, 1, 4 };
  CFuint WeakSlipWall2DHOImplIsoP2Upwind::m_subTri1[6] = { 1, 4, 3, 4, 2, 5 };
  CFuint WeakSlipWall2DHOImplIsoP2Upwind::m_subTri2[6] = { 2, 5, 4, 5, 0, 3 };

//////////////////////////////////////////////////////////////////////////////

void WeakSlipWall2DHOImplIsoP2Upwind::defineConfigOptions(Config::OptionList& options)
{
}

//////////////////////////////////////////////////////////////////////////////

WeakSlipWall2DHOImplIsoP2Upwind::WeakSlipWall2DHOImplIsoP2Upwind(const std::string& name) :
...
WeakSlipWall2DHOImplIsoP2Upwind::~WeakSlipWall2DHOImplIsoP2Upwind()
{
  deletePtr( m_qdState );
}
...
WeakSlipWall2DHOImplIsoP2Upwind::needsSockets()
{
...
void WeakSlipWall2DHOImplIsoP2Upwind::setup()
{
...
void WeakSlipWall2DHOImplIsoP2Upwind::executeOnTrs()
{
  CFAUTOTRACE;
...
//         _flagState[(*cell_states)[v2]->getLocalID()] = true;
  ...
  m_distJacobToState=((*currBetaMatrix)[0]) * m_distJacobFrom0;
  ...
  m_distJacobToState=((*currBetaMatrix)[0]) * m_distJacobFrom3;
  ...
  m_distJacobToState=((*currBetaMatrix)[1]) * m_distJacobFrom0;
  ...
  m_distJacobToState=((*currBetaMatrix)[1]) * m_distJacobFrom3;
  ...
  m_distJacobToState=((*currBetaMatrix)[2]) * m_distJacobFrom0;
  ...
  m_distJacobToState=((*currBetaMatrix)[2]) * m_distJacobFrom3;
