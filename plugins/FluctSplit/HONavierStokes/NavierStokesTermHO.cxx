...
#include "FluctSplit/HONavierStokes/NavierStokesTermHO.hh"
...
MethodStrategyProvider<NavierStokesTermHO,
		       FluctuationSplitData,
		       ComputeDiffusiveTerm,
		       FluctSplitHONavierStokesModule>
navierStokesDiffusiveTermHOProvider("NavierStokesHO");

//////////////////////////////////////////////////////////////////////////////

NavierStokesTermHO::NavierStokesTermHO(const std::string& name) :
...
NavierStokesTermHO::~NavierStokesTermHO()
{
...
void NavierStokesTermHO::setDiffusiveVarSet(SafePtr<DiffusiveVarSet> diffVar)
{
...
void NavierStokesTermHO::setUpdateVarSet(SafePtr<ConvectiveVarSet> updateVar)
{
...
void NavierStokesTermHO::computeDiffusiveTerm
...
//////////////////////////////////////////////////////////////////////////////
void NavierStokesTermHO::fluctuation_diff_galerkin(CFuint& i1, CFuint& i2 , CFuint& i3){
...
//////////////////////////////////////////////////////////////////////////////
void NavierStokesTermHO::fluctuation_diff_bubble(CFuint& i1, CFuint& i2, CFuint& i3)
{
...
void NavierStokesTermHO::configure ( Config::ConfigArgs& args )
{
