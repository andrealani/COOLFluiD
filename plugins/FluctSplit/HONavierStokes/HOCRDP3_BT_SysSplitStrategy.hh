#ifndef COOLFluiD_Numerics_FluctSplit_HOCRDP3_BT_SysSplitStrategy_hh
#define COOLFluiD_Numerics_FluctSplit_HOCRDP3_BT_SysSplitStrategy_hh
...
class HOCRDP3_BT_SysSplitStrategy : public FluctuationSplitStrategy {
public: // methods

  /// Constructor.
  HOCRDP3_BT_SysSplitStrategy(const std::string& name);

  /// Destructor.
  virtual ~HOCRDP3_BT_SysSplitStrategy();
...
/// max number of subcells
 ...
 /// fluctuation on each sub element
  ...
  /// fluctuation on each sub element
  std::vector<RealVector> m_phiN8;

  /// fluctuation on each sub element
  std::vector<RealVector> m_phiN9;
...
/// temporary data for computation of upwind parameters for 1st sub-triangle
  ...
  /// temporary data for computation of upwind parameters for 4th sub-triangle
  std::vector<RealMatrix*> m_k8Plus;

/// temporary data for computation of upwind parameters for 4th sub-triangle
  std::vector<RealMatrix*> m_k9Plus;
...
}; //end class HOCRDP3_BT_sysSplitStrategy

    } //end namespace FluctSplit
} // end COOLFluid

#endif// COOLFluiD_Numerics_FluctSplit_HOCRDP3_BT_sysSplitStrategy_hh
