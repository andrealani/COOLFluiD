#ifndef COOLFluiD_Numerics_FluctSplit_WeakSlipWall2DHOImpl_hh
#define COOLFluiD_Numerics_FluctSplit_WeakSlipWall2DHOImpl_hh
 ...
 *
 */
class WeakSlipWall2DHOImpl : public FluctuationSplitCom {
public:
   ...
   * Constructor.
   */
  WeakSlipWall2DHOImpl(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~WeakSlipWall2DHOImpl();
