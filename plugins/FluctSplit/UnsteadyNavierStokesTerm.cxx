...
#include "FluctSplit/UnsteadyNavierStokesTerm.hh"
...
MethodStrategyProvider<UnsteadyNavierStokesTerm,
		       FluctuationSplitData,
		       ComputeDiffusiveTerm,
		       FluctSplitSpaceTimeNavierStokesModule>
UnsteadyNavierStokesDiffusiveTermProvider("UnsteadyNavierStokes");

//////////////////////////////////////////////////////////////////////////////

UnsteadyNavierStokesTerm::UnsteadyNavierStokesTerm(const std::string& name) :
...
UnsteadyNavierStokesTerm::~UnsteadyNavierStokesTerm()
{
  deletePtr(_avValues);
  deletePtr(_avState);
}
...
void UnsteadyNavierStokesTerm::setDiffusiveVarSet(SafePtr<DiffusiveVarSet> diffVar)
{
...
void UnsteadyNavierStokesTerm::setUpdateVarSet(SafePtr<ConvectiveVarSet> updateVar)
{
...
void UnsteadyNavierStokesTerm::computeDiffusiveTerm
...
void UnsteadyNavierStokesTerm::setup()
{
  const CFuint nbEqs = PhysicalModelStack::getActive()->getNbEq();
  const CFuint dim = PhysicalModelStack::getActive()->getDim();
...
void UnsteadyNavierStokesTerm::configure ( Config::ConfigArgs& args )
{
...
void UnsteadyNavierStokesTerm::computeCellGradientsAndAverageState
(GeometricEntity *const geo, const RealVector& pdata)
{
  ...
  gradU = (_gradRhoU-avU*_gradRho)*ovAvRho;
  gradV = (_gradRhoV-avV*_gradRho)*ovAvRho;
