...
#ifndef COOLFluiD_Numerics_FluctSplit_QCritSetup_hh
#define COOLFluiD_Numerics_FluctSplit_QCritSetup_hh
...
/// @author Tim Horchler
/// @author Lilla Kapa
class FluctSplit_API QCritSetup : public FluctuationSplitCom {
public: // member functions

  /// Constructor.
  explicit QCritSetup(const std::string& name);
...
//   /// socket with theta clending coefficient
       Framework::DataSocketSource<CFreal> socket_qcrit;
  // /// initial limiter socket name
   std::string _qcritSocketName;
