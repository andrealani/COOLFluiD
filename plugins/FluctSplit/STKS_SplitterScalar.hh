#ifndef COOLFluiD_Numerics_FluctSplit_STKS_SplitterScalar_hh
#define COOLFluiD_Numerics_FluctSplit_STKS_SplitterScalar_hh
 ...
 *
 */
class STKS_SplitterScalar : public SpaceTime_Splitter {
public:

  /**
   * Constructor
   */
  STKS_SplitterScalar(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~STKS_SplitterScalar();
...
}; // end of class STKS_SplitterScalar
...
#endif // COOLFluiD_Numerics_FluctSplit_STKS_SplitterScalar_hh
