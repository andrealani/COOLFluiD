#ifndef COOLFluiD_Numerics_FluctSplit_STM_HOCRD_SplitStrategy_hh
#define COOLFluiD_Numerics_FluctSplit_STM_HOCRD_SplitStrategy_hh
...
class STM_HOCRD_SplitStrategy : public FluctuationSplitStrategy {

public: // methods

  /// Constructor.
  STM_HOCRD_SplitStrategy(const std::string& name);

  /// Destructor.
  virtual ~STM_HOCRD_SplitStrategy();
...
protected: // methods
  ...
  void computeHOFluctuation_past();

  /// Compute the past contribution of integral of the Space-Time fluxes

  void computeHOFluctuation_present();
...
#endif // COOLFluiD_Numerics_FluctSplit_STM_HOCRD_SplitStrategy_hh
