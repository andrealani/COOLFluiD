...
#include "StrongNoSlipWallIsothermalNS2DImpl.hh"
...
MethodCommandProvider<StrongNoSlipWallIsothermalNS2DImpl,
		      FluctuationSplitData,
		      FluctSplitNavierStokesModule>
strongNoSlipWallIsothermalNS2DImplProvider("StrongNoSlipWallIsothermalNS2DImpl");

//////////////////////////////////////////////////////////////////////////////

void StrongNoSlipWallIsothermalNS2DImpl::defineConfigOptions(Config::OptionList& options)
{
...
StrongNoSlipWallIsothermalNS2DImpl::StrongNoSlipWallIsothermalNS2DImpl(const std::string& name) :
...
StrongNoSlipWallIsothermalNS2DImpl::~StrongNoSlipWallIsothermalNS2DImpl()
{
}
...
StrongNoSlipWallIsothermalNS2DImpl::needsSockets()
{
...
void StrongNoSlipWallIsothermalNS2DImpl::setup()
{
  ...
  for(CFuint iTRS = 0; iTRS < trsList.size(); ++iTRS) {
    ...
    CFLogDebugMax("StrongNoSlipWallAdiabaticNS2D::setup() called for TRS: "
		  << trs->getName() << "\n");
...
void StrongNoSlipWallIsothermalNS2DImpl::executeOnTrs()
{
	...
	if (!isUpdated[localStateID]) {
	  ...
	  rhs(localStateID, 3, nbEqs) = 0.0;
		...
		if (gID == globalID) {
		  ...
		  // != Backward Euler
		  jacobMatrix->setValue(eID, gID, -2.*coeff*eWall);
		  continue;
		}
		else if (gID == eID) {
