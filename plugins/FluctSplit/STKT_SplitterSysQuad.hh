#ifndef COOLFluiD_Numerics_FluctSplit_STKT_SplitterSysQuad_hh
#define COOLFluiD_Numerics_FluctSplit_STKT_SplitterSysQuad_hh
 ...
 */
class STKT_SplitterSysQuad : public SpaceTime_Splitter {
public:

  /**
   * Constructor
   */
  STKT_SplitterSysQuad(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~STKT_SplitterSysQuad();
...
}; // end of class SpaceTimeRDS_SplitterSysQuad
