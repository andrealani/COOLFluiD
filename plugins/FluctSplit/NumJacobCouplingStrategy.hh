#ifndef COOLFluiD_Numerics_FluctSplit_NumJacobCouplingStrategy_hh
#define COOLFluiD_Numerics_FluctSplit_NumJacobCouplingStrategy_hh
...
/// @author Andrea Lani
class FluctSplit_API NumJacobCouplingStrategy : public ComputeJacobStrategy {
public:
  ...
  /// Constructor.
  NumJacobCouplingStrategy(const std::string& name);

  /// Destructor.
  ~NumJacobCouplingStrategy();
...
}; // class NumJacobCouplingStrategy
...
#endif // COOLFluiD_Numerics_FluctSplit_NumJacobCouplingStrategy_hh
