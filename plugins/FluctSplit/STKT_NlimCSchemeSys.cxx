#include "STKT_NlimCSchemeSys.hh"
...
MethodStrategyProvider<STKT_NlimCSchemeSys,
		       FluctuationSplitData,
		       Splitter,
                       FluctSplitSpaceTimeModule>
spaceTimeRiccNlimcSchemeSysProvider("STKT_SysNlimC");

////////////////////////////////////////////////////////////////////////////

void STKT_NlimCSchemeSys::defineConfigOptions(Config::OptionList& options)
{
  ///@todo NV: for 3D we should put as input two angles
   options.addConfigOption<CFreal>("ProjDir2D","Choose a direction to project the residual(an angle in degree)");
}
//////////////////////////////////////////////////////////////////////////////

STKT_NlimCSchemeSys::STKT_NlimCSchemeSys(const std::string& name) :
...
STKT_NlimCSchemeSys::~STKT_NlimCSchemeSys()
{
}

//////////////////////////////////////////////////////////////////////////////

void STKT_NlimCSchemeSys::setup()
{
...
void STKT_NlimCSchemeSys::computePicardJacob(std::vector<RealMatrix*>& jacob)
{
...
void STKT_NlimCSchemeSys::distribute(vector<RealVector>& residual)
{  
