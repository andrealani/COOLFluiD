...
#include "SuperOutletImplMHD3DProjection.hh"
...
MethodCommandProvider<SuperOutletImplMHD3DProjection,
		      FluctuationSplitData,
		      FluctSplitModule>
superOutletImplMHD3DProjectionProvider("SuperOutletImplMHD3DProjection");

//////////////////////////////////////////////////////////////////////////////

void SuperOutletImplMHD3DProjection::defineConfigOptions(Config::OptionList& options)
{
...
SuperOutletImplMHD3DProjection::SuperOutletImplMHD3DProjection(const std::string& name) :
...
SuperOutletImplMHD3DProjection::~SuperOutletImplMHD3DProjection()
{
}
...
SuperOutletImplMHD3DProjection::needsSockets()
{
...
void SuperOutletImplMHD3DProjection::executeOnTrs()
{
  CFAUTOTRACE;
  ...
  CFLogDebugMax( "SuperOutletImplMHD3DProjection::execute() called for TRS: "
  << trs->getName() << "\n");
...
void SuperOutletImplMHD3DProjection::configure ( Config::ConfigArgs& args )
{
