#ifndef COOLFluiD_Numerics_FluctSplit_WeakSlipWallMHD2DProjection_hh
#define COOLFluiD_Numerics_FluctSplit_WeakSlipWallMHD2DProjection_hh
...
/**
 * This class represents a strong slip wall bc for MHD2DProjection
 *
 * @author Radka Keslerova
 *
 */

class WeakSlipWallMHD2DProjection : public FluctuationSplitCom {
...
public:
   ...
   * Constructor.
   */
  WeakSlipWallMHD2DProjection(const std::string& name);

  /**
   * Default destructor
   */
  ~WeakSlipWallMHD2DProjection();
...
}; // end of class WeakSlipWallMHD2DProjection
...
#endif // COOLFluiD_Numerics_FluctSplit_WeakSlipWallMHD2DProjection_hh
