#ifndef COOLFluiD_Numerics_FluctSplit_PeriodicBC3DMPIeqY_hh
#define COOLFluiD_Numerics_FluctSplit_PeriodicBC3DMPIeqY_hh
...
/// Connnect the nodes having the same Y
/// Both boundaries of the periodic BC should be in the same TRS
/// @author Nadege Villedieu
class FluctSplit_API PeriodicBC3DMPIeqY : public FluctuationSplitCom {
...
public: // functions
  ...
  /// Constructor
  PeriodicBC3DMPIeqY(const std::string& name);

  /// Default destructor
  virtual ~PeriodicBC3DMPIeqY();
...
#endif // COOLFluiD_Numerics_FluctSplit_PeriodicBCMPIeqY_hh
