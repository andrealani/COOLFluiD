...
MethodCommandProvider<WeakSlipWallMHD3D, FluctuationSplitData, FluctSplitModule> weakSlipWallMHD3DProvider("WeakSlipWallMHD3D");

//////////////////////////////////////////////////////////////////////////////

void WeakSlipWallMHD3D::defineConfigOptions(Config::OptionList& options)
{
...
WeakSlipWallMHD3D::WeakSlipWallMHD3D(const std::string& name) :
...
WeakSlipWallMHD3D::~WeakSlipWallMHD3D()
{
}
...
WeakSlipWallMHD3D::needsSockets()
{
...
void WeakSlipWallMHD3D::executeOnTrs()
{
...
void WeakSlipWallMHD3D::computeNormalFlux(const State& state,
...
void WeakSlipWallMHD3D::setFaceNormal(const CFuint faceID,
                                        RealVector& normal)
{
