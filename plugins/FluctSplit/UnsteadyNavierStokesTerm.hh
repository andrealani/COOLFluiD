#ifndef COOLFluiD_Numerics_FluctSplit_UnsteadyNavierStokesTerm_hh
#define COOLFluiD_Numerics_FluctSplit_UnsteadyNavierStokesTerm_hh
 ...
 *
 */
class UnsteadyNavierStokesTerm : public ComputeDiffusiveTerm {
public:

  /**
   * Constructor
   */
  UnsteadyNavierStokesTerm(const std::string& name);
  
  /**
   * Default destructor
   */
  virtual ~UnsteadyNavierStokesTerm();
