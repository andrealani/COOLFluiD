#ifndef COOLFluiD_Numerics_FluctSplit_StrongSubOutletNonRefEuler3DCons_hh
#define COOLFluiD_Numerics_FluctSplit_StrongSubOutletNonRefEuler3DCons_hh
...
class StrongSubOutletNonRefEuler3DCons : public FluctuationSplitCom {
public:

  /**
   * Constructor
   */
  StrongSubOutletNonRefEuler3DCons(const std::string& name);

  /**
   * Default destructor
   */
  ~StrongSubOutletNonRefEuler3DCons();
...
}; // end of class StrongSubOutletNonRefEuler3DCons
