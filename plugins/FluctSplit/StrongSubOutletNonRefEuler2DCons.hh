#ifndef COOLFluiD_Numerics_FluctSplit_StrongSubOutletNonRefEuler2DCons_hh
#define COOLFluiD_Numerics_FluctSplit_StrongSubOutletNonRefEuler2DCons_hh
...
class StrongSubOutletNonRefEuler2DCons : public FluctuationSplitCom {
public:

  /**
   * Constructor
   */
  StrongSubOutletNonRefEuler2DCons(const std::string& name);
...
}; // end of class StrongSubOutletNonRefEuler2DCons
