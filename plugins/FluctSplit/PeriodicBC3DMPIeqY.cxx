...
#include "FluctSplit/PeriodicBC3DMPIeqY.hh"
...
MethodCommandProvider<PeriodicBC3DMPIeqY,
                      FluctuationSplitData,
                      FluctSplitModule>
periodicBC3dmpieqYProvider("PeriodicBC3DMPIeqY");

//////////////////////////////////////////////////////////////////////////////

void PeriodicBC3DMPIeqY::defineConfigOptions(Config::OptionList& options)
{
...
PeriodicBC3DMPIeqY::PeriodicBC3DMPIeqY(const std::string& name) :
...
PeriodicBC3DMPIeqY::~PeriodicBC3DMPIeqY()
{
}
...
PeriodicBC3DMPIeqY::needsSockets()
{
...
void PeriodicBC3DMPIeqY::executeOnTrs()
{
...
void PeriodicBC3DMPIeqY::configure ( Config::ConfigArgs& args )
{
...
void PeriodicBC3DMPIeqY::preProcess()
{
...
void PeriodicBC3DMPIeqY::Barrier()
{
  MPI_Barrier(_comm);
}
