#ifndef COOLFluiD_Numerics_FluctSplit_STU_QLMJ_SplitStrategy_hh
#define COOLFluiD_Numerics_FluctSplit_STU_QLMJ_SplitStrategy_hh
...
/// This class is a special case of STUQLMJ strategy
/// It is done in order to optimize the computation time
class STU_QLMJ_SplitStrategy : public FluctuationSplitStrategy {

public: // methods

  /// Constructor.
  STU_QLMJ_SplitStrategy(const std::string& name);

  /// Destructor.
  virtual ~STU_QLMJ_SplitStrategy();
...
private: // data
  ...
  /// extra values 
  std::vector<RealVector*> m_qdExtraVars_new;
 ...
 /// temporary face normal
  ...
  std::vector<RealVector> m_pdata_new;
  
}; // class STU_QLMJ_SplitStrategy
...
#endif // COOLFluiD_Numerics_FluctSplit_STU_QLMJ_SplitStrategy_hh
