#ifndef COOLFluiD_FluctSplit_RMS_NavierStokes3Dcons_hh
#define COOLFluiD_FluctSplit_RMS_NavierStokes3Dcons_hh
...
/// @author Erik Torres
class RMS_NavierStokes3Dcons : public Framework::DataProcessingCom {
public: // functions
   ...
   * Constructor.
   */
  RMS_NavierStokes3Dcons(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~RMS_NavierStokes3Dcons();
