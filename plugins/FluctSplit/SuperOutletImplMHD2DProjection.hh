#ifndef COOLFluiD_Numerics_FluctSplit_SuperOutletImplMHD2DProjection_hh
#define COOLFluiD_Numerics_FluctSplit_SuperOutletImplMHD2DProjection_hh
 ...
 *
 */
class SuperOutletImplMHD2DProjection : public FluctuationSplitCom {
public:
   ...
   * Constructor
   */
  SuperOutletImplMHD2DProjection(const std::string& name);

  /**
   * Default destructor
   */
  ~SuperOutletImplMHD2DProjection();
...
}; // end of class SuperOutletImplMHD2DProjection
...
#endif // COOLFluiD_Numerics_FluctSplit_SuperOutletImplMHD2DProjection_hh
