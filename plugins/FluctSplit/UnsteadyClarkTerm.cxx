...
#include "FluctSplit/UnsteadyClarkTerm.hh"
...
MethodStrategyProvider<UnsteadyClarkTerm,
		       FluctuationSplitData,
		       ComputeDiffusiveTerm,
		       FluctSplitLESModule>
UnsteadyClark2dDiffusiveTermProvider("UnsteadyClark2d");

//////////////////////////////////////////////////////////////////////////////

UnsteadyClarkTerm::UnsteadyClarkTerm(const std::string& name) :
...
UnsteadyClarkTerm::~UnsteadyClarkTerm()
{
  deletePtr(_avValues);
  deletePtr(_avState);
}
...
void UnsteadyClarkTerm::setDiffusiveVarSet(SafePtr<DiffusiveVarSet> diffVar)
{
  _diffVar = diffVar.d_castTo<Clark2DVarSet>();
 }

//////////////////////////////////////////////////////////////////////////////

void UnsteadyClarkTerm::setUpdateVarSet(SafePtr<ConvectiveVarSet> updateVar)
{
...
void UnsteadyClarkTerm::computeDiffusiveTerm
...
void UnsteadyClarkTerm::configure ( Config::ConfigArgs& args )
{
...
void UnsteadyClarkTerm::computeCellGradientsAndAverageState
