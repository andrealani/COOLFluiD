#ifndef COOLFluiD_Numerics_FluctSplit_WeakSubInletEuler2DConsImpl_hh
#define COOLFluiD_Numerics_FluctSplit_WeakSubInletEuler2DConsImpl_hh
 ...
 * @author Andrea Lani
 */
class WeakSubInletEuler2DConsImpl : public WeakBC2DImpl {
...
public:
   ...
   * Constructor.
   */
  WeakSubInletEuler2DConsImpl(const std::string& name);
...
}; // end of class WeakSubInletEuler2DConsImpl
...
#endif // COOLFluiD_Numerics_FluctSplit_WeakSubInletEuler2DConsImpl_hh
