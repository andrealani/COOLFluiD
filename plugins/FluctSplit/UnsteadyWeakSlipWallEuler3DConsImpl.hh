#ifndef COOLFluiD_Numerics_FluctSplit_UnsteadyWeakSlipWallEuler3DConsImpl_hh
#define COOLFluiD_Numerics_FluctSplit_UnsteadyWeakSlipWallEuler3DConsImpl_hh
 ...
 *
 */
class UnsteadyWeakSlipWallEuler3DConsImpl : public FluctuationSplitCom {
public:
   ...
   * Constructor.
   */
  UnsteadyWeakSlipWallEuler3DConsImpl(const std::string& name);

  /**
   * Default destructor
   */
  ~UnsteadyWeakSlipWallEuler3DConsImpl();
...
}; // end of class UnsteadyWeakSlipWallEuler3DConsImpl
...
#endif // COOLFluiD_Numerics_FluctSplit_UnsteadyWeakSlipWallEuler3DConsImpl_hh
