#ifndef COOLFluiD_FluctSplit_CIntegralTetraP1O1_hh
#define COOLFluiD_FluctSplit_CIntegralTetraP1O1_hh

#include "FluctSplit/MetaSchemes/ContourIntegral.hh"
#include "FluctSplit/MetaSchemes/TetraP1.hh"
...
template <> struct CIntegral < TetraP1, CFPolyOrder::ORDER1 >
{
  typedef TetraP1 Elem;
  typedef CIntegral < TetraP1, CFPolyOrder::ORDER1 > Integrator;
...
template <> double CIntegral<TetraP1,CFPolyOrder::ORDER1>::QdPt<0>::weight  () { return 0.500; }
template <> double CIntegral<TetraP1,CFPolyOrder::ORDER1>::QdPt<0>::xi      () { return 1./3.; }
template <> double CIntegral<TetraP1,CFPolyOrder::ORDER1>::QdPt<0>::eta     () { return 1./3.; }
template <> double CIntegral<TetraP1,CFPolyOrder::ORDER1>::QdPt<0>::zeta    () { return 0.000; }

// definition of element quadrature point 1
template <> double CIntegral<TetraP1,CFPolyOrder::ORDER1>::QdPt<1>::weight  () { return 0.500; }
template <> double CIntegral<TetraP1,CFPolyOrder::ORDER1>::QdPt<1>::xi      () { return 1./3.; }
template <> double CIntegral<TetraP1,CFPolyOrder::ORDER1>::QdPt<1>::eta     () { return 0.000; }
template <> double CIntegral<TetraP1,CFPolyOrder::ORDER1>::QdPt<1>::zeta    () { return 1./3.; }

// definition of element quadrature point 2
template <> double CIntegral<TetraP1,CFPolyOrder::ORDER1>::QdPt<2>::weight  () { return std::sqrt(3.0)/2.0; }
template <> double CIntegral<TetraP1,CFPolyOrder::ORDER1>::QdPt<2>::xi      () { return 1./3.; }
template <> double CIntegral<TetraP1,CFPolyOrder::ORDER1>::QdPt<2>::eta     () { return 1./3.; }
template <> double CIntegral<TetraP1,CFPolyOrder::ORDER1>::QdPt<2>::zeta    () { return 1./3.; }

// definition of element quadrature point 3
template <> double CIntegral<TetraP1,CFPolyOrder::ORDER1>::QdPt<3>::weight  () { return 0.500; }
template <> double CIntegral<TetraP1,CFPolyOrder::ORDER1>::QdPt<3>::xi      () { return 0.000; }
template <> double CIntegral<TetraP1,CFPolyOrder::ORDER1>::QdPt<3>::eta     () { return 1./3.; }
template <> double CIntegral<TetraP1,CFPolyOrder::ORDER1>::QdPt<3>::zeta    () { return 1./3.; }

///////////////////////////////////////////////////////////////////////////////

/// Definition of subelem 0 quadrature point 0
template <> template <>
struct CIntegral<TetraP1,CFPolyOrder::ORDER1>::SubElem<0>::QdPt<0>
{
  enum { ID = 0 };
  template < typename FSDATA >
...
template <> template <>
struct CIntegral<TetraP1,CFPolyOrder::ORDER1>::SubElem<0>::QdPt<1>
{
  enum { ID = 1 };
  template < typename FSDATA >
...
template <> template <>
struct CIntegral<TetraP1,CFPolyOrder::ORDER1>::SubElem<0>::QdPt<2>
{
  enum { ID = 2 };
  template < typename FSDATA >
...
template <> template <>
struct CIntegral<TetraP1,CFPolyOrder::ORDER1>::SubElem<0>::QdPt<3>
{
  enum { ID = 3 };
  template < typename FSDATA >
...
#endif // COOLFluiD_FluctSplit_CIntegralTetraP1O1_hh
