#ifndef COOLFluiD_Numerics_FluctSplit_UnsteadyClarkTerm_hh
#define COOLFluiD_Numerics_FluctSplit_UnsteadyClarkTerm_hh
 ...
 *
 */
class UnsteadyClarkTerm : public ComputeDiffusiveTerm {
public:

  /**
   * Constructor
   */
  UnsteadyClarkTerm(const std::string& name);
  
  /**
   * Default destructor
   */
  virtual ~UnsteadyClarkTerm();
...
protected: // data
  ...
  Common::SafePtr<Physics::LESvki::Clark2DVarSet> _diffVar;
