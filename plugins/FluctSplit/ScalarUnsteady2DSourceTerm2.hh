#ifndef COOLFluiD_Numerics_FluctSplit_ScalarUnsteady2DSourceTerm2_hh
#define COOLFluiD_Numerics_FluctSplit_ScalarUnsteady2DSourceTerm2_hh
 ...
 */
class ScalarUnsteady2DSourceTerm2 : public ComputeSourceTermFSM {
public:
   ...
   * @see LinEuler2D
   */
  ScalarUnsteady2DSourceTerm2(const std::string& name);
  
  /**
   * Default destructor
   */
  ~ScalarUnsteady2DSourceTerm2();
