#ifndef COOLFluiD_FluctSplit_Dilatation_NavierStokes3Dcons_hh
#define COOLFluiD_FluctSplit_Dilatation_NavierStokes3Dcons_hh
...
/// @author Lilla Kapa
class Dilatation_NavierStokes3Dcons : public Framework::DataProcessingCom {
public: // functions
   ...
   * Constructor.
   */
  Dilatation_NavierStokes3Dcons(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~Dilatation_NavierStokes3Dcons();
