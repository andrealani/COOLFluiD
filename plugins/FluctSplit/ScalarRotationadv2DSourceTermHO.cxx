...
#include "ScalarRotationadv2DSourceTermHO.hh"
...
MethodStrategyProvider<ScalarRotationadv2DSourceTermHO,
		       FluctuationSplitData,
		       ComputeSourceTermFSM,
		       FluctSplitRotationDiffusionModule>
sra2DSHOProvider("ScalarRotationadv2DSourceHO");

//////////////////////////////////////////////////////////////////////////////

void ScalarRotationadv2DSourceTermHO::defineConfigOptions(Config::OptionList& options)
{
...
ScalarRotationadv2DSourceTermHO::ScalarRotationadv2DSourceTermHO(const std::string& name) :
...
ScalarRotationadv2DSourceTermHO::~ScalarRotationadv2DSourceTermHO()
{
}

//////////////////////////////////////////////////////////////////////////////

void ScalarRotationadv2DSourceTermHO::setup()
{
...
void ScalarRotationadv2DSourceTermHO::computeSourceFSM(Framework::GeometricEntity *const cell,
					 RealVector& source,
					 const FluctSplit::InwardNormalsData& normalsData)
{
  ...
  { 
    ...
    if (r < 0.25)
      source_value[iState] = 10.0;
    else
      source_value[iState] = 0.0;
