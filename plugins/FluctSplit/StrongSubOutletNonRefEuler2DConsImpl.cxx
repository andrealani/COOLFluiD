...
#include "StrongSubOutletNonRefEuler2DConsImpl.hh"
...
MethodCommandProvider<StrongSubOutletNonRefEuler2DConsImpl, FluctuationSplitData, FluctSplitSpaceTimeNavierStokesModule> strongSubOutletNonRefEuler2DConsImplProvider("StrongSubOutletNonRefEuler2DConsImpl");

//////////////////////////////////////////////////////////////////////////////

StrongSubOutletNonRefEuler2DConsImpl::StrongSubOutletNonRefEuler2DConsImpl(const std::string& name) :
...
StrongSubOutletNonRefEuler2DConsImpl::~StrongSubOutletNonRefEuler2DConsImpl()
{
  if (isSetup()) unsetup();
}
//////////////////////////////////////////////////////////////////////////////

void StrongSubOutletNonRefEuler2DConsImpl::defineConfigOptions(Config::OptionList& options)
{
...
StrongSubOutletNonRefEuler2DConsImpl::needsSockets()
{
...
void StrongSubOutletNonRefEuler2DConsImpl::setup()
{
...
void StrongSubOutletNonRefEuler2DConsImpl::executeOnTrs()
{
  ...
  const bool IsMeanflow = socket_meanflowNS.isConnected();
//    if (IsMeanflow==true)
//      meanflow = socket_meanflowNS.getDataHandle();


  DataHandle<CFreal> rhs = socket_rhs.getDataHandle();
  DataHandle<CFreal> rhsold = socket_rhs.getDataHandle();
  DataHandle < Framework::State*, Framework::GLOBAL > states = socket_states.getDataHandle();
...
// 	  D23[iStat] = m_betas*0.25*c/Area*(nchary*(*m_Statenormals[iStat])[0]-ncharx*(*m_Statenormals[iStat])[1]);
	...
	// First approximation
	  ...
	  if (iJac == boundaryState) {
	   ...
	   jacobians[elemCount*3+iJac](1,1) = Dii[iJac];
...
// 	   jacobians[elemCount*3+iJac](2,3) = -ncharx*D23[iJac]*oneoverc;
	   jacobians[elemCount*3+iJac](2,2) = Dii[iJac];   
...
void StrongSubOutletNonRefEuler2DConsImpl::configure ( Config::ConfigArgs& args )
{
...
void StrongSubOutletNonRefEuler2DConsImpl::computeCharK(std::vector<Framework::State*>& states,   RealVector& _kPlus,   RealVector& _k, RealVector& _kPast, std::vector<RealVector*>& normal, RealVector& faceLength, CFreal& Area)
  {
...
///////////////////////////////////////////////////////////////
CFreal StrongSubOutletNonRefEuler2DConsImpl::distributeLDA(RealVector& m_kPlus, CFreal m_betas, CFuint boundarystate){
...
void StrongSubOutletNonRefEuler2DConsImpl::unsetup()
{
}
