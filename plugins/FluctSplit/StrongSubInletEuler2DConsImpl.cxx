...
#include "StrongSubInletEuler2DConsImpl.hh"
...
MethodCommandProvider<StrongSubInletEuler2DConsImpl, FluctuationSplitData, FluctSplitSpaceTimeNavierStokesModule> strongSubInletEuler2DConsImplProvider("StrongSubInletEuler2DConsImpl");

//////////////////////////////////////////////////////////////////////////////

StrongSubInletEuler2DConsImpl::StrongSubInletEuler2DConsImpl(const std::string& name) :
...
void StrongSubInletEuler2DConsImpl::defineConfigOptions(Config::OptionList&
options)
{
...
StrongSubInletEuler2DConsImpl::~StrongSubInletEuler2DConsImpl()
{
  if (isSetup()) unsetup();
}
...
StrongSubInletEuler2DConsImpl::needsSockets()
{
...
void StrongSubInletEuler2DConsImpl::setup()
{
...
void StrongSubInletEuler2DConsImpl::executeOnTrs()
{
...
void StrongSubInletEuler2DConsImpl::configure ( Config::ConfigArgs& args )
{
  ...
  if(m_function_inflow.empty())
     throw BadValueException(FromHere(),"StrongSubInletEuler2DConsImpl::setFuntion(): no incoming flow function provided.");
...
void StrongSubInletEuler2DConsImpl::computeCharK(std::vector<Framework::State*>& states,   RealVector& _kPlus,   RealVector& _k, RealVector& _kPast, std::vector<RealVector*>& normal, RealVector& faceLength, CFreal& Area)
  {
...
CFreal StrongSubInletEuler2DConsImpl::distributeLDA(RealVector& m_kPlus, CFreal m_betas, CFuint boundarystate){
...
void StrongSubInletEuler2DConsImpl::unsetup()
{
  inflow.resize(0);
  _bcNormals.resize(0);
