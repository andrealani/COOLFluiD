#ifndef COOLFluiD_FluctSplit_MixLayerRandomPerturbation_hh
#define COOLFluiD_FluctSplit_MixLayerRandomPerturbation_hh
...
class MixLayerRandomPerturbation : public Framework::DataProcessingCom {
public: // functions
   ...
   * Constructor.
   */
  MixLayerRandomPerturbation(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~MixLayerRandomPerturbation();
