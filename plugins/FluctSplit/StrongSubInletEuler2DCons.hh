#ifndef COOLFluiD_Numerics_FluctSplit_StrongSubInletEuler2DCons_hh
#define COOLFluiD_Numerics_FluctSplit_StrongSubInletEuler2DCons_hh
...
class StrongSubInletEuler2DCons : public FluctuationSplitCom {
public:

  /**
   * Constructor
   */
  StrongSubInletEuler2DCons(const std::string& name);
...
}; // end of class StrongSubInletEuler2DCons
