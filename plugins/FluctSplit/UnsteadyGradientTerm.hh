#ifndef COOLFluiD_Numerics_FluctSplit_UnsteadyGradientTerm_hh
#define COOLFluiD_Numerics_FluctSplit_UnsteadyGradientTerm_hh
 ...
 *
 */
class UnsteadyGradientTerm : public ComputeDiffusiveTerm {
public:

  /**
   * Constructor
   */
  UnsteadyGradientTerm(const std::string& name);
  
  /**
   * Default destructor
   */
  virtual ~UnsteadyGradientTerm();
...
protected: // data
  ...
  Common::SafePtr<Physics::LESvki::Gradient2DVarSet> _diffVar;
