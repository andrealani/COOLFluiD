#ifndef COOLFluiD_Numerics_FluctSplit_StrongSubInletEuler3DConsImpl_hh
#define COOLFluiD_Numerics_FluctSplit_StrongSubInletEuler3DConsImpl_hh
...
class StrongSubInletEuler3DConsImpl : public FluctuationSplitCom {
public:

  /**
   * Constructor
   */
  StrongSubInletEuler3DConsImpl(const std::string& name);

  /**
   * Default destructor
   */
  ~StrongSubInletEuler3DConsImpl();
...
}; // end of class StrongSubInletEuler3DConsImpl
