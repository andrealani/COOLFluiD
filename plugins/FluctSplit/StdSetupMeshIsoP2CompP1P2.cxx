...
#include "FluctSplit/StdSetupMeshIsoP2CompP1P2.hh"
...
MethodCommandProvider<StdSetupMeshIsoP2CompP1P2, FluctuationSplitData, FluctSplitModule> stdSetupIsoTetraP1p2Provider("StdSetupMeshIsoP2CompP1P2");

//////////////////////////////////////////////////////////////////////////////

StdSetupMeshIsoP2CompP1P2::StdSetupMeshIsoP2CompP1P2(const std::string& name) :
...
StdSetupMeshIsoP2CompP1P2::~StdSetupMeshIsoP2CompP1P2()
{
}
...
StdSetupMeshIsoP2CompP1P2::providesSockets()
{
...
StdSetupMeshIsoP2CompP1P2::needsSockets()
{
...
void StdSetupMeshIsoP2CompP1P2::configure ( Config::ConfigArgs& args )
{
  CFAUTOTRACE;
...
void StdSetupMeshIsoP2CompP1P2::execute()
{
  CFAUTOTRACE;
...
void StdSetupMeshIsoP2CompP1P2::storeBoundaryNormals()
{
...
void StdSetupMeshIsoP2CompP1P2::computeNormalsData()
{
  CFAUTOTRACE;
...
void StdSetupMeshIsoP2CompP1P2::flagBoundaryStates()
{
  CFAUTOTRACE;
...
void StdSetupMeshIsoP2CompP1P2::setFaceNeighCell()
{
  CFAUTOTRACE;
...
//   CF_DEBUG_OBJ( countFaceNodesOnBoundary );
 ...
 //   CF_DEBUG_OBJ(iFace);
		...
		// CF_DEBUG_OBJ(faceIdx);
		// CF_DEBUG_OBJ(currFaceID);
                CFuint countNodes = 0;
		// CF_DEBUG_OBJ(nbNodesInCurrFace);
		// CF_DEBUG_OBJ(nbNodesPerFace);
		  ...
		  // CF_DEBUG_POINT;
		    ...
		    // CF_DEBUG_OBJ(newNodeID);
                    for (CFuint jNode = 0; jNode < nbNodesPerFace; ++jNode) {
		      // CF_DEBUG_OBJ(faceTrs->getNodeID(faceIdx,jNode));
	      ...
	      if(faceFound == false){
   const CFuint nodeID = nodesInFace[1];
	    ...
	    if(faceFound == false){
   const CFuint nodeID = nodesInFace[2];
...
void StdSetupMeshIsoP2CompP1P2::computeCellVolumes()
{
