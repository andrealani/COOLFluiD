#ifndef COOLFluiD_Numerics_FluctSplit_StdSetup_hh
#define COOLFluiD_Numerics_FluctSplit_StdSetup_hh
...
/// @author Andrea Lani
class FluctSplit_API StdSetup : public FluctuationSplitCom {
