#include "FluctSplit/STU_CRD_SplitStrategyquad.hh"
...
/////////////////////////////////////////////////////////////////////////////
MethodStrategyProvider<STU_CRD_SplitStrategyquad,
                       FluctuationSplitData,
                       FluctuationSplitStrategy,
                       FluctSplitSpaceTimeModule>
spaceTimeucrdquadFluctSplitStrategyProvider("STU_CRD_quad");

//////////////////////////////////////////////////////////////////////////////

STU_CRD_SplitStrategyquad::STU_CRD_SplitStrategyquad(const std::string& name) :
...
STU_CRD_SplitStrategyquad::~STU_CRD_SplitStrategyquad()
{
  if (isSetup()) unsetup();
}
...
void STU_CRD_SplitStrategyquad::computeFluctuation(vector<RealVector>& residual)
{
  ...
  // CF_DEBUG_OBJ(getMethodData().getDistributionData().cellID);
  m_splitter->distribute(residual); 
}
    
//////////////////////////////////////////////////////////////////////////////

void STU_CRD_SplitStrategyquad::unsetup()
{
...
void STU_CRD_SplitStrategyquad::setup()
{
  CFAUTOTRACE;
...
STU_CRD_SplitStrategyquad::needsSockets()
{
...
void STU_CRD_SplitStrategyquad::setCurrentCell()
{
  DistributionData& ddata = getMethodData().getDistributionData();
...
void STU_CRD_SplitStrategyquad::computeSTFluxIntegral(bool isPast)
{ 
  const CFreal Area = CellVolume/4.0;
