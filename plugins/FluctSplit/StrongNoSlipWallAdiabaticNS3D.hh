#ifndef COOLFluiD_Numerics_FluctSplit_StrongNoSlipWallAdiabaticNS3D_hh
#define COOLFluiD_Numerics_FluctSplit_StrongNoSlipWallAdiabaticNS3D_hh
...
/// @author Andrea Lani
class FluctSplit_API StrongNoSlipWallAdiabaticNS3D : public FluctuationSplitCom {

public:

  /// Constructor.
  StrongNoSlipWallAdiabaticNS3D(const std::string& name);

  /// Default destructor
  ~StrongNoSlipWallAdiabaticNS3D();
