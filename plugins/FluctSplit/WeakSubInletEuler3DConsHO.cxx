...
#include "WeakSubInletEuler3DConsHO.hh"
...
MethodCommandProvider<WeakSubInletEuler3DConsHO, FluctuationSplitData, FluctSplitNavierStokesModule> weakSubInletEuler3DConshoProvider("WeakSubInletEuler3DConsHO");

//////////////////////////////////////////////////////////////////////////////

void WeakSubInletEuler3DConsHO::defineConfigOptions(Config::OptionList& options)
{
...
WeakSubInletEuler3DConsHO::WeakSubInletEuler3DConsHO(const std::string& name) :
  WeakBC3DHO(name),
  m_varSet(),
  m_dUinDu(),
  m_identity()
...
WeakSubInletEuler3DConsHO::~WeakSubInletEuler3DConsHO()
{
}

//////////////////////////////////////////////////////////////////////////////

void WeakSubInletEuler3DConsHO::setup()
{
  WeakBC3DHO::setup();
  m_varSet->setup();
...
void WeakSubInletEuler3DConsHO::setGhostState(const State& state,
					     State& gstate)
{
...
void WeakSubInletEuler3DConsHO::configure ( Config::ConfigArgs& args )
{
