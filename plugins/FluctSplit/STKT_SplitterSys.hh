#ifndef COOLFluiD_Numerics_FluctSplit_STKT_SplitterSys_hh
#define COOLFluiD_Numerics_FluctSplit_STKT_SplitterSys_hh
 ...
 */
class STKT_SplitterSys : public SpaceTime_Splitter {
public:

  /**
   * Constructor
   */
  STKT_SplitterSys(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~STKT_SplitterSys();
...
}; // end of class SpaceTimeRDS_SplitterSys
