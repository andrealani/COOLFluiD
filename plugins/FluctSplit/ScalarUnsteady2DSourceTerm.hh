#ifndef COOLFluiD_Numerics_FluctSplit_ScalarUnsteady2DSourceTerm_hh
#define COOLFluiD_Numerics_FluctSplit_ScalarUnsteady2DSourceTerm_hh
 ...
 */
class ScalarUnsteady2DSourceTerm : public ComputeSourceTermFSM {
public:
   ...
   * @see LinEuler2D
   */
  ScalarUnsteady2DSourceTerm(const std::string& name);
  
  /**
   * Default destructor
   */
  ~ScalarUnsteady2DSourceTerm();
