#ifndef COOLFluiD_Numerics_FluctSplit_StrongSubOutletNonRefEuler3DConsImpl_hh
#define COOLFluiD_Numerics_FluctSplit_StrongSubOutletNonRefEuler3DConsImpl_hh
...
class StrongSubOutletNonRefEuler3DConsImpl : public FluctuationSplitCom {
public:

  /**
   * Constructor
   */
  StrongSubOutletNonRefEuler3DConsImpl(const std::string& name);

  /**
   * Default destructor
   */
  ~StrongSubOutletNonRefEuler3DConsImpl();
...
private:
  ...
  /// number of adjecant nodes
  
  RealVector nbFreedom;
  
}; // end of class StrongSubOutletNonRefEuler3DConsImpl
