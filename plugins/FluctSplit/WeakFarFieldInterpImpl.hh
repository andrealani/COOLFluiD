#ifndef COOLFluiD_Numerics_FluctSplit_WeakFarFieldInterpImpl_hh
#define COOLFluiD_Numerics_FluctSplit_WeakFarFieldInterpImpl_hh
...
class FluctSplit_API WeakFarFieldInterpImpl : public WEAKBCTYPE {
...
public: // functions
  ...
  /// Constructor.
  WeakFarFieldInterpImpl(const std::string& name);

  /// Default destructor
  ~WeakFarFieldInterpImpl();
...
}; // end of class WeakFarFieldInterpImpl
...
#include "FluctSplit/WeakFarFieldInterpImpl.ci"

//////////////////////////////////////////////////////////////////////////////

#endif // COOLFluiD_Numerics_FluctSplit_WeakFarFieldInterpImpl_hh
