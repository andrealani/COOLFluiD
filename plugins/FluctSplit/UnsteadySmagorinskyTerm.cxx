...
#include "FluctSplit/UnsteadySmagorinskyTerm.hh"
...
MethodStrategyProvider<UnsteadySmagorinskyTerm,
		       FluctuationSplitData,
		       ComputeDiffusiveTerm,
		       FluctSplitLESModule>
UnsteadySmag2dDiffusiveTermProvider("UnsteadySmagorinsky2d");

//////////////////////////////////////////////////////////////////////////////

UnsteadySmagorinskyTerm::UnsteadySmagorinskyTerm(const std::string& name) :
...
UnsteadySmagorinskyTerm::~UnsteadySmagorinskyTerm()
{
  deletePtr(_avValues);
  deletePtr(_avState);
}
...
void UnsteadySmagorinskyTerm::setDiffusiveVarSet(SafePtr<DiffusiveVarSet> diffVar)
{
  _diffVar = diffVar.d_castTo<Smagorinsky2DVarSet>();
 }

//////////////////////////////////////////////////////////////////////////////

void UnsteadySmagorinskyTerm::setUpdateVarSet(SafePtr<ConvectiveVarSet> updateVar)
{
...
void UnsteadySmagorinskyTerm::computeDiffusiveTerm
...
void UnsteadySmagorinskyTerm::setup()
{
  const CFuint nbEqs = PhysicalModelStack::getActive()->getNbEq();
  const CFuint dim = PhysicalModelStack::getActive()->getDim();
...
void UnsteadySmagorinskyTerm::configure ( Config::ConfigArgs& args )
{
...
void UnsteadySmagorinskyTerm::computeCellGradientsAndAverageState
