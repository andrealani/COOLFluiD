...
MethodStrategyProvider<STKT_LDACSchemeSys,
		       FluctuationSplitData,
		       Splitter,
                       FluctSplitSpaceTimeModule>
spaceTimeRiccLDAcSchemeSysProvider("STKT_SysLDAC");

//////////////////////////////////////////////////////////////////////////////

STKT_LDACSchemeSys::STKT_LDACSchemeSys(const std::string& name) :
...
STKT_LDACSchemeSys::~STKT_LDACSchemeSys()
{
}

//////////////////////////////////////////////////////////////////////////////

void STKT_LDACSchemeSys::setup()
{
...
void STKT_LDACSchemeSys::computePicardJacob(std::vector<RealMatrix*>& jacob)
{
...
void STKT_LDACSchemeSys::distribute(vector<RealVector>& residual)
{  
  m_sumKplus = *_kPlus[0];
