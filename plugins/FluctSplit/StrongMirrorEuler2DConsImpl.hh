#ifndef COOLFluiD_Numerics_FluctSplit_StrongMirrorEuler2DConsImpl_hh
#define COOLFluiD_Numerics_FluctSplit_StrongMirrorEuler2DConsImpl_hh
 ...
 *
 */
class StrongMirrorEuler2DConsImpl : public FluctuationSplitCom {
public:

  /**
   * Constructor.
   */
  StrongMirrorEuler2DConsImpl(const std::string& name);

  /**
   * Default destructor
   */
  ~StrongMirrorEuler2DConsImpl();
...
}; // end of class StrongMirrorEuler2DConsImpl
...
#endif // COOLFluiD_Numerics_FluctSplit_StrongMirrorEuler2DConsImpl_hh
