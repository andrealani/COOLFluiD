#ifndef COOLFluiD_Numerics_FluctSplit_StdSetupIsoP3_hh
#define COOLFluiD_Numerics_FluctSplit_StdSetupIsoP3_hh
...
class FluctSplit_API StdSetupIsoP3 : public FluctuationSplitCom {
public: // member functions

  /// Constructor.
  explicit StdSetupIsoP3(const std::string& name);

  /// Destructor.
  virtual ~StdSetupIsoP3();
...
#endif // COOLFluiD_Numerics_FluctSplit_StdSetupIsoP3_hh
