#ifndef COOLFluiD_Numerics_FluctSplit_UnsteadyLESTerm_hh
#define COOLFluiD_Numerics_FluctSplit_UnsteadyLESTerm_hh
...
class UnsteadyLESTerm : public ComputeDiffusiveTerm {
public:

  /**
   * Constructor
   */
  UnsteadyLESTerm(const std::string& name);
  
  /**
   * Default destructor
   */
  virtual ~UnsteadyLESTerm();
...
protected: // data
  ...
  Common::SafePtr<DIFFVAR> _diffVar;
