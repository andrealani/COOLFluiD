#ifndef COOLFluiD_LES_LES2DCons_hh
#define COOLFluiD_LES_LES2DCons_hh

//////////////////////////////////////////////////////////////////////////////

#include "LES2DVarSet.hh"
...
//////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * This class represents a 2D Large Eddy Simulation physical model for conservative variables
   *
   * @author Kris Van den Abeele
   */
class LES2DCons : public LES2DVarSet {
public: // classes
   ...
   * @see LES2D
   */
  LES2DCons(const std::string& name, Common::SafePtr<Framework::PhysicalModelImpl> model);
...
#endif // COOLFluiD_LES_LES2DCons_hh
