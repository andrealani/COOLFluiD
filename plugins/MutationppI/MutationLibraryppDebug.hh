#ifndef COOLFluiD_Physics_Mutationpp_MutationLibraryppDebug_hh
#define COOLFluiD_Physics_Mutationpp_MutationLibraryppDebug_hh
...
/**
 * This class represents the interface for a MutationLibraryppDebug.
 *
 * @author Andrea Lani
 * @author James B. Scoggins
 *
 */
class MutationLibraryppDebug : public Mutation2OLD::MutationLibrary2OLD {
public:
   ...
   */
  MutationLibraryppDebug(const std::string& name);
  ...
  void setState(CFdouble* rhoi, CFdouble* T) 
  {
    ...
    CFLog(DEBUG_MAX, "MutationLibraryppDebug::setState() => rhoiv = " << m_rhoiv << ", T = " << *T << "\n"); 
  ...
  CFdouble electronPressure(CFreal rhoE, CFreal tempE);
   ...
   {
     throw Common::NotImplementedException(FromHere(),"MutationLibraryppDebug::getCvTr()");
     return 0.;
   }
   ...
   void setMoleculesIDs(std::vector<CFuint>& v)
  {
	...
	CFLog(DEBUG_MAX, "MutationLibraryppDebug::setMoleculesIDs() => species ["<< i << "] is " 
...
protected: //variables
  ...
  MutationLibraryppDebug::StateModelType m_smType;
...
#endif // COOLFluiD_Physics_Mutationpp_MutationLibraryppDebug_hh
