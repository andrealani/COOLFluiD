...
#include "FluxReconstructionMHD/MLPLimiterMHD3D.hh"
...
MethodCommandProvider<MLPLimiterMHD3D, FluxReconstructionSolverData, FluxReconstructionMHDModule>
    MLPLimiterMHD3DFRProvider("MLPLimiterMHD3D");

//////////////////////////////////////////////////////////////////////////////

void MLPLimiterMHD3D::defineConfigOptions(Config::OptionList& options)
{
...
MLPLimiterMHD3D::MLPLimiterMHD3D(const std::string& name) :
  MLPLimiter(name),
  m_minDensity(),
  m_minPressure(),
  m_machThreshold(),
...
MLPLimiterMHD3D::~MLPLimiterMHD3D()
{
}

//////////////////////////////////////////////////////////////////////////////

void MLPLimiterMHD3D::configure ( Config::ConfigArgs& args )
{
...
bool MLPLimiterMHD3D::checkPhysicality()
{
  bool physical = true;
...
void MLPLimiterMHD3D::applyChecks(CFreal phi)
{
  const bool Prim = getMethodData().getUpdateVarStr() == "Prim";
  CFreal press;
...
CFreal MLPLimiterMHD3D::computeLimitingValue(RealVector state)
{
  CFAUTOTRACE;
...
void MLPLimiterMHD3D::limitAvgState()
{
  CFAUTOTRACE;
...
bool MLPLimiterMHD3D::checkSpecialLimConditions()
{
  CFAUTOTRACE;
  ...
  else
  {
    ...
    CFLog(WARN, "MLPLimiterMHD3D: Unknown variable set, defaulting to always apply limiting\n");
    M = 10.0;
  }
  ...
  {
    CFLog(INFO, "MLPLimiterMHD3D: Limiting activated in cell " << m_cell->getID() 
          << " (M = " << M << " > " << m_machThreshold << ")\n");
  }
...
void MLPLimiterMHD3D::setup()
{
  CFAUTOTRACE;
  CFLog(INFO, "MLPMHD3D setup\n");
  ...
  {
    // get MHD 3D varset
    m_MHDVarSet = getMethodData().getUpdateVar().d_castTo<MHD3DProjectionVarSet>();
    if (m_MHDVarSet.isNull())
    {
      throw Common::ShouldNotBeHereException (FromHere(),"Update variable set is not MHD3DProjectionVarSet in MLPLimiterMHD3DFluxReconstruction!");
    }
