...
void ConvDiffJacobFluxReconstructionMHD::computeInterfaceFlxCorrection()
{
  for (CFuint iFlx = 0; iFlx < m_nbrFaceFlxPnts; ++iFlx)
  {
  ...
  m_diffusiveVarSetMHD->setGradientVars(m_tempStatesL,m_tempGradTermL,m_nbrFaceFlxPnts);
  m_diffusiveVarSetMHD->setGradientVars(m_tempStatesR,m_tempGradTermR,m_nbrFaceFlxPnts);
...
void ConvDiffJacobFluxReconstructionMHD::computeRiemannFluxJacobianNum(const CFreal resFactor)
{
  CFLog(VERBOSE, "MHD computeRiemannFluxJacobianNum\n");
...
void ConvDiffJacobFluxReconstructionMHD::computeRiemannFluxToGradJacobianNum(const CFreal resFactor)
{  
  CFLog(VERBOSE, "MHD computeRiemannFluxToGradJacobianNum\n");
...
void ConvDiffJacobFluxReconstructionMHD::computeGradVarsToStateJacobianNum()
{
  CFLog(VERBOSE, "MHD computeGradVarsToStateJacobianNum\n");
  ...
  { 
    for (m_pertSol = 0; m_pertSol < m_nbrSolPnts; ++m_pertSol)
    {
      ...
      m_diffusiveVarSetMHD->setGradientVars(m_tempStatesJacob,m_tempGradTermJacob,1);
      ...
      for (m_pertVar = 0; m_pertVar < m_nbrEqs; ++m_pertVar)
      {
        ...
        m_diffusiveVarSetMHD->setGradientVars(m_tempStatesJacob2,m_tempGradTermJacob2,1);
...
void ConvDiffJacobFluxReconstructionMHD::computeGradients()
{
  ...
  m_diffusiveVarSetMHD->setGradientVars(m_tempStatesCell,m_tempGradTerm,m_nbrSolPnts);
  ...
  for (CFuint iSolPnt = 0; iSolPnt < m_nbrSolPnts; ++iSolPnt)
  {
    ...
    for (CFuint iEq = 0; iEq < m_nbrEqs; ++iEq)
    {
	  ...
	  m_projectedCorrL[jDir] = m_tempGradTerm(iEq,iSolPnt) * solPntNormals[solID*(m_dim+m_ndimplus)*m_dim+iDir*m_dim+jDir];
        }
...
void ConvDiffJacobFluxReconstructionMHD::computeGradientFaceCorrections()
{
  ...
  m_diffusiveVarSetMHD->setGradientVars(m_tempStatesL2,m_tempGradTermL,m_nbrFaceFlxPnts);
  m_diffusiveVarSetMHD->setGradientVars(m_tempStatesR2,m_tempGradTermR,m_nbrFaceFlxPnts);
