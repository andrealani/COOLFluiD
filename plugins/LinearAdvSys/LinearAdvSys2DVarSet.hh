...
#ifndef COOLFluiD_Physics_LinearAdvSys_LinearAdvSys2DVarSet_hh
#define COOLFluiD_Physics_LinearAdvSys_LinearAdvSys2DVarSet_hh
 ...
 */
class LinearAdvSys2DVarSet : public LinearAdvSysVarSet {
public: // classes
   ...
   */
  LinearAdvSys2DVarSet(Common::SafePtr<Framework::BaseTerm> term);

  /**
   * Default destructor
   */
  virtual ~LinearAdvSys2DVarSet();
