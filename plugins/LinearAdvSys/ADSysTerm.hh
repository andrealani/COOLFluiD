...
#ifndef COOLFluiD_Physics_LinearAdvSys_ADSysTerm_hh
#define COOLFluiD_Physics_LinearAdvSys_ADSysTerm_hh
...
class ADSysTerm : public Framework::BaseTerm
{
public:
  ...
  ADSysTerm(const std::string& name);
  ...
  /// Get the name
  static std::string getName()  {  return "ADSysTerm"; }
