#ifndef COOLFluiD_Numerics_FiniteVolume_FVMCC_ComputeRHSCell_hh
#define COOLFluiD_Numerics_FiniteVolume_FVMCC_ComputeRHSCell_hh
...
class FVMCC_ComputeRHSCell : public FVMCC_ComputeRHS {
public:

  /**
   * Constructor.
   */
  explicit FVMCC_ComputeRHSCell(const std::string& name);
  
  /**
   * Destructor.
   */
  virtual ~FVMCC_ComputeRHSCell();
...
#include "FVMCC_ComputeRHSCell.ci"

//////////////////////////////////////////////////////////////////////////////

#endif // COOLFluiD_Numerics_FiniteVolume_FVMCC_ComputeRHSCell_hh
