#include "NEQ/NEQ.hh"
#include "Euler2DNEQLinearCons.hh"
...
Environment::ObjectProvider<Euler2DNEQLinearCons, JacobianLinearizer, NEQModule, 1> 
euler2DNEQLinearConsProvider("Euler2DNEQLinearCons");

//////////////////////////////////////////////////////////////////////////////

Euler2DNEQLinearCons::Euler2DNEQLinearCons(Common::SafePtr<Framework::PhysicalModel> model) :
...
Euler2DNEQLinearCons::~Euler2DNEQLinearCons()
{
}

//////////////////////////////////////////////////////////////////////////////

void Euler2DNEQLinearCons::linearize(const vector<State*>& statesInCell)
{
  ...
  const CFuint nbTvs   = _model->getNbScalarVars(1);
  CFuint startTv =  -1; 

  if (nbTvs > 0) {    
	startTv =  _model->getFirstScalarVar(1);
    // ev Average
        linearData[startTv] = _avZ[nbSpecies+3]*ovRho;
  }
  ...
  if (nbTvs > 0) { 
    ...
    linearData[EulerTerm::T] = (linearData[EulerTerm::E] - linearData[startTv] - form - 0.5*V2)/denom;
  }
  else{
    // here could be changed for ionized case ....
 ...
 //    aiyi += yOvM*RT - _ye[i]*beta*eData->energyTr[i];
