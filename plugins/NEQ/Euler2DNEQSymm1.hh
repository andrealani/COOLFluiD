#ifndef COOLFluiD_Physics_NEQ_Euler2DNEQSymm1_hh
#define COOLFluiD_Physics_NEQ_Euler2DNEQSymm1_hh
...
#include "NEQ/Euler2DNEQSymm1ToConsInRef.hh"
#include "NEQ/Euler2DNEQConsToSymm1InRef.hh"
//////////////////////////////////////////////////////////////////////////////
...
public: // classes
   ...
   * @see Euler2D
   */
  Euler2DNEQSymm1(Common::SafePtr<Framework::BaseTerm> term);
  ...
  /**
   * Debugging function that will have to be erased
   */
  /*  
      void debuggingFunction(const RealVector& normal, RealMatrix& jacob, RealMatrix& jacobU, RealMatrix& dUdQ, RealMatrix& dQdU);
  */
...
#endif // COOLFluiD_Physics_NEQ_Euler2DNEQSymm1_hh
