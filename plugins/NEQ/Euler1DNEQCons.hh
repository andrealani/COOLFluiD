#ifndef COOLFluiD_Physics_NEQ_Euler1DNEQCons_hh
#define COOLFluiD_Physics_NEQ_Euler1DNEQCons_hh
...
//////////////////////////////////////////////////////////////////////////////
   ...
   */
class Euler1DNEQCons : public NavierStokes::MultiScalarVarSet<NavierStokes::Euler1DVarSet> {
public: // classes
   ...
   * @see Euler1D
   */
  Euler1DNEQCons(Common::SafePtr<Framework::BaseTerm> term);
  ...
  virtual void computePerturbedPhysicalData(const Framework::State& state,
					    ...
					    CFuint iVar)
  {
    throw Common::NotImplementedException (FromHere(),"Euler1DNEQCons::computePerturbedPhysicalData()");
  }
...
#endif // COOLFluiD_Physics_NEQ_Euler2DNEQCons_hh
