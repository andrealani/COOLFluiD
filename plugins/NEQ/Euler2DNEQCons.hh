#ifndef COOLFluiD_Physics_NEQ_Euler2DNEQCons_hh
#define COOLFluiD_Physics_NEQ_Euler2DNEQCons_hh
...
public: // classes
   ...
   * @see Euler2D
   */
  Euler2DNEQCons(Common::SafePtr<Framework::BaseTerm> term);
