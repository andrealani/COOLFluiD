#include "NEQ.hh"
#include "Euler2DNEQRhoivtTvToCons.hh"
...
Environment::ObjectProvider<Euler2DNEQRhoivtTvToCons, VarSetTransformer, NEQModule, 1>
euler2DNEQRhoivtTvToConsProvider("Euler2DNEQRhoivtTvToCons");

//////////////////////////////////////////////////////////////////////////////

Euler2DNEQRhoivtTvToCons::Euler2DNEQRhoivtTvToCons
...
void Euler2DNEQRhoivtTvToCons::transform(const State& state, State& result)
{
...
void Euler2DNEQRhoivtTvToCons::transformFromRef(const RealVector& data, State& result)
{
  // find a way of storing this pointer (sdd setup() function)
  static Common::SafePtr<PhysicalChemicalLibrary> library =
    PhysicalModelStack::getActive()->getImplementor()->
