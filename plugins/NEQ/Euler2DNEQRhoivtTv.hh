#ifndef COOLFluiD_Physics_NEQ_Euler2DNEQRhoivtTv_hh
#define COOLFluiD_Physics_NEQ_Euler2DNEQRhoivtTv_hh
...
//////////////////////////////////////////////////////////////////////////////
   ...
   * @author Andrea Lani
   */
class Euler2DNEQRhoivtTv : public Euler2DNEQRhoivt {
...
public: // classes
   ...
   * @see EulerNEQ
   */
  Euler2DNEQRhoivtTv(Common::SafePtr<Framework::BaseTerm> term);
  
  /**
   * Default destructor
   */
  virtual ~Euler2DNEQRhoivtTv();
...
}; // end of class Euler2DNEQRhoivtTv
...
#endif // COOLFluiD_Physics_NEQ_Euler2DNEQRhoivtTv_hh
