#include "NEQ.hh"
#include "Euler2DNEQRhoivtTvToRoeVinokur.hh"
...
Environment::ObjectProvider<Euler2DNEQRhoivtTvToRoeVinokur, VarSetTransformer, NEQModule, 1>
euler2DNEQRhoivtTvToRoeVinokurProvider("Euler2DNEQRhoivtTvToRoeVinokur");

//////////////////////////////////////////////////////////////////////////////

Euler2DNEQRhoivtTvToRoeVinokur::Euler2DNEQRhoivtTvToRoeVinokur
...
void Euler2DNEQRhoivtTvToRoeVinokur::transform(const State& state, State& result)
{
  //cout << "In Euler2DNEQRhoivtTvToRoeVinokur::transform(const State& state, State& result)\n";
...
// unused //  CFreal p = pdim/refData[EulerTerm::P];
  ...
  // set extra data needed for the linearization in RoeVinokur variables
...
void Euler2DNEQRhoivtTvToRoeVinokur::transformFromRef(const RealVector& data, State& result)
{
  cout << "In Euler2DNEQRhoivtTvToRoeVinokur::transformFromRef(const RealVector& data, State& result)\n";
  // find a way of storing this pointer (sdd setup() function)
  static Common::SafePtr<PhysicalChemicalLibrary> library =
    PhysicalModelStack::getActive()->getImplementor()->
    getPhysicalPropertyLibrary<PhysicalChemicalLibrary>();
...
// unused //  CFreal Tdim = data[EulerTerm::T]*refData[EulerTerm::T];
  ...
  if (_extraValues != CFNULL) {
    throw Common::NotImplementedException (FromHere(),"Euler2DNEQRhoivtTvToRoeVinokur::transformFromRef()");
  }
}
