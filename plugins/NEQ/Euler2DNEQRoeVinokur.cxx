#include "NEQ.hh"
#include "Euler2DNEQRoeVinokur.hh"
...
Environment::ObjectProvider<Euler2DNEQRoeVinokur, ConvectiveVarSet, NEQModule, 1>
Euler2DNEQRoeVinokurProvider("Euler2DNEQRoeVinokur");

//////////////////////////////////////////////////////////////////////////////

Euler2DNEQRoeVinokur::Euler2DNEQRoeVinokur(Common::SafePtr<BaseTerm> term) :
...
Euler2DNEQRoeVinokur::~Euler2DNEQRoeVinokur()
{
}

//////////////////////////////////////////////////////////////////////////////

void Euler2DNEQRoeVinokur::computeEigenValuesVectors(RealMatrix& rightEv,
                                           RealMatrix& leftEv,
                                           RealVector& eValues,
                                           const RealVector& normal)
{
  throw Common::NotImplementedException (FromHere(),"Euler2DNEQRoeVinokur::computeEigenValuesVectors()");
}

//////////////////////////////////////////////////////////////////////////////

CFuint Euler2DNEQRoeVinokur::getBlockSeparator() const
{
...
void Euler2DNEQRoeVinokur::splitJacobian(RealMatrix& jacobPlus,
                                RealMatrix& jacobMin,
                                RealVector& eValues,
                                const RealVector& normal)
{
  throw Common::NotImplementedException (FromHere(),"Euler2DNEQRoeVinokur::splitJacobian()");
}

//////////////////////////////////////////////////////////////////////////////

void Euler2DNEQRoeVinokur::computePhysicalData(const State& state,
					RealVector& data)
{
  cout << "In Euler2DNEQRoeVinokur::computePhysicalData(const State& , RealVector& )" << endl;
...
void Euler2DNEQRoeVinokur::computeStateFromPhysicalData(const RealVector& data,
						 State& state)
{
  throw Common::NotImplementedException (FromHere(),"Euler2DNEQRoeVinokur::computeStateFromPhysicalData()");
}

//////////////////////////////////////////////////////////////////////////////

CFreal Euler2DNEQRoeVinokur::getSpeed(const State& state) const
{
  throw Common::NotImplementedException
    (FromHere(), "Euler2DNEQRoeVinokur::getSpeed()");
}

//////////////////////////////////////////////////////////////////////////////

void Euler2DNEQRoeVinokur::setDimensionalValues(const State& state,
                                          RealVector& result)
{
  throw Common::NotImplementedException
      (FromHere(), "Euler2DNEQRoeVinokur::setDimensionalValues()");
}

//////////////////////////////////////////////////////////////////////////////

void Euler2DNEQRoeVinokur::setAdimensionalValues(const Framework::State& state,
                             RealVector& result)
{
  throw Common::NotImplementedException
      (FromHere(), "Euler2DNEQRoeVinokur::setAdimensionalValues() not implemented");
}

//////////////////////////////////////////////////////////////////////////////

void Euler2DNEQRoeVinokur::setDimensionalValuesPlusExtraValues
(const State& state, RealVector& result,
 RealVector& extra)
{
  throw Common::NotImplementedException
    (FromHere(), "Euler2DNEQRoeVinokur::setDimensionalValuesPlusExtraValues()");
}

//////////////////////////////////////////////////////////////////////////////

vector<std::string> Euler2DNEQRoeVinokur::getExtraVarNames() const
{
  cf_assert(_library.isNotNull());

  vector<std::string> names;
throw Common::NotImplementedException (FromHere(),"Euler2DNEQRoeVinokur::getExtraVarNames()");
  return names;
}

//////////////////////////////////////////////////////////////////////////////

void Euler2DNEQRoeVinokur::setup()
{
...
void Euler2DNEQRoeVinokur::computePerturbedPhysicalData
(const State& state, const RealVector& pdataBkp, 
 RealVector& pdata, CFuint iVar) 
{
  throw Common::NotImplementedException (FromHere(),"Euler2DNEQRoeVinokur::computePerturbedPhysicalData()");
}

//////////////////////////////////////////////////////////////////////////////

void Euler2DNEQRoeVinokur::setStateVelocityIDs (std::vector<CFuint>& velIDs) 
{
