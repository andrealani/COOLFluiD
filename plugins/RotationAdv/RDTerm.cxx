...
void RDTerm::defineConfigOptions(Config::OptionList& options)
{
...
RDTerm::RDTerm(const std::string& name) :
  BaseTerm(name),
  m_DiffCoef(0.)
{
...
void RDTerm::configure ( Config::ConfigArgs& args )
{
