...
#ifndef COOLFluiD_Physics_RotationAdv_hh
#define COOLFluiD_Physics_RotationAdv_hh
 ...
 */
class RotationAdvModule : public Environment::ModuleRegister<RotationAdvModule> {
public:
