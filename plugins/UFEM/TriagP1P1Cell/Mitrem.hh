#ifndef COOLFluiD_UFEM_TriagP1P1Cell_Mitrem_hh
#define COOLFluiD_UFEM_TriagP1P1Cell_Mitrem_hh
...
class UFEMTriagP1P1Cell_API Mitrem : public UFEMTerm {
...
public:
  ...
  /// Gets the Class name
  static std::string getClassName() { return "Mitrem"; }

  /// Constructor.
  explicit Mitrem ( const std::string& name, Common::SafePtr<ElemProps> props );
...
#endif // COOLFluiD_UFEM_TriagP1P1Cell_Mitrem_hh
