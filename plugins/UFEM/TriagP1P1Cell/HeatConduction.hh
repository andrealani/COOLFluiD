#ifndef COOLFluiD_UFEM_TriagP1P1Cell_HeatConduction_hh
#define COOLFluiD_UFEM_TriagP1P1Cell_HeatConduction_hh
...
class UFEMTriagP1P1Cell_API HeatConduction : public UFEMTerm {
...
#endif // COOLFluiD_UFEM_TriagP1P1Cell_HeatConduction_hh
