...
#include "UFEM/TetraP1P1Cell/PassiveScalar.hh"
...
Environment::ObjectProvider < PassiveScalar,
                              ...
                              UFEMTerm::NARGS >
aTetraP1P1Cell_PassiveScalar_Provider ( "TetraP1P1Cell_PassiveScalar" );
...
#define kronecker(i,j) ((i)==(j)?1.:0.)
  ...
  CFuint Pi,Ui,Vi,Wi,Ti,Pj,Uj,Vj,Wj,Tj;
  CFreal val;
...
//  tauSUPG*=0.;
  ...
  for(CFuint i=0; i<4; ++i) {
    ...
    for(CFuint j=0; j<4; ++j) {
      ...
      Pj+=nbEqs; Uj+=nbEqs; Vj+=nbEqs; Wj+=nbEqs; Tj+=nbEqs;
    }
    Pi+=nbEqs; Ui+=nbEqs; Vi+=nbEqs; Wi+=nbEqs; Ti+=nbEqs;
  }
