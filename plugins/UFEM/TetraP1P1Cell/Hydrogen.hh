#ifndef COOLFluiD_UFEM_TetraP1P1Cell_Hydrogen_hh
#define COOLFluiD_UFEM_TetraP1P1Cell_Hydrogen_hh
...
class UFEMTetraP1P1Cell_API Hydrogen : public UFEMTerm {
...
public:
  ...
  /// Gets the Class name
  static std::string getClassName() { return "Hydrogen"; }

  /// Constructor.
  explicit Hydrogen ( const std::string& name, Common::SafePtr<ElemProps> props );
...
#endif // COOLFluiD_UFEM_TetraP1P1Cell_Hydrogen_hh
