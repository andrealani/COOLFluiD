...
#ifndef COOLFluiD_Pardiso_PardisoMatrix_hh
#define COOLFluiD_Pardiso_PardisoMatrix_hh
...
/// This class represents a PardisoMatrix
class PardisoMatrix : public Framework::LSSMatrix
{

public:

  /// Default constructor without arguments
  PardisoMatrix() : Framework::LSSMatrix() {
    m_ia = CFNULL;
    m_ja = CFNULL;
    m_a  = CFNULL;
    m_nnu = 0;
  ...
  /// Get internal IA array
  int* getArrayIA() const {
    return &m_ia[0];
  }

  /// Get internal JA array
  int* getArrayJA() const {
    return &m_ja[0];
  }

  /// Get internal A array
  double* getArrayA() const {
    return &m_a[0];
  }
...
public:
  ...
  /// Matrix rows indices (CSR ia)
  int* m_ia;

  /// Matrix column indices (CSR ja)
  int* m_ja;

  /// Matrix entries (CSR a)
  double* m_a;
...
private:
  ...
  /// Copy constructor
  PardisoMatrix(const PardisoMatrix& other);

  /// Overloading of the assignment operator
  const PardisoMatrix& operator= (const PardisoMatrix& other);
...
}; // end of class PardisoMatrix


  } // namespace Pardiso
} // namespace COOLFluiD

#endif // COOLFluiD_Pardiso_PardisoMatrix_hh
