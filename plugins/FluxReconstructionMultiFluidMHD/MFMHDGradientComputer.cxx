...
void MFMHDGradientComputer::computeGradients()
{ 
...
void MFMHDGradientComputer::computeGradientFaceCorrections()
{
...
void MFMHDGradientComputer::setup()
{
  CFAUTOTRACE;
  ...
  m_diffusiveVarSet = (getMethodData().getDiffusiveVar()).d_castTo< DiffMFMHDVarSet >();
