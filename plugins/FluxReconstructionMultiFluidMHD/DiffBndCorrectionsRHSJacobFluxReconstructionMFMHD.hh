#ifndef COOLFluiD_FluxReconstructionMethod_DiffBndCorrectionsRHSJacobFluxReconstructionMFMHD_hh
#define COOLFluiD_FluxReconstructionMethod_DiffBndCorrectionsRHSJacobFluxReconstructionMFMHD_hh
...
//////////////////////////////////////////////////////////////////////////////
   ...
   * Flux Reconstruction schemes for diffusive terms to the RHS for implicit schemes for MFMHD
   *
   * @author Ray Vandenhoeck
   * @author Alexander Papen
   *
   */
class DiffBndCorrectionsRHSJacobFluxReconstructionMFMHD : public DiffBndCorrectionsRHSJacobFluxReconstruction {
...
public:
   ...
   * Constructor
   */
  DiffBndCorrectionsRHSJacobFluxReconstructionMFMHD(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~DiffBndCorrectionsRHSJacobFluxReconstructionMFMHD();
...
}; // end of class DiffBndCorrectionsRHSJacobFluxReconstructionMFMHD
...
#endif // COOLFluiD_FluxReconstructionMethod_DiffBndCorrectionsRHSJacobFluxReconstructionMFMHD_hh
