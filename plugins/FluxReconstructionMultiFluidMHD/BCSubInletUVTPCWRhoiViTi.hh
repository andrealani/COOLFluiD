#ifndef COOLFluiD_Numerics_FluxReconstructionMethod_BCSubInletUVTPCWRhoiViTi_hh
#define COOLFluiD_Numerics_FluxReconstructionMethod_BCSubInletUVTPCWRhoiViTi_hh
...
class BCSubInletUVTPCWRhoiViTi : public BCStateComputer { 
...
public: 
   ...
   * Constructor
   */
  BCSubInletUVTPCWRhoiViTi(const std::string& name);
  
  /**
   * Default destructor
   */
  ~BCSubInletUVTPCWRhoiViTi();
...
}; // end of class BCSubInletUVTPCWRhoiViTi
...
#endif // COOLFluiD_Numerics_FiniteVolume_BCSubInletUVTPCWRhoiViTi_hh
