...
#include "FluxReconstructionMultiFluidMHD/BCSubInletUVTEIWRhoiViTi.hh"
...
Framework::MethodStrategyProvider<BCSubInletUVTEIWRhoiViTi, FluxReconstructionSolverData, BCStateComputer, FluxReconstructionMultiFluidMHDModule> BCsubInletUVTEIWRhoiViTiProvider("BCSubInletUVTEIWRhoiViTi");

//////////////////////////////////////////////////////////////////////////////

void BCSubInletUVTEIWRhoiViTi::defineConfigOptions(Config::OptionList& options)
{
...
BCSubInletUVTEIWRhoiViTi::BCSubInletUVTEIWRhoiViTi(const std::string& name) :
...
BCSubInletUVTEIWRhoiViTi::~BCSubInletUVTEIWRhoiViTi()
{
  CFAUTOTRACE;
}
...
void BCSubInletUVTEIWRhoiViTi::setup()
{
...
void BCSubInletUVTEIWRhoiViTi::configure ( Config::ConfigArgs& args )
{
  using namespace COOLFluiD::Framework;
...
void BCSubInletUVTEIWRhoiViTi::computeGhostStates(const vector< State* >& intStates,
...
void BCSubInletUVTEIWRhoiViTi::computeGhostGradients(const std::vector< std::vector< RealVector* > >& intGrads,
