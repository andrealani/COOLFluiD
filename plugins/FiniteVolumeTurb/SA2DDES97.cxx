...
MethodStrategyProvider<SA2DDES97,
		       CellCenterFVMData,
		       ComputeSourceTerm<CellCenterFVMData>,
		       FiniteVolumeSAModule>
SA2DDES97Provider("SA2DDES97");      
      
/////////////////////////////////////////////////////////////////////////////////////////////////////////

SA2DDES97::SA2DDES97(const std::string& name) :
  SA2DSourceTerm(name)
  {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
void SA2DDES97::setup()
{
  CFAUTOTRACE;
  
  SA2DSourceTerm::setup();

}

////////////////////////////////////////////////////////////////////////////////////////////////////////

CFreal SA2DDES97::getSubLenScale (Framework::GeometricEntity *const element)
...
CFreal SA2DDES97::getDistance (Framework::GeometricEntity *const element)
{
