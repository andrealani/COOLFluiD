#include "FiniteVolumeTurb/DistanceBasedExtrapolatorGMoveKOmega3D.hh"
...
MethodStrategyProvider<DistanceBasedExtrapolatorGMoveKOmega3D,
                       CellCenterFVMData,
                       NodalStatesExtrapolator<CellCenterFVMData>,
                       FiniteVolumeKOmegaModule>
DistanceBasedExtrapolatorGMoveKOmega3DProvider("DistanceBasedGMoveKOmega3D");

//////////////////////////////////////////////////////////////////////////////

DistanceBasedExtrapolatorGMoveKOmega3D::DistanceBasedExtrapolatorGMoveKOmega3D
...
void DistanceBasedExtrapolatorGMoveKOmega3D::setup()
{
  DistanceBasedExtrapolatorGMove::setup();

  _varSetTurb = getMethodData().getUpdateVar().d_castTo<EulerVarSet>();
  _diffVarTurb = getMethodData().getDiffusiveVar().d_castTo<NavierStokesTurb3DVarSet>();
}

//////////////////////////////////////////////////////////////////////////////

void DistanceBasedExtrapolatorGMoveKOmega3D::extrapolateInAllNodes()
{
  const CFuint OmegaID = 6;
  ...
  cf_assert (nbEqs == PhysicalModelStack::getActive()->getDim() + 4);
    ...
    if (_isNodeToPrescribe[iNode]) {
      ...
      for (CFuint iState = 0; iState < nbNeighborStates; ++iState) {
        ...
        if (!neighState->isGhost()) {
          ...
          const CFreal Tdim =  (*neighState)[4] * _varSetTurb->getModel()->getTempRef();
	    ...
	    _diffVarTurb->getModel().getReferencePhysicalData()[NSTurbTerm::MU];
          ...
          const CFreal density = (*neighState)[0] / (_varSetTurb->getModel()->getR() * (*neighState)[4]);
...
void DistanceBasedExtrapolatorGMoveKOmega3D::extrapolateInNodes
