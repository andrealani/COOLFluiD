#ifndef COOLFluiD_Physics_NavierStokes_CreateDampingCoefficientDNS_hh
#define COOLFluiD_Physics_NavierStokes_CreateDampingCoefficientDNS_hh
...
class CreateDampingCoefficientDNS : public Framework::DataProcessingCom {
public: // functions
   ...
   * Constructor.
   */
  CreateDampingCoefficientDNS(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~CreateDampingCoefficientDNS();
...
#endif // COOLFluiD_Physics_NavierStokes_CreateDampingCoefficient_hh
