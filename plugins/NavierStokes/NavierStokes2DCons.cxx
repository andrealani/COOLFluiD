...
Environment::ObjectProvider<NavierStokes2DCons, DiffusiveVarSet,
	       NavierStokesModule, 2>
ns2DConsProvider("NavierStokes2DCons");

//////////////////////////////////////////////////////////////////////////////

NavierStokes2DCons::NavierStokes2DCons
...
void NavierStokes2DCons::setGradientVars(const vector<RealVector*>& states,
					 RealMatrix& values,
...
void NavierStokes2DCons::setGradientVarGradients(const vector<RealVector*>& states,
...
void NavierStokes2DCons::setStateGradients(const vector<RealVector*>& states,
...
CFreal NavierStokes2DCons::getDynViscosity(const RealVector& state,
...
CFreal NavierStokes2DCons::getDensity(const RealVector& state)
{
  return state[0];
}
...
void NavierStokes2DCons::setGradientState(const RealVector& state)
{
