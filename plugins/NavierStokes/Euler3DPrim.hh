#ifndef COOLFluiD_Physics_NavierStokes_Euler3DPrim_hh
#define COOLFluiD_Physics_NavierStokes_Euler3DPrim_hh
...
//////////////////////////////////////////////////////////////////////////////
   ...
   * @author Andrea Lani
   */
class Euler3DPrim : public Euler3DVarSet {
public: // classes
   ...
   * @see Euler2D
   */
  Euler3DPrim(Common::SafePtr<Framework::BaseTerm> term);
  ...
  virtual void computePerturbedPhysicalData(const Framework::State& state,
					    ...
					    CFuint iVar)
  {
    throw Common::NotImplementedException (FromHere(),"Euler3DPrim::computePerturbedPhysicalData()");
  }
...
#endif // COOLFluiD_Physics_NavierStokes_Euler3DPrim_hh
