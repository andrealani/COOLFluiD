...
#include "Euler3DRotationCons.hh"
...
Environment::ObjectProvider<Euler3DRotationCons, ConvectiveVarSet, NavierStokesModule, 1>
euler3DRotationConsProvider("Euler3DRotationCons");

//////////////////////////////////////////////////////////////////////////////

Euler3DRotationCons::Euler3DRotationCons(Common::SafePtr<BaseTerm> term) :
  Euler3DRotationVarSet(term),
  _rightEv(5,5),
  _leftEv(5,5)
{
...
Euler3DRotationCons::~Euler3DRotationCons()
{
}

//////////////////////////////////////////////////////////////////////////////

void Euler3DRotationCons::setup()
{
  Euler3DRotationVarSet::setup();
...
void Euler3DRotationCons::setConstJacob()
{
...
void Euler3DRotationCons::computeJacobians()
{
...
void Euler3DRotationCons::computeEigenValuesVectors(RealMatrix& rightEv,
                                        RealMatrix& leftEv,
                                        RealVector& eValues,
                                        const RealVector& normal)
{
  ...
  //degugging infos
  CFLogDebugMax( "RightEigenvectors @Euler3DRotationCons::computeEigenValuesVectors" << "\n"
        << rightEv << "\n");
  CFLogDebugMax( "LeftEigenvectors @Euler3DRotationCons::computeEigenValuesVectors" << "\n"
        << leftEv << "\n");
  CFLogDebugMax( "EigenValues @Euler3DRotationCons::computeEigenValuesVectors" << "\n"
		 << eValues << "\n" << "\n");
...
void Euler3DRotationCons::splitJacobian(RealMatrix& jacobPlus,
                             RealMatrix& jacobMin,
                             RealVector& eValues,
                             const RealVector& normal)
{
...
void Euler3DRotationCons::setEigenVect1(RealVector& r1,
                                State& state,
                                const RealVector& normal)
{
...
void Euler3DRotationCons::setEigenVect2(RealVector& r2,
                                State& state,
                                const RealVector& normal)
{
  const CFreal u = state[1]/state[0];
...
void Euler3DRotationCons::setEigenVect3(RealVector& r3,
                                State& state,
                                const RealVector& normal)
{
  const CFreal u = state[1]/state[0];
...
void Euler3DRotationCons::setEigenVect4(RealVector& r4,
                                State& state,
                                const RealVector& normal)
{
  const CFreal gamma = getModel()->getGamma();
...
void Euler3DRotationCons::setEigenVect5(RealVector& r5,
                                State& state,
                                const RealVector& normal)
{
  const CFreal gamma = getModel()->getGamma();
...
CFuint Euler3DRotationCons::getBlockSeparator() const
{
...
void Euler3DRotationCons::computePhysicalData(const State& state,
					      RealVector& data)
{
...
void Euler3DRotationCons::computeStateFromPhysicalData(const RealVector& data,
					  State& state)
{
...
void Euler3DRotationCons::setDimensionalValues(const State& state,
                                       RealVector& result)
{
...
void Euler3DRotationCons::setAdimensionalValues(const State& state,
                                       RealVector& result)
{
  const RealVector& refData =
    getModel()->getReferencePhysicalData();
