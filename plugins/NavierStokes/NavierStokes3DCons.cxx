...
Environment::ObjectProvider<NavierStokes3DCons, DiffusiveVarSet,
	       NavierStokesModule, 2>
ns3DConsProvider("NavierStokes3DCons");

//////////////////////////////////////////////////////////////////////////////

NavierStokes3DCons::NavierStokes3DCons
...
void NavierStokes3DCons::setGradientVars(const vector<RealVector*>& states,
					 RealMatrix& values,
...
void NavierStokes3DCons::setGradientVarGradients(const vector<RealVector*>& states,
...
void NavierStokes3DCons::setStateGradients(const vector<RealVector*>& states,
...
CFreal NavierStokes3DCons::getDynViscosity(const RealVector& state, const vector<RealVector*>& gradients)
{
...
CFreal NavierStokes3DCons::getDensity(const RealVector& state)
{
  return state[0];
}
...
void NavierStokes3DCons::setGradientState(const RealVector& state)
{
