#ifndef COOLFluiD_Physics_NavierStokes_NavierStokes1DCons_hh
#define COOLFluiD_Physics_NavierStokes_NavierStokes1DCons_hh
...
//////////////////////////////////////////////////////////////////////////////
   ...
   *
   */
class NavierStokes1DCons : public NavierStokes1DVarSet {
public: // classes
   ...
   * @see NavierStokes1D
   */
  NavierStokes1DCons(const std::string& name, Common::SafePtr<Framework::PhysicalModelImpl> model);
...
}; // end of class NavierStokes1DCons
...
#endif // COOLFluiD_Physics_NavierStokes_NavierStokes1DCons_hh
