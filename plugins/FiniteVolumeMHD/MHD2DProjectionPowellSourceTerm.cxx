...
#include "FiniteVolumeMHD/MHD2DProjectionPowellSourceTerm.hh"
...
Environment::ObjectProvider<MHD2DProjectionPowellSourceTerm,
               ComputeSourceTerm,
               FiniteVolumeMHDModule,
               1>
mHD2DProjectionPowellSTFVMCCProvider("MHD2DProjectionPowellST");

//////////////////////////////////////////////////////////////////////////////

MHD2DProjectionPowellSourceTerm::MHD2DProjectionPowellSourceTerm(const std::string& name) :
...
MHD2DProjectionPowellSourceTerm::~MHD2DProjectionPowellSourceTerm()
{
}

//////////////////////////////////////////////////////////////////////////////

boost::filesystem::path MHD2DProjectionPowellSourceTerm::constructFilename()
{
...
void MHD2DProjectionPowellSourceTerm::prepareOutputFile(std::ofstream& outputFile)
{
...
void MHD2DProjectionPowellSourceTerm::writeOutputFile()
{
...
void MHD2DProjectionPowellSourceTerm::setup()
{
...
void MHD2DProjectionPowellSourceTerm::setVarSet(Common::SafePtr<ConvectiveVarSet> varSet)
{
  _varSet = varSet.d_castTo<MHD2DProjectionVarSet>();
}

//////////////////////////////////////////////////////////////////////////////

void MHD2DProjectionPowellSourceTerm::computeSource(GeometricEntity *const element,
           RealVector& source)
{
  cf_assert(_varSet.isNotNull());
  ...
  for (CFuint iFace = 0; iFace < nbFacesInElem; ++iFace) {
    ...
    const CFreal faceLength = sqrt(nx*nx + ny*ny);
