...
#include "SuperInletProjectionParallelRotationAlfven.hh"
...
MethodCommandProvider<SuperInletProjectionParallelRotationAlfven, CellCenterFVMData, FiniteVolumeModule> 
superInletProjectionParallelRotationAlfvenFVMCCProvider("SuperInletProjectionParallelRotationAlfvenFVMCC");

//////////////////////////////////////////////////////////////////////////////

void SuperInletProjectionParallelRotationAlfven::defineConfigOptions(Config::OptionList& options)
{
...
SuperInletProjectionParallelRotationAlfven::SuperInletProjectionParallelRotationAlfven(const std::string& name) :
  SuperInlet(name),
  m_mapGeoToTrs(),
  m_BfromFile(false)
{
...
SuperInletProjectionParallelRotationAlfven::~SuperInletProjectionParallelRotationAlfven()
{
}

//////////////////////////////////////////////////////////////////////////////

void SuperInletProjectionParallelRotationAlfven::setup()
{
  SuperInlet::setup();
...
void SuperInletProjectionParallelRotationAlfven::unsetup()
{
  SuperInlet::unsetup();
}
...
void SuperInletProjectionParallelRotationAlfven::setGhostState(GeometricEntity *const face)
{
  ...
  if (m_initialSolutionMap.size() > 0) {
    ...
    for (CFuint i = 0; i < nbVars; ++i) {
      ...
      CFLog(DEBUG_MIN, "SuperInletProjectionParallelRotationAlfven::setGhostState() => [" << varID << "] => " << (*initialValues)[idx] << " | " << (*innerState)[varID] << "\n");
    }
  }
  ...
  CFreal BrFromFile = 0.;
  m_BfromFile = false; // what follows is not consistent with the original BC when nodal Br is taken from map
  if (m_BfromFile) {
