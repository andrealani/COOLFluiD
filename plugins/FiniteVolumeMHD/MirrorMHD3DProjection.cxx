...
#include "MirrorMHD3DProjection.hh"
...
MethodCommandProvider<MirrorMHD3DProjection, CellCenterFVMData, FiniteVolumeMHDModule> 
mirrorMHD3DProjectionFVMCCProvider("MirrorMHD3DProjectionFVMCC");

//////////////////////////////////////////////////////////////////////////////

MirrorMHD3DProjection::MirrorMHD3DProjection(const std::string& name) :
  FVMCC_BC(name),
  _varSet(CFNULL),
  _dataInnerState(),
  _dataGhostState()
...
MirrorMHD3DProjection::~MirrorMHD3DProjection()
{
}

//////////////////////////////////////////////////////////////////////////////

void MirrorMHD3DProjection::setup()
{
  FVMCC_BC::setup();
...
void MirrorMHD3DProjection::setGhostState(GeometricEntity *const face)
{
