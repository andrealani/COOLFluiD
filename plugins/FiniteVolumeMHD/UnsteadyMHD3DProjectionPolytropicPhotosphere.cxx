...
#include "UnsteadyMHD3DProjectionPolytropicPhotosphere.hh"
...
MethodCommandProvider<UnsteadyMHD3DProjectionPolytropicPhotosphere, CellCenterFVMData, FiniteVolumeMHDModule> 
unsteadyMHD3DProjectionPolytropicPhotosphereFVMCCProvider("UnsteadyMHD3DProjectionPolytropicPhotosphereFVMCC");

//////////////////////////////////////////////////////////////////////
   
void UnsteadyMHD3DProjectionPolytropicPhotosphere::defineConfigOptions(Config::OptionList& options)
{
...
UnsteadyMHD3DProjectionPolytropicPhotosphere::UnsteadyMHD3DProjectionPolytropicPhotosphere(const std::string& name) :
  FVMCC_BC(name),
  _varSet(CFNULL),
  socket_BPFSS("BPFSS"),
...
UnsteadyMHD3DProjectionPolytropicPhotosphere::~UnsteadyMHD3DProjectionPolytropicPhotosphere()
{
}

//////////////////////////////////////////////////////////////////////

void UnsteadyMHD3DProjectionPolytropicPhotosphere::configure ( Config::ConfigArgs& args )
{
...
void UnsteadyMHD3DProjectionPolytropicPhotosphere::setup()
{
  FVMCC_BC::setup();
...
void UnsteadyMHD3DProjectionPolytropicPhotosphere::setGhostState(GeometricEntity *const face)
{
  ...
  _dataGhostState[MHDProjectionPolytropicTerm::V] = VelCartesianGhostState;
  ...
  _dataGhostState[MHDProjectionPolytropicTerm::BX] = Bx1GhostTime;
  _dataGhostState[MHDProjectionPolytropicTerm::BY] = By1GhostTime;
  _dataGhostState[MHDProjectionPolytropicTerm::BZ] = Bz1GhostTime;
  const CFreal BGhostState = sqrt(_dataGhostState[MHDProjectionPolytropicTerm::BX]*_dataGhostState[MHDProjectionPolytropicTerm::BX] +
				_dataGhostState[MHDProjectionPolytropicTerm::BY]*_dataGhostState[MHDProjectionPolytropicTerm::BY] +
				_dataGhostState[MHDProjectionPolytropicTerm::BZ]*_dataGhostState[MHDProjectionPolytropicTerm::BZ]);
  _dataGhostState[MHDProjectionPolytropicTerm::B] = BGhostState;
  ...
  _dataGhostState[MHDProjectionPolytropicTerm::P] = pGhostState; //pow(_dataGhostState[MHDProjectionPolytropicTerm::RHO],_dataGhostState[MHDProjectionPolytropicTerm::N])/_dataGhostState[MHDProjectionPolytropicTerm::N];
...
UnsteadyMHD3DProjectionPolytropicPhotosphere::providesSockets()
{
...
std::vector<SafePtr<BaseDataSocketSink> > UnsteadyMHD3DProjectionPolytropicPhotosphere::needsSockets()
{
