#ifndef COOLFluiD_Numerics_FiniteVolume_MHD3DProjectionPowellSourceTerm_hh
#define COOLFluiD_Numerics_FiniteVolume_MHD3DProjectionPowellSourceTerm_hh
 ...
 *
 */
class MHD3DProjectionPowellSourceTerm : public ComputeSourceTermFVMCC {
...
public:
   ...
   */
  MHD3DProjectionPowellSourceTerm(const std::string& name);

  /**
   * Default destructor
   */
  ~MHD3DProjectionPowellSourceTerm();
...
}; // end of class MHD3DProjectionPowellSourceTerm
...
#endif // COOLFluiD_Numerics_FiniteVolume_MHD3DProjectionPowellSourceTerm_hh
