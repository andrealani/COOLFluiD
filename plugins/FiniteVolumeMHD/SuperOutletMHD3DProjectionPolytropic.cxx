...
#include "SuperOutletMHD3DProjectionPolytropic.hh"
...
MethodCommandProvider<SuperOutletMHD3DProjectionPolytropic, CellCenterFVMData, FiniteVolumeMHDModule> 
superOutletMHD3DProjectionPolytropicFVMCCProvider("SuperOutletMHD3DProjectionPolytropicFVMCC");
    
//////////////////////////////////////////////////////////////////////////////
   
void SuperOutletMHD3DProjectionPolytropic::defineConfigOptions(Config::OptionList& options)
{
...
SuperOutletMHD3DProjectionPolytropic::SuperOutletMHD3DProjectionPolytropic(const std::string& name) : 
  FVMCC_BC(name),
  _varSet(CFNULL),
  socket_BPFSS("BPFSS"),
  _dataInnerState(),
...
SuperOutletMHD3DProjectionPolytropic::~SuperOutletMHD3DProjectionPolytropic() 
{
}

//////////////////////////////////////////////////////////////////////

void SuperOutletMHD3DProjectionPolytropic::setup()
{
 FVMCC_BC::setup();
...
void SuperOutletMHD3DProjectionPolytropic::configure ( Config::ConfigArgs& args )
{
...
void SuperOutletMHD3DProjectionPolytropic::setGhostState(GeometricEntity *const face)
 {
   ...
   _dataGhostState[MHDProjectionPolytropicTerm::PHI] = _refPhi;
...
std::vector<SafePtr<BaseDataSocketSink> > SuperOutletMHD3DProjectionPolytropic::needsSockets()
{
