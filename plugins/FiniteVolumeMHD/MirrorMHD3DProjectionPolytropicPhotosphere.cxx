...
#include "MirrorMHD3DProjectionPolytropicPhotosphere.hh"
...
MethodCommandProvider<MirrorMHD3DProjectionPolytropicPhotosphere, CellCenterFVMData, FiniteVolumeMHDModule> 
mirrorMHD3DProjectionPolytropicPhotosphereFVMCCProvider("MirrorMHD3DProjectionPolytropicPhotosphereFVMCC");

//////////////////////////////////////////////////////////////////////
   
void MirrorMHD3DProjectionPolytropicPhotosphere::defineConfigOptions(Config::OptionList& options)
{
...
MirrorMHD3DProjectionPolytropicPhotosphere::MirrorMHD3DProjectionPolytropicPhotosphere(const std::string& name) :
  FVMCC_BC(name),
  _varSet(CFNULL),
  socket_BPFSS("BPFSS"),
  _dataInnerState(),
...
MirrorMHD3DProjectionPolytropicPhotosphere::~MirrorMHD3DProjectionPolytropicPhotosphere()
{
}

//////////////////////////////////////////////////////////////////////

void MirrorMHD3DProjectionPolytropicPhotosphere::configure ( Config::ConfigArgs& args )
{
...
void MirrorMHD3DProjectionPolytropicPhotosphere::setup()
{
 FVMCC_BC::setup();
...
void MirrorMHD3DProjectionPolytropicPhotosphere::setGhostState(GeometricEntity *const face)
{
...
std::vector<SafePtr<BaseDataSocketSink> > MirrorMHD3DProjectionPolytropicPhotosphere::needsSockets()
{
