#ifndef COOLFluiD_Numerics_FiniteVolume_MHD2DConsACAHWSourceTerm_hh
#define COOLFluiD_Numerics_FiniteVolume_MHD2DConsACAHWSourceTerm_hh
 ...
 *
 */
class MHD2DConsACAHWSourceTerm : public ComputeSourceTermFVMCC {
...
public:
   ...
   */
  MHD2DConsACAHWSourceTerm(const std::string& name);

  /**
   * Default destructor
   */
  ~MHD2DConsACAHWSourceTerm();
...
//  CFint _zplus;
//  CFint _zminus;
}; // end of class MHD2DConsACAHWSourceTerm
...
#endif // COOLFluiD_Numerics_FiniteVolume_MHD2DConsACAHWSourceTerm_hh
