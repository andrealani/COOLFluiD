#ifndef COOLFluiD_Numerics_FiniteVolume_MHDConsACAESourceTerm_hh
#define COOLFluiD_Numerics_FiniteVolume_MHDConsACAESourceTerm_hh
 ...
 *
 */
class MHDConsACAESourceTerm : public ComputeSourceTermFVMCC {
...
public:
   ...
   */
  MHDConsACAESourceTerm(const std::string& name);

  /**
   * Default destructor
   */
  ~MHDConsACAESourceTerm();
...
//  CFint _zplus;
//  CFint _zminus;
}; // end of class MHDConsACAESourceTerm
...
#endif // COOLFluiD_Numerics_FiniteVolume_MHDConsACAESourceTerm_hh
