...
#include "MirrorMHD3DProjectionTanakaPFix.hh"
...
MethodCommandProvider<MirrorMHD3DProjectionTanakaPFix, CellCenterFVMData, FiniteVolumeMHDModule> 
mirrorMHD3DProjectionTanakaPFixFVMCCProvider("MirrorMHD3DProjectionTanakaPFixFVMCC");

//////////////////////////////////////////////////////////////////////
   
void MirrorMHD3DProjectionTanakaPFix::defineConfigOptions(Config::OptionList& options)
{
...
MirrorMHD3DProjectionTanakaPFix::MirrorMHD3DProjectionTanakaPFix(const std::string& name) :
  FVMCC_BC(name),
  _varSet(CFNULL),
  _dataInnerState(),
  _dataGhostState()
...
MirrorMHD3DProjectionTanakaPFix::~MirrorMHD3DProjectionTanakaPFix()
{
}

//////////////////////////////////////////////////////////////////////

void MirrorMHD3DProjectionTanakaPFix::configure ( Config::ConfigArgs& args )
{
...
void MirrorMHD3DProjectionTanakaPFix::setup()
{
 FVMCC_BC::setup();
...
void MirrorMHD3DProjectionTanakaPFix::setGhostState(GeometricEntity *const face)
{
