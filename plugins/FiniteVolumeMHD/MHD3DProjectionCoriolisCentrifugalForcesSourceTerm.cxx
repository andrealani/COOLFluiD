...
#include "FiniteVolumeMHD/MHD3DProjectionCoriolisCentrifugalForcesSourceTerm.hh"
...
MethodStrategyProvider<MHD3DProjectionCoriolisCentrifugalForcesSourceTerm,
		       CellCenterFVMData,
		       ComputeSourceTerm<CellCenterFVMData>,
		       FiniteVolumeMHDModule>
mHD3DProjectionCoriolisCentrifugalForcesSTFVMCCProvider("MHD3DProjectionCoriolisCentrifugalForcesST");

//////////////////////////////////////////////////////////////////////////////

void MHD3DProjectionCoriolisCentrifugalForcesSourceTerm::defineConfigOptions(Config::OptionList& options)
{
...
MHD3DProjectionCoriolisCentrifugalForcesSourceTerm::MHD3DProjectionCoriolisCentrifugalForcesSourceTerm(const std::string& name) :
...
MHD3DProjectionCoriolisCentrifugalForcesSourceTerm::~MHD3DProjectionCoriolisCentrifugalForcesSourceTerm()
{
}

//////////////////////////////////////////////////////////////////////////////

void MHD3DProjectionCoriolisCentrifugalForcesSourceTerm::setup()
{
...
void MHD3DProjectionCoriolisCentrifugalForcesSourceTerm::computeSource(Framework::GeometricEntity *const element,
					  RealVector& source,
					  RealMatrix& jacobian)
{
  cf_assert(_varSet.isNotNull());
