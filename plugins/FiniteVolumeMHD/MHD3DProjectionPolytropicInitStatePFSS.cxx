...
#include "FiniteVolumeMHD/MHD3DProjectionPolytropicInitStatePFSS.hh"
...
MethodCommandProvider<MHD3DProjectionPolytropicInitStatePFSS, CellCenterFVMData, FiniteVolumeMHDModule>
mHD3DProjectionPolytropicInitStatePFSSProvider("MHD3DProjectionPolytropicInitStatePFSS");

//////////////////////////////////////////////////////////////////////////////

void MHD3DProjectionPolytropicInitStatePFSS::defineConfigOptions(Config::OptionList& options)
{
...
MHD3DProjectionPolytropicInitStatePFSS::MHD3DProjectionPolytropicInitStatePFSS(const std::string& name) :
  InitState(name),
  _varSet(CFNULL),
...
MHD3DProjectionPolytropicInitStatePFSS::~MHD3DProjectionPolytropicInitStatePFSS()
{
}

//////////////////////////////////////////////////////////////////////////////

void MHD3DProjectionPolytropicInitStatePFSS::readInputFile()
{
...
void MHD3DProjectionPolytropicInitStatePFSS::computeParkerSolution(const CFreal r, 
...
void MHD3DProjectionPolytropicInitStatePFSS::executeOnTrs()
{
  ...
  if(_inputAdimensionalValues)
  {
    for (itd = trsStates->begin(); itd != trsStates->end(); ++itd) {
      ...
      computeParkerSolution(stateCoordsSpherical[0],velParkerSpherical,rhoParker);
...
void MHD3DProjectionPolytropicInitStatePFSS::setup()
{
...
boost::filesystem::path MHD3DProjectionPolytropicInitStatePFSS::constructFilename(std::string fileName)
{
...
MHD3DProjectionPolytropicInitStatePFSS::providesSockets()
{
