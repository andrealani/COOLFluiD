...
#include "FiniteVolumeMHD/MHD3DProjectionPolytropicGravitySourceTerm.hh"
...
MethodStrategyProvider<MHD3DProjectionPolytropicGravitySourceTerm,
		       CellCenterFVMData,
		       ComputeSourceTerm<CellCenterFVMData>,
		       FiniteVolumeMHDModule>
mHD3DProjectionPolytropicGravitySTFVMCCProvider("MHD3DProjectionPolytropicGravityST");

//////////////////////////////////////////////////////////////////////////////

void MHD3DProjectionPolytropicGravitySourceTerm::defineConfigOptions(Config::OptionList& options)
{
...
MHD3DProjectionPolytropicGravitySourceTerm::MHD3DProjectionPolytropicGravitySourceTerm(const std::string& name) :
...
MHD3DProjectionPolytropicGravitySourceTerm::~MHD3DProjectionPolytropicGravitySourceTerm()
{
}

//////////////////////////////////////////////////////////////////////////////

void MHD3DProjectionPolytropicGravitySourceTerm::setup()
{
...
void MHD3DProjectionPolytropicGravitySourceTerm::computeSource(GeometricEntity *const element,
 					  RealVector& source,
					  RealMatrix& jacobian)
{
 cf_assert(_varSet.isNotNull());
 ...
 source[0] = 0.0;
 source[1] = _physicalData[MHDProjectionPolytropicTerm::RHO]*(gx*nondimconst)*volumes[elementID];
 source[2] = _physicalData[MHDProjectionPolytropicTerm::RHO]*(gy*nondimconst)*volumes[elementID];
 source[3] = _physicalData[MHDProjectionPolytropicTerm::RHO]*(gz*nondimconst)*volumes[elementID];
 source[4] = 0.0;
 source[5] = 0.0;
 source[6] = 0.0;
 source[7] = 0.0;
