...
#include "SuperOutletMHD3DProjectionEps.hh"
...
MethodCommandProvider<SuperOutletMHD3DProjectionEps, CellCenterFVMData, FiniteVolumeMHDModule> 
superOutletMHD3DProjectionEpsFVMCCProvider("SuperOutletMHD3DProjectionEpsFVMCC");
    
//////////////////////////////////////////////////////////////////////////////
   
void SuperOutletMHD3DProjectionEps::defineConfigOptions(Config::OptionList& options)
{
   options.addConfigOption< CFreal >("refPhi","Reference phi value imposed at the supersonic outlet.");
   //options.addConfigOption< CFint >("coronalBC","Switch to force radial B-field at the outlet.");
}

//////////////////////////////////////////////////////////////////////////////

SuperOutletMHD3DProjectionEps::SuperOutletMHD3DProjectionEps(const std::string& name) : 
  FVMCC_BC(name),
  _varSet(CFNULL),
  _dataInnerState(),
  _dataGhostState()
...
SuperOutletMHD3DProjectionEps::~SuperOutletMHD3DProjectionEps() 
{
}

//////////////////////////////////////////////////////////////////////

void SuperOutletMHD3DProjectionEps::setup()
{
 FVMCC_BC::setup();

  _varSet = getMethodData().getUpdateVar().d_castTo<MHD3DProjectionEpsVarSet>();
...
void SuperOutletMHD3DProjectionEps::configure ( Config::ConfigArgs& args )
{
...
void SuperOutletMHD3DProjectionEps::setGhostState(GeometricEntity *const face)
 {
...
// Eps modification, if needed, need to find out how to access the size of variables, number of eqs
  
  (*ghostState)[9] =(*innerState)[9]*rI_dimless*rI_dimless/(rG_dimless*rG_dimless);
  (*ghostState)[10] =(*innerState)[10]*rI_dimless*rI_dimless/(rG_dimless*rG_dimless);

  // CFLog(INFO, "g9 = " <<  (*ghostState)[9] << ", g10 = " << (*ghostState)[10]  << "\n"); 
 }
