#ifndef COOLFluiD_Numerics_FiniteVolume_UnsteadyMHD3DProjectionPhotosphere_hh
#define COOLFluiD_Numerics_FiniteVolume_UnsteadyMHD3DProjectionPhotosphere_hh
...
//////////////////////////////////////////////////////////////////////
   ...
   * on the volumetric heating modelling of the solar wind
   *
   * @author Mehmet Sarp Yalim
   *
   */
class UnsteadyMHD3DProjectionPhotosphere : public FVMCC_BC {
...
public:
   ...
   * Constructor
   */
  UnsteadyMHD3DProjectionPhotosphere(const std::string& name);

  /**
   * Default destructor
   */
  ~UnsteadyMHD3DProjectionPhotosphere();
...
}; // end of class UnsteadyMHD3DProjectionPhotosphere
...
#endif // COOLFluiD_Numerics_FiniteVolume_UnsteadyMHD3DProjectionPhotosphere_hh
