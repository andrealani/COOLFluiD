#ifndef COOLFluiD_Numerics_FiniteVolume_SuperInletProjectionParallelRotationAlfven_hh
#define COOLFluiD_Numerics_FiniteVolume_SuperInletProjectionParallelRotationAlfven_hh
...
//////////////////////////////////////////////////////////////////////////////
   ...
   *
   */
class SuperInletProjectionParallelRotationAlfven : public SuperInlet {
public:
   ...
   * Constructor
   */
  SuperInletProjectionParallelRotationAlfven(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~SuperInletProjectionParallelRotationAlfven();
...
}; // end of class SuperInletProjectionParallelRotationAlfven
...
#endif // COOLFluiD_Numerics_FiniteVolume_SuperInletProjectionParallelRotationAlfven_hh
