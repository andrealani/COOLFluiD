...
#include "SuperOutletMHD3DProjection9.hh"
...
MethodCommandProvider<SuperOutletMHD3DProjection9, CellCenterFVMData, FiniteVolumeMHDModule> 
superOutletMHD3DProjection9FVMCCProvider("SuperOutletMHD3DProjection9FVMCC");
    
//////////////////////////////////////////////////////////////////////////////
   
void SuperOutletMHD3DProjection9::defineConfigOptions(Config::OptionList& options)
{
...
SuperOutletMHD3DProjection9::SuperOutletMHD3DProjection9(const std::string& name) : 
  FVMCC_BC(name),
  _varSet(CFNULL),
  _dataInnerState(),
  _dataGhostState()
...
SuperOutletMHD3DProjection9::~SuperOutletMHD3DProjection9() 
{
}

//////////////////////////////////////////////////////////////////////

void SuperOutletMHD3DProjection9::setup()
{
 FVMCC_BC::setup();
...
void SuperOutletMHD3DProjection9::configure ( Config::ConfigArgs& args )
{
...
void SuperOutletMHD3DProjection9::setGhostState(GeometricEntity *const face)
 {
