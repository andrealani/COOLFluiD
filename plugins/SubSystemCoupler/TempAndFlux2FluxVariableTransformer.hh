#ifndef COOLFluiD_Numerics_SubSystemCoupler_TempAndFlux2FluxVariableTransformer_hh
#define COOLFluiD_Numerics_SubSystemCoupler_TempAndFlux2FluxVariableTransformer_hh
...
class TempAndFlux2FluxVariableTransformer : public PostVariableTransformer {
public:

  /**
   * Default constructor without arguments
   */
  TempAndFlux2FluxVariableTransformer(const std::string& name);

  /**
   * Default destructor
   */
  ~TempAndFlux2FluxVariableTransformer();
...
}; // end of class TempAndFlux2FluxVariableTransformer
...
#endif // COOLFluiD_Numerics_SubSystemCoupler_TempAndFlux2FluxVariableTransformer_hh
