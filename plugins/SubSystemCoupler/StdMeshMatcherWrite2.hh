#ifndef COOLFluiD_Numerics_SubSystemCoupler_StdMeshMatcherWrite2_hh
#define COOLFluiD_Numerics_SubSystemCoupler_StdMeshMatcherWrite2_hh
...
class StdMeshMatcherWrite2 : public CouplerCom {
public:
   ...
   * Constructor.
   */
  explicit StdMeshMatcherWrite2(const std::string& name);

  /**
   * Destructor.
   */
  ~StdMeshMatcherWrite2();
...
protected: // data
  ...
  /**
   * Modify the current mesh to accomodate from a initial difference in the meshes to match
   */
...
#endif // COOLFluiD_Numerics_SubSystemCoupler_StdMeshMatcherWrite2_hh
