#ifndef COOLFluiD_Numerics_SubSystemCoupler_StdMeshMatcherWrite_hh
#define COOLFluiD_Numerics_SubSystemCoupler_StdMeshMatcherWrite_hh
...
class StdMeshMatcherWrite : public CouplerCom {
public:

  /**
   * Constructor.
   */
  explicit StdMeshMatcherWrite(const std::string& name);
...
#endif // COOLFluiD_Numerics_SubSystemCoupler_StdMeshMatcherWrite_hh
