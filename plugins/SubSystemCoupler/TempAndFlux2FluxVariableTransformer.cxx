#include "TempAndFlux2FluxVariableTransformer.hh"
...
MethodStrategyProvider<TempAndFlux2FluxVariableTransformer,SubSysCouplerData,PostVariableTransformer,SubSystemCouplerHeatModule>
tempAndFlux2FluxProvider("TempAndFlux2Flux");

//////////////////////////////////////////////////////////////////////////////

TempAndFlux2FluxVariableTransformer::TempAndFlux2FluxVariableTransformer(const std::string& name) :
...
TempAndFlux2FluxVariableTransformer::~TempAndFlux2FluxVariableTransformer()
{
}
...
TempAndFlux2FluxVariableTransformer::needsSockets()
{
...
void TempAndFlux2FluxVariableTransformer::setup()
{
...
RealVector* TempAndFlux2FluxVariableTransformer::transform(const vector<GeoEntityIdx>& faces, const RealVector& coord, const RealVector& original,const RealVector& pastTransformedVector)
{
  CFAUTOTRACE;
...
//unused//  CFreal averageT = (currentState[0] + original[0])*0.5;
  CFreal constant = 0.5;

  _transVector[0] = (original[1]) - constant * deltaT ;
