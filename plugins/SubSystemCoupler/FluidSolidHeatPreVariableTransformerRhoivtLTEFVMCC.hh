#ifndef COOLFluiD_Numerics_SubSystemCoupler_FluidSolidHeatPreVariableTransformerRhoivtLTEFVMCC_hh
#define COOLFluiD_Numerics_SubSystemCoupler_FluidSolidHeatPreVariableTransformerRhoivtLTEFVMCC_hh
...
class FluidSolidHeatPreVariableTransformerRhoivtLTEFVMCC : public PreVariableTransformer {
public:
   ...
   */
  FluidSolidHeatPreVariableTransformerRhoivtLTEFVMCC(const std::string& name);

  /**
   * Default destructor
   */
  ~FluidSolidHeatPreVariableTransformerRhoivtLTEFVMCC();
...
}; // end of class FluidSolidHeatPreVariableTransformerRhoivtLTEFVMCC
...
#endif // COOLFluiD_Numerics_SubSystemCoupler_FluidSolidHeatPreVariableTransformerRhoivtLTEFVMCC_hh
