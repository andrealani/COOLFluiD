...
MethodCommandProvider<NullMethodCommand<CGWriterData>, CGWriterData, CGNSWriterModule> nullCGWriterComProvider("Null");

//////////////////////////////////////////////////////////////////////////////

void CGWriterData::defineConfigOptions(Config::OptionList& options)
{
...
CGWriterData::CGWriterData(Common::SafePtr<Framework::Method> owner)
...
CGWriterData::~CGWriterData()
{
}

//////////////////////////////////////////////////////////////////////////////

void CGWriterData::configure ( Config::ConfigArgs& args )
{
  ...
  CFLog(VERBOSE, "CGWriterData::outputVarStr = " << provider_base + m_outputVarStr << "\n");
