...
#ifndef COOLFluiD_IO_CFmeshCellSplitter_CellSplitter2D_hh
#define COOLFluiD_IO_CFmeshCellSplitter_CellSplitter2D_hh
 ...
 *
 */
class CellSplitter2D : public Framework::MeshFormatConverter {
public:
   ...
   * Constructor
   */
  CellSplitter2D(const std::string& name);

  /**
   * Destructor
   */
  virtual ~CellSplitter2D();
...
#endif // COOLFluiD_IO_CFmeshCellSplitter_CellSplitter2D_hh
