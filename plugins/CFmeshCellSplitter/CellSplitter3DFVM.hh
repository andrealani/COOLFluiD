...
#ifndef COOLFluiD_IO_CFmeshCellSplitter_CellSplitter3DFVM_hh
#define COOLFluiD_IO_CFmeshCellSplitter_CellSplitter3DFVM_hh
 ...
 *
 */
class CellSplitter3DFVM : public Framework::MeshFormatConverter {
public:
   ...
   * Constructor
   */
  CellSplitter3DFVM(const std::string& name);

  /**
   * Destructor
   */
  virtual ~CellSplitter3DFVM();
...
#endif // COOLFluiD_IO_CFmeshCellSplitter_CellSplitter3DFVM_hh
