...
#ifndef COOLFluiD_Numerics_Petsc_TwoLayerSeqSetup_hh
#define COOLFluiD_Numerics_Petsc_TwoLayerSeqSetup_hh
...
/**
  ...
  *
  */
class TwoLayerSeqSetup : public BaseSetup {
public:

  /**
   * Constructor.
   */
  explicit TwoLayerSeqSetup(const std::string& name);
...
#endif // COOLFluiD_Numerics_Petsc_TwoLayerSeqSetup_hh
