...
void PetscMatrix::createParAIJ(MPI_Comm comm,
                               ...
                               const char* name)
{
 #if PETSC_VERSION_MINOR==4 || PETSC_VERSION_MINOR==6 || PETSC_VERSION_MINOR==7 || PETSC_VERSION_MINOR==9 || PETSC_VERSION_MINOR==11 || PETSC_VERSION_MINOR==12 || PETSC_VERSION_MINOR==15 || PETSC_VERSION_MINOR==18 || PETSC_VERSION_MINOR==20
...
#ifdef CF_HAVE_CUDA
    if (m_useGPU) {
#if PETSC_VERSION_MINOR==9 || PETSC_VERSION_MINOR==11 || PETSC_VERSION_MINOR==12 || PETSC_VERSION_MINOR==15 || PETSC_VERSION_MINOR==18 || PETSC_VERSION_MINOR==20
