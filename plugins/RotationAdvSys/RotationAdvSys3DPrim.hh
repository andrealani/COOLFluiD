...
#ifndef COOLFluiD_Physics_RotationAdvSys_RotationAdvSys3DPrim_hh
#define COOLFluiD_Physics_RotationAdvSys_RotationAdvSys3DPrim_hh
 ...
 */
class RotationAdvSys3DPrim : public RotationAdvSys3DVarSet {
public:
   ...
   * @see RotationAdv3D
   */
  RotationAdvSys3DPrim(Common::SafePtr<Framework::BaseTerm> term);

  /**
   * Default destructor
   */
  virtual ~RotationAdvSys3DPrim();
