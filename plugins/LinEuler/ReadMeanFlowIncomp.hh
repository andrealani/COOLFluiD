#ifndef COOLFluiD_Physics_LinEuler_ReadMeanFlowIncomp_hh
#define COOLFluiD_Physics_LinEuler_ReadMeanFlowIncomp_hh
...
class ReadMeanFlowIncomp : public Framework::DataProcessingCom {
public: // functions
   ...
   * Constructor.
   */
  ReadMeanFlowIncomp(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~ReadMeanFlowIncomp();
...
}; // end of class ReadMeanFlowIncomp
...
#endif // COOLFluiD_Physics_LinEuler_ReadMeanFlowIncomp_hh
