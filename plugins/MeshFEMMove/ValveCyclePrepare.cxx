...
MethodCommandProvider<ValveCyclePrepare, FEMMoveData, MeshFEMMoveModule> ValveCyclePrepareProvider("ValveCyclePrepare");

//////////////////////////////////////////////////////////////////////////////

void ValveCyclePrepare::defineConfigOptions(Config::OptionList& options)
{
...
ValveCyclePrepare::providesSockets()
{
...
ValveCyclePrepare::ValveCyclePrepare(const std::string& name) :
BasePrepare(name),
_sockets()
{
...
void ValveCyclePrepare::configure ( Config::ConfigArgs& args )
{
...
void ValveCyclePrepare::moveBoundaries()
{
