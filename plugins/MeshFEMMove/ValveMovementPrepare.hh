#ifndef COOLFluiD_Numerics_MeshFEMMove_ValveMovementPrepare_hh
#define COOLFluiD_Numerics_MeshFEMMove_ValveMovementPrepare_hh
...
class ValveMovementPrepare : public BasePrepare {
public:
   ...
   * Constructor.
   */
  ValveMovementPrepare(const std::string& name);

  /**
   * Destructor.
   */
  ~ValveMovementPrepare()
  {
  }
...
#endif // COOLFluiD_Numerics_MeshFEMMove_ValveMovementPrepare_hh
