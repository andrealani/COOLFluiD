#ifndef COOLFluiD_Numerics_SpectralFV_NSQuadFreeBndFaceTermComputer_hh
#define COOLFluiD_Numerics_SpectralFV_NSQuadFreeBndFaceTermComputer_hh
 ...
 */
class NSQuadFreeBndFaceTermComputer : public QuadFreeBndFaceTermComputer {

public:  // methods

  /// Constructor
  NSQuadFreeBndFaceTermComputer(const std::string& name);

  /// Destructor
  ~NSQuadFreeBndFaceTermComputer();

  /// Gets the Class name
  static std::string getClassName()
  {
    return "NSQuadFreeBndFaceTermComputer";
  }
...
}; // class NSQuadFreeBndFaceTermComputer
...
#endif  // COOLFluiD_Numerics_SpectralFV_NSQuadFreeBndFaceTermComputer_hh
