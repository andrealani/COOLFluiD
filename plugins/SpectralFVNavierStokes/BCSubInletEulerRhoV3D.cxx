...
#include "SpectralFVNavierStokes/BCSubInletEulerRhoV3D.hh"
...
Framework::MethodStrategyProvider<
    BCSubInletEulerRhoV3D,SpectralFVMethodData,BCStateComputer,SpectralFVNavierStokesModule >
                                               ...
                                               const std::vector< RealVector >& coords)
{
  ...
  for (CFuint iState = 0; iState < nbrStates; ++iState)
  {
    ...
    m_vFunction.evaluate(coords[iState],m_inputVars);
