#ifndef COOLFluiD_Numerics_FiniteVolume_UnsteadySubInletUVTEIWRhoiViTiCanopy_hh
#define COOLFluiD_Numerics_FiniteVolume_UnsteadySubInletUVTEIWRhoiViTiCanopy_hh
...
class UnsteadySubInletUVTEIWRhoiViTiCanopy : public FVMCC_BC {
...
public: 
   ...
   * Constructor
   */
  UnsteadySubInletUVTEIWRhoiViTiCanopy(const std::string& name);
  
  /**
   * Default destructor
   */
  ~UnsteadySubInletUVTEIWRhoiViTiCanopy();
...
}; // end of class UnsteadySubInletUVTEIWRhoiViTiCanopy
...
#endif // COOLFluiD_Numerics_FiniteVolume_UnsteadySubInletUVTEIWRhoiViTiCanopy_hh
