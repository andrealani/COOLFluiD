...
//   1.- GEMMHDST2DHalfTwoFluid.hh: Is the header. Only declaration of the methods (functions) and members (variables used inside the class).
//   2.- GEMMHDST2DHalfTwoFluid.cxx: Only implemented the provider of the class. It is used to be refered in the .CFcase file.
//   3.- GEMMHDST2DHalfTwoFluid.ci: Is the main implementation in here.
//
...
#ifndef COOLFluiD_Numerics_FiniteVolume_GEMMHDST2DHalfTwoFluid_hh
#define COOLFluiD_Numerics_FiniteVolume_GEMMHDST2DHalfTwoFluid_hh
...
class GEMMHDST2DHalfTwoFluid : public ComputeSourceTermFVMCC {
...
public:
   ...
   */
  GEMMHDST2DHalfTwoFluid(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~GEMMHDST2DHalfTwoFluid();
...
}; // end of class GEMMHDST2DHalfTwoFluid
...
#include "GEMMHDST2DHalfTwoFluid.ci"

//////////////////////////////////////////////////////////////////////////////

#endif // COOLFluiD_Numerics_FiniteVolume_GEMMHDST2DHalfTwoFluid_hh
