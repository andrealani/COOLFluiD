...
#include "FiniteVolumeMultiFluidMHD/Venktn3DStrictT3F.hh"
...
MethodStrategyProvider<Venktn3DStrictT3F,
		       CellCenterFVMData,Limiter<CellCenterFVMData>,
		       FiniteVolumeMultiFluidMHDModule>
venktn3DStrictT3F_Provider("Venktn3DStrictT3F");

//////////////////////////////////////////////////////////////////////////////      

void Venktn3DStrictT3F::defineConfigOptions(Config::OptionList& options)
{
...
Venktn3DStrictT3F::Venktn3DStrictT3F(const std::string& name) :
  Venktn2D(name),
  socket_uZ("uZ")
{
...
Venktn3DStrictT3F::~Venktn3DStrictT3F()
{
}

//////////////////////////////////////////////////////////////////////////////

void Venktn3DStrictT3F::limit(const vector<vector<Node*> >& coord,
  ...
  for(CFuint iVar = 0; iVar < nbEquations; ++iVar) {
   ...
   //}
	...
	for (CFuint ip = 0; ip < nbPoints; ++ip) {
	  Venktn3DStrictT3F::computeDeltaMin((*coord[iFace][ip]), *state, iVar);
	  if (_deltaMin > 0.0) {
	...
	State *const neighborState = (state == neighborFace->getState(0)) ?
	  neighborFace->getState(1) : neighborFace->getState(0);
	      ...
	      Venktn3DStrictT3F_orig::computeDeltaMin(neighborState->getCoordinates(), *state, iVar);
