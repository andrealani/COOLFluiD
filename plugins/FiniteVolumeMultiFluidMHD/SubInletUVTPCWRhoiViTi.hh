#ifndef COOLFluiD_Numerics_FiniteVolume_SubInletUVTPCWRhoiViTi_hh
#define COOLFluiD_Numerics_FiniteVolume_SubInletUVTPCWRhoiViTi_hh
...
class SubInletUVTPCWRhoiViTi : public FVMCC_BC { 
...
public: 
   ...
   * Constructor
   */
  SubInletUVTPCWRhoiViTi(const std::string& name);
  
  /**
   * Default destructor
   */
  ~SubInletUVTPCWRhoiViTi();
...
}; // end of class SubInletUVTPCWRhoiViTi
...
#endif // COOLFluiD_Numerics_FiniteVolume_SubInletUVTPCWRhoiViTi_hh
