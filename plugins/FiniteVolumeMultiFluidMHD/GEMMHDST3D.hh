...
//   1.- GEMMHDST3D.hh: Is the header. Only declaration of the methods (functions) and members (variables used inside the class).
//   2.- GEMMHDST3D.cxx: Only implemented the provider of the class. It is used to be refered in the .CFcase file.
//   3.- GEMMHDST3D.ci: Is the main implementation in here.
//
...
#ifndef COOLFluiD_Numerics_FiniteVolume_GEMMHDST3D_hh
#define COOLFluiD_Numerics_FiniteVolume_GEMMHDST3D_hh
...
class GEMMHDST3D : public ComputeSourceTermFVMCC {
...
public:
   ...
   */
  GEMMHDST3D(const std::string& name);
...
#include "GEMMHDST3D.ci"

//////////////////////////////////////////////////////////////////////////////

#endif // COOLFluiD_Numerics_FiniteVolume_GEMMHDST3D_hh
