...
//   1.- HeatingMHDST3D.hh: Is the header. Only declaration of the methods (functions) and members (variables used inside the class).
//   2.- HeatingMHDST3D.cxx: Only implemented the provider of the class. It is used to be refered in the .CFcase file.
//   3.- HeatingMHDST3D.ci: Is the main implementation in here.
//
...
#ifndef COOLFluiD_Numerics_FiniteVolume_HeatingMHDST3D_hh
#define COOLFluiD_Numerics_FiniteVolume_HeatingMHDST3D_hh
...
class HeatingMHDST3D : public ComputeSourceTermFVMCC {
...
public:
   ...
   */
  HeatingMHDST3D(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~HeatingMHDST3D();
...
#include "HeatingMHDST3D.ci"

//////////////////////////////////////////////////////////////////////////////

#endif // COOLFluiD_Numerics_FiniteVolume_HeatingMHDST3D_hh
