#ifndef COOLFluiD_Numerics_FiniteVolume_CoronalSource2Fin_hh
#define COOLFluiD_Numerics_FiniteVolume_CoronalSource2Fin_hh
...
class CoronalSource2Fin : public ComputeSourceTermFVMCC {
...
public:
   ...
   */
  CoronalSource2Fin(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~CoronalSource2Fin();
...
}; // end of class CoronalSource2Fin
...
#include "CoronalSource2Fin.ci"

//////////////////////////////////////////////////////////////////////////////

#endif // COOLFluiD_Numerics_FiniteVolume_CoronalSource2Fin_hh
