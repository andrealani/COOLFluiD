...
MethodCommandProvider<UnsteadySubInletUVTEIWRhoiViTiCanopy, CellCenterFVMData, FiniteVolumeMultiFluidMHDModule> UnsteadySubInletUVTEIWRhoiViTiCanopyFVMCCProvider("UnsteadySubInletUVTEIWRhoiViTiCanopyFVMCC");
                                        
//////////////////////////////////////////////////////////////////////////////

void UnsteadySubInletUVTEIWRhoiViTiCanopy::defineConfigOptions(Config::OptionList& options)
{
...
UnsteadySubInletUVTEIWRhoiViTiCanopy::UnsteadySubInletUVTEIWRhoiViTiCanopy
...
void UnsteadySubInletUVTEIWRhoiViTiCanopy::setup()
{
  FVMCC_BC::setup();
  
//   cout << "UnsteadySubInletUVTEIWRhoiViTiCanopy::setup" << endl;
...
void UnsteadySubInletUVTEIWRhoiViTiCanopy::configure ( Config::ConfigArgs& args )
{
  using namespace COOLFluiD::Framework;
...
void UnsteadySubInletUVTEIWRhoiViTiCanopy::setGhostState(GeometricEntity *const face)
{
  const CFuint nbSpecies = _updateVarSet->getModel()->getNbScalarVars(0);
...
//   std::cout << "UnsteadySubInletUVTEIWRhoiViTiCanopy::setGhostState before assignment" <<"\n";
...
//  const CFreal chi = _varSet->getModel()->getDivECleaningConst();
 ...
 if(_useFunction){
  ...
  (*ghostState)[0] = 2*BxBound - (*innerState)[0] /*+ 2*bn*nx*/;	//Bx is harcoded to be extrapolated from inside
...
//   std::cout << "UnsteadySubInletUVTEIWRhoiViTiCanopy::setGhostState after Maxwell" <<"\n";
...
//    std::cout << "UnsteadySubInletUVTEIWRhoiViTiCanopy::setGhostState Ui = "<< Ui <<"\n";
//    std::cout << "UnsteadySubInletUVTEIWRhoiViTiCanopy::setGhostState =>     Vi        = "<< Vi <<"\n";
...
//    cf_assert((*ghostState)[endEM + nbSpecies + 2*i + 1] + (*innerState)[endEM + nbSpecies + 2*i + 1] != 0.);
    ...
    //std::cout << "UnsteadySubInletUVTEIWRhoiViTiCanopy::setGhostState => (*ghostState) = "<<    (*ghostState)[endEM + nbSpecies + 2*i + 1] <<"\n";
    //std::cout << "UnsteadySubInletUVTEIWRhoiViTiCanopy::setGhostState => (*innerState) = "<<    (*innerState)[endEM + nbSpecies + 2*i + 1] <<"\n";
   
 } 
//   std::cout << "UnsteadySubInletUVTEIWRhoiViTiCanopy::setGhostState after Velocities" <<"\n";
