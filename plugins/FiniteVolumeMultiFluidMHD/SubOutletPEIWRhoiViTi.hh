#ifndef COOLFluiD_Numerics_FiniteVolume_SubOutletPEIWRhoiViTi_hh
#define COOLFluiD_Numerics_FiniteVolume_SubOutletPEIWRhoiViTi_hh
...
//////////////////////////////////////////////////////////////////////////////
   ...
   *
   */
class SubOutletPEIWRhoiViTi : public FVMCC_BC { 
...
public: 
   ...
   * Constructor
   */
  SubOutletPEIWRhoiViTi(const std::string& name);
  
  /**
   * Default destructor
   */
  ~SubOutletPEIWRhoiViTi();
...
}; // end of class SubOutletPEIWRhoiViTi
...
#endif // COOLFluiD_Numerics_FiniteVolume_SubOutletPEIWRhoiViTi_hh
