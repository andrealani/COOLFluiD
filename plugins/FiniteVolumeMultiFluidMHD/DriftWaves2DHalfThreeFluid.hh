...
//   1.- DriftWaves2DHalfThreeFluid.hh: Is the header. Only declaration of the methods (functions) and members (variables used inside the class).
//   2.- DriftWaves2DHalfThreeFluid.cxx: Only implemented the provider of the class. It is used to be refered in the .CFcase file.
//   3.- DriftWaves2DHalfThreeFluid.ci: Is the main implementation in here.
//
...
#ifndef COOLFluiD_Numerics_FiniteVolume_DriftWaves2DHalfThreeFluid_hh
#define COOLFluiD_Numerics_FiniteVolume_DriftWaves2DHalfThreeFluid_hh
...
class DriftWaves2DHalfThreeFluid : public ComputeSourceTermFVMCC {
...
public:
   ...
   */
  DriftWaves2DHalfThreeFluid(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~DriftWaves2DHalfThreeFluid();
...
protected: // data
  ...
  /// Option to change the Collisional cross section of electrons-neutral
  CFreal _Qen;

  /// Option to change the collisional cross section of ion-neutral 
  CFreal _Qin;
...
#include "DriftWaves2DHalfThreeFluid.ci"

//////////////////////////////////////////////////////////////////////////////

#endif // COOLFluiD_Numerics_FiniteVolume_DriftWaves2DHalfThreeFluid_hh
