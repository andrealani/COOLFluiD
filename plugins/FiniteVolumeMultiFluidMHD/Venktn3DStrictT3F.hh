#ifndef COOLFluiD_Numerics_FiniteVolume_Venktn3DStrictT3F_hh
#define COOLFluiD_Numerics_FiniteVolume_Venktn3DStrictT3F_hh
 ...
 *
 */
class Venktn3DStrictT3F : public Venktn2D {
public:
   ...
   * Constructor
   */
  Venktn3DStrictT3F(const std::string& name);
...
}; // end of class Venktn3DStrictT3F_orig
...
#endif // COOLFluiD_Numerics_FiniteVolume_Venktn3DStrictT3F_orig_hh
