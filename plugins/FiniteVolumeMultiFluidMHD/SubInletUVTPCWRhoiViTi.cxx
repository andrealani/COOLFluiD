...
#include "FiniteVolumeMultiFluidMHD/SubInletUVTPCWRhoiViTi.hh"
...
MethodCommandProvider<SubInletUVTPCWRhoiViTi, CellCenterFVMData, FiniteVolumeMultiFluidMHDModule> subInletUVTPCWRhoiViTiFVMCCProvider("SubInletUVTPCWRhoiViTiFVMCC");
                                        
//////////////////////////////////////////////////////////////////////////////

void SubInletUVTPCWRhoiViTi::defineConfigOptions(Config::OptionList& options)
{
...
SubInletUVTPCWRhoiViTi::SubInletUVTPCWRhoiViTi
...
void SubInletUVTPCWRhoiViTi::setup()
{
  FVMCC_BC::setup();
...
void SubInletUVTPCWRhoiViTi::configure ( Config::ConfigArgs& args )
{
  using namespace COOLFluiD::Framework;
...
void SubInletUVTPCWRhoiViTi::setGhostState(GeometricEntity *const face)
{
  const CFuint nbSpecies = _updateVarSet->getModel()->getNbScalarVars(0);
...
//   std::cout << "SubInletUVTPCWRhoiViTi::setGhostState before assignment" <<"\n";
