...
MethodCommandProvider<NoSlipWallIsothermalPCWRhoiViTi, CellCenterFVMData, FiniteVolumeMultiFluidMHDModule> noSlipWallIsothermalPCWRhoiViTiFVMCCProvider("NoSlipWallIsothermalPCWRhoiViTiFVMCC");
                                        
//////////////////////////////////////////////////////////////////////////////

void NoSlipWallIsothermalPCWRhoiViTi::defineConfigOptions(Config::OptionList& options)
{
...
NoSlipWallIsothermalPCWRhoiViTi::NoSlipWallIsothermalPCWRhoiViTi
...
void NoSlipWallIsothermalPCWRhoiViTi::setup()
{
  FVMCC_BC::setup();
...
void NoSlipWallIsothermalPCWRhoiViTi::setGhostState(GeometricEntity *const face)
{
  const CFuint nbSpecies = _updateVarSet->getModel()->getNbScalarVars(0);
