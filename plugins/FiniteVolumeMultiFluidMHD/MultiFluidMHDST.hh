#ifndef COOLFluiD_Numerics_FiniteVolume_MultiFluidMHDST_hh
#define COOLFluiD_Numerics_FiniteVolume_MultiFluidMHDST_hh
...
class MultiFluidMHDST : public ComputeSourceTermFVMCC {
...
public:
   ...
   */
  MultiFluidMHDST(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~MultiFluidMHDST();
...
#include "MultiFluidMHDST.ci"

//////////////////////////////////////////////////////////////////////////////

#endif // COOLFluiD_Numerics_FiniteVolume_MultiFluidMHDST_hh
