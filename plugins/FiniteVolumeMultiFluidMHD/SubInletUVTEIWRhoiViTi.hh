#ifndef COOLFluiD_Numerics_FiniteVolume_SubInletUVTEIWRhoiViTi_hh
#define COOLFluiD_Numerics_FiniteVolume_SubInletUVTEIWRhoiViTi_hh
...
class SubInletUVTEIWRhoiViTi : public FVMCC_BC { 
...
public: 
   ...
   * Constructor
   */
  SubInletUVTEIWRhoiViTi(const std::string& name);
  
  /**
   * Default destructor
   */
  ~SubInletUVTEIWRhoiViTi();
...
}; // end of class SubInletUVTEIWRhoiViTi
...
#endif // COOLFluiD_Numerics_FiniteVolume_SubInletUVTEIWRhoiViTi_hh
