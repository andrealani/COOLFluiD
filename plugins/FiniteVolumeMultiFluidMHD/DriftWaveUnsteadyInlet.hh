#ifndef COOLFluiD_Numerics_FiniteVolume_DriftWaveUnsteadyInlet_hh
#define COOLFluiD_Numerics_FiniteVolume_DriftWaveUnsteadyInlet_hh
...
class DriftWaveUnsteadyInlet : public FVMCC_BC {
...
public: 
   ...
   * Constructor
   */
  DriftWaveUnsteadyInlet(const std::string& name);
  
  /**
   * Default destructor
   */
  ~DriftWaveUnsteadyInlet();
...
}; // end of class DriftWaveUnsteadyInlet
...
#endif // COOLFluiD_Numerics_FiniteVolume_DriftWaveUnsteadyInlet_hh
