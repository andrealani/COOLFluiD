...
//   1.- ThreeFluidMHDST3D.hh: Is the header. Only declaration of the methods (functions) and members (variables used inside the class).
//   2.- ThreeFluidMHDST3D.cxx: Only implements the provider of the class. It is used to be refered in the .CFcase file.
//   3.- ThreeFluidMHDST3D.ci: Is the main implementation in here.
//
...
// Rev History: 2/2015
// Modified by Yana Maneva to include the 3D three-fluid and gravity source 
...
#ifndef COOLFluiD_Numerics_FiniteVolume_ThreeFluidMHDST3D_hh
#define COOLFluiD_Numerics_FiniteVolume_ThreeFluidMHDST3D_hh
...
class ThreeFluidMHDST3D : public ComputeSourceTermFVMCC {
...
public:
   ...
   */
  ThreeFluidMHDST3D(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~ThreeFluidMHDST3D();
 ...
 *     */
 ...
 /*
 * Compute the gravity momentum and energy source terms
 */
...
}; // end of class ThreeFluidMHDST3D
...
#include "ThreeFluidMHDST3D.ci"

//////////////////////////////////////////////////////////////////////////////

#endif // COOLFluiD_Numerics_FiniteVolume_ThreeFluidMHDST3D_hh
