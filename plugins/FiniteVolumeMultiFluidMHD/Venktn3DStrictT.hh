#ifndef COOLFluiD_Numerics_FiniteVolume_Venktn3DStrictT_hh
#define COOLFluiD_Numerics_FiniteVolume_Venktn3DStrictT_hh
 ...
 *
 */
class Venktn3DStrictT : public Venktn2D {
public:
   ...
   * Constructor
   */
  Venktn3DStrictT(const std::string& name);
...
}; // end of class Venktn3DStrictT_orig
...
#endif // COOLFluiD_Numerics_FiniteVolume_Venktn3DStrictT_orig_hh
