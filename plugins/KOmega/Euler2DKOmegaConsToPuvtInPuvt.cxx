#include "KOmega.hh"
#include "Euler2DKOmegaConsToPuvtInPuvt.hh"
...
Environment::ObjectProvider<Euler2DKOmegaConsToPuvtInPuvt, VarSetMatrixTransformer,
	       KOmegaModule, 1>
euler2DKOmegaConsToPuvtInPuvt("Euler2DKOmegaConsToPuvtInPuvt");

//////////////////////////////////////////////////////////////////////////////

Euler2DKOmegaConsToPuvtInPuvt::Euler2DKOmegaConsToPuvtInPuvt(Common::SafePtr<Framework::PhysicalModelImpl> model) :
...
void Euler2DKOmegaConsToPuvtInPuvt::setMatrix(const RealVector& state)
{
