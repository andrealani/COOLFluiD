#ifndef COOLFluiD_Physics_KOmega_NavierStokesKOmegaPvt_hh
#define COOLFluiD_Physics_KOmega_NavierStokesKOmegaPvt_hh
...
class NavierStokesKOmegaPvt : public BASE {
public: // classes
   ...
   * @see NavierStokes
   */
  NavierStokesKOmegaPvt(const std::string& name,
			Common::SafePtr<Framework::PhysicalModelImpl> model);
  
  /**
   * Default destructor
   */
  virtual ~NavierStokesKOmegaPvt();
...
}; // end of class NavierStokesKOmegaPvt
...
#include "NavierStokesKOmegaPvt.ci"

//////////////////////////////////////////////////////////////////////////////

#endif // COOLFluiD_Physics_KOmega_NavierStokesKOmegaPvt_hh
