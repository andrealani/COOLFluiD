...
#ifndef COOLFluiD_MeshTools_ComputeWallDistanceVectorCC_hh
#define COOLFluiD_MeshTools_ComputeWallDistanceVectorCC_hh
 ...
 *
 */
class ComputeWallDistanceVectorCC : public ComputeWallDistance {
public:

  /**
   * Constructor.
   */
  ComputeWallDistanceVectorCC(const std::string& name);

  /**
   * Default destructor
   */
  ~ComputeWallDistanceVectorCC();
...
}; // end of class ComputeWallDistanceVectorCC
...
#endif // COOLFluiD_MeshTools_ComputeWallDistanceVectorCC_hh
