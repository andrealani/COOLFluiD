...
#ifndef COOLFluiD_FluxReconstructionMethod_ConvDiffCLLAVJacobFluxReconstructionNS_hh
#define COOLFluiD_FluxReconstructionMethod_ConvDiffCLLAVJacobFluxReconstructionNS_hh
 ...
 * convective, diffusive and CLLAV tems to the RHS for a Flux Reconstruction scheme for implicit 
 * time marching for NS
 * 
 * @author Ray Vandenhoeck
 */
class ConvDiffCLLAVJacobFluxReconstructionNS : public ConvDiffCLLAVJacobFluxReconstruction {

public: // functions

  /// Constructor
  explicit ConvDiffCLLAVJacobFluxReconstructionNS(const std::string& name);

  /// Destructor
  virtual ~ConvDiffCLLAVJacobFluxReconstructionNS() {}
...
#endif // COOLFluiD_FluxReconstructionMethod_ConvDiffCLLAVJacobFluxReconstructionNS_hh
