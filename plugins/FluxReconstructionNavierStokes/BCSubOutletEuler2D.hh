#ifndef COOLFluiD_FluxReconstructionMethod_BCSubOutletEuler2D_hh
#define COOLFluiD_FluxReconstructionMethod_BCSubOutletEuler2D_hh
...
public:  // methods
  ...
  /**
   * Sets the boundary states from the (p, u, v, T) of computeOutletPrimState.
   */
...
protected: // functions
  ...
  /**
   * Computes the boundary values of (p, u, v, T): the prescribed pressure and the
...
#endif  // COOLFluiD_Numerics_FluxReconstructionMethod_BCSubOutletEuler2D_hh
