...
#include "FluxReconstructionNavierStokes/BCSubOutletEuler3D.hh"
...
Framework::MethodStrategyProvider<
    BCSubOutletEuler3D,FluxReconstructionSolverData,BCStateComputer,FluxReconstructionNavierStokesModule >
...
void BCSubOutletEuler3D::computeBndGradVars(const std::vector< RealVector* >& gradVarsFlxPnt,
...
void BCSubOutletEuler3D::computeBndStates(const std::vector< Framework::State* >& intStates,
                                          const std::vector< Framework::State* >& ghostStates,
                                          const std::vector< RealVector >& unitNormals,
                                          const std::vector< RealVector >& flxPntCoords,
...
void BCSubOutletEuler3D::computeBndGrads(const std::vector< std::vector< RealVector* > >& intGrads,
...
void BCSubOutletEuler3D::computeOutletPrimState(const Framework::State& intState,
                                                RealVector& primState)
{
  m_eulerVarSet->computePhysicalData(intState,m_intSolPhysData);

  primState[0] = m_pressure;
  primState[4] = m_intSolPhysData[EulerTerm::T];
