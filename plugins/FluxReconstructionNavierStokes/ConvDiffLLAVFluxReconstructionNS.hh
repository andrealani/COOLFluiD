...
#ifndef COOLFluiD_FluxReconstructionMethod_ConvDiffLLAVFluxReconstructionNS_hh
#define COOLFluiD_FluxReconstructionMethod_ConvDiffLLAVFluxReconstructionNS_hh
 ...
 * convective, diffusive and LLAV tems to the RHS for a Flux Reconstruction scheme for explicit 
 * time marching for NS
 * 
 * @author Ray Vandenhoeck
 */
class ConvDiffLLAVFluxReconstructionNS : public ConvDiffLLAVFluxReconstruction {

public: // functions

  /// Constructor
  explicit ConvDiffLLAVFluxReconstructionNS(const std::string& name);

  /// Destructor
  virtual ~ConvDiffLLAVFluxReconstructionNS() {}
...
#endif // COOLFluiD_FluxReconstructionMethod_ConvDiffLLAVFluxReconstructionNS_hh
