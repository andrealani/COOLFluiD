#ifndef COOLFluiD_FluxReconstructionMethod_BCNoSlipWallGammaAlpha3D_hh
#define COOLFluiD_FluxReconstructionMethod_BCNoSlipWallGammaAlpha3D_hh
...
/**
 * This class represents a no-slip wall boundary condition for the 3D RANS equations with gamma-alpha LCTM
 *
 ...
 * @author Rayan Dhib
 */
class BCNoSlipWallGammaAlpha3D : public BCStateComputer {
...
public:  // methods
  ...
  /// Constructor
  BCNoSlipWallGammaAlpha3D(const std::string& name);

  /// Destructor
  ~BCNoSlipWallGammaAlpha3D();

  /// Gets the Class name
  static std::string getClassName()
  {
    return "BCNoSlipWallGammaAlpha3D";
  }
   ...
   * velocity, the wall temperature of an isothermal wall, and KWall, the wall
   * value of log-omega and gamma the ghost state carries. The gradient
   * variables are the update variables, Puvt plus the turbulence variables.
   */
...
}; // class BCNoSlipWallGammaAlpha3D
...
#endif  // COOLFluiD_Numerics_FluxReconstructionMethod_BCNoSlipWallGammaAlpha3D_hh
