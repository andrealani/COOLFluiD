#ifndef COOLFluiD_Numerics_FluxReconstructionMethod_BCMirrorEuler3D_hh
#define COOLFluiD_Numerics_FluxReconstructionMethod_BCMirrorEuler3D_hh
...
public:  // methods
  ...
  /**
   * Sets the boundary states from (p, u, v, w, T) with the interior pressure and
