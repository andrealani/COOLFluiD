...
#ifndef COOLFluiD_FluxReconstructionMethod_ConvDiffJacobFluxReconstructionNS_hh
#define COOLFluiD_FluxReconstructionMethod_ConvDiffJacobFluxReconstructionNS_hh
...
public: // functions
  ...
  /// Constructor
  explicit ConvDiffJacobFluxReconstructionNS(const std::string& name);

  /// Destructor
  virtual ~ConvDiffJacobFluxReconstructionNS() {}
...
#endif // COOLFluiD_FluxReconstructionMethod_ConvDiffJacobFluxReconstructionNS_hh
