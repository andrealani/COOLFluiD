...
#ifndef COOLFluiD_IO_CFmeshExtruder_Extruder2D_hh
#define COOLFluiD_IO_CFmeshExtruder_Extruder2D_hh
 ...
 *
 */
class Extruder2D : public Framework::MeshFormatConverter {
public:
   ...
   * Constructor
   */
  Extruder2D(const std::string& name);
...
#endif // COOLFluiD_IO_CFmeshExtruder_Extruder2D_hh
