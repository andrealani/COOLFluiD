...
#ifndef COOLFluiD_IO_CFmeshExtruder_Extruder2DDGM_hh
#define COOLFluiD_IO_CFmeshExtruder_Extruder2DDGM_hh
 ...
 * Modification of Extruder2DFVM(P0) tah create P1 mesh for DGM.
 *
 * @author Tiago Quintino, Martin Holik
 *
 */
class Extruder2DDGM : public Framework::MeshFormatConverter {
public:
   ...
   * Constructor
   */
  Extruder2DDGM(const std::string& name);

  /**
   * Destructor
   */
  virtual ~Extruder2DDGM();
...
#endif // COOLFluiD_IO_CFmeshExtruder_Extruder2DDGM_hh
