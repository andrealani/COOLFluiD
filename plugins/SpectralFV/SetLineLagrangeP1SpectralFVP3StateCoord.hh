#ifndef COOLFluiD_ShapeFunctions_SetLineLagrangeP1SpectralFVP3StateCoord_hh
#define COOLFluiD_ShapeFunctions_SetLineLagrangeP1SpectralFVP3StateCoord_hh
 ...
 * the State's in a line with P1 geometrical and P3 solution
 * interpolation.
 *
 ...
 */
class SetLineLagrangeP1SpectralFVP3StateCoord : public Framework::SetElementStateCoord {
...
public:
   ...
   * Constructor
   */
  SetLineLagrangeP1SpectralFVP3StateCoord() : Framework::SetElementStateCoord()
  {
  }
   ...
   * Destructor
   */
  ~SetLineLagrangeP1SpectralFVP3StateCoord()
  {
  }
...
}; // end of class SetLineLagrangeP1SpectralFVP3StateCoord
...
#endif // COOLFluiD_ShapeFunctions_SetLineLagrangeP1SpectralFVP3StateCoord_hh
