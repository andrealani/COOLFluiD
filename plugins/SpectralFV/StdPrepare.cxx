...
#include "SpectralFV/StdPrepare.hh"
...
MethodCommandProvider<StdPrepare, SpectralFVMethodData, SpectralFVModule> stdPrepareProvider("StdPrepare");

//////////////////////////////////////////////////////////////////////////////

StdPrepare::StdPrepare(const std::string& name) : SpectralFVMethodCom(name),
  socket_rhs("rhs"),
