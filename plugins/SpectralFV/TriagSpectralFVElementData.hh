#ifndef COOLFluiD_SpectralFV_TriagSpectralFVElementData_hh
#define COOLFluiD_SpectralFV_TriagSpectralFVElementData_hh
...
/**
 * This class represents a triangular spectral finite volume element
 *
 * @author Kris Van den Abeele
 *
 */
class TriagSpectralFVElementData : public SpectralFVElementData {
public:

  /**
   * Default constructor without arguments.
   */
  TriagSpectralFVElementData();

  /**
   * Constructor initializing polyOrder.
   */
  TriagSpectralFVElementData(CFPolyOrder::Type polyOrder);
...
}; // end of class TriagSpectralFVElementData
