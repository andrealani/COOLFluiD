#ifndef COOLFluiD_SpectralFV_SpectralFVBaseFunctionFaceTriagP1_hh
#define COOLFluiD_SpectralFV_SpectralFVBaseFunctionFaceTriagP1_hh
 ...
 * representation of the solution on a face of a P1 (linear) tetrahedral element.
 *
 * @author Kris Van den Abeele
 *
 */
class SpectralFVBaseFunctionFaceTriagP1 : public ShapeFunctions::LagrangeShapeFunction {
public:
  ...
  */
  ...
  {
    throw Common::NotImplementedException (FromHere(),"Shapefunction computation has not been implemented yet for P1 SpectralFV");
  }
...
}; // end of class SpectralFVBaseFunctionFaceTriagP1
...
#endif // COOLFluiD_SpectralFV_SpectralFVBaseFunctionFaceTriagP1_hh
