#ifndef COOLFluiD_SpectralFV_SpectralFVBaseFunctionFaceLineP1_hh
#define COOLFluiD_SpectralFV_SpectralFVBaseFunctionFaceLineP1_hh
 ...
 *
 */
class SpectralFVBaseFunctionFaceLineP1 : public ShapeFunctions::LagrangeShapeFunction {
public:
  ...
  */
  ...
  {
      shapeFunc[0] = 29.0/15.0 - 12.0/5.0*mappedCoord[0];
      shapeFunc[1] = -7.0/15.0 + 12.0/5.0*mappedCoord[0];
      shapeFunc[2] = -7.0/15.0;
  }
...
}; // end of class SpectralFVBaseFunctionFaceLineP1
...
#endif // COOLFluiD_SpectralFV_SpectralFVBaseFunctionFaceLineP1_hh
