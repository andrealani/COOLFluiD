#ifndef COOLFluiD_ShapeFunctions_SetTetraLagrangeP1SpectralFVP1StateCoord_hh
#define COOLFluiD_ShapeFunctions_SetTetraLagrangeP1SpectralFVP1StateCoord_hh
 ...
 * the State's in a tetrahedron with P1 geometrical and P1 solution
 * interpolation.
 *
 ...
 */
class SetTetraLagrangeP1SpectralFVP1StateCoord : public Framework::SetElementStateCoord {
...
public:
   ...
   * Constructor
   */
  SetTetraLagrangeP1SpectralFVP1StateCoord() : Framework::SetElementStateCoord()
  {
  }
   ...
   * Destructor
   */
  ~SetTetraLagrangeP1SpectralFVP1StateCoord()
  {
  }
...
}; // end of class SetTetraLagrangeP1SpectralFVP1StateCoord
...
#endif // COOLFluiD_ShapeFunctions_SetTetraLagrangeP1SpectralFVP1StateCoord_hh
