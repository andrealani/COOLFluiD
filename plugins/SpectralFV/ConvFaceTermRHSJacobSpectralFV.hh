#ifndef COOLFluiD_SpectralFV_ConvFaceTermRHSJacobSpectralFV_hh
#define COOLFluiD_SpectralFV_ConvFaceTermRHSJacobSpectralFV_hh
 ...
 *
 */
class ConvFaceTermRHSJacobSpectralFV : public ConvFaceTermRHSSpectralFV {
public:

  /**
   * Constructor.
   */
  explicit ConvFaceTermRHSJacobSpectralFV(const std::string& name);

  /**
   * Destructor.
   */
  virtual ~ConvFaceTermRHSJacobSpectralFV();
...
}; // class ConvFaceTermRHSJacobSpectralFV
