#ifndef COOLFluiD_ShapeFunctions_SetLineLagrangeP1SpectralFVP1StateCoord_hh
#define COOLFluiD_ShapeFunctions_SetLineLagrangeP1SpectralFVP1StateCoord_hh
 ...
 * the State's in a line with P1 geometrical and P1 solution
 * interpolation.
 *
 ...
 */
class SetLineLagrangeP1SpectralFVP1StateCoord : public Framework::SetElementStateCoord {
...
public:
   ...
   * Constructor
   */
  SetLineLagrangeP1SpectralFVP1StateCoord() : Framework::SetElementStateCoord()
  {
  }
   ...
   * Destructor
   */
  ~SetLineLagrangeP1SpectralFVP1StateCoord()
  {
  }
...
}; // end of class SetLineLagrangeP1SpectralFVP1StateCoord
...
#endif // COOLFluiD_ShapeFunctions_SetLineLagrangeP1SpectralFVP1StateCoord_hh
