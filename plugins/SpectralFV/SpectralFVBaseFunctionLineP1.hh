#ifndef COOLFluiD_SpectralFV_LagrangeShapeFunctionLineP1_hh
#define COOLFluiD_SpectralFV_LagrangeShapeFunctionLineP1_hh
 ...
 * representation of the solution in a P1 (linear) linear element.
 *
 * @author Kris Van den Abeele
 *
 */
class SpectralFVBaseFunctionLineP1 : public ShapeFunctions::LagrangeShapeFunction {
public:
  ...
  */
  ...
  {
      shapeFunc[0] = 1.0/2.0 - mappedCoord[0];
      shapeFunc[1] = 1.0/2.0 + mappedCoord[1];
  }
...
}; // end of class SpectralFVBaseFunctionLineP1
...
#endif // COOLFluiD_SpectralFV_SpectralFVBaseFunctionLineP1_hh
