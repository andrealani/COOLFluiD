#ifndef COOLFluiD_ShapeFunctions_SetTetraLagrangeP1SpectralFVP2StateCoord_hh
#define COOLFluiD_ShapeFunctions_SetTetraLagrangeP1SpectralFVP2StateCoord_hh
 ...
 * the State's in a tetrahedron with P1 geometrical and P2 solution
 * interpolation.
 *
 ...
 */
class SetTetraLagrangeP1SpectralFVP2StateCoord : public Framework::SetElementStateCoord {
...
public:
   ...
   * Constructor
   */
  SetTetraLagrangeP1SpectralFVP2StateCoord() : Framework::SetElementStateCoord()
  {
  }
   ...
   * Destructor
   */
  ~SetTetraLagrangeP1SpectralFVP2StateCoord()
  {
  }
...
}; // end of class SetTetraLagrangeP1SpectralFVP2StateCoord
...
#endif // COOLFluiD_ShapeFunctions_SetTetraLagrangeP1SpectralFVP2StateCoord_hh
