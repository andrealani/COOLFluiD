#ifndef COOLFluiD_ShapeFunctions_SetTriagLagrangeP1SpectralFVP1StateCoord_hh
#define COOLFluiD_ShapeFunctions_SetTriagLagrangeP1SpectralFVP1StateCoord_hh
 ...
 */
class SetTriagLagrangeP1SpectralFVP1StateCoord : public Framework::SetElementStateCoord {
...
public:
   ...
   * Constructor
   */
  SetTriagLagrangeP1SpectralFVP1StateCoord() : Framework::SetElementStateCoord()
  {
  }
   ...
   * Destructor
   */
  ~SetTriagLagrangeP1SpectralFVP1StateCoord()
  {
  }
...
}; // end of class SetTriagLagrangeP1SpectralFVP1StateCoord
...
#endif // COOLFluiD_ShapeFunctions_SetTriagLagrangeP1SpectralFVP1StateCoord_hh
