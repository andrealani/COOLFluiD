#ifndef COOLFluiD_SpectralFV_SpectralFVBaseFunctionFaceTriagP2_hh
#define COOLFluiD_SpectralFV_SpectralFVBaseFunctionFaceTriagP2_hh
 ...
 * representation of the solution on a face of a P2 (quadratic) tetrahedral element.
 *
 * @author Kris Van den Abeele
 *
 */
class SpectralFVBaseFunctionFaceTriagP2 : public ShapeFunctions::LagrangeShapeFunction {
public:
  ...
  */
  ...
  {
    throw Common::NotImplementedException (FromHere(),"Shapefunction computation has not been implemented yet for P2 SpectralFV");
  }
...
}; // end of class SpectralFVBaseFunctionFaceTriagP2
...
#endif // COOLFluiD_SpectralFV_SpectralFVBaseFunctionFaceTriagP2_hh
