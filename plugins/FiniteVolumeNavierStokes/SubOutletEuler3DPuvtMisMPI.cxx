...
#include "FiniteVolumeNavierStokes/SubOutletEuler3DPuvtMisMPI.hh"
...
MethodCommandProvider<SubOutletEuler3DPuvtMisMPI, CellCenterFVMData, FiniteVolumeNavierStokesModule>
subOutletEuler3DPuvtMisMPIFVMCCProvider("SubOutletEuler3DPuvtMisMPIFVMCC");

//////////////////////////////////////////////////////////////////////////////

void SubOutletEuler3DPuvtMisMPI::defineConfigOptions(Config::OptionList& options)
{
...
SubOutletEuler3DPuvtMisMPI::SubOutletEuler3DPuvtMisMPI(const std::string& name) :
  FVMCC_BC(name),
  _comm(),
  _myP(),
  _nP()
...
SubOutletEuler3DPuvtMisMPI::~SubOutletEuler3DPuvtMisMPI()
{
}

//////////////////////////////////////////////////////////////////////////////

void SubOutletEuler3DPuvtMisMPI::setup()
{
...
void SubOutletEuler3DPuvtMisMPI::preProcess()
{
  ...
  const CFreal gamma = (getMethodData().getUpdateVar().d_castTo<Euler3DVarSet>())->getModel()->getGamma();
...
void SubOutletEuler3DPuvtMisMPI::setGhostState(GeometricEntity *const face)
{
  ...
  const CFreal w = (*innerState)[3];
  const CFreal gamma = (getMethodData().getUpdateVar().d_castTo<Euler3DVarSet>())->getModel()->getGamma();
  const CFreal R = (getMethodData().getUpdateVar().d_castTo<Euler3DVarSet>())->getModel()->getR();
  const CFreal aInnerState = sqrt(gamma*R*(*innerState)[4]); 
