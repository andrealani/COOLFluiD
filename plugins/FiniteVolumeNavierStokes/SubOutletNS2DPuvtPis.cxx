...
#include "FiniteVolumeNavierStokes/SubOutletNS2DPuvtPis.hh"
...
MethodCommandProvider<SubOutletNS2DPuvtPis, CellCenterFVMData, FiniteVolumeNavierStokesModule>
subOutletNS2DPuvtPisFVMCCProvider("SubOutletNS2DPuvtPisFVMCC");

//////////////////////////////////////////////////////////////////////////////

void SubOutletNS2DPuvtPis::defineConfigOptions(Config::OptionList& options)
{
...
SubOutletNS2DPuvtPis::SubOutletNS2DPuvtPis(const std::string& name) :
  FVMCC_BC(name)
{
...
SubOutletNS2DPuvtPis::~SubOutletNS2DPuvtPis()
{
}

//////////////////////////////////////////////////////////////////////////////

void SubOutletNS2DPuvtPis::setGhostState(GeometricEntity *const face)
{
  ...
  if(M_normal_isoentropic<1.0){
    ...
    const CFreal damping_factor = 10;
...
void SubOutletNS2DPuvtPis::setup()
{
