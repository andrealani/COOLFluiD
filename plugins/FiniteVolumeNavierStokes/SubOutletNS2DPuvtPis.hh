 ...
 *
 */
class SubOutletNS2DPuvtPis : public FVMCC_BC {
public:
   ...
   * Constructor
   */
  SubOutletNS2DPuvtPis(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~SubOutletNS2DPuvtPis();
...
}; // end of class SubOutletNS2DPuvtPis
...
#endif // COOLFluiD_Numerics_FiniteVolume_SubOutletNS2DPuvtPis_hh
