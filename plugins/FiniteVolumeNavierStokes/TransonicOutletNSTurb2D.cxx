...
#include "FiniteVolumeNavierStokes/TransonicOutletNSTurb2D.hh"
...
MethodCommandProvider<TransOutletNSTurb2D, CellCenterFVMData, FiniteVolumeNavierStokesModule> transOutletNSTurb2DFVMCCProvider("TransOutletNSTurb2DFVMCC");

//////////////////////////////////////////////////////////////////////////////

void TransOutletNSTurb2D::defineConfigOptions(Config::OptionList& options)
{
...
TransOutletNSTurb2D::TransOutletNSTurb2D(const std::string& name) :
  FVMCC_BC(name),
  _varSetTurb(CFNULL),
  _dataInnerState(),
  _dataGhostState()
...
TransOutletNSTurb2D::~TransOutletNSTurb2D()
{
}

//////////////////////////////////////////////////////////////////////////////

void TransOutletNSTurb2D::setGhostState(GeometricEntity *const face)
{
  ...
  ///@todo this works only for vertical outlet, normal Mach number needed
  const CFreal OutletVelocity = _dataInnerState[EulerTerm::VX];
  const CFreal OutletSoundSpeed = sqrt( _varSetTurb->getModel()->getGamma()*
				       _dataInnerState[EulerTerm::P]/
				       _dataInnerState[EulerTerm::RHO] );
  const CFreal OutletMach = OutletVelocity/OutletSoundSpeed ;
...
void TransOutletNSTurb2D::setup()
{
  CFAUTOTRACE;
