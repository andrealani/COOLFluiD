#ifndef COOLFluiD_Numerics_FiniteVolume_AUSMPlusUpFlux_Mp_hh
#define COOLFluiD_Numerics_FiniteVolume_AUSMPlusUpFlux_Mp_hh
...
class AUSMPlusUpFlux_Mp : public AUSMFlux<UPDATEVAR> {
public:
  
  /**
   * Constructor
   */
  AUSMPlusUpFlux_Mp(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~AUSMPlusUpFlux_Mp();
...
}; // end of class AUSMPlusUpFlux_Mp
...
#include "AUSMPlusUpFlux_Mp.ci"

//////////////////////////////////////////////////////////////////////////////

#endif // COOLFluiD_Numerics_FiniteVolume_AUSMPlusUpFlux_Mp_hh
