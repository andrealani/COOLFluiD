...
#include "FiniteVolumeNavierStokes/SubOutletNS2DPuvtMis.hh"
...
MethodCommandProvider<SubOutletNS2DPuvtMis, CellCenterFVMData, FiniteVolumeNavierStokesModule>
subOutletNS2DPuvtMisFVMCCProvider("SubOutletNS2DPuvtMisFVMCC");

//////////////////////////////////////////////////////////////////////////////

void SubOutletNS2DPuvtMis::defineConfigOptions(Config::OptionList& options)
{
...
SubOutletNS2DPuvtMis::SubOutletNS2DPuvtMis(const std::string& name) :
  FVMCC_BC(name)
{
...
SubOutletNS2DPuvtMis::~SubOutletNS2DPuvtMis()
{
}

//////////////////////////////////////////////////////////////////////////////

void SubOutletNS2DPuvtMis::setGhostState(GeometricEntity *const face)
{
  ...
  if(M_normal_isoentropic<1.0){
    ...
    const CFreal damping_factor = 4;
    const CFreal damping = abs(pow((1 - abs(ratio_ave - 1)),damping_factor));
    ...
    std::cout <<" M_is:  " <<M_is  <<" M_average_inner:  " <<M_average_inner <<std::endl;
...
void SubOutletNS2DPuvtMis::setup()
{
