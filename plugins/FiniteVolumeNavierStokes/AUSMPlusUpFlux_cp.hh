#ifndef COOLFluiD_Numerics_FiniteVolume_AUSMPlusUpFlux_cp_hh
#define COOLFluiD_Numerics_FiniteVolume_AUSMPlusUpFlux_cp_hh
...
class AUSMPlusUpFlux_cp : public AUSMFlux<UPDATEVAR> {
public:
  
  /**
   * Constructor
   */
  AUSMPlusUpFlux_cp(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~AUSMPlusUpFlux_cp();
...
}; // end of class AUSMPlusUpFlux_cp
...
#include "AUSMPlusUpFlux_cp.ci"

//////////////////////////////////////////////////////////////////////////////

#endif // COOLFluiD_Numerics_FiniteVolume_AUSMPlusUpFlux_cp_hh
