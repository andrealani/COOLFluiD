...
#include "FiniteVolumeNavierStokes/NoSlipWallIsothermalNS3D.hh"
...
MethodCommandProvider<NoSlipWallIsothermalNS3D, CellCenterFVMData, FiniteVolumeNavierStokesModule> noSlipWallIsothermalNS3DFVMCCProvider("NoSlipWallIsothermalNS3DFVMCC");

//////////////////////////////////////////////////////////////////////////////

void NoSlipWallIsothermalNS3D::defineConfigOptions(Config::OptionList& options)
{
...
NoSlipWallIsothermalNS3D::NoSlipWallIsothermalNS3D(const std::string& name) :
  FVMCC_BC(name),
  _varSet(CFNULL),
  _dataInnerState(),
  _dataGhostState(),
...
NoSlipWallIsothermalNS3D::~NoSlipWallIsothermalNS3D()
{
}

//////////////////////////////////////////////////////////////////////////////

void NoSlipWallIsothermalNS3D::setup()
{
  FVMCC_BC::setup();
...
void NoSlipWallIsothermalNS3D::setGhostState(GeometricEntity *const face)
{
  ...
  const CFreal innerT = _dataInnerState[EulerTerm::P]/(R*_dataInnerState[EulerTerm::RHO]);
  ...
  _dataGhostState[EulerTerm::VZ] = -_dataInnerState[EulerTerm::VZ]/factor;
