...
void SubOutletEuler2DPuvtMisMPI::setGhostState(GeometricEntity *const face)
{
  ...
  const CFreal aInnerState = sqrt(gamma*R*(*innerState)[3]); //didn't shoul be "const CFreal aInnerState ..." ?
  ...
  if(M_normal_isoentropic<1.0){
    ...
    const CFreal P_average_inner = _Tot_P_sum/_Tot_N_adds;
    //const CFreal P_average_inner = _P_sum/n_adds;
