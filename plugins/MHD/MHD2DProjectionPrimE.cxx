#include "MHD/MHD.hh"
#include "MHD2DProjectionPrimE.hh"
...
//////////////////////////////////////////////////////////////////////////////
		...
		Environment::ObjectProvider<MHD2DProjectionPrimE, ConvectiveVarSet, MHDModule, 1>
			mhd2DProjectionPrimEProvider("MHD2DProjectionPrimE");

		//////////////////////////////////////////////////////////////////////////////

		MHD2DProjectionPrimE::MHD2DProjectionPrimE(Common::SafePtr<Framework::BaseTerm> term) :
			MHD2DProjectionPrim(term)
		{
		}

		//////////////////////////////////////////////////////////////////////////////

		MHD2DProjectionPrimE::~MHD2DProjectionPrimE()
		{
		}

		//////////////////////////////////////////////////////////////////////////////

		void MHD2DProjectionPrimE::setup()
		{
		...
		vector<std::string> MHD2DProjectionPrimE::getExtraVarNames() const
		{
			return MHD2DProjectionPrim::getExtraVarNames();
		}

		//////////////////////////////////////////////////////////////////////////////

		void MHD2DProjectionPrimE::computeJacobians()
		{
			throw Common::NotImplementedException(FromHere(), "MHD2DProjectionPrimE::computeJacobians()");
		}

		//////////////////////////////////////////////////////////////////////////////

		void MHD2DProjectionPrimE::computeEigenValuesVectors(RealMatrix& rightEv,
			RealMatrix& leftEv,
			RealVector& eValues,
			const RealVector& normal)
		{
			throw Common::NotImplementedException(FromHere(), "MHD2DProjectionPrimE::computeEigenValuesVectors()");
		}

		//////////////////////////////////////////////////////////////////////////////

		void MHD2DProjectionPrimE::setDimensionalValuesPlusExtraValues(const State& state,
			RealVector& result,
			RealVector& extra)
		{
			MHD2DProjectionPrim::setDimensionalValuesPlusExtraValues(state, result, extra);
		...
		void MHD2DProjectionPrimE::splitJacobian(RealMatrix& jacobPlus,
			RealMatrix& jacobMin,
			RealVector& eValues,
			const RealVector& normal)
		{
			throw Common::NotImplementedException(FromHere(), "MHD2DProjectionPrimE::splitJacobian()");
		}
		...
		void MHD2DProjectionPrimE::computeStateFromPhysicalData(const RealVector& data,
			State& state)
		{
		...
		void MHD2DProjectionPrimE::computeFlux(const RealVector& data,
		...
		void MHD2DProjectionPrimE::computeStateFlux(const RealVector& data)
		{
			throw Common::NotImplementedException(FromHere(), "MHD2DProjectionPrimE::computeStateFlux()");
		}

		//////////////////////////////////////////////////////////////////////////////

		void MHD2DProjectionPrimE::computeEigenValues(const RealVector& data,
			const RealVector& normal,
			RealVector& result)
		{
		...
		CFreal MHD2DProjectionPrimE::getMaxEigenValue(const RealVector& data,
			const RealVector& normal)
		{
			// Haopeng: check this
			const CFreal Bx0 = 0.0, By0 = 0.0, Bz0 = 0.0;
		...
		CFreal MHD2DProjectionPrimE::getMaxAbsEigenValue(const RealVector& data,
			const RealVector& normal)
		{
			// Haopeng: check this
			const CFreal Bx0 = 0.0, By0 = 0.0, Bz0 = 0.0;
