...
Environment::ObjectProvider<MHD3DLinearCons, JacobianLinearizer, MHDModule, 1> mhd3DLinearConsProvider("MHD3DLinearCons");

//////////////////////////////////////////////////////////////////////////////

MHD3DLinearCons::MHD3DLinearCons(Common::SafePtr<Framework::PhysicalModel> model) :
...
MHD3DLinearCons::~MHD3DLinearCons()
{
}

//////////////////////////////////////////////////////////////////////////////

void MHD3DLinearCons::linearize(const std::vector<State*>& statesInCell)
{
