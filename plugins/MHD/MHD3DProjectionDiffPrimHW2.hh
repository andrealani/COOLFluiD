#ifndef COOLFluiD_Physics_MHD_MHD3DProjectionDiffPrimHW2_hh
#define COOLFluiD_Physics_MHD_MHD3DProjectionDiffPrimHW2_hh
...
//////////////////////////////////////////////////////////////////////////////
   ...
   * @author Andrea Lani
   */
class MHD3DProjectionDiffPrimHW2 : public MHD3DProjectionDiffVarSet {
public: // classes
   ...
   */
  MHD3DProjectionDiffPrimHW2(const std::string& name, Common::SafePtr<Framework::PhysicalModelImpl> model);

  /**
   * Default destructor
   */
  virtual ~MHD3DProjectionDiffPrimHW2();
...
}; // end of class MHD3DProjectionDiffPrimHW2
...
#endif // COOLFluiD_Physics_MHD_MHD3DProjectionDiffPrimHW2_hh
