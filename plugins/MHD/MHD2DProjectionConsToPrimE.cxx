#include "MHD/MHD.hh"
#include "MHD2DProjectionConsToPrimE.hh"
...
Environment::ObjectProvider<MHD2DProjectionConsToPrimE, VarSetTransformer, MHDModule, 1> mhd2DProjectionConsToPrimEProvider("MHD2DProjectionConsToPrimE");

//////////////////////////////////////////////////////////////////////////////

MHD2DProjectionConsToPrimE::MHD2DProjectionConsToPrimE(Common::SafePtr<Framework::PhysicalModelImpl> model) :
...
MHD2DProjectionConsToPrimE::~MHD2DProjectionConsToPrimE()
{
}

//////////////////////////////////////////////////////////////////////////////

void MHD2DProjectionConsToPrimE::transform(const State& state, 
					  State& result)
{
  ...
  const CFreal p = gammaMinus1 * (state[7] - 0.5*(rho*(u*u + v*v + w*w)));
...
void MHD2DProjectionConsToPrimE::transformFromRef(const RealVector& data, State& result)
{
