#include "MHD/MHD.hh"
#include "MHD3DProjectionConsToPrim.hh"
...
Environment::ObjectProvider<MHD3DProjectionConsToPrim, VarSetTransformer, MHDModule, 1> mhd3DProjectionConsToPrimProvider("MHD3DProjectionConsToPrim");

//////////////////////////////////////////////////////////////////////////////

MHD3DProjectionConsToPrim::MHD3DProjectionConsToPrim(Common::SafePtr<Framework::PhysicalModelImpl> model) :
...
MHD3DProjectionConsToPrim::~MHD3DProjectionConsToPrim()
{
}

//////////////////////////////////////////////////////////////////////////////

void MHD3DProjectionConsToPrim::transform(const State& state, State& result)
{
...
void MHD3DProjectionConsToPrim::transformFromRef(const RealVector& data, 
						 State& result) 
{
