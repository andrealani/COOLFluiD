...
MHD3DProjectionEpsDiffPrim::MHD3DProjectionEpsDiffPrim(const std::string& name,
  ...
  _eulerModel(model->getConvectiveTerm().d_castTo<MHDProjectionEpsTerm>()),
  _tempX()
{
...
void MHD3DProjectionEpsDiffPrim::setGradientVars(const vector<RealVector*>& states,
					      RealMatrix& values,
...
void MHD3DProjectionEpsDiffPrim::setGradientVarGradients(const vector<RealVector*>& states,
						      const vector< vector<RealVector*> >& stateGradients,
						      vector< vector<RealVector*> >& gradVarGradients,
						      const CFuint stateSize)
{
 throw Common::NotImplementedException
   (FromHere(), "MHD3DProjectionEpsDiffPrim::setGradientVarGradients()");
}
      
//////////////////////////////////////////////////////////////////////////////

void MHD3DProjectionEpsDiffPrim::setStateGradients(const vector<RealVector*>& states,
						...
						const CFuint stateSize)
{
  /// PETER
  throw Common::NotImplementedException
   (FromHere(), "MHD3DProjectionEpsDiffPrim::setStateGradients()");
}

//////////////////////////////////////////////////////////////////////////////

CFreal MHD3DProjectionEpsDiffPrim::getDynViscosity(const RealVector& state,
						const vector<RealVector*>& gradients)
{
  throw Common::NotImplementedException
    (FromHere(), "MHD3DProjectionEpsDiffPrim::getDynViscosity()");
  return 0;
}

//////////////////////////////////////////////////////////////////////////////

CFreal MHD3DProjectionEpsDiffPrim::getDensity(const RealVector& state)
{  
  return state[0];
}
...
void MHD3DProjectionEpsDiffPrim::setGradientState(const RealVector& state)
{
  /// PETER
...
void MHD3DProjectionEpsDiffPrim::computeFluxJacobian(const RealVector& state,
...
{
  throw Common::NotImplementedException
    (FromHere(), "MHD3DProjectionEpsDiffPrim::computeFluxJacobian()");
}

//////////////////////////////////////////////////////////////////////////////

void MHD3DProjectionEpsDiffPrim::setComposition(const RealVector& state,
