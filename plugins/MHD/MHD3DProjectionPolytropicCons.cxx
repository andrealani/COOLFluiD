...
#include "MHD/MHD3DProjectionPolytropicCons.hh"
...
Environment::ObjectProvider<MHD3DProjectionPolytropicCons, ConvectiveVarSet, MHDModule, 1> 
mhd3DProjectionPolytropicConsProvider("MHD3DProjectionPolytropicCons");

//////////////////////////////////////////////////////////////////////////////

MHD3DProjectionPolytropicCons::MHD3DProjectionPolytropicCons(Common::SafePtr<Framework::BaseTerm> term) :
...
MHD3DProjectionPolytropicCons::~MHD3DProjectionPolytropicCons()
{
}

//////////////////////////////////////////////////////////////////////////////

void MHD3DProjectionPolytropicCons::setup()
{
...
vector<std::string> MHD3DProjectionPolytropicCons::getExtraVarNames() const
{
...
void MHD3DProjectionPolytropicCons::computeJacobians()
{
  throw Common::NotImplementedException (FromHere(),"MHD3DProjectionPolytropicCons::computeJacobians()");
}

//////////////////////////////////////////////////////////////////////////////

void MHD3DProjectionPolytropicCons::setDimensionalValuesPlusExtraValues(const State& state,
                                                              RealVector& result,
                                                              RealVector& extra)
{
...
CFuint MHD3DProjectionPolytropicCons::getBlockSeparator() const
{
...
void MHD3DProjectionPolytropicCons::computePhysicalData(const State& state,
					      RealVector& data)
{
  const CFreal rho = state[0];
...
void MHD3DProjectionPolytropicCons::computeStateFromPhysicalData(const RealVector& data,
						  State& state)
{
  state[0] = data[MHDProjectionPolytropicTerm::RHO];
  state[1] = data[MHDProjectionPolytropicTerm::RHO]*data[MHDProjectionPolytropicTerm::VX];
  state[2] = data[MHDProjectionPolytropicTerm::RHO]*data[MHDProjectionPolytropicTerm::VY];
  state[3] = data[MHDProjectionPolytropicTerm::RHO]*data[MHDProjectionPolytropicTerm::VZ];
