#include "MHD/MHD.hh"
#include "MHD2DProjectionPrimEToCons.hh"
...
Environment::ObjectProvider<MHD2DProjectionPrimEToCons, VarSetTransformer, MHDModule, 1> 
mhd2DProjectionPrimEToConsProvider("MHD2DProjectionPrimEToCons");

//////////////////////////////////////////////////////////////////////////////

MHD2DProjectionPrimEToCons::MHD2DProjectionPrimEToCons(Common::SafePtr<Framework::PhysicalModelImpl> model) :
...
MHD2DProjectionPrimEToCons::~MHD2DProjectionPrimEToCons()
{
}

//////////////////////////////////////////////////////////////////////////////

void MHD2DProjectionPrimEToCons::transform(const State& state, State& result)
{
...
void MHD2DProjectionPrimEToCons::transformFromRef(const RealVector& data, 
						 State& result) 
{   
  const CFreal gammaMinus1 = _model->getGamma() - 1.;
