#ifndef COOLFluiD_Physics_MHD_MHD3DProjectionCons_hh
#define COOLFluiD_Physics_MHD_MHD3DProjectionCons_hh
 ...
 */
class MHD3DProjectionCons : public MHD3DProjectionVarSet {
public: // classes
   ...
   * @see MHD3DProjection
   */
  MHD3DProjectionCons(Common::SafePtr<Framework::BaseTerm> term);
...
}; // end of class MHD3DProjectionCons
...
#endif // COOLFluiD_Physics_MHD_MHD3DProjectionCons_hh
