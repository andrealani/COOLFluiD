#include "MHD/MHD.hh"
#include "MHD3DProjectionPrimToConsInRef.hh"
...
Environment::ObjectProvider<MHD3DProjectionPrimToConsInRef, VarSetMatrixTransformer, MHDModule, 1> mhd3DProjectionPrimToConsInRefProvider("MHD3DProjectionPrimToConsInRef");

//////////////////////////////////////////////////////////////////////////////

MHD3DProjectionPrimToConsInRef::MHD3DProjectionPrimToConsInRef(Common::SafePtr<Framework::PhysicalModelImpl> model) :
...
MHD3DProjectionPrimToConsInRef::~MHD3DProjectionPrimToConsInRef()
{
}

//////////////////////////////////////////////////////////////////////////////

void MHD3DProjectionPrimToConsInRef::setMatrixFromRef()
{
