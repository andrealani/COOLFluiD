#ifndef COOLFluiD_Physics_MHD_MHD2DProjectionCons_hh
#define COOLFluiD_Physics_MHD_MHD2DProjectionCons_hh
 ...
 */
class MHD2DProjectionCons : public MHD2DProjectionVarSet {
public: // function
   ...
   * @see MHD2DProjection
   */
  MHD2DProjectionCons(Common::SafePtr<Framework::BaseTerm> term);
...
}; // end of class MHD2DProjectionCons
...
#endif // COOLFluiD_Physics_MHD_MHD2DProjectionCons_hh
