#include "MHD/MHD.hh"
#include "MHD/MHD3DProjectionDiffPrimHW2.hh"
...
Environment::ObjectProvider<MHD3DProjectionDiffPrimHW2, DiffusiveVarSet, MHDModule, 2> 
mhd3DProjectionDiffPrimHW2Provider("MHD3DProjectionDiffPrimHW2");
      
//////////////////////////////////////////////////////////////////////////////

MHD3DProjectionDiffPrimHW2::MHD3DProjectionDiffPrimHW2(const std::string& name,
...
MHD3DProjectionDiffPrimHW2::~MHD3DProjectionDiffPrimHW2()
{
}

//////////////////////////////////////////////////////////////////////////////

void MHD3DProjectionDiffPrimHW2::setGradientVars(const vector<RealVector*>& states,
						RealMatrix& values,
...
void MHD3DProjectionDiffPrimHW2::setGradientVarGradients(const vector<RealVector*>& states,
						      const vector< vector<RealVector*> >& stateGradients,
						      vector< vector<RealVector*> >& gradVarGradients,
						      const CFuint stateSize)
{
 throw Common::NotImplementedException
   (FromHere(), "MHD3DProjectionDiffPrimHW2::setGradientVarGradients()");
}
      
//////////////////////////////////////////////////////////////////////////////

void MHD3DProjectionDiffPrimHW2::setStateGradients(const vector<RealVector*>& states,
						...
						const CFuint stateSize)
{
  /// PETER
  throw Common::NotImplementedException
   (FromHere(), "MHD3DProjectionDiffPrimHW2::setStateGradients()");
}

//////////////////////////////////////////////////////////////////////////////

CFreal MHD3DProjectionDiffPrimHW2::getDynViscosity(const RealVector& state,
						const vector<RealVector*>& gradients)
{
  throw Common::NotImplementedException
    (FromHere(), "MHD3DProjectionDiffPrimHW2::getDynViscosity()");
  return 0;
}

//////////////////////////////////////////////////////////////////////////////

CFreal MHD3DProjectionDiffPrimHW2::getDensity(const RealVector& state)
{
  //throw Common::NotImplementedException
  //  (FromHere(), "MHD3DProjectionDiffPrimHW2::getDensity()");
  //return 0;
  return state[0];
}
...
void MHD3DProjectionDiffPrimHW2::setGradientState(const RealVector& state)
{
...
void MHD3DProjectionDiffPrimHW2::computeFluxJacobian(const RealVector& state,
...
{
  throw Common::NotImplementedException
    (FromHere(), "MHD3DProjectionDiffPrimHW2::computeFluxJacobian()");
}

//////////////////////////////////////////////////////////////////////////////

void MHD3DProjectionDiffPrimHW2::setComposition(const RealVector& state,
...
RealVector& MHD3DProjectionDiffPrimHW2::getFlux(const RealVector& state,
					       const vector<RealVector*>& gradients,
					       const RealVector& normal,
					       const CFreal& radius)
{
