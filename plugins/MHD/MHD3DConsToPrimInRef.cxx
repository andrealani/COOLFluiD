#include "MHD/MHD.hh"
#include "MHD3DConsToPrimInRef.hh"
...
Environment::ObjectProvider<MHD3DConsToPrimInRef, VarSetMatrixTransformer, MHDModule, 1> mhd3DConsToPrimInRefProvider("MHD3DConsToPrimInRef");

//////////////////////////////////////////////////////////////////////////////

MHD3DConsToPrimInRef::MHD3DConsToPrimInRef(Common::SafePtr<Framework::PhysicalModelImpl> model) :
...
MHD3DConsToPrimInRef::~MHD3DConsToPrimInRef()
{
}

//////////////////////////////////////////////////////////////////////////////

void MHD3DConsToPrimInRef::setMatrixFromRef()
{
