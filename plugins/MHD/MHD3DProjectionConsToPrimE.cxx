#include "MHD/MHD.hh"
#include "MHD3DProjectionConsToPrimE.hh"
...
Environment::ObjectProvider<MHD3DProjectionConsToPrimE, VarSetTransformer, MHDModule, 1> mhd3DProjectionConsToPrimEProvider("MHD3DProjectionConsToPrimE");

//////////////////////////////////////////////////////////////////////////////

MHD3DProjectionConsToPrimE::MHD3DProjectionConsToPrimE(Common::SafePtr<Framework::PhysicalModelImpl> model) :
...
MHD3DProjectionConsToPrimE::~MHD3DProjectionConsToPrimE()
{
}

//////////////////////////////////////////////////////////////////////////////

void MHD3DProjectionConsToPrimE::transform(const State& state, State& result)
{
...
void MHD3DProjectionConsToPrimE::transformFromRef(const RealVector& data, 
						 State& result) 
{
