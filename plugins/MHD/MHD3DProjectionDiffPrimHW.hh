#ifndef COOLFluiD_Physics_MHD_MHD3DProjectionDiffPrimHW_hh
#define COOLFluiD_Physics_MHD_MHD3DProjectionDiffPrimHW_hh
...
//////////////////////////////////////////////////////////////////////////////
   ...
   * @author Andrea Lani
   */
class MHD3DProjectionDiffPrimHW : public MHD3DProjectionDiffVarSet {
public: // classes
   ...
   */
  MHD3DProjectionDiffPrimHW(const std::string& name, Common::SafePtr<Framework::PhysicalModelImpl> model);

  /**
   * Default destructor
   */
  virtual ~MHD3DProjectionDiffPrimHW();
...
}; // end of class MHD3DProjectionDiffPrimHW
...
#endif // COOLFluiD_Physics_MHD_MHD3DProjectionDiffPrimHW_hh
