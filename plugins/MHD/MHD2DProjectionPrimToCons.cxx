#include "MHD/MHD.hh"
#include "MHD2DProjectionPrimToCons.hh"
...
Environment::ObjectProvider<MHD2DProjectionPrimToCons, VarSetTransformer, MHDModule, 1> 
mhd2DProjectionPrimToConsProvider("MHD2DProjectionPrimToCons");

//////////////////////////////////////////////////////////////////////////////

MHD2DProjectionPrimToCons::MHD2DProjectionPrimToCons(Common::SafePtr<Framework::PhysicalModelImpl> model) :
...
MHD2DProjectionPrimToCons::~MHD2DProjectionPrimToCons()
{
}

//////////////////////////////////////////////////////////////////////////////

void MHD2DProjectionPrimToCons::transform(const State& state, State& result)
{
...
void MHD2DProjectionPrimToCons::transformFromRef(const RealVector& data, 
						 State& result) 
{   
  const CFreal gammaMinus1 = _model->getGamma() - 1.;
