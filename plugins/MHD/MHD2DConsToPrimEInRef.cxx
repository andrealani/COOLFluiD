#include "MHD/MHD.hh"
#include "MHD2DConsToPrimEInRef.hh"
#include "MHDTerm.hh"
...
Environment::ObjectProvider<MHD2DConsToPrimEInRef, VarSetMatrixTransformer, MHDModule, 1> mhd2DConsToPrimEInRefProvider("MHD2DConsToPrimEInRef");

//////////////////////////////////////////////////////////////////////////////

MHD2DConsToPrimEInRef::MHD2DConsToPrimEInRef(Common::SafePtr<Framework::PhysicalModelImpl> model) :
...
MHD2DConsToPrimEInRef::~MHD2DConsToPrimEInRef()
{
}

//////////////////////////////////////////////////////////////////////////////

void MHD2DConsToPrimEInRef::setMatrixFromRef()
{
