...
Environment::ObjectProvider<MHD3DPrimToCons, VarSetTransformer, MHDModule, 1> 
mhd3DPrimToConsProvider("MHD3DPrimToCons");

//////////////////////////////////////////////////////////////////////////////

MHD3DPrimToCons::MHD3DPrimToCons(Common::SafePtr<Framework::PhysicalModelImpl> model) :
...
MHD3DPrimToCons::~MHD3DPrimToCons()
{
}

//////////////////////////////////////////////////////////////////////////////

void MHD3DPrimToCons::transform(const State& state, State& result)
{
...
void MHD3DPrimToCons::transformFromRef(const RealVector& data, 
						 State& result) 
{
  const CFreal gammaMinus1 = _model->getGamma() - 1.;
