#include "MHD/MHD.hh"
#include "MHD3DProjectionLinearPrim.hh"
...
Environment::ObjectProvider<MHD3DProjectionLinearPrim, JacobianLinearizer, MHDModule, 1> mhd3DProjectionLinearPrimProvider("MHD3DProjectionLinearPrim");

//////////////////////////////////////////////////////////////////////////////

MHD3DProjectionLinearPrim::MHD3DProjectionLinearPrim(Common::SafePtr<Framework::PhysicalModel> model) :
...
MHD3DProjectionLinearPrim::~MHD3DProjectionLinearPrim()
{
}

//////////////////////////////////////////////////////////////////////////////

void MHD3DProjectionLinearPrim::linearize(const std::vector<State*>&
                                          statesInCell)
{
