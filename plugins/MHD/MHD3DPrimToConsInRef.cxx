#include "MHD/MHD.hh"
#include "MHD3DPrimToConsInRef.hh"
...
Environment::ObjectProvider<MHD3DPrimToConsInRef, VarSetMatrixTransformer, MHDModule, 1> mhd3DPrimToConsInRefProvider("MHD3DPrimToConsInRef");

//////////////////////////////////////////////////////////////////////////////

MHD3DPrimToConsInRef::MHD3DPrimToConsInRef(Common::SafePtr<Framework::PhysicalModelImpl> model) :
...
MHD3DPrimToConsInRef::~MHD3DPrimToConsInRef()
{
}

//////////////////////////////////////////////////////////////////////////////

void MHD3DPrimToConsInRef::setMatrixFromRef()
{
