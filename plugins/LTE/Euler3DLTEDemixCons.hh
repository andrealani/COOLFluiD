#ifndef COOLFluiD_Physics_LTE_Euler3DLTEDemixCons_hh
#define COOLFluiD_Physics_LTE_Euler3DLTEDemixCons_hh
...
//////////////////////////////////////////////////////////////////////////////
   ...
   * @author Janos Molnar
   */
class Euler3DLTEDemixCons : public 
NavierStokes::MultiScalarVarSet<NavierStokes::Euler3DVarSet> {
...
public: // classes
   ...
   * @see Euler3D
   */
  Euler3DLTEDemixCons(Common::SafePtr<Framework::BaseTerm> term);
...
}; // end of class Euler3DLTEDemixCons
...
#endif // COOLFluiD_Physics_LTE_Euler3DLTEDemixCons_hh
