#ifndef COOLFluiD_Physics_Maxwell_Maxwell2DProjectionAdimCons_hh
#define COOLFluiD_Physics_Maxwell_Maxwell2DProjectionAdimCons_hh
 ...
 * @author Andrea Lani
 */
class Maxwell2DProjectionAdimCons : public Maxwell2DProjectionAdimVarSet {
public: // function

  /**
   * Constructor
   * @see MaxwellProjectionAdim
   */
  Maxwell2DProjectionAdimCons(Common::SafePtr<Framework::BaseTerm> term);

  /**
   * Default destructor
   */
  ~Maxwell2DProjectionAdimCons();
...
}; // end of class Maxwell2DProjectionAdimCons
...
#endif // COOLFluiD_Physics_Maxwell_Maxwell2DProjectionAdimCons_hh
