#ifndef COOLFluiD_Physics_Maxwell_Maxwell2DVarSetAdim_hh
#define COOLFluiD_Physics_Maxwell_Maxwell2DVarSetAdim_hh
...
/**
 * This class represents a variable set for a 2D Maxwell physical model for Adimensional equations.
 *
 * @author Alejandro Alvarez Laguna
 * @author Andrea Lani
 */
class Maxwell2DVarSetAdim : public MaxwellVarSet {
public: // classes
  
  typedef Maxwell2DVarSetAdim EULERSET;
  
  /**
   * Constructor
   * @see MaxwellPhysicalModel
   */
  Maxwell2DVarSetAdim(Common::SafePtr<Framework::BaseTerm> term);

  /**
   * Default destructor
   */
  virtual ~Maxwell2DVarSetAdim();
  ...
  virtual void setup()
  {
    std::cout << "Maxwell2DVarSetAdim::setup()/n";
    Framework::ConvectiveVarSet::setup();
    
    // set EquationSetData
    Maxwell2DVarSetAdim::getEqSetData().resize(1);
    Maxwell2DVarSetAdim::getEqSetData()[0].setup(0,0,6);   
  }
...
}; // end of class Maxwell2DVarSetAdim
...
#endif // COOLFluiD_Physics_Maxwell_Maxwell2DVarSetAdim_hh
