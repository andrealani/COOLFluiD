#ifndef COOLFluiD_Physics_Maxwell_Maxwell2DAdimCons_hh
#define COOLFluiD_Physics_Maxwell_Maxwell2DAdimCons_hh
 ...
 * @author Andrea Lani
 */
class Maxwell2DAdimCons : public Maxwell2DVarSetAdim {
public: // function
   ...
   * @see Maxwell Adim
   */
  Maxwell2DAdimCons(Common::SafePtr<Framework::BaseTerm> term);
...
}; // end of class Maxwell2DAdimCons
...
#endif // COOLFluiD_Physics_Maxwell_Maxwell2DAdimCons_hh
