#ifndef COOLFluiD_Physics_Maxwell_Maxwell2DProjectionCons_hh
#define COOLFluiD_Physics_Maxwell_Maxwell2DProjectionCons_hh
 ...
 * @author Andrea Lani
 */
class Maxwell2DProjectionCons : public Maxwell2DProjectionVarSet {
public: // function
   ...
   */
  Maxwell2DProjectionCons(Common::SafePtr<Framework::BaseTerm> term);

  /**
   * Default destructor
   */
  ~Maxwell2DProjectionCons();
...
}; // end of class Maxwell2DProjectionCons
...
#endif // COOLFluiD_Physics_Maxwell_Maxwell2DProjectionCons_hh
