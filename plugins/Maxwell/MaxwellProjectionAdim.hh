#ifndef COOLFluiD_Physics_Maxwell_MaxwellProjectionAdim_hh
#define COOLFluiD_Physics_Maxwell_MaxwellProjectionAdim_hh
...
/**
 * This class represents the interface for a MaxwellProjectionAdim.
 *
...
template <int DIM>
class MaxwellProjectionAdim : public Framework::ConvectionPM<MaxwellProjectionAdimTerm> {
...
public:
   ...
   */
  MaxwellProjectionAdim(const std::string& name);

  /**
   * Default destructor
   */
  ~MaxwellProjectionAdim();
  ...
  {
    return std::string("Maxwell" + Common::StringOps::to_str(DIM) + "DProjectionAdim");
  }
...
}; // end of class MaxwellProjectionAdim
...
#include "MaxwellProjectionAdim.ci"

//////////////////////////////////////////////////////////////////////////////

#endif // COOLFluiD_Physics_Maxwell_MaxwellProjectionAdim_hh
