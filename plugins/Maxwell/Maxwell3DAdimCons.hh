#ifndef COOLFluiD_Physics_Maxwell_Maxwell3DAdimCons_hh
#define COOLFluiD_Physics_Maxwell_Maxwell3DAdimCons_hh
...
/**
 * This class represents a Maxwell physical model 3D 
 * for conservative variables
 *
 * @author Alejandro Alvarez Laguna
 * 
 */
class Maxwell3DAdimCons : public Maxwell3DVarSetAdim {
public: // function
   ...
   * @see Maxwell Adim
   */
  Maxwell3DAdimCons(Common::SafePtr<Framework::BaseTerm> term);
...
}; // end of class Maxwell3DAdimCons
...
#endif // COOLFluiD_Physics_Maxwell_Maxwell3DAdimCons_hh
