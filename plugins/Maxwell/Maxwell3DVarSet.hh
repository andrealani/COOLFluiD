#ifndef COOLFluiD_Physics_Maxwell_Maxwell3DVarSet_hh
#define COOLFluiD_Physics_Maxwell_Maxwell3DVarSet_hh
...
/**
 * This class represents a variable set for a 3D Maxwell physical model.
 *
 * @author Andrea Lani
 */
class Maxwell3DVarSet : public MaxwellVarSet {
public: // classes
  
  typedef Maxwell3DVarSet EULERSET;
  
  /**
   * Constructor
   * @see MaxwellPhysicalModel
   */
  Maxwell3DVarSet(Common::SafePtr<Framework::BaseTerm> term);

  /**
   * Default destructor
   */
  virtual ~Maxwell3DVarSet();
...
#endif // COOLFluiD_Physics_Maxwell_Maxwell3DVarSet_hh
