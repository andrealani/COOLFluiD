#ifndef COOLFluiD_SpectralFD_SpectralFDBuilder_hh
#define COOLFluiD_SpectralFD_SpectralFDBuilder_hh
 ...
 * @see MeshDataBuilder
 */
class SpectralFDBuilder : public Framework::MeshDataBuilder {
...
public: // functions
   ...
   */
  SpectralFDBuilder(const std::string& name);
...
};  // end of class SpectralFDBuilder
...
#endif  // COOLFluiD_SpectralFD_SpectralFDBuilder_hh
