...
MethodCommandProvider<ConvVolTermRHSSpectralFD, SpectralFDMethodData, SpectralFDModule> ConvVolTermRHSSpectralFDProvider("ConvVolTermRHS");

//////////////////////////////////////////////////////////////////////////////

ConvVolTermRHSSpectralFD::ConvVolTermRHSSpectralFD(const std::string& name) :
...
ConvVolTermRHSSpectralFD::~ConvVolTermRHSSpectralFD()
{
}

//////////////////////////////////////////////////////////////////////////////

void ConvVolTermRHSSpectralFD::defineConfigOptions(Config::OptionList& options)
{
}

//////////////////////////////////////////////////////////////////////////////

void ConvVolTermRHSSpectralFD::configure ( Config::ConfigArgs& args )
{
...
void ConvVolTermRHSSpectralFD::execute()
{
  CFTRACEBEGIN;
...
void ConvVolTermRHSSpectralFD::setVolumeTermData()
{
...
void ConvVolTermRHSSpectralFD::resizeResAndGradUpdates()
{
  // get the local spectral FD data
  vector< SpectralFDElementData* >& sdLocalData = getMethodData().getSDLocalData();
...
void ConvVolTermRHSSpectralFD::updateRHS()
{
...
void ConvVolTermRHSSpectralFD::computeGradients()
{
...
void ConvVolTermRHSSpectralFD::addGradVolTermsAndDivideByJacobDet()
{
  // get the gradients
  DataHandle< vector< RealVector > > gradients = socket_gradients.getDataHandle();
...
void ConvVolTermRHSSpectralFD::setup()
{
  CFAUTOTRACE;
...
void ConvVolTermRHSSpectralFD::unsetup()
{
  CFAUTOTRACE;
}
...
ConvVolTermRHSSpectralFD::needsSockets()
{
