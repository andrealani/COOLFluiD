...
#include "SpectralFD/StdPrepare.hh"
...
MethodCommandProvider<StdPrepare, SpectralFDMethodData, SpectralFDModule> stdPrepareProvider("StdPrepare");

//////////////////////////////////////////////////////////////////////////////

StdPrepare::StdPrepare(const std::string& name) : SpectralFDMethodCom(name),
  socket_rhs("rhs"),
