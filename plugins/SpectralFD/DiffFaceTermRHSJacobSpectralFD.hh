#ifndef COOLFluiD_SpectralFD_DiffFaceTermRHSJacobSpectralFD_hh
#define COOLFluiD_SpectralFD_DiffFaceTermRHSJacobSpectralFD_hh
 ...
 *
 */
class DiffFaceTermRHSJacobSpectralFD : public DiffFaceTermRHSSpectralFD {
public:

  /**
   * Constructor.
   */
  explicit DiffFaceTermRHSJacobSpectralFD(const std::string& name);

  /**
   * Destructor.
   */
  virtual ~DiffFaceTermRHSJacobSpectralFD();
...
}; // class DiffFaceTermRHSJacobSpectralFD
