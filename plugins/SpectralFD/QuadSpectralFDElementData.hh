#ifndef COOLFluiD_SpectralFD_QuadSpectralFDElementData_hh
#define COOLFluiD_SpectralFD_QuadSpectralFDElementData_hh
 ...
 *
 */
class QuadSpectralFDElementData : public SpectralFDElementData {
public:

  /**
   * Default constructor without arguments.
   */
  QuadSpectralFDElementData();

  /**
   * Constructor initializing polyOrder.
   */
  QuadSpectralFDElementData(CFPolyOrder::Type polyOrder);
...
}; // end of class QuadSpectralFDElementData
