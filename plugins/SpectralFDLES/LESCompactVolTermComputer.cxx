...
#include "SpectralFDLES/LESCompactVolTermComputer.hh"
...
Framework::MethodStrategyProvider<
    LESCompactVolTermComputer,SpectralFDMethodData,BaseVolTermComputer,SpectralFDLESModule >
LESCompactVolTermComputerProvider("LESCompactVolTermComputer");

//////////////////////////////////////////////////////////////////////////////

LESCompactVolTermComputer::LESCompactVolTermComputer(const std::string& name) :
  NSCompactVolTermComputer(name),
  m_lesVarSet(CFNULL),
  m_nbrOfIntFlxPnts(),
...
LESCompactVolTermComputer::~LESCompactVolTermComputer()
{
  CFAUTOTRACE;
}
...
void LESCompactVolTermComputer::setup()
{
  CFAUTOTRACE;

  // Call setup of the parent class
  NSCompactVolTermComputer::setup();
...
void LESCompactVolTermComputer::setVolumeTermData(CFuint iElemType)
{
  CFAUTOTRACE;

  // Call setVolumeTermData() of the parent class
  NSCompactVolTermComputer::setVolumeTermData(iElemType);
...
void LESCompactVolTermComputer::computeCellData()
{
  CFAUTOTRACE;

  // Call computeCellData() of the parent class
  NSCompactVolTermComputer::computeCellData();
...
void LESCompactVolTermComputer::computeDiffVolTermFromFlxPntSolAndGrad(RealVector& resUpdates)
{
  CFAUTOTRACE;
...
void LESCompactVolTermComputer::unsetup()
{
  CFAUTOTRACE;

  // Call unsetup of the parent class
  NSCompactVolTermComputer::unsetup();
}
