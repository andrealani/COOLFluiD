...
#ifndef COOLFluiD_Numerics_ForwardEuler_FSHOSetup_hh
#define COOLFluiD_Numerics_ForwardEuler_FSHOSetup_hh
...
class  ForwardEuler_API FSHOSetup : public FwdEulerCom {
public:

  /// Constructor.
  explicit FSHOSetup(const std::string& name);
...
#endif // COOLFluiD_Numerics_ForwardEuler_FSHOdSetup_hh
