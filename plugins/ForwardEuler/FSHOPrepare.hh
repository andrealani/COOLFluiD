...
#ifndef COOLFluiD_Numerics_ForwardEuler_FSHOPrepare_hh
#define COOLFluiD_Numerics_ForwardEuler_FSHOPrepare_hh
...
class  ForwardEuler_API FSHOPrepare : public FwdEulerCom {
public:
