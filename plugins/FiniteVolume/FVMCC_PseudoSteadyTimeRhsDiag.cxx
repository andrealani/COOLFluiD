...
#include "FVMCC_PseudoSteadyTimeRhsDiag.hh"
...
MethodCommandProvider<FVMCC_PseudoSteadyTimeRhsDiag,
		      CellCenterFVMData,
		      FiniteVolumeModule>
fvmccPseudoSteadyTimeRhsDiagProvider("PseudoSteadyTimeRhsDiag");

//////////////////////////////////////////////////////////////////////////////

FVMCC_PseudoSteadyTimeRhsDiag::FVMCC_PseudoSteadyTimeRhsDiag
...
void FVMCC_PseudoSteadyTimeRhsDiag::setup()
{
...
void FVMCC_PseudoSteadyTimeRhsDiag::computeNumericalTransMatrix(const CFuint iState)
{
...
void FVMCC_PseudoSteadyTimeRhsDiag::computeAnalyticalTransMatrix
(const CFuint iState)
{
  DataHandle < Framework::State*, Framework::GLOBAL > states = socket_states.getDataHandle();
  DataHandle<State*> pastStates = socket_pastStates.getDataHandle();
...
vector<SafePtr<BaseDataSocketSink> > FVMCC_PseudoSteadyTimeRhsDiag::needsSockets()
{
