...
#include "FVMCC_ComputeRhsJacobDiagFast.hh"
...
MethodCommandProvider<FVMCC_ComputeRhsJacobDiagFast,
		      CellCenterFVMData,
		      FiniteVolumeModule>
fvmcc_computeRhsJacobDiagFast("NumJacobDiagFast");

//////////////////////////////////////////////////////////////////////////////

FVMCC_ComputeRhsJacobDiagFast::FVMCC_ComputeRhsJacobDiagFast
(const std::string& name) :
  FVMCC_ComputeRhsJacobFast(name),
...
void FVMCC_ComputeRhsJacobDiagFast::defineConfigOptions(Config::OptionList& options)
{
}
...
FVMCC_ComputeRhsJacobDiagFast::providesSockets()
{
...
void FVMCC_ComputeRhsJacobDiagFast::setup()
{
...
void FVMCC_ComputeRhsJacobDiagFast::computeBothJacobTerms()
{
...
void FVMCC_ComputeRhsJacobDiagFast::computeJacobTerm(const CFuint idx)
{
...
void FVMCC_ComputeRhsJacobDiagFast::computeBoundaryJacobianTerm()
{
  // set the index of the block corresponding to the current
  // state in the jacobian matrix
  const CFuint nbEqs = PhysicalModelStack::getActive()->getNbEq();
...
void FVMCC_ComputeRhsJacobDiagFast::computeSourceTermAnalytJacob(CFuint ist)
{
...
void FVMCC_ComputeRhsJacobDiagFast::computeSourceTermNumJacob(CFuint ist)
{
  SafePtr<LSSMatrix> jacobMatrix = _lss->getMatrix();
