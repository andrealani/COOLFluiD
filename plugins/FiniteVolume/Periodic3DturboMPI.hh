#ifndef COOLFluiD_Numerics_FiniteVolume_Periodic3DturboMPI_hh
#define COOLFluiD_Numerics_FiniteVolume_Periodic3DturboMPI_hh
...
//////////////////////////////////////////////////////////////////////////////
   ...
   *
   */
class Periodic3DturboMPI : public FVMCC_BC {
public:
   ...
   * Constructor
   */
  Periodic3DturboMPI(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~Periodic3DturboMPI();
...
}; // end of class Periodic3DturboMPI
...
#endif // COOLFluiD_Numerics_FiniteVolume_Periodic3DturboMPI_hh
