#ifndef COOLFluiD_Numerics_FiniteVolume_FVMCC_ComputeRhsJacobDiagFast_hh
#define COOLFluiD_Numerics_FiniteVolume_FVMCC_ComputeRhsJacobDiagFast_hh
 ...
 *
 */
class FVMCC_ComputeRhsJacobDiagFast : public FVMCC_ComputeRhsJacobFast {
public:
  
  /**
   * Constructor.
   */
  explicit FVMCC_ComputeRhsJacobDiagFast(const std::string& name);

  /**
   * Destructor.
   */
  virtual ~FVMCC_ComputeRhsJacobDiagFast();
...
}; // class FVMCC_ComputeRhsJacobDiagFast
...
#endif // COOLFluiD_Numerics_FiniteVolume_FVMCC_ComputeRhsJacobDiagFast_hh
