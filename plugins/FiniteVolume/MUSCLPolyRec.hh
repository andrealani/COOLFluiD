#ifndef COOLFluiD_Numerics_FiniteVolume_MUSCLPolyRec_hh
#define COOLFluiD_Numerics_FiniteVolume_MUSCLPolyRec_hh
 ...
 * @author Andrea Lani
 */
class MUSCLPolyRec : public FVMCC_PolyRec {
public:

  /**
   * Constructor
   */
  MUSCLPolyRec(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~MUSCLPolyRec();
...
protected:
   ...
   */
  virtual void computeReconstruction(Framework::GeometricEntity* const face, 
  ...
  /**
   * Get the states belonging to the computational stencil
   */
  std::vector<Framework::State*>* getStencil(CFuint faceID, 
					     bool isBoundaryFace);
...
#endif // COOLFluiD_Numerics_FiniteVolume_MUSCLPolyRec_hh
