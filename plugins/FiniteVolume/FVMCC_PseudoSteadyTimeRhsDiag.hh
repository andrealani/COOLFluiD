#ifndef COOLFluiD_Numerics_FiniteVolume_FVMCC_PseudoSteadyTimeRhsDiag_hh
#define COOLFluiD_Numerics_FiniteVolume_FVMCC_PseudoSteadyTimeRhsDiag_hh
 ...
 *
 */
class FVMCC_PseudoSteadyTimeRhsDiag : public FVMCC_PseudoSteadyTimeRhs {
public:

  /**
   * Constructor.
   */
  explicit FVMCC_PseudoSteadyTimeRhsDiag(const std::string& name);

  /**
   * Destructor.
   */
  virtual ~FVMCC_PseudoSteadyTimeRhsDiag();
...
}; // class FVMCC_PseudoSteadyTimeRhsDiag
...
#endif // COOLFluiD_Numerics_FiniteVolume_FVMCC_PseudoSteadyTimeRhsDiag_hh
