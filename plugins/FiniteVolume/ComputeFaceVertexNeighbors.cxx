#include "ComputeFaceVertexNeighbors.hh"
...
Environment::ObjectProvider<ComputeFaceVertexNeighbors,
			    ComputeStencil,
			    FiniteVolumeModule,
			    1>
computeFaceVertexNeighborsProvider("FaceVertex");

//////////////////////////////////////////////////////////////////////////////

ComputeFaceVertexNeighbors::ComputeFaceVertexNeighbors(const std::string& name) :
   ComputeStencil(name)
 {
 }
...
ComputeFaceVertexNeighbors::~ComputeFaceVertexNeighbors()
{
}

//////////////////////////////////////////////////////////////////////////////

void ComputeFaceVertexNeighbors::operator() ()
{
