...
MethodCommandProvider<Periodic3DturboMPI, CellCenterFVMData, FiniteVolumeModule> periodic3DturboMPIFVMCCProvider("Periodic3DturboMPIFVMCC");

//////////////////////////////////////////////////////////////////////////////

void Periodic3DturboMPI::defineConfigOptions(Config::OptionList& options)
{
...
Periodic3DturboMPI::Periodic3DturboMPI(const std::string& name):
  FVMCC_BC(name),
  _comm(),
  _my_nP(),
  _n_P(),
...
Periodic3DturboMPI::~Periodic3DturboMPI()
{
}

//////////////////////////////////////////////////////////////////////////////

void Periodic3DturboMPI::setup()
{
  ...
  for (CFuint iFace = 0; iFace<nbTrsFaces; iFace++){
    ...
    CFreal zCentreCoordinate = 0.25*( (*(nodes[0]))[ZZ] + (*(nodes[1]))[ZZ] + (*(nodes[2]))[ZZ] + (*(nodes[3]))[ZZ] );
    CFreal xCentreCoordinate = 0.25*( (*(nodes[0]))[XX] + (*(nodes[1]))[XX] + (*(nodes[2]))[XX] + (*(nodes[3]))[XX] );
...
void Periodic3DturboMPI::preProcess()
{
...
void Periodic3DturboMPI::setGhostState(GeometricEntity *const face)
{
...
void Periodic3DturboMPI::Barrier()
{
  MPI_Barrier(_comm);
}
