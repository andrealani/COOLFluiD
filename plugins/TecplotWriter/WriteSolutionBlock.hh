...
#ifndef COOLFluiD_IO_TecplotWriter_WriteSolutionBlock_hh
#define COOLFluiD_IO_TecplotWriter_WriteSolutionBlock_hh
...
class TecplotWriter_API WriteSolutionBlock : 
  public TecWriterCom,
...
public:
  ...
  /// Constructor
  explicit WriteSolutionBlock(const std::string& name);

  /// Virtual destructor
  virtual ~WriteSolutionBlock();
...
#endif // COOLFluiD_IO_TecplotWriter_WriteSolutionBlock_hh
