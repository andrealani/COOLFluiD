#ifndef COOLFluiD_Numerics_LESDataProcessing_VelocityGradients3D_hh
#define COOLFluiD_Numerics_LESDataProcessing_VelocityGradients3D_hh
...
/** 
 * This strategy class computes the Velocity Gradients in 3D
 * and stores it in the socket named "VelocityGradients"
 * @author Willem Deconinck
 */
class VelocityGradients3D : public TurbulenceFunction {
...
public: // functions
   ...
   * Constructor
   */
  VelocityGradients3D(const std::string& name);

  /** 
   * Default destructor
   */
  virtual ~VelocityGradients3D();
...
}; // end of class VelocityGradients3D
...
#endif // COOLFluiD_Numerics_LESDataProcessing_VelocityGradients3D_hh
