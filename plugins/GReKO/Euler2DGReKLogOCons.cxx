#include "GReKO.hh"
#include "Euler2DGReKLogOCons.hh"
...
Environment::ObjectProvider<Euler2DGReKLogOCons, ConvectiveVarSet, GReKOModule, 1>
euler2DGReKLogOConsProvider("Euler2DGReKLogOCons");

//////////////////////////////////////////////////////////////////////////////

Euler2DGReKLogOCons::Euler2DGReKLogOCons(Common::SafePtr<BaseTerm> term) :
...
Euler2DGReKLogOCons::~Euler2DGReKLogOCons()
{
}

//////////////////////////////////////////////////////////////////////////////

void Euler2DGReKLogOCons::setup()
{
...
void Euler2DGReKLogOCons::setConstJacob()
{
...
void Euler2DGReKLogOCons::computeJacobians()
{
...
void Euler2DGReKLogOCons::computeEigenValuesVectors(RealMatrix& rightEv,
                                           RealMatrix& leftEv,
                                           RealVector& eValues,
...
CFuint Euler2DGReKLogOCons::getBlockSeparator() const
{
...
void Euler2DGReKLogOCons::splitJacobian(RealMatrix& jacobPlus,
                                RealMatrix& jacobMin,
                                RealVector& eValues,
                                const RealVector& normal)
{
  throw Common::NotImplementedException (FromHere(),"Euler2DGReKLogOCons::splitJacobian()");
}

//////////////////////////////////////////////////////////////////////////////

void Euler2DGReKLogOCons::computePhysicalData(const State& state,
					    RealVector& data)
{
...
void Euler2DGReKLogOCons::computeStateFromPhysicalData(const RealVector& data,
						State& state)
{
...
CFreal Euler2DGReKLogOCons::getSpeed(const State& state) const
{
...
void Euler2DGReKLogOCons::setDimensionalValues(const State& state,
                                          RealVector& result)
{
...
void Euler2DGReKLogOCons::setAdimensionalValues(const State& state,
                                          RealVector& result)
{
  const RealVector& refData = getModel()->getReferencePhysicalData();
...
void Euler2DGReKLogOCons::setDimensionalValuesPlusExtraValues
...
vector<std::string> Euler2DGReKLogOCons::getExtraVarNames() const
{
...
void Euler2DGReKLogOCons::computePerturbedPhysicalData
