...
#include "Euler3DGReKLogOPuvt.hh"
...
Environment::ObjectProvider<Euler3DGReKLogOPuvt, ConvectiveVarSet, GReKOModule, 1>
euler3DGReKLogOPuvtProvider("Euler3DGReKLogOPvt");

//////////////////////////////////////////////////////////////////////////////

Euler3DGReKLogOPuvt::Euler3DGReKLogOPuvt(Common::SafePtr<BaseTerm> term) :
...
Euler3DGReKLogOPuvt::~Euler3DGReKLogOPuvt()
{
}

//////////////////////////////////////////////////////////////////////////////

void Euler3DGReKLogOPuvt::computeEigenValuesVectors(RealMatrix& rightEv,
                                        RealMatrix& leftEv,
                                        RealVector& eValues,
                                        const RealVector& normal)
{
  throw Common::NotImplementedException (FromHere(),"Euler3DGReKLogOPuvt::computeEigenValuesVectors()");
}

//////////////////////////////////////////////////////////////////////////////

CFuint Euler3DGReKLogOPuvt::getBlockSeparator() const
{
...
void Euler3DGReKLogOPuvt::splitJacobian(RealMatrix& jacobPlus,
           RealMatrix& jacobMin,
           RealVector& eValues,
           const RealVector& normal)
{
  throw Common::NotImplementedException (FromHere(),"Euler3DGReKLogOPuvt::splitJacobian()");
}

//////////////////////////////////////////////////////////////////////////////

void Euler3DGReKLogOPuvt::computePhysicalData(const State& state,
					    RealVector& data)
{
...
void Euler3DGReKLogOPuvt::computeStateFromPhysicalData(const RealVector& data,
						State& state)
{
  const CFreal R = getModel()->getR();
...
CFreal Euler3DGReKLogOPuvt::getSpeed(const State& state) const
{
...
void Euler3DGReKLogOPuvt::setDimensionalValues(const State& state,
                                          RealVector& result)
{
...
void Euler3DGReKLogOPuvt::setAdimensionalValues(const State& state,
                                          RealVector& result)
{
  const RealVector& refData = getModel()->getReferencePhysicalData();
...
void Euler3DGReKLogOPuvt::setDimensionalValuesPlusExtraValues
 ...
 RealVector& extra)
{
  ...
  const CFreal Redim = state[8]*refData[iK+3];
  result[5] = Kdim;
  result[6] = Omegadim;
  result[7] = Gadim;
  result[8] = Redim;
  ...
  if(exists) {// this can only work when data are cell-centered otherwise you can have nodal stateID > actual array storage 
    ...
    //  CFLog(INFO, "Euler3DGReKLogOPuvt::setDimensionalValuesPlusExtraValues() => " << stateID << " >= " << wallDistance.size() << "\n");
    //}
...
vector<std::string> Euler3DGReKLogOPuvt::getExtraVarNames() const
{
...
void Euler3DGReKLogOPuvt::setup()
{
...
void Euler3DGReKLogOPuvt::computePerturbedPhysicalData
