...
Environment::ObjectProvider<NavierStokes2DGReKOPuvt, DiffusiveVarSet,
			    GReKOModule, 2>
ns2DGReKOPuvtProvider("NavierStokes2DGReKOPuvt");

//////////////////////////////////////////////////////////////////////////////

NavierStokes2DGReKOPuvt::NavierStokes2DGReKOPuvt
(const std::string& name, SafePtr<PhysicalModelImpl> model) :
  NavierStokesKOmegaPvt<NavierStokesKOmegaVarSet<NavierStokes2DVarSet, 0> >(name, model),
  _unperturbedFluxGa(),
  _unperturbedFluxRe()
{
...
RealVector& NavierStokes2DGReKOPuvt::getFlux(const RealVector& values,
