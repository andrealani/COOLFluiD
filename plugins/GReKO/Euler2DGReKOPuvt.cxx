...
Environment::ObjectProvider<Euler2DGReKOPuvt, ConvectiveVarSet, GReKOModule, 1>
euler2DGReKOPuvtProvider("Euler2DGReKOPuvt");

//////////////////////////////////////////////////////////////////////////////

Euler2DGReKOPuvt::Euler2DGReKOPuvt(Common::SafePtr<BaseTerm> term) :
...
Euler2DGReKOPuvt::~Euler2DGReKOPuvt()
{
}

//////////////////////////////////////////////////////////////////////////////

void Euler2DGReKOPuvt::computeEigenValuesVectors(RealMatrix& rightEv,
                                        RealMatrix& leftEv,
                                        RealVector& eValues,
                                        const RealVector& normal)
{
  throw Common::NotImplementedException (FromHere(),"Euler2DGReKOPuvt::computeEigenValuesVectors()");
}

//////////////////////////////////////////////////////////////////////////////

CFuint Euler2DGReKOPuvt::getBlockSeparator() const
{
...
void Euler2DGReKOPuvt::splitJacobian(RealMatrix& jacobPlus,
           RealMatrix& jacobMin,
           RealVector& eValues,
           const RealVector& normal)
{
  throw Common::NotImplementedException (FromHere(),"Euler2DGReKOPuvt::splitJacobian()");
}

//////////////////////////////////////////////////////////////////////////////

void Euler2DGReKOPuvt::computePhysicalData(const State& state,
					    RealVector& data)
{
...
void Euler2DGReKOPuvt::computeStateFromPhysicalData(const RealVector& data,
						State& state)
{
  const CFreal R = getModel()->getR();
...
CFreal Euler2DGReKOPuvt::getSpeed(const State& state) const
{
...
void Euler2DGReKOPuvt::setDimensionalValues(const State& state,
                                          RealVector& result)
{
...
void Euler2DGReKOPuvt::setAdimensionalValues(const State& state,
                                          RealVector& result)
{
  const RealVector& refData = getModel()->getReferencePhysicalData();
...
void Euler2DGReKOPuvt::setDimensionalValuesPlusExtraValues
...
vector<std::string> Euler2DGReKOPuvt::getExtraVarNames() const
{
...
void Euler2DGReKOPuvt::computePerturbedPhysicalData
