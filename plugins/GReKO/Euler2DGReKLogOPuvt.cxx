...
#include "Euler2DGReKLogOPuvt.hh"
...
Environment::ObjectProvider<Euler2DGReKLogOPuvt, ConvectiveVarSet, GReKOModule, 1>
euler2DGReKLogOPuvtProvider("Euler2DGReKLogOPuvt");

//////////////////////////////////////////////////////////////////////////////

Euler2DGReKLogOPuvt::Euler2DGReKLogOPuvt(Common::SafePtr<BaseTerm> term) :
...
Euler2DGReKLogOPuvt::~Euler2DGReKLogOPuvt()
{
}

//////////////////////////////////////////////////////////////////////////////

void Euler2DGReKLogOPuvt::computeEigenValuesVectors(RealMatrix& rightEv,
                                        RealMatrix& leftEv,
                                        RealVector& eValues,
                                        const RealVector& normal)
{
  throw Common::NotImplementedException (FromHere(),"Euler2DGReKLogOPuvt::computeEigenValuesVectors()");
}

//////////////////////////////////////////////////////////////////////////////

CFuint Euler2DGReKLogOPuvt::getBlockSeparator() const
{
...
void Euler2DGReKLogOPuvt::splitJacobian(RealMatrix& jacobPlus,
           RealMatrix& jacobMin,
           RealVector& eValues,
           const RealVector& normal)
{
  throw Common::NotImplementedException (FromHere(),"Euler2DGReKLogOPuvt::splitJacobian()");
}

//////////////////////////////////////////////////////////////////////////////

void Euler2DGReKLogOPuvt::computePhysicalData(const State& state,
					    RealVector& data)
{
...
void Euler2DGReKLogOPuvt::computeStateFromPhysicalData(const RealVector& data,
						State& state)
{
  const CFreal R = getModel()->getR();
...
CFreal Euler2DGReKLogOPuvt::getSpeed(const State& state) const
{
...
void Euler2DGReKLogOPuvt::setDimensionalValues(const State& state,
                                          RealVector& result)
{
...
void Euler2DGReKLogOPuvt::setAdimensionalValues(const State& state,
                                          RealVector& result)
{
  const RealVector& refData = getModel()->getReferencePhysicalData();
...
void Euler2DGReKLogOPuvt::setDimensionalValuesPlusExtraValues
 ...
 RealVector& extra)
{
  ...
  const CFreal Redim = state[7]*refData[iK+3];
  result[4] = Kdim;
  result[5] = Omegadim;
  result[6] = Gadim;
  result[7] = Redim;
  ...
  if(exists) {// this can only work when data are cell-centered otherwise you can have nodal stateID > actual array storage 
    ...
    //  CFLog(INFO, "Euler2DGReKLogOPuvt::setDimensionalValuesPlusExtraValues() => " << stateID << " >= " << wallDistance.size() << "\n");
    //}
...
vector<std::string> Euler2DGReKLogOPuvt::getExtraVarNames() const
{
...
void Euler2DGReKLogOPuvt::setup()
{
...
void Euler2DGReKLogOPuvt::computePerturbedPhysicalData
