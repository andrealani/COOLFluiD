#ifndef COOLFluiD_Physics_StructMech_MaterialLibIFI_hh
#define COOLFluiD_Physics_StructMech_MaterialLibIFI_hh
...
/**
 * This class computes the properties of a IFI Material
 *
 * @author Thomas Wuilbaut
 *
 */
class MaterialLibIFI : public MaterialPropertyLib
{
public: // functions
   ...
   * Constructor
   */
  MaterialLibIFI(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~MaterialLibIFI();
...
#endif // COOLFluiD_Physics_StructMech_MaterialLibIFI_hh
