...
Environment::ObjectProvider<Euler2DHalfMFMHDConsToRhoiViTiInRhoiViTi, VarSetMatrixTransformer, 
			    MultiFluidMHDModule, 1> 
euler2DHalfConsToRhovtInRhovtProvider("Euler2DHalfMFMHDConsToRhoiViTiInRhoiViTi");

//////////////////////////////////////////////////////////////////////////////

Euler2DHalfMFMHDConsToRhoiViTiInRhoiViTi::Euler2DHalfMFMHDConsToRhoiViTiInRhoiViTi(Common::SafePtr<Framework::PhysicalModelImpl> model) :
...
Euler2DHalfMFMHDConsToRhoiViTiInRhoiViTi::~Euler2DHalfMFMHDConsToRhoiViTiInRhoiViTi()
{
}

//////////////////////////////////////////////////////////////////////////////

void Euler2DHalfMFMHDConsToRhoiViTiInRhoiViTi::setMatrix(const RealVector& state)
{
  throw Common::NotImplementedException (FromHere(),"Euler2DHalfMFMHDConsToRhoiViTiInRhoiViTi::setMatrix()");
...
//   }
//   
//   // Transformation from conservative to Rhoi Vi Ti variables in 2.5D
