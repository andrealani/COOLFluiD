...
#include "Euler2DMFMHDConsToRhoiViTiInRhoiViTi.hh"
...
Environment::ObjectProvider<Euler2DMFMHDConsToRhoiViTiInRhoiViTi, VarSetMatrixTransformer, 
			    MultiFluidMHDModule, 1> 
euler2DConsToRhovtInRhovtProvider("Euler2DMFMHDConsToRhoiViTiInRhoiViTi");

//////////////////////////////////////////////////////////////////////////////

Euler2DMFMHDConsToRhoiViTiInRhoiViTi::Euler2DMFMHDConsToRhoiViTiInRhoiViTi(Common::SafePtr<Framework::PhysicalModelImpl> model) :
...
Euler2DMFMHDConsToRhoiViTiInRhoiViTi::~Euler2DMFMHDConsToRhoiViTiInRhoiViTi()
{
}

//////////////////////////////////////////////////////////////////////////////

void Euler2DMFMHDConsToRhoiViTiInRhoiViTi::setMatrix(const RealVector& state)
{
  throw Common::NotImplementedException (FromHere(),"Euler2DMFMHDConsToRhoiViTiInRhoiViTi::setMatrix()");
...
//   }
//   
//   // Transformation from conservative to Rhoi Vi Ti variables in 2D
//   // First transformation of the densities
//   for (CFuint ie = 0; ie < nbSpecies; ++ie) {
//     _transMatrix(ie,ie) = 1.0;
//   }
//   
//   //Transformation taking as example Euler2DConsToRhovtInRhovt
//   for (CFuint ie = 0; ie < nbSpecies; ++ie) {
//     
