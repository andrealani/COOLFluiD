...
Environment::ObjectProvider<EulerMFMHD3DRhoiViTi, ConvectiveVarSet, MultiFluidMHDModule, 1>
mfMHD3DRhoiViTiProvider("EulerMFMHD3DRhoiViTi");

//////////////////////////////////////////////////////////////////////////////

EulerMFMHD3DRhoiViTi::EulerMFMHD3DRhoiViTi(Common::SafePtr<BaseTerm> term) :
...
EulerMFMHD3DRhoiViTi::~EulerMFMHD3DRhoiViTi()
{
}

//////////////////////////////////////////////////////////////////////////////

void EulerMFMHD3DRhoiViTi::setup()
{
...
void EulerMFMHD3DRhoiViTi::setConstJacob()
{
}

//////////////////////////////////////////////////////////////////////////////

void EulerMFMHD3DRhoiViTi::computeProjectedJacobian(const RealVector& normal,
						   RealMatrix& jacob)
{
}
...
void EulerMFMHD3DRhoiViTi::computeJacobians()
{
}

//////////////////////////////////////////////////////////////////////////////

void EulerMFMHD3DRhoiViTi::computeEigenValuesVectors(RealMatrix& rightEv,
					    RealMatrix& leftEv,
					    RealVector& eValues,
...
CFuint EulerMFMHD3DRhoiViTi::getBlockSeparator() const
{
...
void EulerMFMHD3DRhoiViTi::splitJacobian(RealMatrix& jacobPlus,
					RealMatrix& jacobMin,
					RealVector& eValues,
					const RealVector& normal)
{
...
void EulerMFMHD3DRhoiViTi::computePhysicalData(const State& state, RealVector& data)
{
...
//     cout << "EulerMFMHD3DRhoiViTi::computePhysicalData => R_p  = " << R_p << endl;
//     cout << "EulerMFMHD3DRhoiViTi::computePhysicalData => Cp_p = " << Cp_p << endl;
//     cout << "EulerMFMHD3DRhoiViTi::computePhysicalData => Cv_p = " << Cv_p << endl;
...
//     cout << "EulerMFMHD3DRhoiViTi::computePhysicalData => R_n  = " << R_n << endl;
//     cout << "EulerMFMHD3DRhoiViTi::computePhysicalData => Cp_n = " << Cp_n << endl;
//     cout << "EulerMFMHD3DRhoiViTi::computePhysicalData => Cv_n = " << Cv_n << endl;
...
//       std::cout << "EulerMFMHD3DRhoiViTi::computePhysicalData \n";
...
//     }
  ...
  //   std::cout << "EulerMFMHD3DRhoiViTi::computePhysicalData => data[PTERM::RHO] = " << data[PTERM::RHO] << endl;
  //   std::cout << "EulerMFMHD3DRhoiViTi::computePhysicalData => state[8]         = " << state[8] << endl;
  ...
  //     cout << "EulerMFMHD3DRhoiViTi::computePhysicalData => firstVelocity + 2*ie = " << firstVelocity + 2*ie <<"\n";
  //     cout << "EulerMFMHD3DRhoiViTi::computePhysicalData => firstVelocity + 2*ie + 1 = " << firstVelocity + 2*ie + 1 <<"\n";
  //     cout << "EulerMFMHD3DRhoiViTi::computePhysicalData => firstTemperature = " << firstTemperature <<"\n";
  ...
  //     cout << "EulerMFMHD3DRhoiViTi::computePhysicalData => R   = " << R_gas << endl;
  //     cout << "EulerMFMHD3DRhoiViTi::computePhysicalData => c_p = " << c_p << endl;
  //     cout << "EulerMFMHD3DRhoiViTi::computePhysicalData => c_v = " << c_v << endl;
...
void EulerMFMHD3DRhoiViTi::computeStateFromPhysicalData(const RealVector& data,
					       State& state)
{
...
CFreal EulerMFMHD3DRhoiViTi::getSpeed(const State& state) const
{
  throw Common::NotImplementedException
      (FromHere(), "EulerMFMHD3DRhoiViTi::getSpeed() not implemented");
 //   return 0.;
}

//////////////////////////////////////////////////////////////////////////////

void EulerMFMHD3DRhoiViTi::setDimensionalValues(const State& state,
                                       RealVector& result)
{
...
void EulerMFMHD3DRhoiViTi::setAdimensionalValues(const State& state,
                                       RealVector& result)
{
  const RealVector& refData = getModel()->getReferencePhysicalData();
  const CFuint nbSpecies    = getModel()->getNbScalarVars(0);
...
void EulerMFMHD3DRhoiViTi::computePerturbedPhysicalData(const Framework::State& state,
					       const RealVector& pdataBkp,
					       RealVector& pdata,
					       CFuint iVar)
{
  throw Common::NotImplementedException
      (FromHere(), "EulerMFMHD3DRhoiViTi::computePerturbedPhysicalData() not implemented");
}

//////////////////////////////////////////////////////////////////////////////

bool EulerMFMHD3DRhoiViTi::isValid(const RealVector& data)
{
 //  bool correct = true;
