#ifndef COOLFluiD_Physics_MultiFluidMHD_EulerMFMHD2DRhoiViTi_hh
#define COOLFluiD_Physics_MultiFluidMHD_EulerMFMHD2DRhoiViTi_hh
 ...
 * 
 */
class EulerMFMHD2DRhoiViTi : public MultiFluidMHDVarSet<Maxwell::Maxwell2DProjectionVarSet> {
public: // classes
   ...
   */
  EulerMFMHD2DRhoiViTi(Common::SafePtr<Framework::BaseTerm> term);
  
  /**
   * Default destructor
   */
  virtual ~EulerMFMHD2DRhoiViTi();
