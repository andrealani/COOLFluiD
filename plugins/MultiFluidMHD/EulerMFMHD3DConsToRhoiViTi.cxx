...
#include "EulerMFMHD3DConsToRhoiViTi.hh"
...
Environment::ObjectProvider<EulerMFMHD3DConsToRhoiViTi, VarSetTransformer, MultiFluidMHDModule, 1> eulerMFMHD3DConsToRhoiViTiProvider("EulerMFMHD3DConsToRhoiViTi");

//////////////////////////////////////////////////////////////////////////////

EulerMFMHD3DConsToRhoiViTi::EulerMFMHD3DConsToRhoiViTi(Common::SafePtr<Framework::PhysicalModelImpl> model) :
...
EulerMFMHD3DConsToRhoiViTi::~EulerMFMHD3DConsToRhoiViTi()
{
}

//////////////////////////////////////////////////////////////////////////////

void EulerMFMHD3DConsToRhoiViTi::transform(const State& state, State& result)
{
...
void EulerMFMHD3DConsToRhoiViTi::transformFromRef(const RealVector& data, State& result)
{
  const CFuint nbSpecies    = _model->getNbScalarVars(0);
  const CFuint nbMomentum   = _model->getNbScalarVars(1);
  const CFuint nbEnergyEqs  = _model->getNbScalarVars(2);
