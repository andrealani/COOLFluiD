...
#include "EulerMFMHD2DHalfRhoiViTiToCons.hh"
...
Environment::ObjectProvider<EulerMFMHD2DHalfRhoiViTiToCons, VarSetTransformer, MultiFluidMHDModule, 1> eulerMFMHD2DHalfRhoiViTiToConsProvider("EulerMFMHD2DHalfRhoiViTiToCons");

//////////////////////////////////////////////////////////////////////////////

EulerMFMHD2DHalfRhoiViTiToCons::EulerMFMHD2DHalfRhoiViTiToCons(Common::SafePtr<Framework::PhysicalModelImpl> model) :
...
EulerMFMHD2DHalfRhoiViTiToCons::~EulerMFMHD2DHalfRhoiViTiToCons()
{
}

//////////////////////////////////////////////////////////////////////////////

void EulerMFMHD2DHalfRhoiViTiToCons::transform(const State& state, State& result)
{
...
void EulerMFMHD2DHalfRhoiViTiToCons::transformFromRef(const RealVector& data, State& result)
{
  const CFuint nbSpecies    = _model->getNbScalarVars(0);
  const CFuint nbMomentum   = _model->getNbScalarVars(1);
  const CFuint nbEnergyEqs  = _model->getNbScalarVars(2);
