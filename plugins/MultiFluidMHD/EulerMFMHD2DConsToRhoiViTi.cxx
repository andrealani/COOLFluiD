...
#include "EulerMFMHD2DConsToRhoiViTi.hh"
...
Environment::ObjectProvider<EulerMFMHD2DConsToRhoiViTi, VarSetTransformer, MultiFluidMHDModule, 1> eulerMFMHD2DConsToRhoiViTiProvider("EulerMFMHD2DConsToRhoiViTi");

//////////////////////////////////////////////////////////////////////////////

EulerMFMHD2DConsToRhoiViTi::EulerMFMHD2DConsToRhoiViTi(Common::SafePtr<Framework::PhysicalModelImpl> model) :
...
EulerMFMHD2DConsToRhoiViTi::~EulerMFMHD2DConsToRhoiViTi()
{
}

//////////////////////////////////////////////////////////////////////////////

void EulerMFMHD2DConsToRhoiViTi::transform(const State& state, State& result)
{
...
void EulerMFMHD2DConsToRhoiViTi::transformFromRef(const RealVector& data, State& result)
{
  const CFuint nbSpecies    = _model->getNbScalarVars(0);
  const CFuint nbMomentum   = _model->getNbScalarVars(1);
  const CFuint nbEnergyEqs  = _model->getNbScalarVars(2);
