...
Environment::ObjectProvider<EulerMFMHD2DHalfCons, ConvectiveVarSet, MultiFluidMHDModule, 1>
mf2DHalfConsProvider("EulerMFMHD2DHalfCons");

//////////////////////////////////////////////////////////////////////////////

EulerMFMHD2DHalfCons::EulerMFMHD2DHalfCons(Common::SafePtr<BaseTerm> term) :
...
EulerMFMHD2DHalfCons::~EulerMFMHD2DHalfCons()
{
}

//////////////////////////////////////////////////////////////////////////////

void EulerMFMHD2DHalfCons::setup()
{
...
void EulerMFMHD2DHalfCons::setConstJacob()
{
}

//////////////////////////////////////////////////////////////////////////////

void EulerMFMHD2DHalfCons::computeProjectedJacobian(const RealVector& normal,
						   RealMatrix& jacob)
{
}
...
void EulerMFMHD2DHalfCons::computeJacobians()
{
}

//////////////////////////////////////////////////////////////////////////////

void EulerMFMHD2DHalfCons::computeEigenValuesVectors(RealMatrix& rightEv,
					    RealMatrix& leftEv,
					    RealVector& eValues,
...
CFuint EulerMFMHD2DHalfCons::getBlockSeparator() const
{
...
void EulerMFMHD2DHalfCons::splitJacobian(RealMatrix& jacobPlus,
					RealMatrix& jacobMin,
					RealVector& eValues,
					const RealVector& normal)
{
...
void EulerMFMHD2DHalfCons::computePhysicalData(const State& state, RealVector& data)
{
					       ...
					       State& state)
{
 ...
 //set the Energies
  ...
  cout << "EulerMFMHD2DHalfCons::computeStateFromPhysicalData" << endl;
...
CFreal EulerMFMHD2DHalfCons::getSpeed(const State& state) const
{
...
void EulerMFMHD2DHalfCons::setDimensionalValues(const State& state,
                                       RealVector& result)
{
...
void EulerMFMHD2DHalfCons::setAdimensionalValues(const State& state,
                                       RealVector& result)
{
  const RealVector& refData = getModel()->getReferencePhysicalData();
  const CFuint nbSpecies    = getModel()->getNbScalarVars(0);
...
void EulerMFMHD2DHalfCons::computePerturbedPhysicalData(const Framework::State& state,
					       const RealVector& pdataBkp,
					       RealVector& pdata,
					       CFuint iVar)
{
  throw Common::NotImplementedException
      (FromHere(), "EulerMFMHD2DHalfCons::computePerturbedPhysicalData() not implemented");
}

//////////////////////////////////////////////////////////////////////////////

bool EulerMFMHD2DHalfCons::isValid(const RealVector& data)
{
 //  bool correct = true;
