#ifndef COOLFluiD_Physics_MultiFluidMHD_EulerMFMHD2DHalfRhoiViTi_hh
#define COOLFluiD_Physics_MultiFluidMHD_EulerMFMHD2DHalfRhoiViTi_hh
 ...
 * 
 */
class EulerMFMHD2DHalfRhoiViTi : public MultiFluidMHDVarSet<Maxwell::Maxwell2DProjectionVarSet> {
public: // classes
   ...
   */
  EulerMFMHD2DHalfRhoiViTi(Common::SafePtr<Framework::BaseTerm> term);
  
  /**
   * Default destructor
   */
  virtual ~EulerMFMHD2DHalfRhoiViTi();
