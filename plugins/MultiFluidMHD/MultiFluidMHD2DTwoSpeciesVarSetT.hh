#ifndef COOLFluiD_Physics_MultiFluidMHD_MultiFluidMHD2DTwoSpeciesVarSetT_hh
#define COOLFluiD_Physics_MultiFluidMHD_MultiFluidMHD2DTwoSpeciesVarSetT_hh
...
class MultiFluidMHD2DTwoSpeciesVarSetT : public BASE {
public: // classes
  ...
  typedef MultiFluidMHD2DTwoSpeciesVarSetT EULERSET;
  /**
   * Constructor
  ...
  HOST_DEVICE MultiFluidMHD2DTwoSpeciesVarSetT(EulerMFMHDTerm::DeviceConfigOptions<NOTYPE>* dco) :
    m_dco(dco) {} 


  HOST_DEVICE MultiFluidMHD2DTwoSpeciesVarSetT() {}
   ...
   * Default destructor
   */
  HOST_DEVICE virtual ~MultiFluidMHD2DTwoSpeciesVarSetT() {};
...
*/
  ...
  HOST_DEVICE bool getIsLeake() {return m_dco->isLeake;}
...
}; // end of class MultiFluidMHD2DTwoSpeciesVarSetT
...
#endif // COOLFluiD_Physics_MultiFluidMHD_MultiFluidMHD2DTwoSpeciesVarSetT_hh
