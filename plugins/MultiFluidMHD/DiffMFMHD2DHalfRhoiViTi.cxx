...
Environment::ObjectProvider<DiffMFMHD2DHalfRhoiViTi, DiffusiveVarSet, MultiFluidMHDModule, 2>
nsMHD2DHalfRhoiViTiProvider("MultiFluidMHD2DHalfRhoiViTi");

//////////////////////////////////////////////////////////////////////////////

DiffMFMHD2DHalfRhoiViTi::DiffMFMHD2DHalfRhoiViTi(const std::string& name, Common::SafePtr<Framework::PhysicalModelImpl> model) :
  DiffMFMHD2DHalfVarSet(name, model),
...
DiffMFMHD2DHalfRhoiViTi::~DiffMFMHD2DHalfRhoiViTi()
{
}

//////////////////////////////////////////////////////////////////////////////

void DiffMFMHD2DHalfRhoiViTi::setGradientVars(const vector<RealVector*>& states,
					  RealMatrix& values,
...
void DiffMFMHD2DHalfRhoiViTi::setGradientVarGradients(const vector<RealVector*>& states,
...
void DiffMFMHD2DHalfRhoiViTi::setStateGradients(const vector<RealVector*>& states,
...
RealVector& DiffMFMHD2DHalfRhoiViTi::getDynViscosityVec(const RealVector& state,
...
CFreal DiffMFMHD2DHalfRhoiViTi::getDynViscosity(const RealVector& state,
                                            const vector<RealVector*>& gradients)
{
...
CFreal DiffMFMHD2DHalfRhoiViTi::getThermConductivity(const RealVector& state,
...
CFreal DiffMFMHD2DHalfRhoiViTi::getDensity(const RealVector& state)
{
  const CFuint nbSpecies = m_eulerModel->getNbScalarVars(0);
  const CFuint endEM = 8;
  CFreal rho = 0.0;
...
void DiffMFMHD2DHalfRhoiViTi::setGradientState(const RealVector& state)
{
