#ifndef COOLFluiD_Physics_Mutation_OnlySigma_hh
#define COOLFluiD_Physics_Mutation_OnlySigma_hh
...
/**
 * This class represents the interface for a OnlySigma.
 *
 ...
 *
 */
class OnlySigma : public Framework::PhysicalChemicalLibrary {
public:
   ...
   */
  OnlySigma(const std::string& name);
 ...
 /**
  ...
  virtual void getSourceEE(CFdouble& temp,
			   ...
			   CFdouble& omegaEE) 
  {
    throw Common::NotImplementedException (FromHere(),"OnlySigma::getSourceEE()");
  }
...
protected: // helper function
  ...
  typedef CFdouble (OnlySigma::*ComputeQuantity)
    (CFdouble&, CFdouble&);
...
#endif // COOLFluiD_Physics_Mutation_OnlySigma_hh
