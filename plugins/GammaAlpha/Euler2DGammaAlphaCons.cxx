...
#include "Euler2DGammaAlphaCons.hh"
...
Environment::ObjectProvider<Euler2DGammaAlphaCons, ConvectiveVarSet, GammaAlphaModule, 1>
euler2DGammaAlphaConsProvider("Euler2DGammaAlphaCons");

//////////////////////////////////////////////////////////////////////////////

Euler2DGammaAlphaCons::Euler2DGammaAlphaCons(Common::SafePtr<BaseTerm> term) :
  MultiScalarVarSet<Euler2DCons>(term)
{
...
Euler2DGammaAlphaCons::~Euler2DGammaAlphaCons()
{
}

//////////////////////////////////////////////////////////////////////////////

void Euler2DGammaAlphaCons::setup()
{
  MultiScalarVarSet<Euler2DCons>::setup();

  // set the equation set data for each of the equation subsets
  // first equation subset
  Euler2DCons::getEqSetData().resize(1);
  Euler2DCons::getEqSetData()[0].setup(0,0,4);

  // second equation subset
  MultiScalarVarSet<Euler2DCons>::getEqSetData().resize(1);
  MultiScalarVarSet<Euler2DCons>::getEqSetData()[0].setup
...
void Euler2DGammaAlphaCons::setConstJacob()
{
...
void Euler2DGammaAlphaCons::computeJacobians()
{
...
void Euler2DGammaAlphaCons::computeEigenValuesVectors(RealMatrix& rightEv,
                                           RealMatrix& leftEv,
                                           RealVector& eValues,
                                           const RealVector& normal)
{

  //throw Common::NotImplementedException (FromHere(),"Euler2DGammaAlphaCons::computeEigenValuesVectors()");
...
CFuint Euler2DGammaAlphaCons::getBlockSeparator() const
{
...
void Euler2DGammaAlphaCons::splitJacobian(RealMatrix& jacobPlus,
                                RealMatrix& jacobMin,
                                RealVector& eValues,
                                const RealVector& normal)
{
  throw Common::NotImplementedException (FromHere(),"Euler2DGammaAlphaCons::splitJacobian()");
}

//////////////////////////////////////////////////////////////////////////////

void Euler2DGammaAlphaCons::computePhysicalData(const State& state,
					    RealVector& data)
{
...
//  data[EulerTerm::A] = sqrt(gammaMinus1*(data[EulerTerm::H] - 0.5*V2) + (gammaMinus1*K);
  ...
  data[iK+3] = rhoAlpha*overRho;

}

//////////////////////////////////////////////////////////////////////////////

void Euler2DGammaAlphaCons::computeStateFromPhysicalData(const RealVector& data,
						State& state)
{
...
CFreal Euler2DGammaAlphaCons::getSpeed(const State& state) const
{
...
void Euler2DGammaAlphaCons::setDimensionalValues(const State& state,
                                          RealVector& result)
{
...
void Euler2DGammaAlphaCons::setAdimensionalValues(const State& state,
                                          RealVector& result)
{
  const RealVector& refData = getModel()->getReferencePhysicalData();
...
void Euler2DGammaAlphaCons::setDimensionalValuesPlusExtraValues
 ...
 RealVector& extra)
{
  ...
  result[7] = rhoAlpha*refData[EulerTerm::RHO]*refData[iK+3];
  ...
  const CFreal Omegadim = exp(result[5]);
...
vector<std::string> Euler2DGammaAlphaCons::getExtraVarNames() const
{
...
void Euler2DGammaAlphaCons::computePerturbedPhysicalData
