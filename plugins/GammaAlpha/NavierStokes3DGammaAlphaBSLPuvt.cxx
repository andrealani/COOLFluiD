...
Environment::ObjectProvider<NavierStokes3DGammaAlphaBSLPuvt, DiffusiveVarSet,
	       GammaAlphaModule, 2>
ns3DGammaAlphaBSLPuvtProvider("NavierStokes3DGammaAlphaBSLPvt");

//////////////////////////////////////////////////////////////////////////////

NavierStokes3DGammaAlphaBSLPuvt::NavierStokes3DGammaAlphaBSLPuvt
(const std::string& name, SafePtr<PhysicalModelImpl> model) :
  NavierStokes3DGammaAlphaPuvt(name, model)
{
}
...
void NavierStokes3DGammaAlphaBSLPuvt::computeBlendingCoefFromGradientVars(const RealVector& state, const RealVector& gradK, const RealVector& gradOmega)
{
...
CFreal NavierStokes3DGammaAlphaBSLPuvt::getTurbDynViscosityFromGradientVars(const RealVector& state, const vector<RealVector*>& gradients)
{
  ...
  {
    CFreal mut = NavierStokes3DGammaAlphaPuvt::getTurbDynViscosityFromGradientVars(state, gradients);
