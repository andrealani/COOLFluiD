...
#include "Euler3DGammaAlphaCons.hh"
...
Environment::ObjectProvider<Euler3DGammaAlphaCons, ConvectiveVarSet, GammaAlphaModule, 1>
euler3DGammaAlphaConsProvider("Euler3DGammaAlphaCons");

//////////////////////////////////////////////////////////////////////////////

Euler3DGammaAlphaCons::Euler3DGammaAlphaCons(Common::SafePtr<BaseTerm> term) :
...
Euler3DGammaAlphaCons::~Euler3DGammaAlphaCons()
{
}

//////////////////////////////////////////////////////////////////////////////

void Euler3DGammaAlphaCons::setup()
{
...
void Euler3DGammaAlphaCons::setConstJacob()
{
...
void Euler3DGammaAlphaCons::computeJacobians()
{
...
void Euler3DGammaAlphaCons::computeEigenValuesVectors(RealMatrix& rightEv,
                                           RealMatrix& leftEv,
                                           RealVector& eValues,
                                           const RealVector& normal)
{

  //throw Common::NotImplementedException (FromHere(),"Euler3DGammaAlphaCons::computeEigenValuesVectors()");
  ///@todo fix this, this is only correct for the Euler part, not the 2 turb equations
  const RealVector& linearData = getModel()->getPhysicalData();
  
  CFLog(INFO, "Euler3DGammaAlphaCons::computeEigenValuesVectors: This should not be executed!\n");
...
CFuint Euler3DGammaAlphaCons::getBlockSeparator() const
{
...
void Euler3DGammaAlphaCons::splitJacobian(RealMatrix& jacobPlus,
                                RealMatrix& jacobMin,
                                RealVector& eValues,
                                const RealVector& normal)
{
  throw Common::NotImplementedException (FromHere(),"Euler3DGammaAlphaCons::splitJacobian()");
}

//////////////////////////////////////////////////////////////////////////////

void Euler3DGammaAlphaCons::computePhysicalData(const State& state,
					    RealVector& data)
{
...
void Euler3DGammaAlphaCons::computeStateFromPhysicalData(const RealVector& data,
						State& state)
{
...
CFreal Euler3DGammaAlphaCons::getSpeed(const State& state) const
{
...
void Euler3DGammaAlphaCons::setDimensionalValues(const State& state,
                                          RealVector& result)
{
...
void Euler3DGammaAlphaCons::setAdimensionalValues(const State& state,
                                          RealVector& result)
{
  const RealVector& refData = getModel()->getReferencePhysicalData();
...
void Euler3DGammaAlphaCons::setDimensionalValuesPlusExtraValues
 ...
 RealVector& extra)
{
  ...
  result[3] = rhoW*refData[EulerTerm::RHO]*refData[EulerTerm::V];
  ...
  result[8] = rhoAlpha*refData[EulerTerm::RHO]*refData[iK+3];
...
vector<std::string> Euler3DGammaAlphaCons::getExtraVarNames() const
{
...
void Euler3DGammaAlphaCons::computePerturbedPhysicalData
