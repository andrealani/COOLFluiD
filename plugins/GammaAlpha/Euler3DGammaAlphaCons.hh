#ifndef COOLFluiD_Physics_GammaAlpha_Euler3DGammaAlphaCons_hh
#define COOLFluiD_Physics_GammaAlpha_Euler3DGammaAlphaCons_hh
...
//////////////////////////////////////////////////////////////////////////////
   ...
   */
class Euler3DGammaAlphaCons : public Physics::NavierStokes::MultiScalarVarSet<Physics::NavierStokes::Euler3DCons> {
public: // classes
   ...
   * @see Euler3D
   */
  Euler3DGammaAlphaCons(Common::SafePtr<Framework::BaseTerm> term);

  /**
   * Default destructor
   */
  ~Euler3DGammaAlphaCons();
...
}; // end of class Euler3DGammaAlphaCons
...
#endif // COOLFluiD_Physics_GammaAlpha_Euler3DGammaAlphaCons_hh
