#ifndef COOLFluiD_Physics_GammaAlpha_Euler3DGammaAlphaPuvt_hh
#define COOLFluiD_Physics_GammaAlpha_Euler3DGammaAlphaPuvt_hh
...
//////////////////////////////////////////////////////////////////////////////
   ...
   * variables with Gamma-Alpha transition Model coupled with k-LogOmega turbulence model
   *
   * @author Khalil Bensassi
   * @author Ray Vandenhoeck
   */

class Euler3DGammaAlphaPuvt : public Physics::NavierStokes::MultiScalarVarSet<Physics::NavierStokes::Euler3DPvt<Physics::NavierStokes::Euler3DVarSet> > {
public: // classes
   ...
   * @see Euler3D
   */
  Euler3DGammaAlphaPuvt(Common::SafePtr<Framework::BaseTerm> term);

  /**
   * Default destructor
   */
  ~Euler3DGammaAlphaPuvt();
...
}; // end of class Euler3DGammaAlphaPuvt
...
#endif // COOLFluiD_Physics_GammaAlpha_Euler3DGammaAlphaPuvt_hh
