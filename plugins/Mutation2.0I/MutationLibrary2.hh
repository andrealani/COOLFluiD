#ifndef COOLFluiD_Physics_Mutation2_MutationLibrary2_hh
#define COOLFluiD_Physics_Mutation2_MutationLibrary2_hh
...
/**
 * This class represents the interface for a MutationLibrary2.
 *
 ...
 *
 */
class MutationLibrary2 : public Framework::PhysicalChemicalLibrary {
public:
   ...
   */
  MutationLibrary2(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~MutationLibrary2();
...
private: // helper function
  ...
  void setTVec(CFdouble& tr, RealVector& tVec)
  {
    ...
    _TVEC[1+_nbTvib] = (_nbTe == 0) ? 
      std::min(tVec[0],_maxTe) : std::min(tVec[tVec.size()-1], _maxTe);
  }
...
protected: // data to use to interface FORTRAN77
  ...
  /// Pointer to molecule characteristic vibrational temperatures
  int _ITV;
...
#endif // COOLFluiD_Physics_Mutation2_MutationLibrary2_hh
