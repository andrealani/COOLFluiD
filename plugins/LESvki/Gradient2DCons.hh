#ifndef COOLFluiD_Physics_LESvki_Gradient2DCons_hh
#define COOLFluiD_Physics_LESvki_Gradient2DCons_hh
...
//////////////////////////////////////////////////////////////////////////////
   ...
   * @author Andrea Lani
   */
class Gradient2DCons : public Gradient2DVarSet {
public: // classes
   ...
   * @see NavierStokes2D
   */
  Gradient2DCons(const std::string& name, Common::SafePtr<Framework::PhysicalModelImpl> model);
