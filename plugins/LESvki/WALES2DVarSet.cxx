...
RealVector& WALES2DVarSet::getFlux(const RealVector& state,
...
RealMatrix& WALES2DVarSet::getFlux(const RealVector& state,
                                          const vector<RealVector*>& gradients,
                                          const CFreal& radius)
{
  setGradientState(state);
...
void WALES2DVarSet::getAxiSourceTerm(const RealVector& physicalData,
...
CFreal WALES2DVarSet::getHeatFlux(const RealVector& state,
					 const vector<RealVector*>& gradients,
					 const RealVector& normal)
{
