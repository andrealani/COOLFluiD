...
Environment::ObjectProvider<Gradient2DCons, DiffusiveVarSet,
	       LESvkiModule, 2>
Gradient2DConsProvider("Gradient2DCons");

//////////////////////////////////////////////////////////////////////////////

Gradient2DCons::Gradient2DCons
(const std::string& name, Common::SafePtr<Framework::PhysicalModelImpl> model) :
  Gradient2DVarSet(name, model),
...
void Gradient2DCons::setGradientVars(const vector<RealVector*>& states,
					 RealMatrix& values,
...
void Gradient2DCons::setGradientVarGradients(const vector<RealVector*>& states,
...
void Gradient2DCons::setStateGradients(const vector<RealVector*>& states,
...
CFreal Gradient2DCons::getDynViscosity(const RealVector& state,
...
CFreal Gradient2DCons::getDensity(const RealVector& state)
{
  return state[0];
}
...
void Gradient2DCons::setGradientState(const RealVector& state)
{
...
////////////////////////////////////////////////////////////////////////////////
CFreal Gradient2DCons::getTurbDynViscosityFromGradientVars(const RealVector& state, const vector<RealVector*>& gradients)
{
