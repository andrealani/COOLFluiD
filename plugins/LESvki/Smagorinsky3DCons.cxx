...
Environment::ObjectProvider<Smagorinsky3DCons, DiffusiveVarSet,
	       LESvkiModule, 2>
smacons3DConsProvider("Smagorinsky3DCons");

//////////////////////////////////////////////////////////////////////////////

Smagorinsky3DCons::Smagorinsky3DCons
(const std::string& name, Common::SafePtr<Framework::PhysicalModelImpl> model) :
  Smagorinsky3DVarSet(name, model),
...
void Smagorinsky3DCons::setGradientVars(const vector<RealVector*>& states,
					 RealMatrix& values,
...
void Smagorinsky3DCons::setGradientVarGradients(const vector<RealVector*>& states,
...
void Smagorinsky3DCons::setStateGradients(const vector<RealVector*>& states,
...
CFreal Smagorinsky3DCons::getDynViscosity(const RealVector& state,
...
CFreal Smagorinsky3DCons::getDensity(const RealVector& state)
{
  return state[0];
}
...
void Smagorinsky3DCons::setGradientState(const RealVector& state)
{
...
////////////////////////////////////////////////////////////////////////////////
CFreal Smagorinsky3DCons::getTurbDynViscosityFromGradientVars(const RealVector& state, const vector<RealVector*>& gradients)
{
