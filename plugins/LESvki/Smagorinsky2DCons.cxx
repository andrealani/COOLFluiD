...
Environment::ObjectProvider<Smagorinsky2DCons, DiffusiveVarSet,
	       LESvkiModule, 2>
smacons2DConsProvider("Smagorinsky2DCons");

//////////////////////////////////////////////////////////////////////////////

Smagorinsky2DCons::Smagorinsky2DCons
(const std::string& name, Common::SafePtr<Framework::PhysicalModelImpl> model) :
  Smagorinsky2DVarSet(name, model),
...
void Smagorinsky2DCons::setGradientVars(const vector<RealVector*>& states,
					 RealMatrix& values,
...
void Smagorinsky2DCons::setGradientVarGradients(const vector<RealVector*>& states,
...
void Smagorinsky2DCons::setStateGradients(const vector<RealVector*>& states,
...
CFreal Smagorinsky2DCons::getDynViscosity(const RealVector& state,
...
CFreal Smagorinsky2DCons::getDensity(const RealVector& state)
{
  return state[0];
}
...
void Smagorinsky2DCons::setGradientState(const RealVector& state)
{
...
////////////////////////////////////////////////////////////////////////////////
CFreal Smagorinsky2DCons::getTurbDynViscosityFromGradientVars(const RealVector& state, const vector<RealVector*>& gradients)
{
