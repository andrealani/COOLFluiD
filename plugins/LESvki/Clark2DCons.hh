#ifndef COOLFluiD_Physics_LESvki_Clark2DCons_hh
#define COOLFluiD_Physics_LESvki_Clark2DCons_hh
...
//////////////////////////////////////////////////////////////////////////////
   ...
   * @author Andrea Lani
   */
class Clark2DCons : public Clark2DVarSet {
public: // classes
   ...
   * @see NavierStokes2D
   */
  Clark2DCons(const std::string& name, Common::SafePtr<Framework::PhysicalModelImpl> model);
  ...
  CFreal  getLaminarDynViscosityFromGradientVars(const COOLFluiD::RealVector&) {return 0.;}
