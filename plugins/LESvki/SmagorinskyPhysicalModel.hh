#ifndef COOLFluiD_Physics_LSvki_SmagorinskyPhysicalModel_hh
#define COOLFluiD_Physics_LSvki_SmagorinskyPhysicalModel_hh
...
template <int DIM>
 class SmagorinskyPhysicalModel :
 ...
 public:
    ...
    */
  SmagorinskyPhysicalModel(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~SmagorinskyPhysicalModel();
  ...
  {
    return std::string("Smagorinsky" + Common::StringOps::to_str(DIM) + "D");
  }
...
#include "SmagorinskyPhysicalModel.ci"
