#ifndef COOLFluiD_Physics_LSvki_WALESPhysicalModel_hh
#define COOLFluiD_Physics_LSvki_WALESPhysicalModel_hh
...
template <int DIM>
 ...
 public:
    ...
    */
  WALESPhysicalModel(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~WALESPhysicalModel();
  ...
  {
    return std::string("WALES" + Common::StringOps::to_str(DIM) + "D");
  }
