#ifndef COOLFluiD_Physics_LESvki_Smagorinsky3DCons_hh
#define COOLFluiD_Physics_LESvki_Smagorinsky3DCons_hh
...
//////////////////////////////////////////////////////////////////////////////
   ...
   * @author Andrea Lani
   */
class Smagorinsky3DCons : public Smagorinsky3DVarSet {
public: // classes
   ...
   * @see NavierStokes3D
   */
  Smagorinsky3DCons(const std::string& name, Common::SafePtr<Framework::PhysicalModelImpl> model);
