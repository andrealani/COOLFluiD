...
#ifndef COOLFluiD_Physics_LinearAdv_AdvectionDiffusion3DPrim_hh
#define COOLFluiD_Physics_LinearAdv_AdvectionDiffusion3DPrim_hh
...
class LinearAdv_API AdvectionDiffusion3DPrim : public AdvectionDiffusion3DVarSet {
public: // classes

  /// Constructor
  /// @see AdvectionDiffusion2D
  AdvectionDiffusion3DPrim(const std::string& name, Common::SafePtr<Framework::PhysicalModelImpl> model);

  /// Default destructor
  ~AdvectionDiffusion3DPrim();
