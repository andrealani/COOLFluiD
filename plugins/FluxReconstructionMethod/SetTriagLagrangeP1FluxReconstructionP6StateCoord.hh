#ifndef COOLFluiD_ShapeFunctions_SetTriagLagrangeP1FluxReconstructionP6StateCoord_hh
#define COOLFluiD_ShapeFunctions_SetTriagLagrangeP1FluxReconstructionP6StateCoord_hh
 ...
 * the State's in a triangle with P1 geometrical and P6 solution
 * interpolation.
 *
 ...
 * @author Rayan Dhib
 */
class SetTriagLagrangeP1FluxReconstructionP6StateCoord : public Framework::SetElementStateCoord {
...
public:
   ...
   * Constructor
   */
  SetTriagLagrangeP1FluxReconstructionP6StateCoord() : Framework::SetElementStateCoord()
  {
  }
   ...
   * Destructor
   */
  ~SetTriagLagrangeP1FluxReconstructionP6StateCoord()
  {
  }
...
}; // end of class SetTriagLagrangeP1FluxReconstructionP6StateCoord
...
#endif // COOLFluiD_ShapeFunctions_SetTriagLagrangeP1FluxReconstructionP6StateCoord_hh
