#ifndef COOLFluiD_ShapeFunctions_SetTriagLagrangeP2FluxReconstructionP5StateCoord_hh
#define COOLFluiD_ShapeFunctions_SetTriagLagrangeP2FluxReconstructionP5StateCoord_hh
 ...
 * the State's in a triangle with P2 geometrical and P5 solution
 * interpolation.
 *
 ...
 * @author Rayan Dhib
 */
class SetTriagLagrangeP2FluxReconstructionP5StateCoord : public Framework::SetElementStateCoord {
...
public:
   ...
   * Constructor
   */
  SetTriagLagrangeP2FluxReconstructionP5StateCoord() : Framework::SetElementStateCoord()
  {
  }
   ...
   * Destructor
   */
  ~SetTriagLagrangeP2FluxReconstructionP5StateCoord()
  {
  }
...
}; // end of class SetTriagLagrangeP2FluxReconstructionP5StateCoord
...
#endif // COOLFluiD_ShapeFunctions_SetTriagLagrangeP2FluxReconstructionP5StateCoord_hh
