#ifndef COOLFluiD_ShapeFunctions_SetTriagLagrangeP2FluxReconstructionP8StateCoord_hh
#define COOLFluiD_ShapeFunctions_SetTriagLagrangeP2FluxReconstructionP8StateCoord_hh
 ...
 * the State's in a triangle with P2 geometrical and P8 solution
 * interpolation.
 *
 ...
 * @author Rayan Dhib
 */
class SetTriagLagrangeP2FluxReconstructionP8StateCoord : public Framework::SetElementStateCoord {
...
public:
   ...
   * Constructor
   */
  SetTriagLagrangeP2FluxReconstructionP8StateCoord() : Framework::SetElementStateCoord()
  {
  }
   ...
   * Destructor
   */
  ~SetTriagLagrangeP2FluxReconstructionP8StateCoord()
  {
  }
...
}; // end of class SetTriagLagrangeP2FluxReconstructionP8StateCoord
...
#endif // COOLFluiD_ShapeFunctions_SetTriagLagrangeP2FluxReconstructionP8StateCoord_hh
