#ifndef COOLFluiD_ShapeFunctions_SetQuadLagrangeP2FluxReconstructionP1StateCoord_hh
#define COOLFluiD_ShapeFunctions_SetQuadLagrangeP2FluxReconstructionP1StateCoord_hh
 ...
 */
class SetQuadLagrangeP2FluxReconstructionP1StateCoord : public Framework::SetElementStateCoord {
...
public:
   ...
   * Constructor
   */
  SetQuadLagrangeP2FluxReconstructionP1StateCoord() : Framework::SetElementStateCoord()
  {
  }
   ...
   * Destructor
   */
  ~SetQuadLagrangeP2FluxReconstructionP1StateCoord()
  {
  }
...
}; // end of class SetQuadLagrangeP2FluxReconstructionP1StateCoord
...
#endif // COOLFluiD_ShapeFunctions_SetQuadLagrangeP2FluxReconstructionP1StateCoord_hh
