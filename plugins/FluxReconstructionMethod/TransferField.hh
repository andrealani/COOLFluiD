#ifndef COOLFluiD_FluxReconstructionMethod_TransferField_hh
#define COOLFluiD_FluxReconstructionMethod_TransferField_hh
...
/**
 * This class represent a preprocessing command that transfers the magnetic field from an FR Hyperbolized Poisson solution in another subsystem
 *
 * @author Rayan Dhib
 * 
 ...
 *
 */
class TransferField : public FluxReconstructionSolverCom {
public:

  /**
   * Constructor.
   */
  explicit TransferField(const std::string& name);

  /**
   * Destructor.
   */
  virtual ~TransferField();
...
#endif // COOLFluiD_FluxReconstructionMethod_TransferField_hh
