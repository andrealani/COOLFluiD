#ifndef COOLFluiD_ShapeFunctions_SetTetraLagrangeP2FluxReconstructionP4StateCoord_hh
#define COOLFluiD_ShapeFunctions_SetTetraLagrangeP2FluxReconstructionP4StateCoord_hh
 ...
 * the State's in a Tetra with P2 geometrical and P4 solution
 * interpolation.
 *
 * @author Rayan Dhib
 */
class SetTetraLagrangeP2FluxReconstructionP4StateCoord : public Framework::SetElementStateCoord {
...
public:
   ...
   * Constructor
   */
  SetTetraLagrangeP2FluxReconstructionP4StateCoord() : Framework::SetElementStateCoord()
  {
  }
   ...
   * Destructor
   */
  ~SetTetraLagrangeP2FluxReconstructionP4StateCoord()
  {
  }
...
}; // end of class SetTetraLagrangeP2FluxReconstructionP4StateCoord
