#ifndef COOLFluiD_FluxReconstructionMethod_FluxReconstructionBaseFunctionFaceQuadP1_hh
#define COOLFluiD_FluxReconstructionMethod_FluxReconstructionBaseFunctionFaceQuadP1_hh
...
public:
  ...
  */
        ...
        const RealVector& mappedCoord, RealVector& shapeFunc)
  {
    ...
    const CFreal etaP = (1.0 + mappedCoord[1]);
    shapeFunc[0] = 0.25*ksiM*etaM;
    shapeFunc[1] = 0.25*ksiM*etaP;
    shapeFunc[2] = 0.25*ksiP*etaM;
    shapeFunc[3] = 0.25*ksiP*etaP;
  }
  ...
  {
    return "FluxReconstructionFaceQuadP1";
  }
...
}; // end of class FluxReconstructionBaseFunctionFaceQuadP1
...
#endif // COOLFluiD_FluxReconstructionMethod_FluxReconstructionBaseFunctionFaceQuadP1_hh
