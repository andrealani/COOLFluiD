#ifndef COOLFluiD_ShapeFunctions_SetTriagLagrangeP2FluxReconstructionP4StateCoord_hh
#define COOLFluiD_ShapeFunctions_SetTriagLagrangeP2FluxReconstructionP4StateCoord_hh
 ...
 * the State's in a triangle with P2 geometrical and P4 solution
 * interpolation.
 *
 ...
 * @author Rayan Dhib
 */
class SetTriagLagrangeP2FluxReconstructionP4StateCoord : public Framework::SetElementStateCoord {
...
public:
   ...
   * Constructor
   */
  SetTriagLagrangeP2FluxReconstructionP4StateCoord() : Framework::SetElementStateCoord()
  {
  }
   ...
   * Destructor
   */
  ~SetTriagLagrangeP2FluxReconstructionP4StateCoord()
  {
  }
...
}; // end of class SetTriagLagrangeP2FluxReconstructionP4StateCoord
...
#endif // COOLFluiD_ShapeFunctions_SetTriagLagrangeP2FluxReconstructionP4StateCoord_hh
