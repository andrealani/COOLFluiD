#ifndef COOLFluiD_ShapeFunctions_SetTriagLagrangeP1FluxReconstructionP4StateCoord_hh
#define COOLFluiD_ShapeFunctions_SetTriagLagrangeP1FluxReconstructionP4StateCoord_hh
 ...
 * the State's in a triangle with P1 geometrical and P4 solution
 * interpolation.
 *
 ...
 * @author Rayan Dhib
 */
class SetTriagLagrangeP1FluxReconstructionP4StateCoord : public Framework::SetElementStateCoord {
...
public:
   ...
   * Constructor
   */
  SetTriagLagrangeP1FluxReconstructionP4StateCoord() : Framework::SetElementStateCoord()
  {
  }
   ...
   * Destructor
   */
  ~SetTriagLagrangeP1FluxReconstructionP4StateCoord()
  {
  }
...
}; // end of class SetTriagLagrangeP1FluxReconstructionP4StateCoord
...
#endif // COOLFluiD_ShapeFunctions_SetTriagLagrangeP1FluxReconstructionP4StateCoord_hh
