#ifndef COOLFluiD_ShapeFunctions_SetTriagLagrangeP2FluxReconstructionP0StateCoord_hh
#define COOLFluiD_ShapeFunctions_SetTriagLagrangeP2FluxReconstructionP0StateCoord_hh
 ...
 * the State's in a triangle with P2 geometrical and P0 solution
 * interpolation.
 *
 ...
 * @author Rayan Dhib
 */
class SetTriagLagrangeP2FluxReconstructionP0StateCoord : public Framework::SetElementStateCoord {
...
public:
   ...
   * Constructor
   */
  SetTriagLagrangeP2FluxReconstructionP0StateCoord() : Framework::SetElementStateCoord()
  {
  }
   ...
   * Destructor
   */
  ~SetTriagLagrangeP2FluxReconstructionP0StateCoord()
  {
  }
...
}; // end of class SetTriagLagrangeP2FluxReconstructionP0StateCoord
...
#endif // COOLFluiD_ShapeFunctions_SetTriagLagrangeP2FluxReconstructionP0StateCoord_hh
