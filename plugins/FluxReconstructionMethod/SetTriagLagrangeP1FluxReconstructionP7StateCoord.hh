#ifndef COOLFluiD_ShapeFunctions_SetTriagLagrangeP1FluxReconstructionP7StateCoord_hh
#define COOLFluiD_ShapeFunctions_SetTriagLagrangeP1FluxReconstructionP7StateCoord_hh
 ...
 * the State's in a triangle with P1 geometrical and P7 solution
 * interpolation.
 *
 ...
 * @author Rayan Dhib
 */
class SetTriagLagrangeP1FluxReconstructionP7StateCoord : public Framework::SetElementStateCoord {
...
public:
   ...
   * Constructor
   */
  SetTriagLagrangeP1FluxReconstructionP7StateCoord() : Framework::SetElementStateCoord()
  {
  }
   ...
   * Destructor
   */
  ~SetTriagLagrangeP1FluxReconstructionP7StateCoord()
  {
  }
...
}; // end of class SetTriagLagrangeP1FluxReconstructionP7StateCoord
...
#endif // COOLFluiD_ShapeFunctions_SetTriagLagrangeP1FluxReconstructionP7StateCoord_hh
