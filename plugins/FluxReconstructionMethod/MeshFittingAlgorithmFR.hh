#ifndef COOLFluiD_FluxReconstructionMethod_MeshFittingAlgorithmFR_hh
#define COOLFluiD_FluxReconstructionMethod_MeshFittingAlgorithmFR_hh
 ...
 *
 */
class MeshFittingAlgorithmFR : public Framework::DataProcessingCom {
public:
   ...
   * Constructor
   */
  MeshFittingAlgorithmFR(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~MeshFittingAlgorithmFR();
