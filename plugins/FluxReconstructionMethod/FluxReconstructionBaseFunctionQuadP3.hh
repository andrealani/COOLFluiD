#ifndef COOLFluiD_FluxReconstructionMethod_FluxReconstructionBaseFunctionQuadP3_hh
#define COOLFluiD_FluxReconstructionMethod_FluxReconstructionBaseFunctionQuadP3_hh
 ...
 * representation of the solution in a P3 quadrangular element.
 *
 * @author Kris Van den Abeele
 *
 */
class FluxReconstructionBaseFunctionQuadP3 : public ShapeFunctions::LagrangeShapeFunction {
public:
  ...
  */
        ...
        const RealVector& mappedCoord, RealVector& shapeFunc)
  {
    ...
    for (CFuint iKsi = 0; iKsi < 4; ++iKsi)
    {
      ...
      for (CFuint iEta = 0; iEta < 4; ++iEta, ++iFunc)
      {
  ...
  {
    return "FluxReconstructionQuadP3";
  }
...
}; // end of class FluxReconstructionBaseFunctionQuadP3
...
#endif // COOLFluiD_FluxReconstructionMethod_FluxReconstructionBaseFunctionQuadP3_hh
