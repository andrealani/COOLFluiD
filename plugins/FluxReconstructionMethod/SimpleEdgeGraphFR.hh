#ifndef COOLFluiD_FluxReconstructionMethod_SimpleEdgeFR_hh
#define COOLFluiD_FluxReconstructionMethod_SimpleEdgeFR_hh
...
class SimpleEdgeFR{
public:
  SimpleEdgeFR( Framework::Node* node1 , Framework::Node* node2):
    firstNode(node1),
    secondNode(node2)
  { 
  }
...
class SimpleEdgeGraphFR
{

public: 
  
  SimpleEdgeGraphFR():socket_nodes("socket_nodes"){;}
  ...
  public:
    ...
    iterator(const SimpleEdgeGraphFR &edgeGraph) :
	...
	m_edgeGraph->socket_nodes.getDataHandle();
      ...
      SimpleEdgeFR tmp( nodes[firstNodeID], nodes[secondNodeID]);
      return tmp;
    }
  ...
  private:
    SimpleEdgeGraphFR const *m_edgeGraph;
    CFuint m_row;
    CFuint m_col;
  };
