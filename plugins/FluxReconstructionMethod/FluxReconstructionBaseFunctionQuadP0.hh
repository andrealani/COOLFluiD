#ifndef COOLFluiD_FluxReconstructionMethod_FluxReconstructionBaseFunctionQuadP0_hh
#define COOLFluiD_FluxReconstructionMethod_FluxReconstructionBaseFunctionQuadP0_hh
...
public:
  ...
  */
        ...
        const RealVector& mappedCoord, RealVector& shapeFunc)
  {
    ...
    CFuint iFunc = 0;
    for (CFuint iKsi = 0; iKsi < nbrSolPnts; ++iKsi)
    {
      const CFreal ksiFac = m_ksiFac[iKsi];
      for (CFuint iEta = 0; iEta < nbrSolPnts; ++iEta, ++iFunc)
      {
  ...
  {
    return "FluxReconstructionQuadP0";
  }
...
}; // end of class FluxReconstructionBaseFunctionQuadP0
...
#endif // COOLFluiD_FluxReconstructionMethod_FluxReconstructionBaseFunctionQuadP0_hh
