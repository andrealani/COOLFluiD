#ifndef COOLFluiD_FluxReconstructionMethod_ConvFaceTermRHSFluxReconstruction_hh
#define COOLFluiD_FluxReconstructionMethod_ConvFaceTermRHSFluxReconstruction_hh
 ...
 *
 */
class ConvFaceTermRHSFluxReconstruction : public FluxReconstructionSolverCom {
public:

  /**
   * Constructor.
   */
  explicit ConvFaceTermRHSFluxReconstruction(const std::string& name);

  /**
   * Destructor.
   */
  virtual ~ConvFaceTermRHSFluxReconstruction();
...
}; // class ConvFaceTermRHSFluxReconstruction
