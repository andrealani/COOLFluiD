...
#ifndef COOLFluiD_FluxReconstructionMethod_ConvLLAVJacobFluxReconstruction_hh
#define COOLFluiD_FluxReconstructionMethod_ConvLLAVJacobFluxReconstruction_hh
...
public: // functions
  ...
  /// Constructor
  explicit ConvLLAVJacobFluxReconstruction(const std::string& name);

  /// Destructor
  virtual ~ConvLLAVJacobFluxReconstruction() {}
...
#endif // COOLFluiD_FluxReconstructionMethod_ConvLLAVJacobFluxReconstruction_hh
