...
#include "FluxReconstructionMethod/ComputeFieldFromPotential.hh"
...
MethodCommandProvider<ComputeFieldFromPotential, FluxReconstructionSolverData, FluxReconstructionModule> ComputeFieldFromPotentialFluxReconstructionProvider("ComputeFieldFromPotential");
...
void ComputeFieldFromPotential::configure ( Config::ConfigArgs& args )
{
  ...
  CFLog(VERBOSE, "ComputeFieldFromPotential::configure() => m_otherNamespace = " << m_otherNamespace << "\n");
...
//    const CFuint nbStates = states.size();
        ...
        {
          CFLog(INFO, "ComputeFieldFromPotential::execute() => Extrapolation to different radius mesh (InterRadius > 0) not implemented for FR!!\n");
          cf_assert(false);
...
void ComputeFieldFromPotential::computeFlxPntStates(std::vector< RealVector > states, std::vector< RealVector >& statesFlxPnt)
{
...
ComputeFieldFromPotential::providesSockets()
{
