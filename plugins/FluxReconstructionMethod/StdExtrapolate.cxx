#include "FluxReconstructionMethod/StdExtrapolate.hh"
...
MethodCommandProvider< StdExtrapolate,FluxReconstructionSolverData,FluxReconstructionModule >
...
void StdExtrapolate::execute()
{
  ...
  for (CFuint iElemType = 0; iElemType < nbrElemTypes; ++iElemType)
  {
    ...
    SafePtr< vector< RealVector > > cellNodeLocalCoords
        = frLocalData[iElemType]->getCellNodeCoords();
    ...
    vector< vector< CFreal > > solPolyValsAtNodes
        = frLocalData[iElemType]->getSolPolyValsAtNode(*cellNodeLocalCoords);
