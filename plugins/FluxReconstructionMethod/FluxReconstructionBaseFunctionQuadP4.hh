#ifndef COOLFluiD_FluxReconstructionMethod_FluxReconstructionBaseFunctionQuadP4_hh
#define COOLFluiD_FluxReconstructionMethod_FluxReconstructionBaseFunctionQuadP4_hh
 ...
 * representation of the solution in a P4 quadrangular element.
 *
 * @author Kris Van den Abeele
 *
 */
class FluxReconstructionBaseFunctionQuadP4 : public ShapeFunctions::LagrangeShapeFunction {
public:
  ...
  */
        ...
        const RealVector& mappedCoord, RealVector& shapeFunc)
  {
    ...
    for (CFuint iKsi = 0; iKsi < 5; ++iKsi)
    {
      ...
      for (CFuint iEta = 0; iEta < 5; ++iEta, ++iFunc)
      {
  ...
  {
    return "FluxReconstructionQuadP4";
  }
...
}; // end of class FluxReconstructionBaseFunctionQuadP4
...
#endif // COOLFluiD_FluxReconstructionMethod_FluxReconstructionBaseFunctionQuadP4_hh
