#include "FluxReconstructionMethod/SimpleEdgeGraphFR.hh"
...
void SimpleEdgeGraphFR::setNodeDataSocketFR( Framework::DataSocketSink < Framework::Node* , Framework::GLOBAL > nodes )
{
  socket_nodes = nodes;
}
 
void SimpleEdgeGraphFR::computeConnectivityFR(){
