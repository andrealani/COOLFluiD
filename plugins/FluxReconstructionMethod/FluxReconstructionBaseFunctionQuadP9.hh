#ifndef COOLFluiD_FluxReconstructionMethod_FluxReconstructionBaseFunctionQuadP9_hh
#define COOLFluiD_FluxReconstructionMethod_FluxReconstructionBaseFunctionQuadP9_hh
 ...
 * representation of the solution in a P9 quadrangular element.
 *
 * @author Ray Vandenhoeck
 * @author Alexander Papen
 *
 */
class FluxReconstructionBaseFunctionQuadP9 : public ShapeFunctions::LagrangeShapeFunction {
public:
  ...
  */
        ...
        const RealVector& mappedCoord, RealVector& shapeFunc)
  {
    ...
    for (CFuint iKsi = 0; iKsi < 10; ++iKsi)
    {
      ...
      for (CFuint iEta = 0; iEta < 10; ++iEta, ++iFunc)
      {
  ...
  {
    return "FluxReconstructionQuadP9";
  }
...
}; // end of class FluxReconstructionBaseFunctionQuadP9
...
#endif // COOLFluiD_FluxReconstructionMethod_FluxReconstructionBaseFunctionQuadP9_hh
