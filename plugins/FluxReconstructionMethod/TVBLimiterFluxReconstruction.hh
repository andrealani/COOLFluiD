#ifndef COOLFluiD_FluxReconstructionMethod_TVBLimiterFluxReconstruction_hh
#define COOLFluiD_FluxReconstructionMethod_TVBLimiterFluxReconstruction_hh
 ...
 *
 */
class TVBLimiterFluxReconstruction : public FluxReconstructionSolverCom {
public:

  /**
   * Constructor.
   */
  explicit TVBLimiterFluxReconstruction(const std::string& name);

  /**
   * Destructor.
   */
  virtual ~TVBLimiterFluxReconstruction();
...
}; // class TVBLimiterFluxReconstruction
...
#endif // COOLFluiD_FluxReconstructionMethod_TVBLimiterFluxReconstruction_hh
