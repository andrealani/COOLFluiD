#ifndef COOLFluiD_FluxReconstructionMethod_FluxReconstructionBaseFunctionQuadP8_hh
#define COOLFluiD_FluxReconstructionMethod_FluxReconstructionBaseFunctionQuadP8_hh
 ...
 * representation of the solution in a P8 quadrangular element.
 *
 * @author Ray Vandenhoeck
 * @author Alexander Papen
 *
 */
class FluxReconstructionBaseFunctionQuadP8 : public ShapeFunctions::LagrangeShapeFunction {
public:
  ...
  */
        ...
        const RealVector& mappedCoord, RealVector& shapeFunc)
  {
    ...
    for (CFuint iKsi = 0; iKsi < 9; ++iKsi)
    {
      ...
      for (CFuint iEta = 0; iEta < 9; ++iEta, ++iFunc)
      {
  ...
  {
    return "FluxReconstructionQuadP8";
  }
...
}; // end of class FluxReconstructionBaseFunctionQuadP8
...
#endif // COOLFluiD_FluxReconstructionMethod_FluxReconstructionBaseFunctionQuadP8_hh
