...
#include "FluxReconstructionMethod/TVBLimiterFluxReconstruction.hh"
...
MethodCommandProvider<TVBLimiterFluxReconstruction, FluxReconstructionSolverData, FluxReconstructionModule> TVBLimiterFluxReconstructionProvider("TVBLimiter");

//////////////////////////////////////////////////////////////////////////////

void TVBLimiterFluxReconstruction::defineConfigOptions(Config::OptionList& options)
{
...
TVBLimiterFluxReconstruction::TVBLimiterFluxReconstruction(const std::string& name) :
...
TVBLimiterFluxReconstruction::~TVBLimiterFluxReconstruction()
{
}

//////////////////////////////////////////////////////////////////////////////

void TVBLimiterFluxReconstruction::configure ( Config::ConfigArgs& args )
{
...
void TVBLimiterFluxReconstruction::execute()
{
  CFTRACEBEGIN;
  CFLog(VERBOSE, "EXECUTE TVBLimiterFluxReconstruction\n");
...
void TVBLimiterFluxReconstruction::resetNodeNghbrCellAvgStates()
{
...
void TVBLimiterFluxReconstruction::setAvgReconstructionData(CFuint iElemType)
{
...
void TVBLimiterFluxReconstruction::setAllReconstructionData(CFuint iElemType)
{
  // set reconstruction data for averaged solutions
  setAvgReconstructionData(iElemType);
  ...
  m_allFlxPntIdxs = frLocalData[iElemType]->getAllFlxPntIdxs();

  // get flux point index (in the matrix flxPntRecCoefs) for reconstruction
  m_flxPntMatrixIdxForReconstruction = frLocalData[iElemType]->getFlxPntMatrixIdxForReconstruction();

  // get reconstruction coefficients for the flux points
  m_flxPntsRecCoefs = frLocalData[iElemType]->getRecCoefsFlxPnts1D();

  // get solution point index (in the cell) for reconstruction
  m_solPntIdxsForReconstruction = frLocalData[iElemType]->getSolPntIdxsForReconstruction();
  ...
  m_nbrFlxPnts = frLocalData[iElemType]->getNbrOfFlxPnts();
}

//////////////////////////////////////////////////////////////////////////////

void TVBLimiterFluxReconstruction::reconstructCellAveragedState()
{
...
void TVBLimiterFluxReconstruction::reconstructCellAveragedVariable(const CFuint iEq)
{
...
void TVBLimiterFluxReconstruction::computeCellCenterDerivVariable(const CFuint iEq)
{
...
void TVBLimiterFluxReconstruction::setMinMaxNodeNghbrCellAvgStates()
{
  // get the data handles for the minimum and maximum nodal states
  DataHandle< RealVector > nodeNghbCellMinAvgStates = socket_nodeNghbCellMinAvgStates.getDataHandle();
  DataHandle< RealVector > nodeNghbCellMaxAvgStates = socket_nodeNghbCellMaxAvgStates.getDataHandle();
...
void TVBLimiterFluxReconstruction::setMinMaxNghbrCellAvgStates()
{
  // get the data handles for the minimum and maximum nodal states
  DataHandle< RealVector > nodeNghbCellMinAvgStates = socket_nodeNghbCellMinAvgStates.getDataHandle();
  DataHandle< RealVector > nodeNghbCellMaxAvgStates = socket_nodeNghbCellMaxAvgStates.getDataHandle();
...
void TVBLimiterFluxReconstruction::setLimitBooleans()
{
...
void TVBLimiterFluxReconstruction::limitStates()
{
  for (CFuint iEq = 0; iEq < m_nbrEqs; ++iEq)
  {
/*    if (m_applyLimiterToPhysVar[iEq])
...
void TVBLimiterFluxReconstruction::setup()
{
  CFAUTOTRACE;
...
void TVBLimiterFluxReconstruction::unsetup()
{
  CFAUTOTRACE;
...
TVBLimiterFluxReconstruction::providesSockets()
{
