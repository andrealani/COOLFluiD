#include "FluxReconstructionMethod/SimpleEdgeGraphFRQ2.hh"
...
void SimpleEdgeGraphFRQ2::setNodeDataSocketFR( Framework::DataSocketSink < Framework::Node* , Framework::GLOBAL > nodes )
{
  socket_nodes = nodes;
}
...
void SimpleEdgeGraphFRQ2::computeConnectivityFR(){
  ...
  m_nbOfNeighborCellsToaNode.clear();
  m_nbOfNeighborCellsToaNode.resize(nbNodes);
  ...
  for (CFuint iNode = 0; iNode < nbNodes; ++iNode)
  {
    ...
    m_nbOfNeighborCellsToaNode[nodes[iNode]->getLocalID()] = nbNeighborCells;
