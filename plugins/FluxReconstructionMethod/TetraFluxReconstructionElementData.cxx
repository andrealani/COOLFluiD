...
switch(polyOrder)
    {
      ...
      case CFPolyOrder::ORDER4:   // To be ordered from P4 to P
      {
                        m_flxPntsLocalCoord2D[0][0] = 0.035870877695734; 
                        m_flxPntsLocalCoord2D[0][1] = 0.035870877695734;

                        m_flxPntsLocalCoord2D[1][0] = 0.928258244608533; 
                        m_flxPntsLocalCoord2D[1][1] = 0.035870877695734;

                        m_flxPntsLocalCoord2D[2][0] = 0.035870877695734; 
                        m_flxPntsLocalCoord2D[2][1] = 0.928258244608533; 

                        m_flxPntsLocalCoord2D[3][0] = 0.241729395767967;
                        m_flxPntsLocalCoord2D[3][1] = 0.241729395767967;

                        m_flxPntsLocalCoord2D[4][0] = 0.516541208464066; 
                        m_flxPntsLocalCoord2D[4][1] = 0.241729395767967; 

                        m_flxPntsLocalCoord2D[5][0] = 0.241729395767967; 
                        m_flxPntsLocalCoord2D[5][1] = 0.516541208464066; 

                        m_flxPntsLocalCoord2D[6][0] = 0.474308787777079;
                        m_flxPntsLocalCoord2D[6][1] = 0.051382424445843; 

                        m_flxPntsLocalCoord2D[7][0] = 0.051382424445843;
                        m_flxPntsLocalCoord2D[7][1] = 0.474308787777079;

                        m_flxPntsLocalCoord2D[8][0] = 0.474308787777079; 
                        m_flxPntsLocalCoord2D[8][1] = 0.474308787777079;

                        m_flxPntsLocalCoord2D[9][0] = 0.751183631106484; 
                        m_flxPntsLocalCoord2D[9][1] = 0.047312487011716;

                        m_flxPntsLocalCoord2D[10][0] = 0.047312487011716; 
                        m_flxPntsLocalCoord2D[10][1] = 0.751183631106484;

                        m_flxPntsLocalCoord2D[11][0] =  0.201503881881800;
                        m_flxPntsLocalCoord2D[11][1] =  0.751183631106484;

                        m_flxPntsLocalCoord2D[12][0] = 0.201503881881800; 
                        m_flxPntsLocalCoord2D[12][1] =  0.047312487011716;

                        m_flxPntsLocalCoord2D[13][0] = 0.047312487011716;
                        m_flxPntsLocalCoord2D[13][1] = 0.201503881881800;

                        m_flxPntsLocalCoord2D[14][0] = 0.751183631106484; 
                        m_flxPntsLocalCoord2D[14][1] = 0.201503881881800;
      ...
      case CFPolyOrder::ORDER5:
      {
                        ...
                        m_flxPntsLocalCoord2D[1][0] = 0.943774095634672;
                        m_flxPntsLocalCoord2D[1][1] = 0.028112952182664; 

                        m_flxPntsLocalCoord2D[2][0] = 0.028112952182664;
                        m_flxPntsLocalCoord2D[2][1] = 0.943774095634672;

                        m_flxPntsLocalCoord2D[3][0] = 0.177139098469317;
                        m_flxPntsLocalCoord2D[3][1] = 0.177139098469317;

                        m_flxPntsLocalCoord2D[4][0] = 0.645721803061365; 
                        m_flxPntsLocalCoord2D[4][1] = 0.177139098469317;

                        m_flxPntsLocalCoord2D[5][0] = 0.177139098469317;
                        m_flxPntsLocalCoord2D[5][1] = 0.645721803061365;

                        m_flxPntsLocalCoord2D[6][0] = 0.405508595867433;
                        m_flxPntsLocalCoord2D[6][1] = 0.188982808265134;

                        m_flxPntsLocalCoord2D[7][0] = 0.188982808265134;
                        m_flxPntsLocalCoord2D[7][1] = 0.405508595867433;

                        m_flxPntsLocalCoord2D[8][0] = 0.405508595867433;
                        m_flxPntsLocalCoord2D[8][1] = 0.405508595867433;

                        m_flxPntsLocalCoord2D[9][0] = 0.817900980028499; 
                        m_flxPntsLocalCoord2D[9][1] = 0.033533207700614;

                        m_flxPntsLocalCoord2D[10][0] = 0.033533207700614; 
                        m_flxPntsLocalCoord2D[10][1] = 0.817900980028499;

                        m_flxPntsLocalCoord2D[11][0] = 0.148565812270887;
                        m_flxPntsLocalCoord2D[11][1] = 0.817900980028499;

                        m_flxPntsLocalCoord2D[12][0] = 0.148565812270887; 
                        m_flxPntsLocalCoord2D[12][1] = 0.033533207700614; 

                        m_flxPntsLocalCoord2D[13][0] = 0.033533207700614;
                        m_flxPntsLocalCoord2D[13][1] = 0.148565812270887;

                        m_flxPntsLocalCoord2D[14][0] = 0.817900980028499;
                        m_flxPntsLocalCoord2D[14][1] = 0.148565812270887;

                        m_flxPntsLocalCoord2D[15][0] = 0.604978911775132; 
                        m_flxPntsLocalCoord2D[15][1] = 0.037824789609186;

                        m_flxPntsLocalCoord2D[16][0] = 0.037824789609186; 
                        m_flxPntsLocalCoord2D[16][1] = 0.604978911775132;

                        m_flxPntsLocalCoord2D[17][0] = 0.357196298615681;
                        m_flxPntsLocalCoord2D[17][1] = 0.604978911775132;

                        m_flxPntsLocalCoord2D[18][0] = 0.357196298615681; 
                        m_flxPntsLocalCoord2D[18][1] = 0.037824789609186;

                        m_flxPntsLocalCoord2D[19][0] = 0.037824789609186; 
                        m_flxPntsLocalCoord2D[19][1] = 0.357196298615681; 

                        m_flxPntsLocalCoord2D[20][0] = 0.604978911775132; 
                        m_flxPntsLocalCoord2D[20][1] = 0.357196298615681; 
