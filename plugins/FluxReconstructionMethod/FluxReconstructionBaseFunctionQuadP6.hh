#ifndef COOLFluiD_FluxReconstructionMethod_FluxReconstructionBaseFunctionQuadP6_hh
#define COOLFluiD_FluxReconstructionMethod_FluxReconstructionBaseFunctionQuadP6_hh
 ...
 * representation of the solution in a P6 quadrangular element.
 *
 * @author Ray Vandenhoeck
 * @author Alexander Papen
 *
 */
class FluxReconstructionBaseFunctionQuadP6 : public ShapeFunctions::LagrangeShapeFunction {
public:
  ...
  */
        ...
        const RealVector& mappedCoord, RealVector& shapeFunc)
  {
    ...
    for (CFuint iKsi = 0; iKsi < 7; ++iKsi)
    {
      ...
      for (CFuint iEta = 0; iEta < 7; ++iEta, ++iFunc)
      {
  ...
  {
    return "FluxReconstructionQuadP6";
  }
...
}; // end of class FluxReconstructionBaseFunctionQuadP6
...
#endif // COOLFluiD_FluxReconstructionMethod_FluxReconstructionBaseFunctionQuadP6_hh
