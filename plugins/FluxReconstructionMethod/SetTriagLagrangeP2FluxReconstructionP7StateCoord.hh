#ifndef COOLFluiD_ShapeFunctions_SetTriagLagrangeP2FluxReconstructionP7StateCoord_hh
#define COOLFluiD_ShapeFunctions_SetTriagLagrangeP2FluxReconstructionP7StateCoord_hh
 ...
 * the State's in a triangle with P2 geometrical and P7 solution
 * interpolation.
 *
 ...
 * @author Rayan Dhib
 */
class SetTriagLagrangeP2FluxReconstructionP7StateCoord : public Framework::SetElementStateCoord {
...
public:
   ...
   * Constructor
   */
  SetTriagLagrangeP2FluxReconstructionP7StateCoord() : Framework::SetElementStateCoord()
  {
  }
   ...
   * Destructor
   */
  ~SetTriagLagrangeP2FluxReconstructionP7StateCoord()
  {
  }
...
}; // end of class SetTriagLagrangeP2FluxReconstructionP7StateCoord
...
#endif // COOLFluiD_ShapeFunctions_SetTriagLagrangeP2FluxReconstructionP7StateCoord_hh
