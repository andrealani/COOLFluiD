#ifndef COOLFluiD_FluxReconstructionMethod_FluxReconstructionBaseFunctionQuadP10_hh
#define COOLFluiD_FluxReconstructionMethod_FluxReconstructionBaseFunctionQuadP10_hh
 ...
 * representation of the solution in a P10 quadrangular element.
 *
 * @author Ray Vandenhoeck
 * @author Alexander Papen
 *
 */
class FluxReconstructionBaseFunctionQuadP10 : public ShapeFunctions::LagrangeShapeFunction {
public:
  ...
  */
        ...
        const RealVector& mappedCoord, RealVector& shapeFunc)
  {
    ...
    for (CFuint iKsi = 0; iKsi < 11; ++iKsi)
    {
      ...
      for (CFuint iEta = 0; iEta < 11; ++iEta, ++iFunc)
      {
  ...
  {
    return "FluxReconstructionQuadP10";
  }
...
}; // end of class FluxReconstructionBaseFunctionQuadP10
...
#endif // COOLFluiD_FluxReconstructionMethod_FluxReconstructionBaseFunctionQuadP10_hh
