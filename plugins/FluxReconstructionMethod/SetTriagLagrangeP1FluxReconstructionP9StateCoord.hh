#ifndef COOLFluiD_ShapeFunctions_SetTriagLagrangeP1FluxReconstructionP9StateCoord_hh
#define COOLFluiD_ShapeFunctions_SetTriagLagrangeP1FluxReconstructionP9StateCoord_hh
 ...
 * the State's in a triangle with P1 geometrical and P9 solution
 * interpolation.
 *
 ...
 * @author Rayan Dhib
 */
class SetTriagLagrangeP1FluxReconstructionP9StateCoord : public Framework::SetElementStateCoord {
...
public:
   ...
   * Constructor
   */
  SetTriagLagrangeP1FluxReconstructionP9StateCoord() : Framework::SetElementStateCoord()
  {
  }
   ...
   * Destructor
   */
  ~SetTriagLagrangeP1FluxReconstructionP9StateCoord()
  {
  }
...
}; // end of class SetTriagLagrangeP1FluxReconstructionP9StateCoord
...
#endif // COOLFluiD_ShapeFunctions_SetTriagLagrangeP1FluxReconstructionP9StateCoord_hh
