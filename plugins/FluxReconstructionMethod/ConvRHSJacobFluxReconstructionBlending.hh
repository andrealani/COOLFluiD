#ifndef COOLFluiD_FluxReconstructionMethod_ConvRHSJacobFluxReconstructionBlending_hh
#define COOLFluiD_FluxReconstructionMethod_ConvRHSJacobFluxReconstructionBlending_hh
 ...
 * FR schemes for convection terms, for both the RHS and the Jacobian with order blending
 *
 * @author Rayan Dhib
 * 
 * based on the class ConvRHSJacobFluxReconstruction
 * @author Ray Vandenhoeck
 * @author Alexander Papen
 *
 */
class ConvRHSJacobFluxReconstructionBlending : public ConvRHSFluxReconstructionBlending {
public:

  /**
   * Constructor.
   */
  explicit ConvRHSJacobFluxReconstructionBlending(const std::string& name);

  /**
   * Destructor.
   */
  virtual ~ConvRHSJacobFluxReconstructionBlending();
...
protected: // data
  ...
  std::vector< std::vector< RealVector > > m_cellStatesFlxPntBackupP0;
  std::vector< std::vector< RealVector> > m_flxPntRiemannFluxBackupP0;
  ...
  std::vector< std::vector< Framework::State* >* > m_states_P0;
...
#endif // COOLFluiD_FluxReconstructionMethod_ConvRHSJacobFluxReconstructionBlending_hh
