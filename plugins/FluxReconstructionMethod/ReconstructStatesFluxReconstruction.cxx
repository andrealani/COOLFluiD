...
Framework::MethodStrategyProvider<
    ReconstructStatesFluxReconstruction,FluxReconstructionSolverData,ReconstructStatesFluxReconstruction,FluxReconstructionModule >
  ReconstructStatesFluxReconstructionProvider("ReconstructStatesFluxReconstruction");

//////////////////////////////////////////////////////////////////////////////

ReconstructStatesFluxReconstruction::ReconstructStatesFluxReconstruction(const std::string& name) :
...
ReconstructStatesFluxReconstruction::~ReconstructStatesFluxReconstruction()
{
  CFAUTOTRACE;
}
...
void ReconstructStatesFluxReconstruction::reconstructState(const vector< State* >& cellStates,
                                                   State& recState,
...
void ReconstructStatesFluxReconstruction::reconstructStates(const vector< State* >& cellStates,
...
void ReconstructStatesFluxReconstruction::reconstructExtraVars(const vector< RealVector* >& cellExtraVars,
...
void ReconstructStatesFluxReconstruction::reconstructGradients(const vector< vector< RealVector >* >& cellGradients,
...
void ReconstructStatesFluxReconstruction::reconstructPhysVar(const CFuint iVar,
...
void ReconstructStatesFluxReconstruction::reconstructPhysVarGrad(const CFuint iVar, const vector< vector< RealVector >* >& cellGradients,
                                                         vector< vector< RealVector* > >& recGradients,
                                                         const RealMatrix& recCoefs,
                                                         const vector< CFuint >& recGradIdxs,
                                                         const vector< CFuint >& recGradMatrixIdxs,
...
void ReconstructStatesFluxReconstruction::computePolyGradients(const vector< Framework::State* >& cellStates,
                                                       vector< vector< RealVector* > >& recGradients,
...
void ReconstructStatesFluxReconstruction::computePolyGradient(const CFuint iVar,
...
void ReconstructStatesFluxReconstruction::setup()
{
