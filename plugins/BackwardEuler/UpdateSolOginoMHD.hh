...
#ifndef COOLFluiD_Numerics_BackwardEuler_UpdateSolOginoMHD_hh
#define COOLFluiD_Numerics_BackwardEuler_UpdateSolOginoMHD_hh
...
class UpdateSolOginoMHD : public BwdEulerCom {
public:
  ...
  /// Constructor.
  explicit UpdateSolOginoMHD(const std::string& name);
...
private:
  ...
  Framework::DataSocketSink< bool> socket_hasToBeUpdated;
...
#endif // COOLFluiD_Numerics_BackwardEuler_UpdateSolOginoMHD_hh
