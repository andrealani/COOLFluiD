#ifndef COOLFluiD_Numerics_FiniteVolume_SubInletEuler1DTtPtYi_hh
#define COOLFluiD_Numerics_FiniteVolume_SubInletEuler1DTtPtYi_hh
...
class SubInletEuler1DTtPtYi : public FVMCC_BC {
public:
   ...
   * Constructor
   */
  SubInletEuler1DTtPtYi(const std::string& name);

  /**
   * Default destructor
   */
  ~SubInletEuler1DTtPtYi();
...
#endif // COOLFluiD_Numerics_FiniteVolume_SubInletEuler1DTtPtYi_hh
