#include "FiniteVolumeNEQ/DistanceBasedExtrapolatorGMoveRhoivtCoupled.hh"
...
MethodStrategyProvider<DistanceBasedExtrapolatorGMoveRhoivtCoupled,
                       CellCenterFVMData,
                       NodalStatesExtrapolator<CellCenterFVMData>,
                       FiniteVolumeNEQModule>
DistanceBasedExtrapolatorGMoveRhoivtCoupledProvider("DistanceBasedGMoveRhoivtCoupled");

//////////////////////////////////////////////////////////////////////////////

void DistanceBasedExtrapolatorGMoveRhoivtCoupled::defineConfigOptions(Config::OptionList& options)
{
...
DistanceBasedExtrapolatorGMoveRhoivtCoupled::DistanceBasedExtrapolatorGMoveRhoivtCoupled
...
void DistanceBasedExtrapolatorGMoveRhoivtCoupled::configure ( Config::ConfigArgs& args )
{
  CFAUTOTRACE;

  DistanceBasedExtrapolatorGMoveRhoivt::configure(args);
...
void DistanceBasedExtrapolatorGMoveRhoivtCoupled::setup()
{
  CFAUTOTRACE;
...
_nbNonCoupledValues = _wValuesIdx.size();
  ...
  if (count != _coupledTRSNames.size()) {
    throw BadValueException
      (FromHere(), "DistanceBasedExtrapolatorGMoveRhoivtCoupled::setup() => Coupled TRS name not found");
  }
...
void DistanceBasedExtrapolatorGMoveRhoivtCoupled::setIndex()
{
  CFAUTOTRACE;
...
void DistanceBasedExtrapolatorGMoveRhoivtCoupled::extrapolateInAllNodes()
{
  CFAUTOTRACE;
...
// CFout << "_isNodeToPrescribe["<<nodeID<<"]: " << _isNodeToPrescribe[nodeID] << "\n";
	      ...
	      nodalStates[nodeID] += _tmpState*weight;
            }

            transformBack(nodalStates[nodeID]);
          }
        }
      }
    }
...
void DistanceBasedExtrapolatorGMoveRhoivtCoupled::extrapolateInNodes
