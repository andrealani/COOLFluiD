#ifndef COOLFluiD_Numerics_FiniteVolume_SubInletEuler1DTtPtYiTv_hh
#define COOLFluiD_Numerics_FiniteVolume_SubInletEuler1DTtPtYiTv_hh
...
//////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * This class implements a subsonic inlet in terms of tTotal, pTotal, Yi and Tv
  *
  * @author Alessandro Munafò
  *
  */
   
class SubInletEuler1DTtPtYiTv : public FVMCC_BC {
public:
   ...
   * Constructor
   */
  SubInletEuler1DTtPtYiTv(const std::string& name);

  /**
   * Default destructor
   */
  ~SubInletEuler1DTtPtYiTv();
