...
#include "FiniteVolumeNEQ/SubInletEuler2DTtPtAlphaYiMultiTvTe.hh"
...
MethodCommandProvider<SubInletEuler2DTtPtAlphaYiMultiTvTe,
                      CellCenterFVMData,
                       FiniteVolumeNEQModule>
subInletEuler2DTtPtAlphaYiMultiTvTeFVMCCProvider("SubInletEuler2DTtPtAlphaYiMultiTvTe");

//////////////////////////////////////////////////////////////////////////////

void SubInletEuler2DTtPtAlphaYiMultiTvTe::defineConfigOptions(Config::OptionList& options)
{
...
SubInletEuler2DTtPtAlphaYiMultiTvTe::SubInletEuler2DTtPtAlphaYiMultiTvTe(const std::string& name) :
  FVMCC_BC(name),
  _varSet(CFNULL),
  _library(CFNULL),
  _dataInnerState()
...
SubInletEuler2DTtPtAlphaYiMultiTvTe::~SubInletEuler2DTtPtAlphaYiMultiTvTe()
{
}

//////////////////////////////////////////////////////////////////////////////

void SubInletEuler2DTtPtAlphaYiMultiTvTe::setGhostState(GeometricEntity *const face)
{
  ...
  for (CFuint i = 0; i < nbSpecies; ++i) {
    ...
    ghostState[i] = yIGhost*Rho_Ghost;
      ...
      ghostState[nbSpecies+3+nbEvEqs] = 2.0*_Te-innerState[nbSpecies+3+nbEvEqs];
  }
...
void SubInletEuler2DTtPtAlphaYiMultiTvTe::setup()
{
  FVMCC_BC::setup();
