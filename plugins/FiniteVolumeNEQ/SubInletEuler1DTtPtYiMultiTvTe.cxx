...
#include "FiniteVolumeNEQ/SubInletEuler1DTtPtYiMultiTvTe.hh"
...
MethodCommandProvider<SubInletEuler1DTtPtYiMultiTvTe,
                      CellCenterFVMData,
                       FiniteVolumeNEQModule>
subInletEuler1DTtPtYiMultiTvTeFVMCCProvider("SubInletEuler1DTtPtYiMultiTvTeFVMCC");

//////////////////////////////////////////////////////////////////////////////

void SubInletEuler1DTtPtYiMultiTvTe::defineConfigOptions(Config::OptionList& options)
{
...
SubInletEuler1DTtPtYiMultiTvTe::SubInletEuler1DTtPtYiMultiTvTe(const std::string& name) :
  FVMCC_BC(name),
  _varSet(CFNULL),
  _library(CFNULL),
  _dataInnerState()
...
SubInletEuler1DTtPtYiMultiTvTe::~SubInletEuler1DTtPtYiMultiTvTe()
{
}

//////////////////////////////////////////////////////////////////////////////

void SubInletEuler1DTtPtYiMultiTvTe::setGhostState(GeometricEntity *const face)
{
  ...
  for (CFuint k = 0;k < nbEvEqs;k++ ){
   ...
   ghostState[nbSpecies+2+nbEvEqs] = 2.0*_Te-innerState[nbSpecies+2+nbEvEqs];
 }

//////////////////////////////////////////////////////////////////////////////

void SubInletEuler1DTtPtYiMultiTvTe::setup()
{
  FVMCC_BC::setup();
