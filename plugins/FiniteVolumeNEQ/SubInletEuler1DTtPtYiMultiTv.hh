#ifndef COOLFluiD_Numerics_FiniteVolume_SubInletEuler1DTtPtYiMultiTv_hh
#define COOLFluiD_Numerics_FiniteVolume_SubInletEuler1DTtPtYiMultiTv_hh
...
//////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * This class implements a subsonic inlet in terms of tTotal, pTotal, Yi and the various Tv
  *
  * @author Alessandro Munafò
  *
  */
   
class SubInletEuler1DTtPtYiMultiTv : public FVMCC_BC {
public:
   ...
   * Constructor
   */
  SubInletEuler1DTtPtYiMultiTv(const std::string& name);

  /**
   * Default destructor
   */
  ~SubInletEuler1DTtPtYiMultiTv();
