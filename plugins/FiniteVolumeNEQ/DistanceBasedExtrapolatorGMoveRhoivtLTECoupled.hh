#ifndef COOLFluiD_Numerics_FiniteVolume_DistanceBasedExtrapolatorGMoveRhoivtLTECoupled_hh
#define COOLFluiD_Numerics_FiniteVolume_DistanceBasedExtrapolatorGMoveRhoivtLTECoupled_hh
 ...
 *
 */
class DistanceBasedExtrapolatorGMoveRhoivtLTECoupled :
  public DistanceBasedExtrapolatorGMoveRhoivtLTE {
...
public:
   ...
   * Constructor
   */
  DistanceBasedExtrapolatorGMoveRhoivtLTECoupled(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~DistanceBasedExtrapolatorGMoveRhoivtLTECoupled();
  ...
  virtual std::vector<Common::SafePtr<Framework::BaseDataSocketSink> > needsSockets()
  {
    std::vector<Common::SafePtr<Framework::BaseDataSocketSink> > result =
      DistanceBasedExtrapolatorGMoveRhoivtLTE::needsSockets();
...
}; // end of class DistanceBasedExtrapolatorGMoveRhoivtLTECoupled
...
#endif // COOLFluiD_Numerics_FiniteVolume_DistanceBasedExtrapolatorGMoveRhoivtLTECoupled_hh
