...
#include "FiniteVolumeNEQ/SubInletEuler1DTtPtYiTv.hh"
...
MethodCommandProvider<SubInletEuler1DTtPtYiTv,
                      CellCenterFVMData,
                       FiniteVolumeNEQModule>
subInletEuler1DTtPtYiTvFVMCCProvider("SubInletEuler1DTtPtYiTvFVMCC");

//////////////////////////////////////////////////////////////////////////////

void SubInletEuler1DTtPtYiTv::defineConfigOptions(Config::OptionList& options)
{
...
SubInletEuler1DTtPtYiTv::SubInletEuler1DTtPtYiTv(const std::string& name) :
  FVMCC_BC(name),
  _varSet(CFNULL),
  _library(CFNULL),
  _dataInnerState()
...
SubInletEuler1DTtPtYiTv::~SubInletEuler1DTtPtYiTv()
{
}

//////////////////////////////////////////////////////////////////////////////

void SubInletEuler1DTtPtYiTv::setGhostState(GeometricEntity *const face)
{  
...
void SubInletEuler1DTtPtYiTv::setup()
{
  FVMCC_BC::setup();
