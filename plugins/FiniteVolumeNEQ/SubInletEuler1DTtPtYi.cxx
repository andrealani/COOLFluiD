...
#include "FiniteVolumeNEQ/SubInletEuler1DTtPtYi.hh"
...
MethodCommandProvider<SubInletEuler1DTtPtYi,
                      CellCenterFVMData,
                       FiniteVolumeNEQModule>
subInletEuler1DTtPtYiFVMCCProvider("SubInletEuler1DTtPtYiFVMCC");

//////////////////////////////////////////////////////////////////////////////

void SubInletEuler1DTtPtYi::defineConfigOptions(Config::OptionList& options)
{
...
SubInletEuler1DTtPtYi::SubInletEuler1DTtPtYi(const std::string& name) :
  FVMCC_BC(name),
  _varSet(CFNULL),
  _library(CFNULL),
  _dataInnerState(),
...
SubInletEuler1DTtPtYi::~SubInletEuler1DTtPtYi()
{
}

//////////////////////////////////////////////////////////////////////////////

void SubInletEuler1DTtPtYi::setGhostState(GeometricEntity *const face)
{
...
void SubInletEuler1DTtPtYi::setup()
{
  FVMCC_BC::setup();
