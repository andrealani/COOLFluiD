...
#include "FiniteVolumeNEQ/SubInletEuler2DTtPtAlphaYi.hh"
...
MethodCommandProvider<SubInletEuler2DTtPtAlphaYi,
                      CellCenterFVMData,
                       FiniteVolumeNEQModule>
subInletEuler2DTtPtAlphaYiFVMCCProvider("SubInletEuler2DTtPtAlphaYi");

//////////////////////////////////////////////////////////////////////////////

void SubInletEuler2DTtPtAlphaYi::defineConfigOptions(Config::OptionList& options)
{
...
SubInletEuler2DTtPtAlphaYi::SubInletEuler2DTtPtAlphaYi(const std::string& name) :
  FVMCC_BC(name),
  _varSet(CFNULL),
  _library(CFNULL),
  _dataInnerState()
...
SubInletEuler2DTtPtAlphaYi::~SubInletEuler2DTtPtAlphaYi()
{
}

//////////////////////////////////////////////////////////////////////////////

void SubInletEuler2DTtPtAlphaYi::setGhostState(GeometricEntity *const face)
{
...
void SubInletEuler2DTtPtAlphaYi::setup()
{
  FVMCC_BC::setup();
