...
#include "FiniteVolumeNEQ/SubInletEuler2DTtPtAlphaYiTv.hh"
...
MethodCommandProvider<SubInletEuler2DTtPtAlphaYiTv,
                      CellCenterFVMData,
                       FiniteVolumeNEQModule>
subInletEuler2DTtPtAlphaYiTvFVMCCProvider("SubInletEuler2DTtPtAlphaYiTv");

//////////////////////////////////////////////////////////////////////////////

void SubInletEuler2DTtPtAlphaYiTv::defineConfigOptions(Config::OptionList& options)
{
...
SubInletEuler2DTtPtAlphaYiTv::SubInletEuler2DTtPtAlphaYiTv(const std::string& name) :
  FVMCC_BC(name),
  _varSet(CFNULL),
  _library(CFNULL),
  _dataInnerState()
...
SubInletEuler2DTtPtAlphaYiTv::~SubInletEuler2DTtPtAlphaYiTv()
{
}

//////////////////////////////////////////////////////////////////////////////

void SubInletEuler2DTtPtAlphaYiTv::setGhostState(GeometricEntity *const face)
{
  ...
  for (CFuint i = 0; i < nbSpecies; ++i) {
   ...
   // ghost state Vibrational Temperature
      ghostState[nbSpecies+3] = 2.0*_Tv-innerState[nbSpecies+3];
 }

//////////////////////////////////////////////////////////////////////////////

void SubInletEuler2DTtPtAlphaYiTv::setup()
{
  FVMCC_BC::setup();
