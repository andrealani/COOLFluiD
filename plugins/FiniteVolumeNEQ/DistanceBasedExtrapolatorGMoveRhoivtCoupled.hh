#ifndef COOLFluiD_Numerics_FiniteVolume_DistanceBasedExtrapolatorGMoveRhoivtCoupled_hh
#define COOLFluiD_Numerics_FiniteVolume_DistanceBasedExtrapolatorGMoveRhoivtCoupled_hh
 ...
 *
 */
class DistanceBasedExtrapolatorGMoveRhoivtCoupled :
...
public:
   ...
   * Constructor
   */
  DistanceBasedExtrapolatorGMoveRhoivtCoupled(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~DistanceBasedExtrapolatorGMoveRhoivtCoupled();
  ...
  virtual std::vector<Common::SafePtr<Framework::BaseDataSocketSink> > needsSockets()
  {
    std::vector<Common::SafePtr<Framework::BaseDataSocketSink> > result =
      DistanceBasedExtrapolatorGMoveRhoivt::needsSockets();
...
}; // end of class DistanceBasedExtrapolatorGMoveRhoivtCoupled
...
#endif // COOLFluiD_Numerics_FiniteVolume_DistanceBasedExtrapolatorGMoveRhoivtCoupled_hh
