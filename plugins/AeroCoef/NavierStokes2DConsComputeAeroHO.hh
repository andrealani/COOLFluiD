#ifndef COOLFluiD_Numerics_AeroCoef_NavierStokes2DConsComputeAeroHO_hh
#define COOLFluiD_Numerics_AeroCoef_NavierStokes2DConsComputeAeroHO_hh
 ...
 */
class NavierStokes2DConsComputeAeroHO : public Framework::DataProcessingCom {
public: // functions
   ...
   * Constructor.
   */
  NavierStokes2DConsComputeAeroHO(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~NavierStokes2DConsComputeAeroHO();
...
/// pressure at infinity
 ...
 std::vector<RealVector> m_QdCf ;
  ...
  /// !!!!!! This is implemented only for non-viscous aerocoefficients!!!!!!!
  bool m_exact_norm;
