#ifndef COOLFluiD_Numerics_AeroCoef_EulerConsComputeAeroSpectralFV_hh
#define COOLFluiD_Numerics_AeroCoef_EulerConsComputeAeroSpectralFV_hh
 ...
 * for Euler2DCons with spectral volume
 *
 * @author Kris Van den Abeele
 *
 */
class EulerConsComputeAeroSpectralFV : public Framework::DataProcessingCom {
public:
   ...
   * Constructor.
   */
  EulerConsComputeAeroSpectralFV(const std::string& name);

  /**
   * Default destructor
   */
  ~EulerConsComputeAeroSpectralFV();
...
private:
  ...
  /// SpectralFV strategy that computes the boundary face terms
  Common::SafePtr< SpectralFV::BaseBndFaceTermComputer > m_bndFaceTermComputer;

  /// the BCStateComputer for this BC
  Common::SafePtr< SpectralFV::BCStateComputer > m_bcStateComputer;
...
}; /// end of class EulerConsComputeAeroSpectralFV
...
#endif /// COOLFluiD_Numerics_AeroCoef_EulerConsComputeAeroSpectralFV_hh
