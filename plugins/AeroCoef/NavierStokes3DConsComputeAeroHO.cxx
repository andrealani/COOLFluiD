...
#include "AeroCoef/NavierStokes3DConsComputeAeroHO.hh"
...
MethodCommandProvider<NavierStokes3DConsComputeAeroHO,
                      DataProcessingData,
                      AeroCoefFSModule>
aNavierStokes3DConsComputeAeroHOProvider("NavierStokes3DConsComputeAeroHO");

//////////////////////////////////////////////////////////////////////////////

void NavierStokes3DConsComputeAeroHO::defineConfigOptions(Config::OptionList& options)
{
...
NavierStokes3DConsComputeAeroHO::NavierStokes3DConsComputeAeroHO(const std::string& name) :
  ...
  m_QdCmf()
{
  ...
  m_isViscous = false; // set from diffusivevar's name

}

//////////////////////////////////////////////////////////////////////////////

NavierStokes3DConsComputeAeroHO::~NavierStokes3DConsComputeAeroHO()
{
	if (isSetup()) unsetup();
}
...
NavierStokes3DConsComputeAeroHO::needsSockets()
{
...
NavierStokes3DConsComputeAeroHO::providesSockets()
{
...
void NavierStokes3DConsComputeAeroHO::setup()
{
...
void NavierStokes3DConsComputeAeroHO::configure ( Config::ConfigArgs& args )
{
  CFAUTOTRACE;
...
void NavierStokes3DConsComputeAeroHO::setFunction()
{
  // some sanity checks
  std::vector<std::string> m_functionDef = Common::StringOps::getWords(m_function);
  if(m_functionDef.size() != 1)
   throw BadValueException (FromHere(),"NavierStokes3DConsComputeAeroHO::setFuntion(): alpha function wrongly defined.");
...
void NavierStokes3DConsComputeAeroHO::executeOnTrs()
{
  CFAUTOTRACE;
...
void NavierStokes3DConsComputeAeroHO::computeWall()
{
  CFAUTOTRACE;
  ...
  DataHandle<const CFreal*> boundaryNormals = m_sockets.getSocketSource<const CFreal*>(socketName)->getDataHandle();
    ...
    for (CFuint iFace = 0; iFace < nbFaces; ++iFace)
    {
      ...
      for(CFuint iDim = 0; iDim < DIM_2D; iDim++){
        normal[iDim] = -(boundaryNormals[iFace])[iDim]; // THIS IS OK BECAUSE NON-CURVED ELEMENTS
      }
...
void NavierStokes3DConsComputeAeroHO::computeAero()
{
  CFAUTOTRACE;
  ...
  // project Cp
  CFreal actual_lift = (sin(m_alpharad)*(Cp[XX] + Cf[XX]) + cos(m_alpharad)*(Cp[YY] + Cf[YY])) / refLength;
  ...
  CFreal actual_drag = actual_drag_p + actual_drag_f;
...
void NavierStokes3DConsComputeAeroHO::unsetup()
{
...
void NavierStokes3DConsComputeAeroHO::prepareOutputFileWall()
{
