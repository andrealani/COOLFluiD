#ifndef COOLFluiD_Numerics_AeroCoef_NavierStokesComputeAeroDG_hh
#define COOLFluiD_Numerics_AeroCoef_NavierStokesComputeAeroDG_hh
 ...
 *
 */
class NavierStokesComputeAeroDG : public Framework::DataProcessingCom {
public:
   ...
   * Constructor.
   */
  NavierStokesComputeAeroDG(const std::string& name);

  /**
   * Default destructor
   */
  ~NavierStokesComputeAeroDG();
...
}; /// end of class NavierStokesComputeAeroDG
...
#endif /// COOLFluiD_Numerics_AeroCoef_NavierStokesComputeAeroDG_hh
