#ifndef COOLFluiD_Numerics_AeroCoef_NavierStokes2DConsComputeAero_hh
#define COOLFluiD_Numerics_AeroCoef_NavierStokes2DConsComputeAero_hh
 ...
 */
class NavierStokes2DConsComputeAero : public Framework::DataProcessingCom {
public: // functions
   ...
   * Constructor.
   */
  NavierStokes2DConsComputeAero(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~NavierStokes2DConsComputeAero();
...
/// pressure at infinity
  ...
  bool m_isViscous;
}; // end of class NavierStokes2DConsComputeAero
...
#endif // COOLFluiD_Numerics_AeroCoef_NavierStokes2DConsComputeAero_hh
