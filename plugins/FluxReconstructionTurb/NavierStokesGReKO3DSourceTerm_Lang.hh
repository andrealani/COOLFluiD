#ifndef COOLFluiD_FluxReconstructionMethod_NavierStokesGReKO3DSourceTerm_Lang_hh
#define COOLFluiD_FluxReconstructionMethod_NavierStokesGReKO3DSourceTerm_Lang_hh
 ...
 *
 */
class NavierStokesGReKO3DSourceTerm_Lang : 
...
public:
   ...
   * Constructor
   */
  NavierStokesGReKO3DSourceTerm_Lang(const std::string& name);

  /**
   * Default destructor
   */
  ~NavierStokesGReKO3DSourceTerm_Lang();
...
}; // end of class NavierStokesGReKO3DSourceTerm_Lang
...
#endif // COOLFluiD_FluxReconstructionMethod_NavierStokesGReKO3DSourceTerm_hh
