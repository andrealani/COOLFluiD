#ifndef COOLFluiD_FluxReconstructionMethod_GammaAlpha3DSourceTerm_hh
#define COOLFluiD_FluxReconstructionMethod_GammaAlpha3DSourceTerm_hh
...
/**
 * This class represents the 3D Gamma-Re_theta-K-Omega Source Term for FR
 *
 * @author Ray Vandenhoeck
 *
 */
class GammaAlpha3DSourceTerm : 
	public KLogOmega3DSourceTerm {
...
public:
   ...
   * Constructor
   */
  GammaAlpha3DSourceTerm(const std::string& name);

  /**
   * Default destructor
   */
  ~GammaAlpha3DSourceTerm();
...
private: // helper functions
  ...
  CFreal getRethetatwithPressureGradient(const CFreal avAlpha, const CFreal rhoInfLocal, const CFreal uInfLocal, const CFreal muInfLocal, const CFreal mu, const CFreal rho, const CFreal dpx, const CFreal dpy, const CFreal dpz);
...
}; // end of class GammaAlpha3DSourceTerm
...
#endif // COOLFluiD_FluxReconstructionMethod_NavierStokesGammaAlpha3DSourceTerm_hh
