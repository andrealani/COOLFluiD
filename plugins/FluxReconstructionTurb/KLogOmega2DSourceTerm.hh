#ifndef COOLFluiD_FluxReconstructionMethod_KLogOmega2DSourceTerm_hh
#define COOLFluiD_FluxReconstructionMethod_KLogOmega2DSourceTerm_hh
...
/**
 * A base command for adding the source term for 2D K LogOmega
 *
 * @author Ray Vandenhoeck
 */
class KLogOmega2DSourceTerm : public StdSourceTerm {
public:
   ...
   * Constructor.
   */
  explicit KLogOmega2DSourceTerm(const std::string& name);

  /**
   * Destructor.
   */
  ~KLogOmega2DSourceTerm();
...
#endif // COOLFluiD_FluxReconstructionMethod_KLogOmega2DSourceTerm_hh
