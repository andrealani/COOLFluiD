#ifndef COOLFluiD_DiscontGalerkin_StdSolveCells_hh
#define COOLFluiD_DiscontGalerkin_StdSolveCells_hh
 ...
 * @author Martin Holik
 */
class StdSolveCells : public StdBaseSolve{
public: // functions

  /// Constructor
  explicit StdSolveCells(const std::string& name);

  /// Destructor
  virtual ~StdSolveCells();
...
#endif // COOLFluiD_DiscontGalerkin_StdSolveCells_hh
