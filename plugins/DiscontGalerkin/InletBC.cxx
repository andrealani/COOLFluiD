...
#include "DiscontGalerkin/InletBC.hh"
...
MethodCommandProvider< InletBC,DiscontGalerkinSolverData,DiscontGalerkinModule >
  InletBCProvider("InletBC");

//////////////////////////////////////////////////////////////////////////////

void InletBC::defineConfigOptions(Config::OptionList& options)
{
...
InletBC::InletBC(const std::string& name)
: StdBaseSolve(name),
  socket_rhs("rhs"),
  kappa1(0.4)
...
void InletBC::configure ( Config::ConfigArgs& args )
{
  CFAUTOTRACE;
...
void InletBC::ExactRiemannSolver2D(Framework::State UL, Framework::State UR, RealVector S, Framework::State *US)
{
  CFAUTOTRACE;
...
void InletBC::ExactRiemannSolver3D(Framework::State UL, Framework::State UR, RealVector S, Framework::State *US)
{
  CFAUTOTRACE;
// CFout << " left " << UL[0] << " PR " << UL[1] << " CL " << UL[2] << " CR " << UL[3] << CFendl; 
// CFout << " right " << UR[0] << " PR " << UR[1] << " CL " << UR[2] << " CR " << UR[3] << CFendl; 
...
CFreal InletBC::pressure(Framework::State U)
{
...
std::vector<Common::SafePtr<BaseDataSocketSink> > InletBC::needsSockets()
{
