...
#include "DiscontGalerkin/SuperOutletBC.hh"
...
MethodCommandProvider< SuperOutletBC,DiscontGalerkinSolverData,DiscontGalerkinModule >
  SuperOutletBCProvider("SuperOutletBC");

//////////////////////////////////////////////////////////////////////////////

SuperOutletBC::SuperOutletBC(const std::string& name)
: StdBaseSolve(name),
  socket_rhs("rhs"),
  kappa1(0.4)
...
SuperOutletBC::~SuperOutletBC()
{
}

//////////////////////////////////////////////////////////////////////////////

void SuperOutletBC::setup()
{
  CFAUTOTRACE;
...
void SuperOutletBC::unsetup()
{
}

//////////////////////////////////////////////////////////////////////////////

void SuperOutletBC::executeOnTrs()
{
  CFAUTOTRACE;
CFout << "SuperOutletBC applied to " << getCurrentTRS()->getName() << CFendl;
    ...
    for(CFuint kvadrature_point = 0; kvadrature_point < m_nbKvadrPoint; kvadrature_point++ )
    {
      ...
      for(CFuint row = 0; row < nbStatesInCellLeft; row++ )
      {
        for(CFuint i = 0; i < nbEqs; i++ )//loop over member of state - to test function
        {
          ...
          {
            elemVec[row*nbEqs+i]+=(Pminus(i,j))*(state)[j];
          }
...
std::vector<Common::SafePtr<BaseDataSocketSink> > SuperOutletBC::needsSockets()
{
