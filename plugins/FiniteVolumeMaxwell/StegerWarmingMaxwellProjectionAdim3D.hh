#ifndef COOLFluiD_Numerics_FiniteVolume_StegerWarmingMaxwellProjectionAdim3D_hh
#define COOLFluiD_Numerics_FiniteVolume_StegerWarmingMaxwellProjectionAdim3D_hh
...
class StegerWarmingMaxwellProjectionAdim3D : public FVMCC_FluxSplitter {
public:
  
  /**
   * Constructor
   */
  StegerWarmingMaxwellProjectionAdim3D(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~StegerWarmingMaxwellProjectionAdim3D();
...
}; // end of class StegerWarmingMaxwellProjectionAdim3D
...
#include "StegerWarmingMaxwellProjectionAdim3D.ci"

//////////////////////////////////////////////////////////////////////////////

#endif // COOLFluiD_Numerics_FiniteVolume_StegerWarmingMaxwellProjectionAdim3D_hh
