#ifndef COOLFluiD_Numerics_FiniteVolume_StegerWarmingMaxwell3D_hh
#define COOLFluiD_Numerics_FiniteVolume_StegerWarmingMaxwell3D_hh
...
class StegerWarmingMaxwell3D : public FVMCC_FluxSplitter {
public:
  
  /**
   * Constructor
   */
  StegerWarmingMaxwell3D(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~StegerWarmingMaxwell3D();
...
}; // end of class StegerWarmingMaxwell3D
...
#include "StegerWarmingMaxwell3D.ci"

//////////////////////////////////////////////////////////////////////////////

#endif // COOLFluiD_Numerics_FiniteVolume_StegerWarmingMaxwell3D_hh
