#ifndef COOLFluiD_Numerics_FiniteVolume_StegerWarmingMaxwellProjection3D_hh
#define COOLFluiD_Numerics_FiniteVolume_StegerWarmingMaxwellProjection3D_hh
...
class StegerWarmingMaxwellProjection3D : public FVMCC_FluxSplitter {
public:
  
  /**
   * Constructor
   */
  StegerWarmingMaxwellProjection3D(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~StegerWarmingMaxwellProjection3D();
...
}; // end of class StegerWarmingMaxwellProjection3D
...
#include "StegerWarmingMaxwellProjection3D.ci"

//////////////////////////////////////////////////////////////////////////////

#endif // COOLFluiD_Numerics_FiniteVolume_StegerWarmingMaxwellProjection3D_hh
