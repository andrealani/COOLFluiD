...
#include "PerfectConductingWall2DProjectionAdim.hh"
...
MethodCommandProvider<PerfectConductingWall2DProjectionAdim, CellCenterFVMData, FiniteVolumeMaxwellModule> perfectConductingWall2DProjectionAdimFVMCCProvider("PerfectConductingWall2DProjectionAdimFVMCC");

//////////////////////////////////////////////////////////////////////////////

PerfectConductingWall2DProjectionAdim::PerfectConductingWall2DProjectionAdim(const std::string& name) :
  FVMCC_BC(name),
  _varSet(CFNULL),
  _dataInnerState(),
  _dataGhostState()
...
PerfectConductingWall2DProjectionAdim::~PerfectConductingWall2DProjectionAdim()
{
}

//////////////////////////////////////////////////////////////////////////////

void PerfectConductingWall2DProjectionAdim::setup()
{
  FVMCC_BC::setup();
...
void PerfectConductingWall2DProjectionAdim::setGhostState(GeometricEntity *const face)
{
