...
class MacCormackMaxwell3D : public FVMCC_FluxSplitter {
public:
  
  /**
   * Constructor
   */
  MacCormackMaxwell3D(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~MacCormackMaxwell3D();
...
}; // end of class MacCormackMaxwell3D
...
#include "MacCormackMaxwell3D.ci"
