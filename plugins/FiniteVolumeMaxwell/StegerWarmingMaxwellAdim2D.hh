#ifndef COOLFluiD_Numerics_FiniteVolume_StegerWarmingMaxwellAdim2D_hh
#define COOLFluiD_Numerics_FiniteVolume_StegerWarmingMaxwellAdim2D_hh
...
class StegerWarmingMaxwellAdim2D : public FVMCC_FluxSplitter {
public:
  
  /**
   * Constructor
   */
  StegerWarmingMaxwellAdim2D(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~StegerWarmingMaxwellAdim2D();
...
}; // end of class StegerWarmingMaxwellAdim2D
...
#include "StegerWarmingMaxwellAdim2D.ci"

//////////////////////////////////////////////////////////////////////////////

#endif // COOLFluiD_Numerics_FiniteVolume_StegerWarmingMaxwellAdim2D_hh
