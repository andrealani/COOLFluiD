...
class MacCormackMaxwell2D : public FVMCC_FluxSplitter {
public:
  
  /**
   * Constructor
   */
  MacCormackMaxwell2D(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~MacCormackMaxwell2D();
...
}; // end of class MacCormackMaxwell2D
...
#include "MacCormackMaxwell2D.ci"
