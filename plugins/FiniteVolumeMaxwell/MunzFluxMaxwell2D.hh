#ifndef COOLFluiD_Numerics_FiniteVolume_MunzFluxMaxwell2D_hh
#define COOLFluiD_Numerics_FiniteVolume_MunzFluxMaxwell2D_hh
...
/**
 * This class computes the interface flux as suggested in 
 * Computer Physics Communications 130 (2000) 83-117
 * 
 * @author Andrea Lani
...
class MunzFluxMaxwell2D : public FVMCC_FluxSplitter {
public:
  
  /**
   * Constructor
   */
  MunzFluxMaxwell2D(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~MunzFluxMaxwell2D();
  ...
  /**
   * Compute the D SubMatrix
   */
  virtual void computeSubMatrixD(CFreal mu, CFreal nu);
  
  /**
   * Compute the E SubMatrix
   */
  virtual void computeSubMatrixE();    
...
}; // end of class MunzFluxMaxwell2D
...
#include "MunzFluxMaxwell2D.ci"

//////////////////////////////////////////////////////////////////////////////

#endif // COOLFluiD_Numerics_FiniteVolume_MunzFluxMaxwell2D_hh
