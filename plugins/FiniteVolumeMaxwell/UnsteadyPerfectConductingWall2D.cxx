...
#include "UnsteadyPerfectConductingWall2D.hh"
...
MethodCommandProvider<UnsteadyPerfectConductingWall2D, CellCenterFVMData, FiniteVolumeMaxwellModule> unsteadyPerfectConductingWall2DFVMCCProvider("UnsteadyPerfectConductingWall2DFVMCC");

//////////////////////////////////////////////////////////////////////////////

UnsteadyPerfectConductingWall2D::UnsteadyPerfectConductingWall2D(const std::string& name) :
  FVMCC_BC(name),
  _varSet(CFNULL),
  _dataInnerState(),
  _dataGhostState()
...
UnsteadyPerfectConductingWall2D::~UnsteadyPerfectConductingWall2D()
{
}

//////////////////////////////////////////////////////////////////////////////

void UnsteadyPerfectConductingWall2D::setup()
{
  FVMCC_BC::setup();
  
  _varSet = getMethodData().getUpdateVar().d_castTo<Maxwell2DVarSetAdim>();
...
void UnsteadyPerfectConductingWall2D::setGhostState(GeometricEntity *const face)
{
