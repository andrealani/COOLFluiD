...
class MacCormackMaxwell3DProjection : public FVMCC_FluxSplitter {
public:
  
  /**
   * Constructor
   */
  MacCormackMaxwell3DProjection(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~MacCormackMaxwell3DProjection();
...
}; // end of class MacCormackMaxwell3DProjection
...
#include "MacCormackMaxwell3DProjection.ci"
