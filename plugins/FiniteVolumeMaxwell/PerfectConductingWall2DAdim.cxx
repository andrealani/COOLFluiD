...
#include "PerfectConductingWall2DAdim.hh"
...
MethodCommandProvider<PerfectConductingWall2DAdim, CellCenterFVMData, FiniteVolumeMaxwellModule> perfectConductingWall2DAdimFVMCCProvider("PerfectConductingWall2DAdimFVMCC");

//////////////////////////////////////////////////////////////////////////////

PerfectConductingWall2DAdim::PerfectConductingWall2DAdim(const std::string& name) :
  FVMCC_BC(name),
  _varSet(CFNULL),
  _dataInnerState(),
  _dataGhostState()
...
PerfectConductingWall2DAdim::~PerfectConductingWall2DAdim()
{
}

//////////////////////////////////////////////////////////////////////////////

void PerfectConductingWall2DAdim::setup()
{
  FVMCC_BC::setup();
...
void PerfectConductingWall2DAdim::setGhostState(GeometricEntity *const face)
{
