#ifndef COOLFluiD_Numerics_FiniteVolume_StegerWarmingMaxwell2D_hh
#define COOLFluiD_Numerics_FiniteVolume_StegerWarmingMaxwell2D_hh
...
class StegerWarmingMaxwell2D : public FVMCC_FluxSplitter {
public:
  
  /**
   * Constructor
   */
  StegerWarmingMaxwell2D(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~StegerWarmingMaxwell2D();
...
}; // end of class StegerWarmingMaxwell2D
...
#include "StegerWarmingMaxwell2D.ci"

//////////////////////////////////////////////////////////////////////////////

#endif // COOLFluiD_Numerics_FiniteVolume_StegerWarmingMaxwell2D_hh
