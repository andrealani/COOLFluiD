#ifndef COOLFluiD_Numerics_FiniteVolume_MunzFluxMaxwell3D_hh
#define COOLFluiD_Numerics_FiniteVolume_MunzFluxMaxwell3D_hh
...
class MunzFluxMaxwell3D : public FVMCC_FluxSplitter {
public:
  
  /**
   * Constructor
   */
  MunzFluxMaxwell3D(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~MunzFluxMaxwell3D();
...
}; // end of class MunzFluxMaxwell3D
...
#include "MunzFluxMaxwell3D.ci"

//////////////////////////////////////////////////////////////////////////////

#endif // COOLFluiD_Numerics_FiniteVolume_MunzFluxMaxwell3D_hh
