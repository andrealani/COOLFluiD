#ifndef COOLFluiD_Numerics_FiniteVolume_StegerWarmingMaxwellProjectionAdim2D_hh
#define COOLFluiD_Numerics_FiniteVolume_StegerWarmingMaxwellProjectionAdim2D_hh
...
class StegerWarmingMaxwellProjectionAdim2D : public FVMCC_FluxSplitter {
public:
  
  /**
   * Constructor
   */
  StegerWarmingMaxwellProjectionAdim2D(const std::string& name);

  /**
   * Default destructor
   */
  virtual ~StegerWarmingMaxwellProjectionAdim2D();
...
}; // end of class StegerWarmingMaxwellProjectionAdim2D
...
#include "StegerWarmingMaxwellProjectionAdim2D.ci"

//////////////////////////////////////////////////////////////////////////////

#endif // COOLFluiD_Numerics_FiniteVolume_StegerWarmingMaxwellProjectionAdim2D_hh
