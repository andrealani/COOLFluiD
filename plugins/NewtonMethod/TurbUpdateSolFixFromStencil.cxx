...
#include "TurbUpdateSolFixFromStencil.hh"
...
MethodCommandProvider<TurbUpdateSolFixFromStencil, NewtonIteratorData, NewtonMethodModule>
turbUpdateSolProvider("TurbUpdateSolFixFromStencil");

//////////////////////////////////////////////////////////////////////////////

void TurbUpdateSolFixFromStencil::defineConfigOptions(Config::OptionList& options)
{
...
TurbUpdateSolFixFromStencil::TurbUpdateSolFixFromStencil(const std::string& name) :
...
void TurbUpdateSolFixFromStencil::setup()
{
  ...
  if (_alpha.size() != nbEqs) {
    throw BadValueException (FromHere(),"TurbUpdateSolFixFromStencil::setup() : _alpha.size() != nbEqs");
  }
}

//////////////////////////////////////////////////////////////////////////////

void TurbUpdateSolFixFromStencil::execute()
{
  CFAUTOTRACE;
      ...
      for (CFuint iEq = 0; iEq < nbEqs; ++iEq) {
        ...
        if(iEq == 0) {
          if( (*states[iState])[iEq] < 0. ){
            negativeP++;
            (*states[iState])[iEq] = std::max((*states[iState])[iEq], 1000.);
          }
        }
...
vector<SafePtr<BaseDataSocketSink> > TurbUpdateSolFixFromStencil::needsSockets()
{
