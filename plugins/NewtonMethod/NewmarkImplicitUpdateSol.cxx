...
#include "NewmarkImplicitUpdateSol.hh"
...
MethodCommandProvider<NewmarkImplicitUpdateSol, NewtonIteratorData, NewtonMethodModule> newmarkImplicitUpdateSolProvider("NewmarkImplicitUpdateSol");

//////////////////////////////////////////////////////////////////////////////

void NewmarkImplicitUpdateSol::defineConfigOptions(Config::OptionList& options)
{
...
NewmarkImplicitUpdateSol::NewmarkImplicitUpdateSol(const std::string& name)
...
void NewmarkImplicitUpdateSol::execute()
{
  CFAUTOTRACE;
...
vector<SafePtr<BaseDataSocketSink> > NewmarkImplicitUpdateSol::needsSockets()
{
