...
#ifndef COOLFluiD_Numerics_NewtonMethod_CrankNichLimInit_hh
#define COOLFluiD_Numerics_NewtonMethod_CrankNichLimInit_hh
...
class CrankNichLimInit : public NewtonIteratorCom {
public:
  ...
  /// Constructor.
  explicit CrankNichLimInit(const std::string& name);
...
#endif // COOLFluiD_Numerics_NewtonMethod_CrankNichLimInit_hh
