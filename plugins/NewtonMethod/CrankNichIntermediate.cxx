...
MethodCommandProvider<CrankNichIntermediate, NewtonIteratorData, NewtonMethodModule> crankNichIntermediateProvider("CrankNichIntermediate");

//////////////////////////////////////////////////////////////////////////////

void CrankNichIntermediate::execute()
{
  CFAUTOTRACE;
...
vector<SafePtr<BaseDataSocketSink> > CrankNichIntermediate::needsSockets()
{
