...
#ifndef COOLFluiD_Numerics_NewtonMethod_StdUpdateSolPP2_hh
#define COOLFluiD_Numerics_NewtonMethod_StdUpdateSolPP2_hh
...
class StdUpdateSolPP2 : public NewtonIteratorCom {
public:
  ...
  /// Constructor.
  explicit StdUpdateSolPP2(const std::string& name);

  /// Destructor.
  virtual ~StdUpdateSolPP2()
  {
  }
...
protected:
  ...
  /// Check whether define nonhomgenious density within 1.2 Rs
  bool rho_fullMHDorNot;
...
#endif // COOLFluiD_Numerics_NewtonMethod_StdUpdateSolPP2_hh
