...
#     "boost"      => [ "1_85_0", 'on' ,  'off', $priority++,  \&install_boost ],
     "boost"      => [ "1_88_0", 'on' ,  'off', $priority++,  \&install_boost ],
...
#    "petsc"      => [ "3.20.4",'on',  'off', $priority++,  \&install_petsc ],
    "petsc"      => [ "3.24.3", 'on',  'off', $priority++,  \&install_petsc ], 
...
sub install_petsc ()
{
  ...
  unless ($opt_fetchonly)
  {
    ...
    if ($opt_cuda_dir) {
      ...
      if ($version eq "3.6.3" or $version eq "3.7.3a" or $version eq "3.7.3-next" or $version eq "3.7.6" or $version eq "3.9.0" or $version eq "3.9.3" or $version eq "3.12.3" or $version eq "3.15.1" or $version eq "3.18.0" or $version eq "3.20.4" or $version eq "3.24.3") {
         my $cuda_arch="--with-cuda-arch=sm_30";
	 my $cusp_dir="cusp-v0.4.0";  
	 if ($version eq "3.9.0" or $version eq "3.9.3" or $version eq "3.12.3" or $version eq "3.15.1" or $version eq "3.18.0" or $version eq "3.20.4" or $version eq "3.24.3" ) {
	 ...
	 if ($opt_viennacl eq "0") {
	   ...
	   my $cuda_arch="--with-cuda-arch=sm_30";
	   if ($version eq "3.9.0" or $version eq "3.9.3" or $version eq "3.12.3" or $version eq "3.15.1" or $version eq "3.18.0" or $version eq "3.20.4"or $version eq "3.24.3" ) {$cuda_arch="--CUDAFLAGS=-arch=sm_30";} 
  ...
  if ($version eq "3.2-p6") {
   ...
   run_command_or_die("make $opt_makeopts");
  ...
  elsif ($version eq "3.6.3" or $version eq "3.7.3a" or $version eq "3.7.3-next" or $version eq "3.7.6" or $version eq "3.9.0" or $version eq "3.9.3" or $version eq "3.12.3" or $version eq "3.15.1" or $version eq "3.18.0" or $version eq "3.20.4" or $version eq "3.24.3" ) {
    my $FFLAGS = "-O3 ";
    my $F90FLAGS ="-O3 ";
    my $CFLAGS ="-O3 "; 
    my $CXXFLAGS ="-O3 ";
    ...
    if ($version eq "3.7.6" or $version eq "3.9.0" or $version eq "3.9.3" or $version eq "3.12.3" or $version eq "3.15.1" or $version eq "3.18.0" or $version eq "3.20.4" or $version eq "3.24.3" ) {
      $dynamicload ="";
    } 
...
sub install_boost()
{
  ...
  unless ($opt_fetchonly)
  {
    ...
    unless ($opt_nompi or $version  eq "1_59_0" or $version eq "1_62_0" or $version eq "1_66_0" or $version eq "1_70_0" or $version eq "1_72_0" or $version eq "1_76_0" or $version eq "1_79_0" or $version eq "1_85_0" or $version eq "1_88_0" or $version eq "1_90_0")  {
...
ZZZ
   ...
   if ($version eq "1_79_0" or $version eq "1_85_0" or $version eq "1_88_0" or $version eq "1_90_0")
      {
