...
if( CF_PERFORM_PTESTS )
  ctest_test(BUILD "${CTEST_BINARY_DIRECTORY}/src" APPEND INCLUDE "test-perf")
  if (CF_SUBMIT_TO_DASHBOARD_SERVER)
    ctest_submit(PARTS Test)
  endif()
endif()
...
if( CF_PERFORM_PCASES )
  ctest_test(BUILD "${CTEST_BINARY_DIRECTORY}/src" APPEND INCLUDE "case-perf")
  if (CF_SUBMIT_TO_DASHBOARD_SERVER)
    ctest_submit(PARTS Test)
  endif()
endif
...
message("COVERAGE")
  ...
  ctest_coverage(BUILD "${CTEST_BINARY_DIRECTORY}/src" APPEND)
