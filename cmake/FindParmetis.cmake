...
IF ( NOT CF_SKIP_PARMETIS OR NOT CF_HAVE_MPI )
 ...
 ENDIF( CF_ENABLE_STATIC )
  ...
  FIND_LIBRARY(PARMETIS_LIB_PARMETIS ${CF_LIBPARMETIS_NAME} ${TRIAL_LIBRARY_PATHS} NO_DEFAULT_PATH)

  IF ( NOT PARMETIS_LIB_PARMETIS )
    FIND_LIBRARY(PARMETIS_LIB_PARMETIS ${CF_LIBPARMETIS_NAME} )
  ENDIF() 

 FIND_LIBRARY(PARMETIS_LIB_METIS ${CF_LIBMETIS_NAME} ${TRIAL_LIBRARY_PATHS} NO_DEFAULT_PATH)
  
 IF ( NOT PARMETIS_LIB_METIS )
    FIND_LIBRARY(PARMETIS_LIB_METIS ${CF_LIBMETIS_NAME} )
 ENDIF()
