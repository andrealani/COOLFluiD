...
#ifndef COOLFluiD_ShapeFunctions_SetTriagLagrangeP1LagrangeP3StateCoord_hh
#define COOLFluiD_ShapeFunctions_SetTriagLagrangeP1LagrangeP3StateCoord_hh
...
class ShapeFunctions_API SetTriagLagrangeP1LagrangeP3StateCoord : public Framework::SetElementStateCoord {
public:

  /// Constructor
  SetTriagLagrangeP1LagrangeP3StateCoord() :
  Framework::SetElementStateCoord(),
  _tempMappedCoords(10),
  _tempShapeFunctions(3)
  {
...
}; // end of class SetTriagLagrangeP1LagrangeP2StateCoord
...
#endif // COOLFluiD_ShapeFunctions_SetTriagLagrangeP1LagrangeP3StateCoord_hh
