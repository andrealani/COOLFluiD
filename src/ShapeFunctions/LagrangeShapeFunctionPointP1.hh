...
#ifndef COOLFluiD_Numerics_ShapeFunctions_LagrangeShapeFunctionPointP1_hh
#define COOLFluiD_Numerics_ShapeFunctions_LagrangeShapeFunctionPointP1_hh
...
/// 1D element.
/// @author Andrea Lani
class ShapeFunctions_API LagrangeShapeFunctionPointP1 : public ShapeFunctions::LagrangeShapeFunction {
public:
  ...
  {
    static const std::string name = "LagrangePointP1";
    return name;
  }
...
}; // end of class LagrangeShapeFunctionPointP1
...
#endif // COOLFluiD_Numerics_ShapeFunctions_LagrangeShapeFunctionPointP1_hh
