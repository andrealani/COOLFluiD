...
#ifndef COOLFluiD_ShapeFunctions_SetPyramLagrangeP1LagrangeP0StateCoord_hh
#define COOLFluiD_ShapeFunctions_SetPyramLagrangeP1LagrangeP0StateCoord_hh
...
/// the State's in a pyramid with P1 geometrical and P0 solution
/// interpolation.
/// @author Andrea Lani
class ShapeFunctions_API SetPyramLagrangeP1LagrangeP0StateCoord : public Framework::SetElementStateCoord {

public:

  /// Constructor
  SetPyramLagrangeP1LagrangeP0StateCoord() : Framework::SetElementStateCoord()
  {
  }

  /// Destructor
  ~SetPyramLagrangeP1LagrangeP0StateCoord()
  {
  }
...
}; // end of class SetPyramLagrangeP1LagrangeP0StateCoord
...
#endif // COOLFluiD_ShapeFunctions_SetPyramLagrangeP1LagrangeP0StateCoord_hh
