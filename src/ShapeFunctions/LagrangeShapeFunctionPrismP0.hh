...
#ifndef COOLFluiD_ShapeFunctions_LagrangeShapeFunctionPrismP0_hh
#define COOLFluiD_ShapeFunctions_LagrangeShapeFunctionPrismP0_hh
...
class ShapeFunctions_API LagrangeShapeFunctionPrismP0 : public ShapeFunctions::LagrangeShapeFunction {
public:
  ...
  {
    static const std::string name = "LagrangePrismP0";
    return name;
  }
...
}; // end of class LagrangeShapeFunctionPrismP0
...
#endif // COOLFluiD_ShapeFunctions_LagrangeShapeFunctionPrismP0_hh
