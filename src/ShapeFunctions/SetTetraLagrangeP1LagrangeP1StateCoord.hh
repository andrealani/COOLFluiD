...
#ifndef COOLFluiD_ShapeFunctions_SetTetraLagrangeP1LagrangeP1StateCoord_hh
#define COOLFluiD_ShapeFunctions_SetTetraLagrangeP1LagrangeP1StateCoord_hh
...
/// interpolation.
/// @author Andrea Lani
class ShapeFunctions_API SetTetraLagrangeP1LagrangeP1StateCoord : public Framework::SetElementStateCoord {
public:

  /// Constructor
  SetTetraLagrangeP1LagrangeP1StateCoord() : Framework::SetElementStateCoord()
  {
  }

  /// Destructor
  ~SetTetraLagrangeP1LagrangeP1StateCoord()
  {
  }
...
}; // end of class SetTetraLagrangeP1LagrangeP1StateCoord
...
#endif // COOLFluiD_ShapeFunctions_SetTetraLagrangeP1LagrangeP1StateCoord_hh
