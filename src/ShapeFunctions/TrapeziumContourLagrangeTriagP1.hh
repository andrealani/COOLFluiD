...
#ifndef COOLFluiD_ShapeFunctions_TrapeziumContourLagrangeTriagP1_hh
#define COOLFluiD_ShapeFunctions_TrapeziumContourLagrangeTriagP1_hh
...
class TrapeziumContourLagrangeTriagP1 : public Framework::ContourIntegratorImpl {
public:
  ...
  {
    return "TrapeziumContourLagrangeTriagP1";
  }
  ...
  const std::vector<RealVector>& getQuadraturePointsCoordinates() const
  {
    throw Common::NotImplementedException
      (FromHere(), "TrapeziumContourLagrangeTriagP1::getQuadraturePointsCoordinates()");
  }
  ...
  {
    throw Common::NotImplementedException
      (FromHere(), "TrapeziumContourLagrangeTriagP1::getShapeFunctionsAtQuadraturePoints()");
  }
  ...
  {
    throw Common::NotImplementedException
      (FromHere(), "TrapeziumContourLagrangeTriagP1::computeShapeFunctionsAtQuadraturePoints()");
  }
...
}; // end class TrapeziumContourLagrangeTriagP1
...
#endif // COOLFluiD_ShapeFunctions_TrapeziumContourLagrangeTriagP1_hh
