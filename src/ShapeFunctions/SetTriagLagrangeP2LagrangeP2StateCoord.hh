...
#ifndef COOLFluiD_ShapeFunctions_SetTriagLagrangeP2LagrangeP2StateCoord_hh
#define COOLFluiD_ShapeFunctions_SetTriagLagrangeP2LagrangeP2StateCoord_hh
...
class ShapeFunctions_API SetTriagLagrangeP2LagrangeP2StateCoord : public Framework::SetElementStateCoord {
public:

  /// Constructor
  SetTriagLagrangeP2LagrangeP2StateCoord() :
  Framework::SetElementStateCoord(),
  _tempMappedCoords(6),
  _tempShapeFunctions(6)
  {
...
}; // end of class SetTriagLagrangeP2LagrangeP2StateCoord
...
#endif // COOLFluiD_ShapeFunctions_SetTriagLagrangeP2LagrangeP2StateCoord_hh
