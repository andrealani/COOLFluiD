...
Environment::ObjectProvider<SetTriagLagrangeP2LagrangeP2StateCoord,
           Framework::SetElementStateCoord,  ShapeFunctionsLib>
SetTriagLagrangeP2LagrangeP2StateCoord("TriagLagrangeP2LagrangeP2");

//////////////////////////////////////////////////////////////////////////////

void SetTriagLagrangeP2LagrangeP2StateCoord::operator() (const vector<Framework::Node*>& nodes,
...
void SetTriagLagrangeP2LagrangeP2StateCoord::update(const vector<Framework::Node*>& nodes,
                                    vector<Framework::State*>& states)
{
  /*
  cf_assert(states.size() == 6);
