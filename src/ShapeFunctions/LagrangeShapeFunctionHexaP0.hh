...
#ifndef COOLFluiD_ShapeFunctions_LagrangeShapeFunctionHexaP0_hh
#define COOLFluiD_ShapeFunctions_LagrangeShapeFunctionHexaP0_hh
...
class ShapeFunctions_API LagrangeShapeFunctionHexaP0 : public ShapeFunctions::LagrangeShapeFunction {
public:
  ...
  {
    static const std::string name = "LagrangeHexaP0";
    return name;
  }

  /// Get the ID for this interpolator
  static Framework::InterpolatorID getInterpolatorID()
  {
    return _interpolatorID;
  }

  /// Set the ID for this interpolator
...
}; // end of class LagrangeShapeFunctionHexaP0
...
#endif // COOLFluiD_ShapeFunctions_LagrangeShapeFunctionHexaP0_hh
