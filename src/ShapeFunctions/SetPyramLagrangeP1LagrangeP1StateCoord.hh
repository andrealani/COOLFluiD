...
#ifndef COOLFluiD_ShapeFunctions_SetPyramLagrangeP1LagrangeP1StateCoord_hh
#define COOLFluiD_ShapeFunctions_SetPyramLagrangeP1LagrangeP1StateCoord_hh
...
/// the State's in a pyramid with P1 geometrical and solution
/// interpolation.
/// @author Tiago Quintino
class ShapeFunctions_API SetPyramLagrangeP1LagrangeP1StateCoord : public Framework::SetElementStateCoord {
public:

  /// Constructor
  SetPyramLagrangeP1LagrangeP1StateCoord() : Framework::SetElementStateCoord()
  {
  }

  /// Destructor
  ~SetPyramLagrangeP1LagrangeP1StateCoord()
  {
  }
...
}; // end of class SetPyramLagrangeP1LagrangeP1StateCoord
...
#endif // COOLFluiD_ShapeFunctions_SetPyramLagrangeP1LagrangeP1StateCoord_hh
