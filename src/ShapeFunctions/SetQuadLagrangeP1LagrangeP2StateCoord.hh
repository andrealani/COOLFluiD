...
#ifndef COOLFluiD_ShapeFunctions_SetQuadLagrangeP1LagrangeP2StateCoord_hh
#define COOLFluiD_ShapeFunctions_SetQuadLagrangeP1LagrangeP2StateCoord_hh
...
class ShapeFunctions_API SetQuadLagrangeP1LagrangeP2StateCoord : public Framework::SetElementStateCoord {
public:

  /// Constructor
  SetQuadLagrangeP1LagrangeP2StateCoord() :
  Framework::SetElementStateCoord(),
  _tempMappedCoords(9),
  _tempShapeFunctions(4)
  {
...
}; // end of class SetQuadLagrangeP1LagrangeP2StateCoord
...
#endif // COOLFluiD_ShapeFunctions_SetQuadLagrangeP1LagrangeP2StateCoord_hh
