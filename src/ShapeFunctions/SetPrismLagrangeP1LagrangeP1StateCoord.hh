...
#ifndef COOLFluiD_ShapeFunctions_SetPrismLagrangeP1LagrangeP1StateCoord_hh
#define COOLFluiD_ShapeFunctions_SetPrismLagrangeP1LagrangeP1StateCoord_hh
...
/// the State's in a prism with P1 geometrical and solution
/// interpolation.
/// @author Tiago Quintino
class ShapeFunctions_API SetPrismLagrangeP1LagrangeP1StateCoord : public Framework::SetElementStateCoord {

public:

  /// Constructor
  SetPrismLagrangeP1LagrangeP1StateCoord() : Framework::SetElementStateCoord()
  {
  }

  /// Destructor
  ~SetPrismLagrangeP1LagrangeP1StateCoord()
  {
  }
...
}; // end of class SetPrismLagrangeP1LagrangeP1StateCoord
...
#endif // COOLFluiD_ShapeFunctions_SetPrismLagrangeP1LagrangeP1StateCoord_hh
