...
#ifndef COOLFluiD_ShapeFunctions_VolumeGaussLegendre1LagrangePyram_hh
#define COOLFluiD_ShapeFunctions_VolumeGaussLegendre1LagrangePyram_hh
...
class VolumeGaussLegendre1LagrangePyram : public Framework::GaussLegendreVolumeIntegratorImpl<VolumeGaussLegendre1LagrangePyram<INTERPOLATOR>,INTERPOLATOR> {
public:
...
protected: // methods
  using Framework::GaussLegendreVolumeIntegratorImpl<VolumeGaussLegendre1LagrangePyram<INTERPOLATOR>,INTERPOLATOR>::_mappedCoord;
  using Framework::GaussLegendreVolumeIntegratorImpl<VolumeGaussLegendre1LagrangePyram<INTERPOLATOR>,INTERPOLATOR>::_coeff;
  /// Set the mapped coordinates
  /// @todo Compute coordinates for Pyram
  void setMappedCoordinates();

  /// Set the weights
  /// @todo Compute weights for Pyram
  void setWeights();

}; // end VolumeGaussLegendre1LagrangePyram
...
#endif // COOLFluiD_ShapeFunctions_VolumeGaussLegendre1LagrangePyram_hh
