...
#ifndef COOLFluiD_ShapeFunctions_LagrangeShapeFunctionTetraP0_hh
#define COOLFluiD_ShapeFunctions_LagrangeShapeFunctionTetraP0_hh
...
/// triangular element.
/// @author Andrea Lani
class ShapeFunctions_API LagrangeShapeFunctionTetraP0 : public ShapeFunctions::LagrangeShapeFunction {
public:
  ...
  static void getStatesMappedCoordinates(std::vector<RealVector>& mappedCoords)
  {
    ...
    mappedCoords[0][KSI] = 0.25 ;
    mappedCoords[0][ETA] = 0.25 ;
    mappedCoords[0][ZTA] = 0.25 ;
  ...
  {
    static const std::string name = "LagrangeTetraP0";
    return name;
  }
  ...
  {
    /// Constant element -> same as computeAvgFaceNormals for all mappedCoord
...
}; // end of class LagrangeShapeFunctionTetraP0
...
#endif // COOLFluiD_ShapeFunctions_LagrangeShapeFunctionTetraP0_hh
