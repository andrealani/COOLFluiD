...
#ifndef COOLFluiD_ShapeFunctions_SetTriagLagrangeP3LagrangeP3StateCoord_hh
#define COOLFluiD_ShapeFunctions_SetTriagLagrangeP3LagrangeP3StateCoord_hh
...
/// the State's in a triangle with P3 geometrical and P3 solution
/// interpolation.
/// @author Thomas Wuilbaut
class ShapeFunctions_API SetTriagLagrangeP3LagrangeP3StateCoord : public Framework::SetElementStateCoord {
public:

  /// Constructor
  SetTriagLagrangeP3LagrangeP3StateCoord() :
  Framework::SetElementStateCoord(),
  _tempMappedCoords(10),
  _tempShapeFunctions(10)
  {
    const CFuint nbMappedCoordinates = 2;
...
}; // end of class SetTriagLagrangeP3LagrangeP3StateCoord
...
#endif // COOLFluiD_ShapeFunctions_SetTriagLagrangeP3LagrangeP3StateCoord_hh
