...
#ifndef COOLFluiD_ShapeFunctions_LagrangeShapeFunctionQuadP0_hh
#define COOLFluiD_ShapeFunctions_LagrangeShapeFunctionQuadP0_hh
...
/// triangular element.
/// @author Andrea Lani
class ShapeFunctions_API LagrangeShapeFunctionQuadP0 : public ShapeFunctions::LagrangeShapeFunction {
public:
  ...
  /// mapped coordinates
  static void computeShapeFunctions( const std::vector<RealVector>& mappedCoord, std::vector<RealVector>& shapeFunc)
  {
  ...
  {
    static const std::string name("LagrangeQuadP0");
    return name;
  }
  ...
  {
    throw Common::NotImplementedException (FromHere(), getName()+"::computeMappedCoordinatesPlus1D()");
  }
  ...
  {
    throw Common::NotImplementedException (FromHere(), getName()+"::computeMappedCoordinatesPlus2D()");
  }
  ...
  static RealVector computeCellNormal(const std::vector<Framework::Node*>& nodes)
  {
...
private:
  ...
  static Framework::InterpolatorID _interpolatorID;

}; // end of class LagrangeShapeFunctionQuadP0
...
#endif // COOLFluiD_ShapeFunctions_LagrangeShapeFunctionQuadP0_hh
