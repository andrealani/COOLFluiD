...
#ifndef COOLFluiD_ShapeFunctions_VolumeGaussLegendre6LagrangeTetra_hh
#define COOLFluiD_ShapeFunctions_VolumeGaussLegendre6LagrangeTetra_hh
...
class VolumeGaussLegendre6LagrangeTetra :
public Framework::GaussLegendreVolumeIntegratorImpl<VolumeGaussLegendre6LagrangeTetra<INTERPOLATOR>,INTERPOLATOR> {
public:

  /// Gets the name of this concrete integrator
  static const std::string getName()
  {
    return "VolumeGaussLegendre6" + INTERPOLATOR::getName();
  }
...
protected: // methods
  using Framework::GaussLegendreVolumeIntegratorImpl<VolumeGaussLegendre6LagrangeTetra<INTERPOLATOR>,INTERPOLATOR>::_mappedCoord;
  using Framework::GaussLegendreVolumeIntegratorImpl<VolumeGaussLegendre6LagrangeTetra<INTERPOLATOR>,INTERPOLATOR>::_coeff;
...
}; // end VolumeGaussLegendre6LagrangeTetra
...
#endif // COOLFluiD_ShapeFunctions_VolumeGaussLegendre6LagrangeTetra_hh
