...
#ifndef CF_LOGCPP_CATEGORY_HH
#define CF_LOGCPP_CATEGORY_HH
...
namespace logcpp {
     ...
     * features of log4j (and hence logcpp) are hierarchal categories and
     * their evaluation.
     **/
    class logcpp_API Category {
