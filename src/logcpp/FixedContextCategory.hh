...
#ifndef CF_LOGCPP_FIXEDCONTEXTCATEGORY_HH
#define CF_LOGCPP_FIXEDCONTEXTCATEGORY_HH
...
namespace logcpp {
     ...
     * @since 0.2.4
     **/
    class logcpp_API FixedContextCategory : public Category {
...
#endif // CF_LOGCPP_FIXEDCONTEXTCATEGORY_HH
