...
#ifndef CF_LOGCPP_FILTER_HH
#define CF_LOGCPP_FILTER_HH
...
namespace logcpp {
    ...
    /**
       ...
       event filtering. Note that {@link logcpp::Category} and {@link
       logcpp::Appender} have built-in filtering rules. It is suggested 
       ...
       <p>The philosophy of logcpp filters is largely inspired from the
       Linux ipchains. 
    **/

    class logcpp_API Filter {
        public:
