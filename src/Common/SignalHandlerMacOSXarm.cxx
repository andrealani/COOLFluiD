...
fegetexcept (void)
{
  ...
  return fegetenv (&fenv) ? -1 : (fenv.__fpcr & FE_ALL_EXCEPT);
}
...
SignalHandlerMacOSXarm::SignalHandlerMacOSXarm()
{
}
...
void SignalHandlerMacOSXarm::registSignalHandlers()
{
  // register handler functions for the signals
  signal(SIGFPE,    (sighandler_t) SignalHandlerMacOSXarm::handleSIGFPE);
  signal(SIGSEGV,   (sighandler_t) SignalHandlerMacOSXarm::handleSIGSEGV);
...
int SignalHandlerMacOSXarm::handleSIGFPE (int signal)
{
...
int SignalHandlerMacOSXarm::handleSIGSEGV(int signal)
{
