...
#ifndef COOLFluiD_Framework_TrsMultiGeoWithNodesBuilder_hh
#define COOLFluiD_Framework_TrsMultiGeoWithNodesBuilder_hh
...
class Framework_API TrsMultiGeoWithNodesBuilder {
public:
  ...
  /// the data aggregated by this TrsMultiGeoWithNodesBuilder
  /// @see TopologicalRegionSet
  /// @author Andrea Lani
  /// @author Tiago Quintino
  ...
  TrsMultiGeoWithNodesBuilder::GeoData& getDataGE() {  return _data;  }
...
private:
  ...
  TrsMultiGeoWithNodesBuilder::GeoData _data;
...
}; // end of class TrsMultiGeoWithNodesBuilder
...
#endif // COOLFluiD_Framework_TrsMultiGeoWithNodesBuilder_hh
