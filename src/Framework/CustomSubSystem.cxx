...
{
  Common::SafePtr<Framework::Method> method_ptr = MethodRegistry::getInstance().getMethod(method_name);
  CFout << "Executing function [" << function_name << "] in method ["<<  method_name << "]\n";
  method_ptr->run_function(function_name);
  CFout << "Finished  function [" << function_name << "] in method ["<<  method_name << "]\n";
}
